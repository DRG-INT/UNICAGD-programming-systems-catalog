...
<!-- canonical: https://github.com/zilliztech/attu -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/zilliztech/attu](https://github.com/zilliztech/attu) |
| Source record ids | github_search_databases-a36ae79a38a5a1 |

## System Engineer Summary

zilliztech/attu is tracked as a database datastore record in the Databases branch. The source did
...
For a systems engineer, zilliztech/attu belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-11T06:23:28Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-a36ae79a38a5a1` from `github_search_databases` as `registry_expansion`
