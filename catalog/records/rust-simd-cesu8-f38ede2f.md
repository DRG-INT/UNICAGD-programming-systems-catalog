...
| Canonical URL | [https://crates.io/crates/simd_cesu8](https://crates.io/crates/simd_cesu8) |
| Source record ids | crates_io-d7482ef2df34c8 |
...
For a systems engineer, simd_cesu8 belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0 | 2026-07-13T21:51:49.803302Z | [https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads) |  |
...
- `crates_io-d7482ef2df34c8` from `crates_io` as `registry_expansion`
