...
| Source record ids | github_search_swift-053d856d1b05c1 |
...
For a systems engineer, iina/iina belongs in the Swift inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T18:10:02Z | gh search repos language:Swift stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-053d856d1b05c1` from `github_search_swift` as `registry_expansion`
