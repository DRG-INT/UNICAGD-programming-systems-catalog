...
<!-- canonical: https://cran.r-project.org/web/packages/rpql/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rpql/index.html](https://cran.r-project.org/web/packages/rpql/index.html) |
| Source record ids | cran_packages_by_date-70719cdf898be8 |
...
For a systems engineer, rpql belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.4 | 2026-09-06 22:10:02 UTC | [https://cran.r-project.org/web/packages/rpql/DESCRIPTION](https://cran.r-project.org/web/packages/rpql/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rpql/DESCRIPTION` at `2026-09-06T22:18:48+00:00`.
...
- `cran_packages_by_date-70719cdf898be8` from `cran_packages_by_date` as `registry_expansion`
