# Muhammaduazir69/ns3-ntn-toolkit
...
<!-- canonical: https://github.com/Muhammaduazir69/ns3-ntn-toolkit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Muhammaduazir69/ns3-ntn-toolkit](https://github.com/Muhammaduazir69/ns3-ntn-toolkit) |
| Source record ids | github_search_satcom_satellites-a7ddeceb977b27 |

## System Engineer Summary

End-to-end ns-3.43 simulator for 6G non-terrestrial networks: measured NR-NTN data plane under SGP4
mobility, NTN/O-RAN application layer with in-band QoS KPIs, E2SM-KPM flow monitor, multi-tier RIC,
regenerative payloads, TR 38.821-calibrated radio, all 5 NTN handover trigger classes, THz, Sionna
RT, AI/ML, digital twin.

## Operational Role

For a systems engineer, Muhammaduazir69/ns3-ntn-toolkit belongs in the SatCom Satellites inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.0.2 | 2026-06-04T21:39:28Z | [https://api.github.com/repos/Muhammaduazir69/ns3-ntn-toolkit/releases/latest](https://api.github.com/repos/Muhammaduazir69/ns3-ntn-toolkit/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/Muhammaduazir69/ns3-ntn-toolkit/releases/latest` at `2026-09-01T08:26:36+00:00`.
...
- `github_search_satcom_satellites-a7ddeceb977b27` from `github_search_satcom_satellites` as `registry_expansion`
