...
<!-- canonical: https://cran.r-project.org/web/packages/RtForecastR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/RtForecastR/index.html](https://cran.r-project.org/web/packages/RtForecastR/index.html) |
| Source record ids | cran_packages_by_date-f0a15dc89e5fef |
...
For a systems engineer, RtForecastR belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-08-21 13:10:37 UTC | [https://cran.r-project.org/web/packages/RtForecastR/DESCRIPTION](https://cran.r-project.org/web/packages/RtForecastR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/RtForecastR/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-f0a15dc89e5fef` from `cran_packages_by_date` as `registry_expansion`
