...
<!-- canonical: https://github.com/kiraio-moe/Schale-Archive -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kiraio-moe/Schale-Archive](https://github.com/kiraio-moe/Schale-Archive) |
| Source record ids | github_search_assets-89f080014e6951 |

## System Engineer Summary

Blue Archive game assets & resources collection.

## Operational Role

For a systems engineer, kiraio-moe/Schale-Archive belongs in the Assets inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-01-06T07:45:01Z | gh search repos topic:game-assets stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-89f080014e6951` from `github_search_assets` as `registry_expansion`
