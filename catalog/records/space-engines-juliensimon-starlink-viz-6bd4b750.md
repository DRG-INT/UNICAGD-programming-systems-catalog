...
<!-- canonical: https://github.com/juliensimon/starlink-viz -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/juliensimon/starlink-viz](https://github.com/juliensimon/starlink-viz) |
| Source record ids | github_search_space_engines-522188ba9b2928 |

## System Engineer Summary

Real-time 3D Starlink satellite tracker with Space view, Sky view, live dish telemetry, SGP4
propagation, and ISL routing. Track ~10,000 satellites, ground stations, handoffs, and network
performance — built with Next.js and Three.js.

## Operational Role

For a systems engineer, juliensimon/starlink-viz belongs in the Space Engines inventory as part of
...
- `github_search_space_engines-522188ba9b2928` from `github_search_space_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| nmisyats/KSP-MGA-Planner | Type Checker | [open](space-engines-nmisyats-ksp-mga-planner-a09837d6.md) |
