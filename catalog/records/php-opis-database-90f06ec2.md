...
<!-- canonical: https://packagist.org/packages/opis/database -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/opis/database](https://packagist.org/packages/opis/database) |
| Source record ids | packagist_search-f424008c71bead |

## System Engineer Summary

A database abstraction layer over PDO, that provides a powerful and intuitive query builder, bundled
with an easy to use schema builder

## Operational Role

For a systems engineer, opis/database belongs in the PHP inventory as part of build graph control,
...
- `packagist_search-f424008c71bead` from `packagist_search` as `registry_expansion`
