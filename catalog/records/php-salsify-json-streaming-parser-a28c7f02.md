...
<!-- canonical: https://packagist.org/packages/salsify/json-streaming-parser -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/salsify/json-streaming-parser](https://packagist.org/packages/salsify/json-streaming-parser) |
| Source record ids | packagist_search-f34b340bfe83a7 |
...
For a systems engineer, salsify/json-streaming-parser belongs in the PHP inventory as part of
...
- `packagist_search-f34b340bfe83a7` from `packagist_search` as `registry_expansion`
