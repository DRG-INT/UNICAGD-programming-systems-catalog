...
| Canonical URL | [https://luarocks.org/modules/ganesan/jsonpath](https://luarocks.org/modules/ganesan/jsonpath) |
| Source record ids | luarocks_root_manifest-18917247736b8a |
...
For a systems engineer, jsonpath belongs in the Lua family inventory as part of wire formats,
...
- `luarocks_root_manifest-18917247736b8a` from `luarocks_root_manifest` as `registry_expansion`
