...
[Catalog index](../index.md) · [Language: "aim's"](../by-language/aim-s.md) · [Category: Dependency Manager](../by-category/dependency-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/rtk-ai/rtk -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rtk-ai/rtk](https://github.com/rtk-ai/rtk) |
| Source record ids | github_search_aims-00a4ebef580424 |
...
For a systems engineer, rtk-ai/rtk belongs in the "aim's" inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T20:36:29Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-00a4ebef580424` from `github_search_aims` as `registry_expansion`
