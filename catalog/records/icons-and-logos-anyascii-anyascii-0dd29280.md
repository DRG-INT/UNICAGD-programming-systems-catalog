...
<!-- canonical: https://github.com/anyascii/anyascii -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/anyascii/anyascii](https://github.com/anyascii/anyascii) |
| Source record ids | github_search_icons_and_logos-5ae2de8f41194e |
...
For a systems engineer, anyascii/anyascii belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-06T10:27:53Z | gh search repos topic:emoji stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-5ae2de8f41194e` from `github_search_icons_and_logos` as `registry_expansion`
