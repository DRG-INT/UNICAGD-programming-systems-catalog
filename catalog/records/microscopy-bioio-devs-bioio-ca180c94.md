...
| Canonical URL | [https://github.com/bioio-devs/bioio](https://github.com/bioio-devs/bioio) |
| Source record ids | github_search_microscopy-791a4ff7b9acc0 |
...
For a systems engineer, bioio-devs/bioio belongs in the Microscopy inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v3.4.0 | 2026-06-24T18:23:39Z | [https://api.github.com/repos/bioio-devs/bioio/releases/latest](https://api.github.com/repos/bioio-devs/bioio/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/bioio-devs/bioio/releases/latest` at `2026-09-01T08:26:16+00:00`.
...
- `github_search_microscopy-791a4ff7b9acc0` from `github_search_microscopy` as `registry_expansion`
