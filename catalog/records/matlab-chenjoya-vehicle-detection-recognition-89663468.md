...
<!-- canonical: https://github.com/chenjoya/Vehicle_Detection_Recognition -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/chenjoya/Vehicle_Detection_Recognition](https://github.com/chenjoya/Vehicle_Detection_Recognition) |
| Source record ids | github_search_matlab-d10cc64e009e35 |

## System Engineer Summary

This is a Matlab lesson design for vehicle detection and recognition. Using cifar-10Net to training
a RCNN, and finetune AlexNet to classify. Thanks to Cars Dataset:

## Operational Role

For a systems engineer, chenjoya/Vehicle_Detection_Recognition belongs in the Matlab inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-06-06T09:31:11Z | gh search repos language:MATLAB topic:matlab | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-d10cc64e009e35` from `github_search_matlab` as `registry_expansion`
