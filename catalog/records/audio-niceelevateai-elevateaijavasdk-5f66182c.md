...
<!-- canonical: https://github.com/NICEElevateAI/ElevateAIJavaSDK -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/NICEElevateAI/ElevateAIJavaSDK](https://github.com/NICEElevateAI/ElevateAIJavaSDK) |
| Source record ids | github_search_audio-9428f87b25d50d |

## System Engineer Summary

NICEElevateAI/ElevateAIJavaSDK is tracked as a machine learning record in the Audio branch. The
...
For a systems engineer, NICEElevateAI/ElevateAIJavaSDK belongs in the Audio inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-05-04T17:08:59Z | gh search repos topic:speech-processing stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | GPL (>= 2) \| file LICENCE; MIT License; https://api.github.com/licenses/mit |
...
- `github_search_audio-9428f87b25d50d` from `github_search_audio` as `registry_expansion`
