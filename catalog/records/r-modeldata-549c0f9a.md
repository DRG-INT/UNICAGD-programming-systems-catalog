...
<!-- canonical: https://cran.r-project.org/web/packages/modeldata/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/modeldata/index.html](https://cran.r-project.org/web/packages/modeldata/index.html) |
| Source record ids | cran_packages_by_date-e0adf9a594d7b0 |
...
For a systems engineer, modeldata belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.6.0 | 2026-08-21 11:10:02 UTC | [https://cran.r-project.org/web/packages/modeldata/DESCRIPTION](https://cran.r-project.org/web/packages/modeldata/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/modeldata/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-e0adf9a594d7b0` from `cran_packages_by_date` as `registry_expansion`
