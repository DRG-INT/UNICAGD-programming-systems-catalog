...
<!-- canonical: https://cran.r-project.org/web/packages/flightsbr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/flightsbr/index.html](https://cran.r-project.org/web/packages/flightsbr/index.html) |
| Source record ids | cran_packages_by_date-168075dc51e7a5 |
...
For a systems engineer, flightsbr belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0 | 2026-08-21 21:00:33 UTC | [https://cran.r-project.org/web/packages/flightsbr/DESCRIPTION](https://cran.r-project.org/web/packages/flightsbr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/flightsbr/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-168075dc51e7a5` from `cran_packages_by_date` as `registry_expansion`
