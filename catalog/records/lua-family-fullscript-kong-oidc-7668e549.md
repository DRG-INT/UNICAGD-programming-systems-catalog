...
| Canonical URL | [https://luarocks.org/modules/fullscript-devops/fullscript-kong-oidc](https://luarocks.org/modules/fullscript-devops/fullscript-kong-oidc) |
| Source record ids | luarocks_root_manifest-eed0a01ab813c2 |
...
For a systems engineer, fullscript-kong-oidc belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-eed0a01ab813c2` from `luarocks_root_manifest` as `registry_expansion`
