...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CitableText](https://github.com/JuliaRegistries/General/tree/master/C/CitableText) |
| Source record ids | julia_general-240108d517df0d |

## System Engineer Summary

Julia package registered in General at C/CitableText.

## Operational Role

For a systems engineer, CitableText belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CitableText", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-240108d517df0d` from `julia_general` as `registry_expansion`
