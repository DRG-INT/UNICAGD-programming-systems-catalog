...
<!-- canonical: https://crates.io/crates/aes -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/aes](https://crates.io/crates/aes) |
| Source record ids | crates_io-828b2f6f4b3bf4 |
...
For a systems engineer, aes belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.3 | 2026-08-28T14:49:06.194127Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- `crates_io-828b2f6f4b3bf4` from `crates_io` as `registry_expansion`
