...
<!-- canonical: https://github.com/supertone-inc/supertonic -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/supertone-inc/supertonic](https://github.com/supertone-inc/supertonic) |
| Source record ids | github_search_swift-1572c3a72b3103 |
...
For a systems engineer, supertone-inc/supertonic belongs in the Swift inventory as part of runtime
...
- `github_search_swift-1572c3a72b3103` from `github_search_swift` as `registry_expansion`
...
| vapor-community/vapor-aws-lambda-runtime | Interpreter Runtime | [open](swift-vapor-community-vapor-aws-lambda-runtime-99d3d03d.md) |
