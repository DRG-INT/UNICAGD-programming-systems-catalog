...
<!-- canonical: https://cran.r-project.org/web/packages/weatherMRJD/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/weatherMRJD/index.html](https://cran.r-project.org/web/packages/weatherMRJD/index.html) |
| Source record ids | cran_packages_by_date-bc4efa4d8484b6 |
...
For a systems engineer, weatherMRJD belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-08-20 15:20:02 UTC | [https://cran.r-project.org/web/packages/weatherMRJD/DESCRIPTION](https://cran.r-project.org/web/packages/weatherMRJD/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/weatherMRJD/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-bc4efa4d8484b6` from `cran_packages_by_date` as `registry_expansion`
