...
[Catalog index](../index.md) · [Language: Haskell](../by-language/haskell.md) · [Category: Api Abi Checker](../by-category/api-abi-checker.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://hackage.haskell.org/package/telegram-api -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/telegram-api](https://hackage.haskell.org/package/telegram-api) |
| Source record ids | hackage_top_downloads-00203d525269ef |
...
For a systems engineer, telegram-api belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.2.0 | 2018-01-22T04:42:45Z | [https://hackage.haskell.org/package/telegram-api](https://hackage.haskell.org/package/telegram-api) |  |
| candidate | partial | 0.1.0.0 |  | [https://hackage.haskell.org/package/telegram-api](https://hackage.haskell.org/package/telegram-api) | hackage_candidate_date_missing |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0 |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/telegram-api` at `2026-09-01T14:24:32+00:00`.
...
- `hackage_top_downloads-00203d525269ef` from `hackage_top_downloads` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| advent-of-code-api | Api Abi Checker | [open](haskell-advent-of-code-api-84c4b5b1.md) |
| apiary | Api Abi Checker | [open](haskell-apiary-099546ad.md) |
| apiary-cookie | Api Abi Checker | [open](haskell-apiary-cookie-c33374cd.md) |
| cachix-api | Api Abi Checker | [open](haskell-cachix-api-422fb824.md) |
| hapistrano | Api Abi Checker | [open](haskell-hapistrano-9477229e.md) |
| hls-plugin-api | Api Abi Checker | [open](haskell-hls-plugin-api-d1d79e30.md) |
| hspec-api | Api Abi Checker | [open](haskell-hspec-api-3cd9511e.md) |
| keel-abi | Api Abi Checker | [open](haskell-keel-abi-d416a882.md) |
