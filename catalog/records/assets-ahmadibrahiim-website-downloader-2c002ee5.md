...
<!-- canonical: https://github.com/AhmadIbrahiim/Website-downloader -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AhmadIbrahiim/Website-downloader](https://github.com/AhmadIbrahiim/Website-downloader) |
| Source record ids | github_search_assets-329db7da5f3067 |

## System Engineer Summary

💡 Download the complete source code of any website (including all assets). Javascripts, Stylesheets,
Images using Node.js

## Operational Role

For a systems engineer, AhmadIbrahiim/Website-downloader belongs in the Assets inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-12T16:37:38Z | gh search repos topic:assets stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-329db7da5f3067` from `github_search_assets` as `registry_expansion`
