...
<!-- canonical: https://crates.io/crates/ciborium -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/ciborium](https://crates.io/crates/ciborium) |
| Source record ids | crates_io-0603b1e7941b8b |
...
For a systems engineer, ciborium belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.2 | 2024-01-24T03:04:25.973012Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
- `crates_io-0603b1e7941b8b` from `crates_io` as `registry_expansion`
