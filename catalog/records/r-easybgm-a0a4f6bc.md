...
<!-- canonical: https://cran.r-project.org/web/packages/easybgm/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/easybgm/index.html](https://cran.r-project.org/web/packages/easybgm/index.html) |
| Source record ids | cran_packages_by_date-f1ef408e130e31 |
...
For a systems engineer, easybgm belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2026-09-10 11:30:02 UTC | [https://cran.r-project.org/web/packages/easybgm/DESCRIPTION](https://cran.r-project.org/web/packages/easybgm/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/easybgm/DESCRIPTION` at `2026-09-10T12:26:17+00:00`.
...
- `cran_packages_by_date-f1ef408e130e31` from `cran_packages_by_date` as `registry_expansion`
