...
<!-- canonical: https://gitlab.com/to-be-continuous/mobsf -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/to-be-continuous/mobsf](https://gitlab.com/to-be-continuous/mobsf) |
| Source record ids | gitlab_projects_api-4cd469c10b3b22 |

## System Engineer Summary

to-be-continuous/mobsf is tracked as a project scaffolding record in the Repository Workplaces
...
For a systems engineer, to-be-continuous/mobsf belongs in the Repository Workplaces inventory as
...
- `gitlab_projects_api-4cd469c10b3b22` from `gitlab_projects_api` as `registry_expansion`
