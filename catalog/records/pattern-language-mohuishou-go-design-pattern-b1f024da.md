...
[Catalog index](../index.md) · [Language: Pattern language](../by-language/pattern-language.md) · [Category: Visualization Gui](../by-category/visualization-gui.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://github.com/mohuishou/go-design-pattern](https://github.com/mohuishou/go-design-pattern) |
| Source record ids | github_search_pattern_language-f0849c683be11c |
...
For a systems engineer, mohuishou/go-design-pattern belongs in the Pattern language inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.0.0 | 2020-11-05T06:18:11Z | [https://api.github.com/repos/mohuishou/go-design-pattern/releases/latest](https://api.github.com/repos/mohuishou/go-design-pattern/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/mohuishou/go-design-pattern/releases/latest` at `2026-09-01T12:30:28+00:00`.
...
- `github_search_pattern_language-f0849c683be11c` from `github_search_pattern_language` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| keenthemes/reui | Visualization Gui | [open](pattern-language-keenthemes-reui-f3f4a8f3.md) |
