...
<!-- canonical: https://github.com/jinleili/simuverse -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jinleili/simuverse](https://github.com/jinleili/simuverse) |
| Source record ids | github_search_physics_engines-f124b217d5d30f |

## System Engineer Summary

Simulate particle vector fields, fluid dynamics, procedural textures, and position-based dynamics
based on wgpu + egui

## Operational Role

For a systems engineer, jinleili/simuverse belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-15T09:52:13Z | gh search repos topic:fluid-simulation stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-f124b217d5d30f` from `github_search_physics_engines` as `registry_expansion`
