...
<!-- canonical: https://github.com/zbanks/radiance -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/zbanks/radiance](https://github.com/zbanks/radiance) |
| Source record ids | github_search_effects-eb36764b3586cd |

## System Engineer Summary

Radiance is video art software for VJs. It supports beat detection, animated GIFs, YouTube video,
OpenGL shader effects. It is designed for live performance and runs on Linux and MacOS.

## Operational Role

For a systems engineer, zbanks/radiance belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-23T01:55:44Z | gh search repos shader effects | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-eb36764b3586cd` from `github_search_effects` as `registry_expansion`
