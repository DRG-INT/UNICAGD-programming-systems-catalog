...
<!-- canonical: https://luarocks.org/modules/buffgenji/calky -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/buffgenji/calky](https://luarocks.org/modules/buffgenji/calky) |
| Source record ids | luarocks_root_manifest-b5705a29c2d5a0 |

## System Engineer Summary

A lua library that helps making small calculations while following along in class

## Operational Role

For a systems engineer, calky belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-b5705a29c2d5a0` from `luarocks_root_manifest` as `registry_expansion`
