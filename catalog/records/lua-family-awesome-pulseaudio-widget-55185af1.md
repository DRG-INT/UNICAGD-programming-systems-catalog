...
<!-- canonical: https://luarocks.org/modules/daskol/awesome-pulseaudio-widget -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/daskol/awesome-pulseaudio-widget](https://luarocks.org/modules/daskol/awesome-pulseaudio-widget) |
| Source record ids | luarocks_root_manifest-ae8915b7a874f9 |
...
For a systems engineer, awesome-pulseaudio-widget belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-ae8915b7a874f9` from `luarocks_root_manifest` as `registry_expansion`
