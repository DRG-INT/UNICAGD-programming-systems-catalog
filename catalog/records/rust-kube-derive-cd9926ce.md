...
| Canonical URL | [https://crates.io/crates/kube-derive](https://crates.io/crates/kube-derive) |
| Source record ids | crates_io-7b42e6317f3f30 |
...
For a systems engineer, kube-derive belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.2.0 | 2026-07-22T08:41:57.596494Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- `crates_io-7b42e6317f3f30` from `crates_io` as `registry_expansion`
