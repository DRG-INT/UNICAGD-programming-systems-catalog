...
<!-- canonical: https://luarocks.org/modules/akarmazyn/3rd-party-oauth -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/akarmazyn/3rd-party-oauth](https://luarocks.org/modules/akarmazyn/3rd-party-oauth) |
| Source record ids | luarocks_root_manifest-057f17f70f4351 |
...
For a systems engineer, 3rd-party-oauth belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-057f17f70f4351` from `luarocks_root_manifest` as `registry_expansion`
