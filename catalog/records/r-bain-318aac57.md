...
<!-- canonical: https://cran.r-project.org/web/packages/bain/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/bain/index.html](https://cran.r-project.org/web/packages/bain/index.html) |
| Source record ids | cran_packages_by_date-ce06effb70dfb8 |
...
For a systems engineer, bain belongs in the R inventory as part of low-noise code review, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.12 | 2026-08-24 11:20:08 UTC | [https://cran.r-project.org/web/packages/bain/DESCRIPTION](https://cran.r-project.org/web/packages/bain/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/bain/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-ce06effb70dfb8` from `cran_packages_by_date` as `registry_expansion`
