...
<!-- canonical: https://github.com/Softmotions/ejdb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Softmotions/ejdb](https://github.com/Softmotions/ejdb) |
| Source record ids | github_search_databases-504cdf968f7807 |

## System Engineer Summary

:snowboarder: EJDB2 — Embeddable JSON Database engine C library. Simple XPath like query language
(JQL).

## Operational Role

For a systems engineer, Softmotions/ejdb belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-30T12:04:25Z | gh search repos topic:nosql stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-504cdf968f7807` from `github_search_databases` as `registry_expansion`
...
| pgMagic🪄 | Language Specification | [open](databases-pgmagic-a4d9d632.md) |
