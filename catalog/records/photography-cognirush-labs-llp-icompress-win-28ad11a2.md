# Cognirush-Labs-LLP/icompress-win

## Navigation

[Catalog index](../index.md) · [Language: Photography](../by-language/photography.md) · [Category: Compression](../by-category/compression.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Cognirush-Labs-LLP/icompress-win -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Cognirush-Labs-LLP/icompress-win](https://github.com/Cognirush-Labs-LLP/icompress-win) |
| Source record ids | github_search_photography-2aba1567ce2284 |

## System Engineer Summary

Convert, Compress, Optimize Images in Bulk with Mass Image Compressor (Windows)

## Operational Role

For a systems engineer, Cognirush-Labs-LLP/icompress-win belongs in the Photography inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-09T09:48:14Z | gh search repos topic:raw-image stars:>20 | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; BSD 2-Clause "Simplified" License; https://api.github.com/licenses/bsd-2-clause; Apache License 2.0; https://api.github.com/licenses/apache-2.0; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0 |
...
- `github_search_photography-2aba1567ce2284` from `github_search_photography` as `registry_expansion`
