...
<!-- canonical: https://cran.r-project.org/web/packages/alcyon/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/alcyon/index.html](https://cran.r-project.org/web/packages/alcyon/index.html) |
| Source record ids | cran_packages_by_date-a2c14517bae66b |
...
For a systems engineer, alcyon belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.0 | 2026-08-29 22:40:08 UTC | [https://cran.r-project.org/web/packages/alcyon/DESCRIPTION](https://cran.r-project.org/web/packages/alcyon/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/alcyon/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-a2c14517bae66b` from `cran_packages_by_date` as `registry_expansion`
