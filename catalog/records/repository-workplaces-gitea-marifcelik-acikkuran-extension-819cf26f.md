# Gitea: marifcelik/acikkuran-extension

## Navigation

[Catalog index](../index.md) · [Language: Repository Workplaces](../by-language/repository-workplaces.md) · [Category: Precommit Ci Quality](../by-category/precommit-ci-quality.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://gitea.com/marifcelik/acikkuran-extension -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/marifcelik/acikkuran-extension](https://gitea.com/marifcelik/acikkuran-extension) |
| Source record ids | gitea_repositories_api-586cf7a8ca8230 |
...
For a systems engineer, Gitea: marifcelik/acikkuran-extension belongs in the Repository Workplaces
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-08T14:55:58Z | [https://gitea.com/api/v1/repos/search?q=ci&limit=50](https://gitea.com/api/v1/repos/search?q=ci&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| gitea_compatible_repository_search_api | forge-api-derived | 2026-09-10 | `{"endpoint": "Gitea", "kind": "gitea_compatible_repository_search_api", "query": "ci", "retrieved": "2026-09-10", "status": "forge-api-derived"}` |
...
- `gitea_repositories_api-586cf7a8ca8230` from `gitea_repositories_api` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Gitea Actions | Precommit Ci Quality | [open](repository-workplaces-gitea-actions-1ac1fc74.md) |
| Gitea: afzal/bangladesh-land-law-treatise | Precommit Ci Quality | [open](repository-workplaces-gitea-afzal-bangladesh-land-law-treatise-8fcb7e22.md) |
| Gitea: avagarcia000/Avagarcia-s-works | Precommit Ci Quality | [open](repository-workplaces-gitea-avagarcia000-avagarcia-s-works-97423086.md) |
| Gitea: B27_ADDIN/B27_CIV_BATCH | Precommit Ci Quality | [open](repository-workplaces-gitea-b27-addin-b27-civ-batch-5c3013c6.md) |
| Gitea: bancethreeleocico/bancethreeleocico | Precommit Ci Quality | [open](repository-workplaces-gitea-bancethreeleocico-bancethreeleocico-7a3e0761.md) |
| Gitea: baocode0411/ascii-art | Precommit Ci Quality | [open](repository-workplaces-gitea-baocode0411-ascii-art-6dc39c37.md) |
| Gitea: baocode0411/ascii-art-web | Precommit Ci Quality | [open](repository-workplaces-gitea-baocode0411-ascii-art-web-e9dce736.md) |
| Gitea: benito.rodriguez/ASCII_ROMPECABEZAS | Precommit Ci Quality | [open](repository-workplaces-gitea-benito-rodriguez-ascii-rompecabezas-4bd6f9e4.md) |
