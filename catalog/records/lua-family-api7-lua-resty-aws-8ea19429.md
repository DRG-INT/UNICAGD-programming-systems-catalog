...
<!-- canonical: https://luarocks.org/modules/membphis/api7-lua-resty-aws -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/membphis/api7-lua-resty-aws](https://luarocks.org/modules/membphis/api7-lua-resty-aws) |
| Source record ids | luarocks_root_manifest-644b3f0a151223 |

## System Engineer Summary

api7-lua-resty-aws is tracked as an api abi checker record in the Lua family branch. The source did
...
For a systems engineer, api7-lua-resty-aws belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-644b3f0a151223` from `luarocks_root_manifest` as `registry_expansion`
