...
<!-- canonical: https://cran.r-project.org/web/packages/mlr3inferr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mlr3inferr/index.html](https://cran.r-project.org/web/packages/mlr3inferr/index.html) |
| Source record ids | cran_packages_by_date-3773d4d89c8361 |
...
For a systems engineer, mlr3inferr belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.2 | 2026-08-21 06:20:19 UTC | [https://cran.r-project.org/web/packages/mlr3inferr/DESCRIPTION](https://cran.r-project.org/web/packages/mlr3inferr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mlr3inferr/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-3773d4d89c8361` from `cran_packages_by_date` as `registry_expansion`
