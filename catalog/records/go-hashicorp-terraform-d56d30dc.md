...
<!-- canonical: https://github.com/hashicorp/terraform -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/hashicorp/terraform](https://github.com/hashicorp/terraform) |
| Source record ids | github_search_go-38cf05a7120f17 |

## System Engineer Summary

Terraform enables you to safely and predictably create, change, and improve infrastructure. It is a
source-available tool that codifies APIs into declarative configuration files that can be shared
amongst team members, treated as code, edited, reviewed, and versioned.

## Operational Role

For a systems engineer, hashicorp/terraform belongs in the Go inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T18:53:29Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-38cf05a7120f17` from `github_search_go` as `registry_expansion`
