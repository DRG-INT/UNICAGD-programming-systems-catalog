...
<!-- canonical: https://cran.r-project.org/web/packages/stratifyR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/stratifyR/index.html](https://cran.r-project.org/web/packages/stratifyR/index.html) |
| Source record ids | cran_packages_by_date-5c497efdecf510 |
...
For a systems engineer, stratifyR belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0-1 | 2026-09-10 14:40:08 UTC | [https://cran.r-project.org/web/packages/stratifyR/DESCRIPTION](https://cran.r-project.org/web/packages/stratifyR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/stratifyR/DESCRIPTION` at `2026-09-10T15:20:55+00:00`.
...
- `cran_packages_by_date-5c497efdecf510` from `cran_packages_by_date` as `registry_expansion`
