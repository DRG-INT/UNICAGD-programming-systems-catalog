...
<!-- canonical: https://hackage.haskell.org/package/katip -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/katip](https://hackage.haskell.org/package/katip) |
| Source record ids | hackage_top_downloads-1670f00fe18ee2 |
...
For a systems engineer, katip belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.8.4 | 2025-09-03T02:05:46Z | [https://hackage.haskell.org/package/katip](https://hackage.haskell.org/package/katip) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/katip` at `2026-09-01T14:24:22+00:00`.
...
- `hackage_top_downloads-1670f00fe18ee2` from `hackage_top_downloads` as `registry_expansion`
