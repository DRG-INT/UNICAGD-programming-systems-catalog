...
<!-- canonical: https://cran.r-project.org/web/packages/gpciProgTyIIImpSam/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/gpciProgTyIIImpSam/index.html](https://cran.r-project.org/web/packages/gpciProgTyIIImpSam/index.html) |
| Source record ids | cran_packages_by_date-6923927596b6cd |

## System Engineer Summary

Generalized Process Capability Indices for Progressive Type-II Censored Data using Importance
Sampling

## Operational Role

For a systems engineer, gpciProgTyIIImpSam belongs in the R inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-07 21:00:02 UTC | [https://cran.r-project.org/web/packages/gpciProgTyIIImpSam/DESCRIPTION](https://cran.r-project.org/web/packages/gpciProgTyIIImpSam/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/gpciProgTyIIImpSam/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-6923927596b6cd` from `cran_packages_by_date` as `registry_expansion`
