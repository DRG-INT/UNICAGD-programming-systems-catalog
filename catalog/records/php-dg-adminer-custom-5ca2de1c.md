...
| Canonical URL | [https://packagist.org/packages/dg/adminer-custom](https://packagist.org/packages/dg/adminer-custom) |
| Source record ids | packagist_search-a8dffb4ec84bd0 |
...
For a systems engineer, dg/adminer-custom belongs in the PHP inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v3.4.1 | 2026-08-13T00:19:44+00:00 | [https://repo.packagist.org/p2/dg/adminer-custom.json](https://repo.packagist.org/p2/dg/adminer-custom.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/dg/adminer-custom.json` at `2026-09-01T07:20:24+00:00`.
...
- `packagist_search-a8dffb4ec84bd0` from `packagist_search` as `registry_expansion`
