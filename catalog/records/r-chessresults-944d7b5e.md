...
<!-- canonical: https://cran.r-project.org/web/packages/chessResults/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/chessResults/index.html](https://cran.r-project.org/web/packages/chessResults/index.html) |
| Source record ids | cran_packages_by_date-d0b974f3493f53 |

## System Engineer Summary

Scraper for Chess-Results.com

## Operational Role

For a systems engineer, chessResults belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2026.08.27 | 2026-08-28 07:01:26 UTC | [https://cran.r-project.org/web/packages/chessResults/DESCRIPTION](https://cran.r-project.org/web/packages/chessResults/DESCRIPTION) |  |
...
| Evidence | GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0; {"key": "", "name": "", "url": ""}; BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/chessResults/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-d0b974f3493f53` from `cran_packages_by_date` as `registry_expansion`
