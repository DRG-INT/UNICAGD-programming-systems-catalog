...
<!-- canonical: https://hackage.haskell.org/package/hat -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/hat](https://hackage.haskell.org/package/hat) |
| Source record ids | hackage_top_downloads-fedb89ec298ae3 |
...
For a systems engineer, hat belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.9.4 | 2017-11-03T16:45:40Z | [https://hackage.haskell.org/package/hat](https://hackage.haskell.org/package/hat) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/hat` at `2026-09-01T14:24:19+00:00`.
...
- `hackage_top_downloads-fedb89ec298ae3` from `hackage_top_downloads` as `registry_expansion`
