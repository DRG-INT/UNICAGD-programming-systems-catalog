...
<!-- canonical: https://github.com/StarRocks/starrocks -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/StarRocks/starrocks](https://github.com/StarRocks/starrocks) |
| Source record ids | github_search_databases-ab02469f0cdaa3 |

## System Engineer Summary

The world's fastest open query engine for sub-second analytics both on and off the data lakehouse.
With the flexibility to support nearly any scenario, StarRocks provides best-in-class performance
for multi-dimensional analytics, real-time analytics, and ad-hoc queries. A Linux Foundation
project.

## Operational Role

For a systems engineer, StarRocks/starrocks belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T15:01:44Z | gh search repos topic:database stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-ab02469f0cdaa3` from `github_search_databases` as `registry_expansion`
...
| Stolon | Undefined Behavior Analyzer | [open](databases-stolon-807bae3f.md) |
