...
<!-- canonical: https://cran.r-project.org/web/packages/kro.inv.test/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/kro.inv.test/index.html](https://cran.r-project.org/web/packages/kro.inv.test/index.html) |
| Source record ids | cran_packages_by_date-edacde5e2c9c65 |
...
For a systems engineer, kro.inv.test belongs in the R inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.3 | 2026-09-08 13:40:24 UTC | [https://cran.r-project.org/web/packages/kro.inv.test/DESCRIPTION](https://cran.r-project.org/web/packages/kro.inv.test/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/kro.inv.test/DESCRIPTION` at `2026-09-08T14:22:48+00:00`.
...
- `cran_packages_by_date-edacde5e2c9c65` from `cran_packages_by_date` as `registry_expansion`
