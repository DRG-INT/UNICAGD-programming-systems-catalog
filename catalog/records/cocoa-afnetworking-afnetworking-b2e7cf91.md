...
<!-- canonical: https://github.com/AFNetworking/AFNetworking -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AFNetworking/AFNetworking](https://github.com/AFNetworking/AFNetworking) |
| Source record ids | github_search_cocoa-65c6394f8ac8fe |
...
For a systems engineer, AFNetworking/AFNetworking belongs in the Cocoa inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-01-17T19:30:05Z | gh search repos language:Objective-C stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-65c6394f8ac8fe` from `github_search_cocoa` as `registry_expansion`
