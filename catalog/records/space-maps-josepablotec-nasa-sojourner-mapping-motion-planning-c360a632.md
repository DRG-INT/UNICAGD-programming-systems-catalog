# JosePabloTec/NASA-SOJOURNER-Mapping-Motion-Planning
...
<!-- canonical: https://github.com/JosePabloTec/NASA-SOJOURNER-Mapping-Motion-Planning -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JosePabloTec/NASA-SOJOURNER-Mapping-Motion-Planning](https://github.com/JosePabloTec/NASA-SOJOURNER-Mapping-Motion-Planning) |
| Source record ids | github_search_space_maps-c88f14e0c26c4a |

## System Engineer Summary

Developed a six-wheel rocker–bogie rover controller in Webots with IMU-based odometry, LiDAR-based
probabilistic occupancy grid mapping, waypoint navigation, and real-time cost-map generation for
autonomous planetary-style navigation.

## Operational Role

For a systems engineer, JosePabloTec/NASA-SOJOURNER-Mapping-Motion-Planning belongs in the Space
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-25T08:40:35Z | gh search repos planetary maps | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-c88f14e0c26c4a` from `github_search_space_maps` as `registry_expansion`
