...
<!-- canonical: https://github.com/rishikksh20/VocGAN -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rishikksh20/VocGAN](https://github.com/rishikksh20/VocGAN) |
| Source record ids | github_search_audio-bfb2e9350a027b |
...
For a systems engineer, rishikksh20/VocGAN belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-07-25T11:04:25Z | gh search repos topic:speech-processing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-bfb2e9350a027b` from `github_search_audio` as `registry_expansion`
