...
<!-- canonical: https://github.com/valeriansaliou/node-sonic-channel -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/valeriansaliou/node-sonic-channel](https://github.com/valeriansaliou/node-sonic-channel) |
| Source record ids | github_search_catalogs-b75cf8b4913deb |

## System Engineer Summary

🦉 Sonic Channel integration for Node. Used in pair with Sonic, the fast, lightweight and schema-less
search backend.

## Operational Role

For a systems engineer, valeriansaliou/node-sonic-channel belongs in the Catalogs inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-10-16T14:06:17Z | gh search repos topic:index stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-b75cf8b4913deb` from `github_search_catalogs` as `registry_expansion`
