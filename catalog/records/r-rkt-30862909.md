...
<!-- canonical: https://cran.r-project.org/web/packages/rkt/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rkt/index.html](https://cran.r-project.org/web/packages/rkt/index.html) |
| Source record ids | cran_packages_by_date-8946c850edb451 |
...
For a systems engineer, rkt belongs in the R inventory as part of unit/integration validation,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.8 | 2026-08-25 21:20:08 UTC | [https://cran.r-project.org/web/packages/rkt/DESCRIPTION](https://cran.r-project.org/web/packages/rkt/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rkt/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-8946c850edb451` from `cran_packages_by_date` as `registry_expansion`
