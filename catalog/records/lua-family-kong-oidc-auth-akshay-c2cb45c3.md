...
| Canonical URL | [https://luarocks.org/modules/akshay-harale/kong-oidc-auth-akshay](https://luarocks.org/modules/akshay-harale/kong-oidc-auth-akshay) |
| Source record ids | luarocks_root_manifest-3ebe2826142e40 |
...
For a systems engineer, kong-oidc-auth-akshay belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-3ebe2826142e40` from `luarocks_root_manifest` as `registry_expansion`
