# astropy-learn/astropy-tutorials
...
<!-- canonical: https://github.com/astropy-learn/astropy-tutorials -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/astropy-learn/astropy-tutorials](https://github.com/astropy-learn/astropy-tutorials) |
| Source record ids | github_search_telescopes-9a43e1dc802cdd |
...
For a systems engineer, astropy-learn/astropy-tutorials belongs in the Telescopes inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T16:53:31Z | gh search repos topic:astronomy stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_telescopes-9a43e1dc802cdd` from `github_search_telescopes` as `registry_expansion`
