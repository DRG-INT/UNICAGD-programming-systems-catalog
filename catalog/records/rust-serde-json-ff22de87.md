...
<!-- canonical: https://crates.io/crates/serde_json -->
<!-- crawl-delay: 10 -->
...
| Source record ids | crates_io-97d33bb7f25d45 |
...
For a systems engineer, serde_json belongs in the Rust inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.151 | 2026-07-20T05:54:44.078083Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-97d33bb7f25d45` from `crates_io` as `registry_expansion`
