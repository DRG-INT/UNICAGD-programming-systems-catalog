...
<!-- canonical: https://github.com/baidut/BIMEF -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/baidut/BIMEF](https://github.com/baidut/BIMEF) |
| Source record ids | github_search_matlab-1e7c2c49eea4d6 |

## System Engineer Summary

Code and data for the research paper "A Bio-Inspired Multi-Exposure Fusion Framework for Low-light
Image Enhancement" (Submitted to IEEE Transactions on Cybernetics)

## Operational Role

For a systems engineer, baidut/BIMEF belongs in the Matlab inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-03-16T15:23:45Z | gh search repos language:MATLAB topic:image-processing | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-1e7c2c49eea4d6` from `github_search_matlab` as `registry_expansion`
