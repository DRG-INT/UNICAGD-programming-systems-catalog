...
<!-- canonical: https://pub.dev/packages/wave -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/wave](https://pub.dev/packages/wave) |
| Source record ids | pub_dev-ca1c3010c953f3 |
...
For a systems engineer, wave belongs in the Dart inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.5 | 2026-07-08T09:07:38.007322Z | [https://pub.dev/api/packages/wave](https://pub.dev/api/packages/wave) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/wave` at `2026-09-01T16:41:09+00:00`.
...
- `pub_dev-ca1c3010c953f3` from `pub_dev` as `registry_expansion`
