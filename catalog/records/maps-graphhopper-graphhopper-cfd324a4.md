...
| Canonical URL | [https://github.com/graphhopper/graphhopper](https://github.com/graphhopper/graphhopper) |
| Source record ids | github_search_maps-2b1bd0c17b63bf |
...
For a systems engineer, graphhopper/graphhopper belongs in the Maps inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 11.0 | 2025-10-14T14:50:34Z | [https://api.github.com/repos/graphhopper/graphhopper/releases/latest](https://api.github.com/repos/graphhopper/graphhopper/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/graphhopper/graphhopper/releases/latest` at `2026-09-01T12:30:00+00:00`.
...
- `github_search_maps-2b1bd0c17b63bf` from `github_search_maps` as `registry_expansion`
