...
<!-- canonical: https://cran.r-project.org/web/packages/BayesBinMix/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/BayesBinMix/index.html](https://cran.r-project.org/web/packages/BayesBinMix/index.html) |
| Source record ids | cran_packages_by_date-aa67e977b94c24 |
...
For a systems engineer, BayesBinMix belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.2 | 2026-08-20 14:42:28 UTC | [https://cran.r-project.org/web/packages/BayesBinMix/DESCRIPTION](https://cran.r-project.org/web/packages/BayesBinMix/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/BayesBinMix/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-aa67e977b94c24` from `cran_packages_by_date` as `registry_expansion`
