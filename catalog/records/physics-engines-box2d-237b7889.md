...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Physics Engines](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/physics-engines.md) · [Category: Game Engine Game Dev](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/game-engine-game-dev.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://github.com/erincatto/box2d](https://github.com/erincatto/box2d) |
| Source record ids | curated_language_routes-fd3bb9fa8674a7 |

## System Engineer Summary

2D rigid-body physics engine for games and simulations.

## Operational Role

For a systems engineer, Box2D belongs in the Physics Engines inventory as part of ecosystem
...
- `curated_language_routes-fd3bb9fa8674a7` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Bullet Physics | Game Engine Game Dev | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/physics-engines-bullet-physics-9d2ea309.md) |
| Chipmunk2D | Game Engine Game Dev | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/physics-engines-chipmunk2d-2e5fd06d.md) |
| Jolt Physics | Game Engine Game Dev | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/physics-engines-jolt-physics-3ac5b243.md) |
| NVIDIA PhysX | Game Engine Game Dev | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/physics-engines-nvidia-physx-8fd4adec.md) |
| Open Dynamics Engine | Game Engine Game Dev | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/physics-engines-open-dynamics-engine-1018dfe4.md) |
| Rapier | Game Engine Game Dev | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/physics-engines-rapier-6fed13ab.md) |
