...
<!-- canonical: https://cran.r-project.org/web/packages/igoR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/igoR/index.html](https://cran.r-project.org/web/packages/igoR/index.html) |
| Source record ids | cran_packages_by_date-95f11270636b43 |
...
For a systems engineer, igoR belongs in the R inventory as part of state persistence, migrations,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-08-25 09:50:12 UTC | [https://cran.r-project.org/web/packages/igoR/DESCRIPTION](https://cran.r-project.org/web/packages/igoR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/igoR/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-95f11270636b43` from `cran_packages_by_date` as `registry_expansion`
