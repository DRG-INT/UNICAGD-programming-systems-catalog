...
| Canonical URL | [https://packagist.org/packages/ddmaster/postgre-search-bundle](https://packagist.org/packages/ddmaster/postgre-search-bundle) |
| Source record ids | packagist_search-8767587606578a |
...
For a systems engineer, ddmaster/postgre-search-bundle belongs in the PHP inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.0 | 2019-11-17T16:36:50+00:00 | [https://repo.packagist.org/p2/ddmaster/postgre-search-bundle.json](https://repo.packagist.org/p2/ddmaster/postgre-search-bundle.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/ddmaster/postgre-search-bundle.json` at `2026-09-01T07:20:25+00:00`.
...
- `packagist_search-8767587606578a` from `packagist_search` as `registry_expansion`
