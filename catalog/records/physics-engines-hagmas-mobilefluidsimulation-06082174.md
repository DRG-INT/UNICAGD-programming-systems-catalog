...
<!-- canonical: https://github.com/hagmas/MobileFluidSimulation -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/hagmas/MobileFluidSimulation](https://github.com/hagmas/MobileFluidSimulation) |
| Source record ids | github_search_physics_engines-39c70d4a21acc6 |
...
For a systems engineer, hagmas/MobileFluidSimulation belongs in the Physics Engines inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2017-10-30T12:43:50Z | gh search repos topic:fluid-simulation stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-39c70d4a21acc6` from `github_search_physics_engines` as `registry_expansion`
