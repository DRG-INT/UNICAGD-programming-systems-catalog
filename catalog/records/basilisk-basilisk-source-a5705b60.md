...
[Catalog index](../index.md) · [Language: Basilisk](../by-language/basilisk.md) · [Category: Registry Repository](../by-category/registry-repository.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://basilisk.fr/src/README -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://basilisk.fr/src/README](https://basilisk.fr/src/README) |
| Source record ids | curated_language_routes-c8462370c09479 |

## System Engineer Summary

Official Basilisk source-code route for the fluid simulation framework and Basilisk C ecosystem.

## Operational Role

For a systems engineer, Basilisk Source belongs in the Basilisk inventory as part of ecosystem
...
- `curated_language_routes-c8462370c09479` from `curated_language_routes` as `registry_expansion`
