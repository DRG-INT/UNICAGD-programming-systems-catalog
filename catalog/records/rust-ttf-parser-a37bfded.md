...
<!-- canonical: https://crates.io/crates/ttf-parser -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/ttf-parser](https://crates.io/crates/ttf-parser) |
| Source record ids | crates_io-6f9d2c0ba70a0e |
...
For a systems engineer, ttf-parser belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.25.1 | 2024-11-29T19:59:37.395141Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- `crates_io-6f9d2c0ba70a0e` from `crates_io` as `registry_expansion`
