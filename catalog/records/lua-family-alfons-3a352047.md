...
<!-- canonical: https://luarocks.org/modules/daelvn/alfons -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/daelvn/alfons](https://luarocks.org/modules/daelvn/alfons) |
| Source record ids | luarocks_root_manifest-e26beb8adf5f22 |

## System Engineer Summary

Small program to run tasks for your project

## Operational Role

For a systems engineer, alfons belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-e26beb8adf5f22` from `luarocks_root_manifest` as `registry_expansion`
