...
<!-- canonical: https://cran.r-project.org/web/packages/plotmo/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/plotmo/index.html](https://cran.r-project.org/web/packages/plotmo/index.html) |
| Source record ids | cran_packages_by_date-c913592d434da2 |
...
For a systems engineer, plotmo belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.7.1 | 2026-08-21 11:50:09 UTC | [https://cran.r-project.org/web/packages/plotmo/DESCRIPTION](https://cran.r-project.org/web/packages/plotmo/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/plotmo/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-c913592d434da2` from `cran_packages_by_date` as `registry_expansion`
