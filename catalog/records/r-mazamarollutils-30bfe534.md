...
<!-- canonical: https://cran.r-project.org/web/packages/MazamaRollUtils/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/MazamaRollUtils/index.html](https://cran.r-project.org/web/packages/MazamaRollUtils/index.html) |
| Source record ids | cran_packages_by_date-d7deede3991b52 |
...
For a systems engineer, MazamaRollUtils belongs in the R inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-09-01 17:00:02 UTC | [https://cran.r-project.org/web/packages/MazamaRollUtils/DESCRIPTION](https://cran.r-project.org/web/packages/MazamaRollUtils/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/MazamaRollUtils/DESCRIPTION` at `2026-09-01T18:22:20+00:00`.
...
- `cran_packages_by_date-d7deede3991b52` from `cran_packages_by_date` as `registry_expansion`
