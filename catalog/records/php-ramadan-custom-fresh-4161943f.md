...
<!-- canonical: https://packagist.org/packages/ramadan/custom-fresh -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/ramadan/custom-fresh](https://packagist.org/packages/ramadan/custom-fresh) |
| Source record ids | packagist_search-56bb3bfffc5865 |
...
For a systems engineer, ramadan/custom-fresh belongs in the PHP inventory as part of state
...
- `packagist_search-56bb3bfffc5865` from `packagist_search` as `registry_expansion`
