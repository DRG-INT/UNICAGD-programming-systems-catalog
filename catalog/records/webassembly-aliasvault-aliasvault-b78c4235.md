...
[Catalog index](../index.md) · [Language: WebAssembly](../by-language/webassembly.md) · [Category: Cryptography](../by-category/cryptography.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/aliasvault/aliasvault -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/aliasvault/aliasvault](https://github.com/aliasvault/aliasvault) |
| Source record ids | github_search_webassembly-c3f02bc4a3620a |
...
For a systems engineer, aliasvault/aliasvault belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-13T20:35:50Z | gh search repos topic:wasm stars:>500 | gh_search_reports_activity_not_release_version |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; GNU Lesser General Public License v3.0; https://api.github.com/licenses/lgpl-3.0; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0 |
...
- `github_search_webassembly-c3f02bc4a3620a` from `github_search_webassembly` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| jungomi/xxhash-wasm | Cryptography | [open](webassembly-jungomi-xxhash-wasm-8e6c0c5e.md) |
