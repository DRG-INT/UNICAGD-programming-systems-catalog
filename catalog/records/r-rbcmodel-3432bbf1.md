...
<!-- canonical: https://cran.r-project.org/web/packages/rbcmodel/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rbcmodel/index.html](https://cran.r-project.org/web/packages/rbcmodel/index.html) |
| Source record ids | cran_packages_by_date-e2512ed58be434 |
...
For a systems engineer, rbcmodel belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-08-04 13:50:02 UTC | [https://cran.r-project.org/web/packages/rbcmodel/DESCRIPTION](https://cran.r-project.org/web/packages/rbcmodel/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rbcmodel/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-e2512ed58be434` from `cran_packages_by_date` as `registry_expansion`
