# tony-hw/DSP-Audio-Effects-TMS320C5515

## Navigation

[Catalog index](../index.md) · [Language: Effects](../by-language/effects.md) · [Category: Embedded Hardware](../by-category/embedded-hardware.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/tony-hw/DSP-Audio-Effects-TMS320C5515 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tony-hw/DSP-Audio-Effects-TMS320C5515](https://github.com/tony-hw/DSP-Audio-Effects-TMS320C5515) |
| Source record ids | github_search_effects-df90e57daa930a |

## System Engineer Summary

Initial commit: MATLAB simulations and CCS hardware implementation

## Operational Role

For a systems engineer, tony-hw/DSP-Audio-Effects-TMS320C5515 belongs in the Effects inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-18T17:34:50Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-df90e57daa930a` from `github_search_effects` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ARM-software/CMSIS-DSP | Embedded Hardware | [open](effects-arm-software-cmsis-dsp-70248de5.md) |
