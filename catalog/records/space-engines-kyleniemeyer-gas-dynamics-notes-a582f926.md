# kyleniemeyer/gas-dynamics-notes

## Navigation

[Catalog index](../index.md) · [Language: Space Engines](../by-language/space-engines.md) · [Category: Compression](../by-category/compression.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/kyleniemeyer/gas-dynamics-notes -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kyleniemeyer/gas-dynamics-notes](https://github.com/kyleniemeyer/gas-dynamics-notes) |
| Source record ids | github_search_space_engines-962801170ccf5f |
...
For a systems engineer, kyleniemeyer/gas-dynamics-notes belongs in the Space Engines inventory as
...
- `github_search_space_engines-962801170ccf5f` from `github_search_space_engines` as `registry_expansion`
