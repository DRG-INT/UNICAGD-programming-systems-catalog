...
| Source record ids | hackage_recent-3cb9e60284563c |
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.4 | 2026-09-02T04:29:11Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/packages/recent` at `2026-09-02T06:29:50+00:00`.
...
- `hackage_recent-3cb9e60284563c` from `hackage_recent` as `registry_expansion`
