...
<!-- canonical: https://pub.dev/packages/drift_flutter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/drift_flutter](https://pub.dev/packages/drift_flutter) |
| Source record ids | pub_dev-8117669094c20b |
...
For a systems engineer, drift_flutter belongs in the Dart inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.1 | 2026-07-11T09:52:38.707710Z | [https://pub.dev/api/packages/drift_flutter](https://pub.dev/api/packages/drift_flutter) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/drift_flutter` at `2026-09-01T14:20:33+00:00`.
...
- `pub_dev-8117669094c20b` from `pub_dev` as `registry_expansion`
