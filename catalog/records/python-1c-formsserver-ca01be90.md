...
<!-- canonical: https://pypi.org/project/1c-formsserver/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/1c-formsserver/](https://pypi.org/project/1c-formsserver/) |
| Source record ids | pypi_simple-57c9e2de586b93 |

## System Engineer Summary

MCP server for 1C managed form generation, validation, and search

## Operational Role

For a systems engineer, 1c-formsserver belongs in the Python inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.20260729 | 2026-07-29T08:36:41.142711Z | [https://pypi.org/pypi/1c-formsserver/json](https://pypi.org/pypi/1c-formsserver/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/1c-formsserver/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-57c9e2de586b93` from `pypi_simple` as `registry_expansion`
