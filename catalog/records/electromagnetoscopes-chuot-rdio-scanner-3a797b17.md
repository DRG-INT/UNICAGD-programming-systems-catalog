...
<!-- canonical: https://github.com/chuot/rdio-scanner -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/chuot/rdio-scanner](https://github.com/chuot/rdio-scanner) |
| Source record ids | github_search_electromagnetoscopes-396438597a4518 |

## System Engineer Summary

Rdio Scanner is an open source software that ingest and distribute audio files generated by various
software-defined radio recorders. Its interface tries to reproduce the user experience of a real
police scanner, while adding its own touch.

## Operational Role

For a systems engineer, chuot/rdio-scanner belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v6.6.3 | 2022-11-25T12:37:15Z | [https://api.github.com/repos/chuot/rdio-scanner/releases/latest](https://api.github.com/repos/chuot/rdio-scanner/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/chuot/rdio-scanner/releases/latest` at `2026-09-01T08:26:39+00:00`.
...
- `github_search_electromagnetoscopes-396438597a4518` from `github_search_electromagnetoscopes` as `registry_expansion`
