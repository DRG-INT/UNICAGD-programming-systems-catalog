...
<!-- canonical: https://pub.dev/packages/dart_style -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/dart_style](https://pub.dev/packages/dart_style) |
| Source record ids | pub_dev-df45d1afe553e4 |
...
For a systems engineer, dart_style belongs in the Dart inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.1.13 | 2026-08-26T18:47:59.106940Z | [https://pub.dev/api/packages/dart_style](https://pub.dev/api/packages/dart_style) |  |
| preview | known | 2.2.5-dev | 2023-03-02T21:33:12.577694Z | [https://pub.dev/api/packages/dart_style](https://pub.dev/api/packages/dart_style) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/dart_style` at `2026-09-01T07:20:15+00:00`.
...
- `pub_dev-df45d1afe553e4` from `pub_dev` as `registry_expansion`
