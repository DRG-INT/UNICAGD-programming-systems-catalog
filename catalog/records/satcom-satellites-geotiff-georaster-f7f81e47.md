...
<!-- canonical: https://github.com/GeoTIFF/georaster -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/GeoTIFF/georaster](https://github.com/GeoTIFF/georaster) |
| Source record ids | github_search_satcom_satellites-edbb0a233473e3 |

## System Engineer Summary

Wrapper around Georeferenced Rasters like GeoTIFF and soon JPG and PNG that provides a standard
interface

## Operational Role

For a systems engineer, GeoTIFF/georaster belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.6.0 | 2023-08-01T02:10:36Z | [https://api.github.com/repos/GeoTIFF/georaster/releases/latest](https://api.github.com/repos/GeoTIFF/georaster/releases/latest) |  |
| preview | known | v1.7.0-0 | 2023-08-07T02:15:27Z | [https://api.github.com/repos/GeoTIFF/georaster/releases?per_page=10](https://api.github.com/repos/GeoTIFF/georaster/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/GeoTIFF/georaster/releases/latest` at `2026-09-01T08:26:34+00:00`.
...
- `github_search_satcom_satellites-edbb0a233473e3` from `github_search_satcom_satellites` as `registry_expansion`
