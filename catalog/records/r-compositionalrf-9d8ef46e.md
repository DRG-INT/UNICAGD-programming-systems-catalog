...
<!-- canonical: https://cran.r-project.org/web/packages/CompositionalRF/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/CompositionalRF/index.html](https://cran.r-project.org/web/packages/CompositionalRF/index.html) |
| Source record ids | cran_packages_by_date-47de592fe3b20d |
...
For a systems engineer, CompositionalRF belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7 | 2026-09-10 13:30:02 UTC | [https://cran.r-project.org/web/packages/CompositionalRF/DESCRIPTION](https://cran.r-project.org/web/packages/CompositionalRF/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/CompositionalRF/DESCRIPTION` at `2026-09-10T14:19:51+00:00`.
...
- `cran_packages_by_date-47de592fe3b20d` from `cran_packages_by_date` as `registry_expansion`
