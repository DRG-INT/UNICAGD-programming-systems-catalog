...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: C99](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/c99.md) · [Category: Compression](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/compression.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | master-7a6199f20ca2 |

## System Engineer Summary

zlib is tracked as a compression record in the C99 branch. The source did not provide a long
...
For a systems engineer, zlib belongs in the C99 inventory as part of ecosystem capability mapping,
...
- `master-7a6199f20ca2` from `master_json` as `compression`
