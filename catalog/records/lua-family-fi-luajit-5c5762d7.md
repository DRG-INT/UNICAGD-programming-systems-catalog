...
| Canonical URL | [https://luarocks.org/modules/nyfair/fi-luajit](https://luarocks.org/modules/nyfair/fi-luajit) |
| Source record ids | luarocks_root_manifest-947607c48a35d2 |
...
For a systems engineer, fi-luajit belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-947607c48a35d2` from `luarocks_root_manifest` as `registry_expansion`
