# Gitea: Hyperling/example-android-database-room
...
<!-- canonical: https://gitea.com/Hyperling/example-android-database-room -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/Hyperling/example-android-database-room](https://gitea.com/Hyperling/example-android-database-room) |
| Source record ids | gitea_repositories_api-c399d3c1da216f |
...
For a systems engineer, Gitea: Hyperling/example-android-database-room belongs in the Repository
Workplaces inventory as part of state persistence, migrations, performance, and operational
recovery.
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-12-29T15:58:18Z | [https://gitea.com/api/v1/repos/search?q=database&limit=50](https://gitea.com/api/v1/repos/search?q=database&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-c399d3c1da216f` from `gitea_repositories_api` as `registry_expansion`
