...
<!-- canonical: https://hackage.haskell.org/package/llvm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/llvm](https://hackage.haskell.org/package/llvm) |
| Source record ids | hackage_top_downloads-4c3963bac4e04c |
...
For a systems engineer, llvm belongs in the Haskell inventory as part of compiler selection,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.2.0.2 | 2013-05-28T00:59:47Z | [https://hackage.haskell.org/package/llvm](https://hackage.haskell.org/package/llvm) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/llvm` at `2026-09-03T00:34:36+00:00`.
...
- `hackage_top_downloads-4c3963bac4e04c` from `hackage_top_downloads` as `registry_expansion`
