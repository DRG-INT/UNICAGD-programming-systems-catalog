...
<!-- canonical: https://crates.io/crates/headers-core -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/headers-core](https://crates.io/crates/headers-core) |
| Source record ids | crates_io-7c37dc71345ed4 |
...
For a systems engineer, headers-core belongs in the Rust inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2023-11-24T19:13:05.687876Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-7c37dc71345ed4` from `crates_io` as `registry_expansion`
