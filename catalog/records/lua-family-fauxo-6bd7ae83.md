...
| Canonical URL | [https://luarocks.org/modules/koonix/fauxo](https://luarocks.org/modules/koonix/fauxo) |
| Source record ids | luarocks_root_manifest-334cca28420193 |

## System Engineer Summary

fauxo is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, fauxo belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-334cca28420193` from `luarocks_root_manifest` as `registry_expansion`
