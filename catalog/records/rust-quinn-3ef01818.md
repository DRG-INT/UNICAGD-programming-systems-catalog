...
<!-- canonical: https://crates.io/crates/quinn -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/quinn](https://crates.io/crates/quinn) |
| Source record ids | crates_io-493c6f9cf84d35 |
...
For a systems engineer, quinn belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.11.12 | 2026-09-14T10:08:47.662258Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads` at `2026-09-14T10:20:41+00:00`.
...
- `crates_io-493c6f9cf84d35` from `crates_io` as `registry_expansion`
