...
<!-- canonical: https://github.com/archie-judd/telescope-words.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/archie-judd/telescope-words.nvim](https://github.com/archie-judd/telescope-words.nvim) |
| Source record ids | github_search_telescopes-3580aedee4f9be |

## System Engineer Summary

A fast and offline dictionary and thesaurus fuzzy finder for Neovim

## Operational Role

For a systems engineer, archie-judd/telescope-words.nvim belongs in the Telescopes inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-08-06T01:31:33Z | gh search repos topic:telescope stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_telescopes-3580aedee4f9be` from `github_search_telescopes` as `registry_expansion`
