...
<!-- canonical: https://cran.r-project.org/web/packages/sps/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/sps/index.html](https://cran.r-project.org/web/packages/sps/index.html) |
| Source record ids | cran_packages_by_date-99e355926e0ed5 |
...
For a systems engineer, sps belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.0 | 2026-08-31 16:10:02 UTC | [https://cran.r-project.org/web/packages/sps/DESCRIPTION](https://cran.r-project.org/web/packages/sps/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/sps/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-99e355926e0ed5` from `cran_packages_by_date` as `registry_expansion`
