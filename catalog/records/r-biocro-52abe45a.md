...
<!-- canonical: https://cran.r-project.org/web/packages/BioCro/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/BioCro/index.html](https://cran.r-project.org/web/packages/BioCro/index.html) |
| Source record ids | cran_packages_by_date-1d390ca39ac852 |
...
For a systems engineer, BioCro belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.4.0 | 2026-08-21 19:10:08 UTC | [https://cran.r-project.org/web/packages/BioCro/DESCRIPTION](https://cran.r-project.org/web/packages/BioCro/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/BioCro/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-1d390ca39ac852` from `cran_packages_by_date` as `registry_expansion`
