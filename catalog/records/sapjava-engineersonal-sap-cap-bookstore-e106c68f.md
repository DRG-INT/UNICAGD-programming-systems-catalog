# engineersonal/SAP-CAP-Bookstore

## Navigation

[Catalog index](../index.md) · [Language: SAPJava](../by-language/sapjava.md) · [Category: Game Engine Game Dev](../by-category/game-engine-game-dev.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/engineersonal/SAP-CAP-Bookstore -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/engineersonal/SAP-CAP-Bookstore](https://github.com/engineersonal/SAP-CAP-Bookstore) |
| Source record ids | github_search_sapjava-492c5f36f6ff22 |
...
For a systems engineer, engineersonal/SAP-CAP-Bookstore belongs in the SAPJava inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-03-21T18:15:03Z | gh search repos SAP CAP Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-492c5f36f6ff22` from `github_search_sapjava` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| engineersonal/SAP-CAP-Products-Service | Game Engine Game Dev | [open](sapjava-engineersonal-sap-cap-products-service-4d205505.md) |
