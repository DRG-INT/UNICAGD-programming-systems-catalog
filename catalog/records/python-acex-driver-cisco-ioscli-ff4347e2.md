...
<!-- canonical: https://pypi.org/project/acex-driver-cisco-ioscli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acex-driver-cisco-ioscli/](https://pypi.org/project/acex-driver-cisco-ioscli/) |
| Source record ids | pypi_simple-98b6089424717d |
...
For a systems engineer, acex-driver-cisco-ioscli belongs in the Python inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.7.0 | 2026-08-21T08:43:42.902421Z | [https://pypi.org/pypi/acex-driver-cisco-ioscli/json](https://pypi.org/pypi/acex-driver-cisco-ioscli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acex-driver-cisco-ioscli/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-98b6089424717d` from `pypi_simple` as `registry_expansion`
