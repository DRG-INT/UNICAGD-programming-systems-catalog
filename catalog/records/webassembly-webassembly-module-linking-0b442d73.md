...
<!-- canonical: https://github.com/WebAssembly/module-linking -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/WebAssembly/module-linking](https://github.com/WebAssembly/module-linking) |
| Source record ids | github_search_webassembly-f0106612c1b744 |
...
For a systems engineer, WebAssembly/module-linking belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-05-01T20:17:59Z | gh search repos language:WebAssembly stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-f0106612c1b744` from `github_search_webassembly` as `registry_expansion`
