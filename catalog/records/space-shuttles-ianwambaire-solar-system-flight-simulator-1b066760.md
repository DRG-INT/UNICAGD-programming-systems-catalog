# ianwambaire/solar-system-flight-simulator

## Navigation

[Catalog index](../index.md) · [Language: Space Shuttles](../by-language/space-shuttles.md) · [Category: Parser Lexer Ast](../by-category/parser-lexer-ast.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/ianwambaire/solar-system-flight-simulator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ianwambaire/solar-system-flight-simulator](https://github.com/ianwambaire/solar-system-flight-simulator) |
| Source record ids | github_search_space_shuttles-bc14cfe76603a6 |

## System Engineer Summary

Is an interactive multimedia application that simulates a dynamic solar system where planets orbit
around the sun while the user pilots a spaceship through space. The objective is to survive as long
as possible by avoiding asteroids, managing fuel efficiently, and staying away from the sun

## Operational Role

For a systems engineer, ianwambaire/solar-system-flight-simulator belongs in the Space Shuttles
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-22T08:15:01Z | gh search repos orbiter space flight simulator | gh_search_reports_activity_not_release_version |
...
- `github_search_space_shuttles-bc14cfe76603a6` from `github_search_space_shuttles` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| asrikanth777/columbiaSpaceShuttle | Parser Lexer Ast | [open](space-shuttles-asrikanth777-columbiaspaceshuttle-3a93a59e.md) |
| Astro-Rabbit/VRC_Orbiter | Parser Lexer Ast | [open](space-shuttles-astro-rabbit-vrc-orbiter-655eeb9e.md) |
| MasterERTS/sipro-spaceshuttle | Parser Lexer Ast | [open](space-shuttles-mastererts-sipro-spaceshuttle-7cda4942.md) |
| monkeybeam/lastshuttle | Parser Lexer Ast | [open](space-shuttles-monkeybeam-lastshuttle-b6cb3960.md) |
| sebastianhamza/orbital-collector | Parser Lexer Ast | [open](space-shuttles-sebastianhamza-orbital-collector-0fd4955b.md) |
