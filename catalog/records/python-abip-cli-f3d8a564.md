...
<!-- canonical: https://pypi.org/project/abip-cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/abip-cli/](https://pypi.org/project/abip-cli/) |
| Source record ids | pypi_simple-3ff38032105bca |
...
For a systems engineer, abip-cli belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-03-18T17:22:07.264253Z | [https://pypi.org/pypi/abip-cli/json](https://pypi.org/pypi/abip-cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/abip-cli/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-3ff38032105bca` from `pypi_simple` as `registry_expansion`
