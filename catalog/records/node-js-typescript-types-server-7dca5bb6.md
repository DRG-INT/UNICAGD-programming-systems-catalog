...
<!-- canonical: https://www.npmjs.com/package/@types/server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@types/server](https://www.npmjs.com/package/@types/server) |
| Source record ids | npm_registry-41a2e35badbc2f |
...
For a systems engineer, @types/server belongs in the Node.js/TypeScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.11 | 2023-11-22T00:50:30.171Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-41a2e35badbc2f` from `npm_registry` as `registry_expansion`
