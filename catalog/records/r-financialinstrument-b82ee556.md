...
<!-- canonical: https://cran.r-project.org/web/packages/FinancialInstrument/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/FinancialInstrument/index.html](https://cran.r-project.org/web/packages/FinancialInstrument/index.html) |
| Source record ids | cran_packages_by_date-9c5461489fcbf4 |

## System Engineer Summary

Financial Instrument Modeling Infrastructure

## Operational Role

For a systems engineer, FinancialInstrument belongs in the R inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.1 | 2026-08-04 14:00:20 UTC | [https://cran.r-project.org/web/packages/FinancialInstrument/DESCRIPTION](https://cran.r-project.org/web/packages/FinancialInstrument/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/FinancialInstrument/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-9c5461489fcbf4` from `cran_packages_by_date` as `registry_expansion`
