...
<!-- canonical: https://github.com/mjuric/minify-ephems -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mjuric/minify-ephems](https://github.com/mjuric/minify-ephems) |
| Source record ids | github_search_space_maps-9aaafc4712d57e |

## System Engineer Summary

Make tiny versions of JPL ephems/SPICE kernels

## Operational Role

For a systems engineer, mjuric/minify-ephems belongs in the Space Maps inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-11-28T04:42:38Z | gh search repos SPICE kernels | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-9aaafc4712d57e` from `github_search_space_maps` as `registry_expansion`
