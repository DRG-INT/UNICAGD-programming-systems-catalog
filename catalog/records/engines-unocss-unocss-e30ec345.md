...
<!-- canonical: https://github.com/unocss/unocss -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/unocss/unocss](https://github.com/unocss/unocss) |
| Source record ids | github_search_engines-df7344d8a4bc89 |
...
For a systems engineer, unocss/unocss belongs in the Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T07:57:30Z | gh search repos topic:engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-df7344d8a4bc89` from `github_search_engines` as `registry_expansion`
