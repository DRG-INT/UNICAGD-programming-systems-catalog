...
<!-- canonical: https://cran.r-project.org/web/packages/colocboost/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/colocboost/index.html](https://cran.r-project.org/web/packages/colocboost/index.html) |
| Source record ids | cran_packages_by_date-14650df237bcae |
...
For a systems engineer, colocboost belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.10 | 2026-09-09 07:30:02 UTC | [https://cran.r-project.org/web/packages/colocboost/DESCRIPTION](https://cran.r-project.org/web/packages/colocboost/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/colocboost/DESCRIPTION` at `2026-09-09T08:21:42+00:00`.
...
- `cran_packages_by_date-14650df237bcae` from `cran_packages_by_date` as `registry_expansion`
