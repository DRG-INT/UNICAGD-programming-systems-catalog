...
<!-- canonical: https://pypi.org/project/ab-client-token-issuer/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/ab-client-token-issuer/](https://pypi.org/project/ab-client-token-issuer/) |
| Source record ids | pypi_simple-38ebf20d91d818 |
...
For a systems engineer, ab-client-token-issuer belongs in the Python inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0 | 2026-02-27T04:20:43.058641Z | [https://pypi.org/pypi/ab-client-token-issuer/json](https://pypi.org/pypi/ab-client-token-issuer/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/ab-client-token-issuer/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-38ebf20d91d818` from `pypi_simple` as `registry_expansion`
