...
| Canonical URL | [https://packagist.org/packages/clouddueling/mysqldump-php](https://packagist.org/packages/clouddueling/mysqldump-php) |
| Source record ids | packagist_search-115d20016e2a25 |
...
For a systems engineer, clouddueling/mysqldump-php belongs in the PHP inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.13 | 2026-08-02T19:42:28+00:00 | [https://repo.packagist.org/p2/clouddueling/mysqldump-php.json](https://repo.packagist.org/p2/clouddueling/mysqldump-php.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/clouddueling/mysqldump-php.json` at `2026-09-01T07:20:24+00:00`.
...
- `packagist_search-115d20016e2a25` from `packagist_search` as `registry_expansion`
