...
<!-- canonical: https://www.npmjs.com/package/@sap/hana-project-explorer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@sap/hana-project-explorer](https://www.npmjs.com/package/@sap/hana-project-explorer) |
| Source record ids | npm_registry-c2a88aa09fcaae |

## System Engineer Summary

Allows you to deploy SAP HANA database modules and artifacts and manage database connections

## Operational Role

For a systems engineer, @sap/hana-project-explorer belongs in the Node.js/JavaScript inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.38.0 | 2026-06-26T09:58:53.379Z | [https://registry.npmjs.org/-/v1/search?text=database&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=database&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-c2a88aa09fcaae` from `npm_registry` as `registry_expansion`
