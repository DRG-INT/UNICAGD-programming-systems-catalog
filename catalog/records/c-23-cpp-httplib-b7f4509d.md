...
| Source record ids | corpus-ae7d9148301528 |

## System Engineer Summary

cpp-httplib is tracked as a networking http record in the C++23 branch. The source did not provide a
...
For a systems engineer, cpp-httplib belongs in the C++23 inventory as part of service communication,
...
- `corpus-ae7d9148301528` from `master_json` as `networking_http`
...
| Boost.Beast | Networking Http | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-boost-beast-3b222dcf.md) |
