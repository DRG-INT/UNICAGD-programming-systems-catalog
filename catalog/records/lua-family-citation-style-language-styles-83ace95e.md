...
<!-- canonical: https://luarocks.org/modules/freed-wu/citation-style-language-styles -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/freed-wu/citation-style-language-styles](https://luarocks.org/modules/freed-wu/citation-style-language-styles) |
| Source record ids | luarocks_root_manifest-88c71b7481700d |
...
For a systems engineer, citation-style-language-styles belongs in the Lua family inventory as part
...
- `luarocks_root_manifest-88c71b7481700d` from `luarocks_root_manifest` as `registry_expansion`
