...
<!-- canonical: https://cran.r-project.org/web/packages/simplermarkdown/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/simplermarkdown/index.html](https://cran.r-project.org/web/packages/simplermarkdown/index.html) |
| Source record ids | cran_packages_by_date-8747459190b75d |
...
For a systems engineer, simplermarkdown belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-11 12:10:02 UTC | [https://cran.r-project.org/web/packages/simplermarkdown/DESCRIPTION](https://cran.r-project.org/web/packages/simplermarkdown/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/simplermarkdown/DESCRIPTION` at `2026-09-11T12:25:27+00:00`.
...
- `cran_packages_by_date-8747459190b75d` from `cran_packages_by_date` as `registry_expansion`
...
| Certara.NLME8 | Game Engine Game Dev | [open](r-certara-nlme8-6e386477.md) |
