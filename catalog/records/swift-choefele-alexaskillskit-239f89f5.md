...
<!-- canonical: https://github.com/choefele/AlexaSkillsKit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/choefele/AlexaSkillsKit](https://github.com/choefele/AlexaSkillsKit) |
| Source record ids | github_search_swift-a5b518f21f16d4 |
...
For a systems engineer, choefele/AlexaSkillsKit belongs in the Swift inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-02-14T20:32:59Z | gh search repos topic:swift-server stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-a5b518f21f16d4` from `github_search_swift` as `registry_expansion`
