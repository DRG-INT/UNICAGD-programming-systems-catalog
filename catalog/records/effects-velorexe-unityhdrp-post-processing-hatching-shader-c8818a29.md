...
<!-- canonical: https://github.com/Velorexe/UnityHDRP-Post-Processing-Hatching-Shader -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Velorexe/UnityHDRP-Post-Processing-Hatching-Shader](https://github.com/Velorexe/UnityHDRP-Post-Processing-Hatching-Shader) |
| Source record ids | github_search_effects-de5620c0e7e77c |
...
For a systems engineer, Velorexe/UnityHDRP-Post-Processing-Hatching-Shader belongs in the Effects
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-11-26T08:16:28Z | gh search repos post processing shader | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-de5620c0e7e77c` from `github_search_effects` as `registry_expansion`
