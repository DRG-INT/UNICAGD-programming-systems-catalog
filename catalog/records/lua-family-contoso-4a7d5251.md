...
<!-- canonical: https://luarocks.org/modules/usrbinr/contoso -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/usrbinr/contoso](https://luarocks.org/modules/usrbinr/contoso) |
| Source record ids | luarocks_root_manifest-2663516897b760 |
...
For a systems engineer, contoso belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-2663516897b760` from `luarocks_root_manifest` as `registry_expansion`
