...
| Name | Category | Page |
| --- | --- | --- |
| AccerionSensorAPI_jll | Embedded Hardware | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-accerionsensorapi-jll-2ee4dcd4.md) |
| aws_c_iot_jll | Embedded Hardware | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-aws-c-iot-jll-85b89475.md) |
| BladeRFHardwareDriver_jll | Embedded Hardware | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-bladerfhardwaredriver-jll-78b0a42c.md) |
