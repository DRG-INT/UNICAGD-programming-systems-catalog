...
[Catalog index](../index.md) · [Language: Julia](../by-language/julia.md) · [Category: Embedded Hardware](../by-category/embedded-hardware.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/JuliaRegistries/General/tree/master/B/BioTools -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/B/BioTools](https://github.com/JuliaRegistries/General/tree/master/B/BioTools) |
| Source record ids | julia_general-07663e3aa45b2c |

## System Engineer Summary

Julia package registered in General at B/BioTools.

## Operational Role

For a systems engineer, BioTools belongs in the Julia inventory as part of device constraints,
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/BioTools", "retrieved": "2026-09-01", "status": "registry-derived"}` |
...
- `julia_general-07663e3aa45b2c` from `julia_general` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AccerionSensorAPI_jll | Embedded Hardware | [open](julia-accerionsensorapi-jll-2ee4dcd4.md) |
| aws_c_iot_jll | Embedded Hardware | [open](julia-aws-c-iot-jll-85b89475.md) |
| BladeRFHardwareDriver_jll | Embedded Hardware | [open](julia-bladerfhardwaredriver-jll-78b0a42c.md) |
