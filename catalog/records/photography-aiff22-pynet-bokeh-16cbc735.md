...
| Source record ids | github_search_photography-ecac393d17694a |
...
For a systems engineer, aiff22/PyNET-Bokeh belongs in the Photography inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-08-23T13:03:09Z | gh search repos topic:photography stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | BSD_3_clause + file LICENSE; Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0; Other |
...
- `github_search_photography-ecac393d17694a` from `github_search_photography` as `registry_expansion`
