...
<!-- canonical: https://cran.r-project.org/web/packages/ProbSVMs/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ProbSVMs/index.html](https://cran.r-project.org/web/packages/ProbSVMs/index.html) |
| Source record ids | cran_packages_by_date-b74503719bcb61 |
...
For a systems engineer, ProbSVMs belongs in the R inventory as part of runtime behavior, deployment
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-09-12 23:50:02 UTC | [https://cran.r-project.org/web/packages/ProbSVMs/DESCRIPTION](https://cran.r-project.org/web/packages/ProbSVMs/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ProbSVMs/DESCRIPTION` at `2026-09-13T00:27:51+00:00`.
...
- `cran_packages_by_date-b74503719bcb61` from `cran_packages_by_date` as `registry_expansion`
