...
<!-- canonical: https://cran.r-project.org/web/packages/uGMAR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/uGMAR/index.html](https://cran.r-project.org/web/packages/uGMAR/index.html) |
| Source record ids | cran_packages_by_date-172306a0e8991c |
...
For a systems engineer, uGMAR belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.6.1 | 2026-08-04 19:50:02 UTC | [https://cran.r-project.org/web/packages/uGMAR/DESCRIPTION](https://cran.r-project.org/web/packages/uGMAR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/uGMAR/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-172306a0e8991c` from `cran_packages_by_date` as `registry_expansion`
