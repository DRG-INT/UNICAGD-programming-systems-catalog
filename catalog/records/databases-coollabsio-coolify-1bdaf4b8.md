...
<!-- canonical: https://github.com/coollabsio/coolify -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/coollabsio/coolify](https://github.com/coollabsio/coolify) |
| Source record ids | github_search_databases-424a278ce706da |

## System Engineer Summary

An open-source, self-hostable PaaS alternative to Vercel, Heroku & Netlify that lets you easily
deploy static sites, databases, full-stack applications and 280+ one-click services on your own
servers.

## Operational Role

For a systems engineer, coollabsio/coolify belongs in the Databases inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T06:21:27Z | gh search repos topic:mysql stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-424a278ce706da` from `github_search_databases` as `registry_expansion`
