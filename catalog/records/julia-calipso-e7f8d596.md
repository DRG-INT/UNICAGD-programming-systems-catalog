...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CALIPSO](https://github.com/JuliaRegistries/General/tree/master/C/CALIPSO) |
| Source record ids | julia_general-01e4184783171b |

## System Engineer Summary

Julia package registered in General at C/CALIPSO.

## Operational Role

For a systems engineer, CALIPSO belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CALIPSO", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-01e4184783171b` from `julia_general` as `registry_expansion`
