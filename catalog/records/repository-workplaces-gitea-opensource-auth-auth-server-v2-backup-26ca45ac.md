# Gitea: OpenSource-Auth/auth-server-v2-backup
...
<!-- canonical: https://gitea.com/OpenSource-Auth/auth-server-v2-backup -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/OpenSource-Auth/auth-server-v2-backup](https://gitea.com/OpenSource-Auth/auth-server-v2-backup) |
| Source record ids | gitea_repositories_api-3628d0353c6902 |
...
For a systems engineer, Gitea: OpenSource-Auth/auth-server-v2-backup belongs in the Repository
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-20T04:49:04Z | [https://gitea.com/api/v1/repos/search?q=server&limit=50](https://gitea.com/api/v1/repos/search?q=server&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-3628d0353c6902` from `gitea_repositories_api` as `registry_expansion`
