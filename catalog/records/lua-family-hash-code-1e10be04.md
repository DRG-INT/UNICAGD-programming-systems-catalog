...
| Canonical URL | [https://luarocks.org/modules/zhaoyang1221/hash-code](https://luarocks.org/modules/zhaoyang1221/hash-code) |
| Source record ids | luarocks_root_manifest-036806ddc283b1 |

## System Engineer Summary

A simple library for hashing code in java implemented in C++

## Operational Role

For a systems engineer, hash-code belongs in the Lua family inventory as part of confidentiality,
...
- `luarocks_root_manifest-036806ddc283b1` from `luarocks_root_manifest` as `registry_expansion`
