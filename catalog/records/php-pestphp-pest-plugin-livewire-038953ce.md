...
<!-- canonical: https://packagist.org/packages/pestphp/pest-plugin-livewire -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/pestphp/pest-plugin-livewire](https://packagist.org/packages/pestphp/pest-plugin-livewire) |
| Source record ids | packagist_search-4bad8fc85fa9c0 |
...
For a systems engineer, pestphp/pest-plugin-livewire belongs in the PHP inventory as part of
...
- `packagist_search-4bad8fc85fa9c0` from `packagist_search` as `registry_expansion`
