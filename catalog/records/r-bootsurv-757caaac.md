...
<!-- canonical: https://cran.r-project.org/web/packages/bootsurv/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/bootsurv/index.html](https://cran.r-project.org/web/packages/bootsurv/index.html) |
| Source record ids | cran_packages_by_date-4b2f5b06998485 |

## System Engineer Summary

Bootstrap Methods for Complete Survey Data

## Operational Role

For a systems engineer, bootsurv belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-28 07:01:39 UTC | [https://cran.r-project.org/web/packages/bootsurv/DESCRIPTION](https://cran.r-project.org/web/packages/bootsurv/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/bootsurv/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-4b2f5b06998485` from `cran_packages_by_date` as `registry_expansion`
