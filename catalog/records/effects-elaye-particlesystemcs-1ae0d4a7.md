...
<!-- canonical: https://github.com/elaye/particleSystemCS -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/elaye/particleSystemCS](https://github.com/elaye/particleSystemCS) |
| Source record ids | github_search_effects-b9c1ce6e2ba4ad |

## System Engineer Summary

openFrameworks particle system using compute shader

## Operational Role

For a systems engineer, elaye/particleSystemCS belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2015-02-10T15:55:22Z | gh search repos particle system | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-b9c1ce6e2ba4ad` from `github_search_effects` as `registry_expansion`
