...
| Canonical URL | [https://luarocks.org/modules/neorocks/flutter-tools.nvim](https://luarocks.org/modules/neorocks/flutter-tools.nvim) |
| Source record ids | luarocks_root_manifest-0649bd578aa565 |
...
For a systems engineer, flutter-tools.nvim belongs in the Lua family inventory as part of editor
...
- `luarocks_root_manifest-0649bd578aa565` from `luarocks_root_manifest` as `registry_expansion`
