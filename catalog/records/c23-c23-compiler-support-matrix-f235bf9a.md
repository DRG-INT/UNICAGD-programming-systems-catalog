...
| Language branch | C23 |
| Category | Compiler |
| Source type | compatibility_reference |
| Verification | web_verified_this_pass |
| Canonical URL | [https://en.cppreference.com/w/c/compiler_support/23](https://en.cppreference.com/w/c/compiler_support/23) |
| Source record ids | web-verified-0003 |

## System Engineer Summary

C23 compiler feature-support matrix.

## Operational Role

For a systems engineer, C23 compiler support matrix belongs in the C23 inventory as part of compiler
...
- `web-verified-0003` from `master_json` as `compatibility_reference`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Clang C23 | Compiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c23-clang-c23-efe57632.md) |
| GCC C23 | Compiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c23-gcc-c23-7c479877.md) |
| MSVC C23 | Compiler | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c23-msvc-c23-e8a2b6b4.md) |
