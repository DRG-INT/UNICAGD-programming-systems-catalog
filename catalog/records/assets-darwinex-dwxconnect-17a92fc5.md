...
<!-- canonical: https://github.com/darwinex/dwxconnect -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/darwinex/dwxconnect](https://github.com/darwinex/dwxconnect) |
| Source record ids | github_search_assets-603f7acbba0de2 |

## System Engineer Summary

Seamlessly link any Trading Strategy in ANY programming language to Darwinex liquidity via
MetaTrader 4 or 5. DWX Connect is your very own, fully customizable Trading API!

## Operational Role

For a systems engineer, darwinex/dwxconnect belongs in the Assets inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-05-25T07:44:34Z | gh search repos topic:asset-management stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-603f7acbba0de2` from `github_search_assets` as `registry_expansion`
