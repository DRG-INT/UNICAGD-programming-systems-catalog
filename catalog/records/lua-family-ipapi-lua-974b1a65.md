...
| Canonical URL | [https://luarocks.org/modules/jodros/ipapi-lua](https://luarocks.org/modules/jodros/ipapi-lua) |
| Source record ids | luarocks_root_manifest-2b22199447d620 |

## System Engineer Summary

Lua facility to call IPQwery API and use its data in your scripts...

## Operational Role

For a systems engineer, ipapi-lua belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-2b22199447d620` from `luarocks_root_manifest` as `registry_expansion`
