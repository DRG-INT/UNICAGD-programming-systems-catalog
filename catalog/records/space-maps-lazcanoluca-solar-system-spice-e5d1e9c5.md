# lazcanoluca/solar_system_spice

## Navigation

[Catalog index](../index.md) · [Language: Space Maps](../by-language/space-maps.md) · [Category: Data Science](../by-category/data-science.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/lazcanoluca/solar_system_spice -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lazcanoluca/solar_system_spice](https://github.com/lazcanoluca/solar_system_spice) |
| Source record ids | github_search_space_maps-67d83215dbe31d |

## System Engineer Summary

Some tinkering with the NAIF SPICE kernels, and Python data science libraries.

## Operational Role

For a systems engineer, lazcanoluca/solar_system_spice belongs in the Space Maps inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-06-24T20:03:26Z | gh search repos SPICE kernels | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-67d83215dbe31d` from `github_search_space_maps` as `registry_expansion`
