# mdrstudiogroup-ai/MDR-Studio-World-Map-For-Developers
...
<!-- canonical: https://github.com/mdrstudiogroup-ai/MDR-Studio-World-Map-For-Developers -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mdrstudiogroup-ai/MDR-Studio-World-Map-For-Developers](https://github.com/mdrstudiogroup-ai/MDR-Studio-World-Map-For-Developers) |
| Source record ids | github_search_space_maps-bda3b652857f83 |

## System Engineer Summary

World map With AI Integration, 3d, Planetary Full Free

## Operational Role

For a systems engineer, mdrstudiogroup-ai/MDR-Studio-World-Map-For-Developers belongs in the Space
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-17T10:44:42Z | gh search repos planetary maps | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-bda3b652857f83` from `github_search_space_maps` as `registry_expansion`
