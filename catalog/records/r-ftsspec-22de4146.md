...
<!-- canonical: https://cran.r-project.org/web/packages/ftsspec/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ftsspec/index.html](https://cran.r-project.org/web/packages/ftsspec/index.html) |
| Source record ids | cran_packages_by_date-8c74fd4ffb37c7 |
...
For a systems engineer, ftsspec belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-08-04 08:40:15 UTC | [https://cran.r-project.org/web/packages/ftsspec/DESCRIPTION](https://cran.r-project.org/web/packages/ftsspec/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ftsspec/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-8c74fd4ffb37c7` from `cran_packages_by_date` as `registry_expansion`
