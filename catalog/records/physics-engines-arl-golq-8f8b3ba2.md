...
[Catalog index](../index.md) · [Language: Physics Engines](../by-language/physics-engines.md) · [Category: Library](../by-category/library.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/arl/golq -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/arl/golq](https://github.com/arl/golq) |
| Source record ids | github_search_physics_engines-8a8d4ed4a612ba |
...
For a systems engineer, arl/golq belongs in the Physics Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-06-03T07:51:33Z | gh search repos topic:collision-detection stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-8a8d4ed4a612ba` from `github_search_physics_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AkhilRaja/Dave | Library | [open](physics-engines-akhilraja-dave-7adda8a3.md) |
| arjunkarpur/triangle-mesh-collision | Library | [open](physics-engines-arjunkarpur-triangle-mesh-collision-628d02ee.md) |
| attcs/Octree | Library | [open](physics-engines-attcs-octree-841d1400.md) |
| Aweptimum/Strike | Library | [open](physics-engines-aweptimum-strike-b376ac60.md) |
| brucefan1983/GPUMD | Library | [open](physics-engines-brucefan1983-gpumd-7fdd533e.md) |
| Cardboy0/Cardboy0s-SACS | Library | [open](physics-engines-cardboy0-cardboy0s-sacs-bfad56a5.md) |
| Continuous-Collision-Detection/Tight-Inclusion | Library | [open](physics-engines-continuous-collision-detection-tight-inclusion-12817950.md) |
| detomon/wigglebone | Library | [open](physics-engines-detomon-wigglebone-6ddf2d2b.md) |
