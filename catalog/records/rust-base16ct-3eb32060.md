...
<!-- canonical: https://crates.io/crates/base16ct -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/base16ct](https://crates.io/crates/base16ct) |
| Source record ids | crates_io-3563beec7dc1e3 |

## System Engineer Summary

Pure Rust implementation of Base16 a.k.a hexadecimal (RFC 4648) which avoids any usages of data-
dependent branches/LUTs and thereby provides portable "best effort" constant-time operation and
embedded-friendly no_std support

## Operational Role

For a systems engineer, base16ct belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-01-03T17:10:19.013127Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
- `crates_io-3563beec7dc1e3` from `crates_io` as `registry_expansion`
