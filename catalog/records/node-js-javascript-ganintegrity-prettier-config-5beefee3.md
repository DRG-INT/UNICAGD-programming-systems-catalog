...
| Canonical URL | [https://www.npmjs.com/package/@ganintegrity/prettier-config](https://www.npmjs.com/package/@ganintegrity/prettier-config) |
| Source record ids | npm_registry-01ebae9970394f |

## System Engineer Summary

@ganintegrity/prettier-config is tracked as a formatter record in the Node.js/JavaScript branch. The
...
For a systems engineer, @ganintegrity/prettier-config belongs in the Node.js/JavaScript inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2.1 | 2026-06-08T07:17:05.224Z | [https://registry.npmjs.org/-/v1/search?text=prettier&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=prettier&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-01ebae9970394f` from `npm_registry` as `registry_expansion`
