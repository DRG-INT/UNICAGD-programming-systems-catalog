...
<!-- canonical: https://github.com/doomlaser/DepthMask-Unity-Shader -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/doomlaser/DepthMask-Unity-Shader](https://github.com/doomlaser/DepthMask-Unity-Shader) |
| Source record ids | github_search_effects-3bb7a56410b735 |

## System Engineer Summary

Simple but powerful Unity shader that enables geometry masking for cutouts, UI, AR, and multiple
camera VFX tricks.

## Operational Role

For a systems engineer, doomlaser/DepthMask-Unity-Shader belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-12-05T02:53:25Z | gh search repos topic:vfx stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-3bb7a56410b735` from `github_search_effects` as `registry_expansion`
