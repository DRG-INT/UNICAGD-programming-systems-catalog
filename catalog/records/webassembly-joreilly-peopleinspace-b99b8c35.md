...
[Catalog index](../index.md) · [Language: WebAssembly](../by-language/webassembly.md) · [Category: Networking Http](../by-category/networking-http.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/joreilly/PeopleInSpace -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/joreilly/PeopleInSpace](https://github.com/joreilly/PeopleInSpace) |
| Source record ids | github_search_webassembly-af00c109e8f82a |

## System Engineer Summary

Kotlin Multiplatform sample with SwiftUI, Jetpack Compose, Compose for Wear, Compose for Desktop,
and Compose for Web clients along with Ktor backend.

## Operational Role

For a systems engineer, joreilly/PeopleInSpace belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-06T03:40:06Z | gh search repos topic:wasm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-af00c109e8f82a` from `github_search_webassembly` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| bots-garden/capsule | Networking Http | [open](webassembly-bots-garden-capsule-6ddc1d64.md) |
| deislabs/wagi | Networking Http | [open](webassembly-deislabs-wagi-65e75fe1.md) |
| deislabs/wasi-experimental-http | Networking Http | [open](webassembly-deislabs-wasi-experimental-http-bee04041.md) |
| dispatchrun/net | Networking Http | [open](webassembly-dispatchrun-net-ea550bf8.md) |
| evgeny-nadymov/telegram-react | Networking Http | [open](webassembly-evgeny-nadymov-telegram-react-7bf2bf4e.md) |
| near/nearcore | Networking Http | [open](webassembly-near-nearcore-94125d0d.md) |
| WebAssembly/WASI | Networking Http | [open](webassembly-webassembly-wasi-e42b23bc.md) |
| WebAssembly/wasi-http | Networking Http | [open](webassembly-webassembly-wasi-http-ad3f0d17.md) |
