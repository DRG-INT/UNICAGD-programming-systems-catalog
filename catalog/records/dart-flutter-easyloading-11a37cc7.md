...
<!-- canonical: https://pub.dev/packages/flutter_easyloading -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_easyloading](https://pub.dev/packages/flutter_easyloading) |
| Source record ids | pub_dev-00365abed0a721 |
...
For a systems engineer, flutter_easyloading belongs in the Dart inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.0.2 | 2026-07-30T02:17:48.509538Z | [https://pub.dev/api/packages/flutter_easyloading](https://pub.dev/api/packages/flutter_easyloading) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_easyloading` at `2026-09-01T14:20:30+00:00`.
...
- `pub_dev-00365abed0a721` from `pub_dev` as `registry_expansion`
