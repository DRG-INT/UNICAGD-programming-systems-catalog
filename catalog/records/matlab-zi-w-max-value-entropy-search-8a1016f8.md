...
<!-- canonical: https://github.com/zi-w/Max-value-Entropy-Search -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/zi-w/Max-value-Entropy-Search](https://github.com/zi-w/Max-value-Entropy-Search) |
| Source record ids | github_search_matlab-956eb1693ade5e |
...
For a systems engineer, zi-w/Max-value-Entropy-Search belongs in the Matlab inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-02-22T21:48:31Z | gh search repos language:MATLAB topic:machine-learning | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-956eb1693ade5e` from `github_search_matlab` as `registry_expansion`
