...
<!-- canonical: https://cran.r-project.org/web/packages/fred/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/fred/index.html](https://cran.r-project.org/web/packages/fred/index.html) |
| Source record ids | cran_packages_by_date-9a6f70c76f9d69 |
...
For a systems engineer, fred belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.1 | 2026-09-09 10:00:07 UTC | [https://cran.r-project.org/web/packages/fred/DESCRIPTION](https://cran.r-project.org/web/packages/fred/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/fred/DESCRIPTION` at `2026-09-09T10:21:05+00:00`.
...
- `cran_packages_by_date-9a6f70c76f9d69` from `cran_packages_by_date` as `registry_expansion`
