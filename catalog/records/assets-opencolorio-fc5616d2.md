...
| Canonical URL | [https://github.com/AcademySoftwareFoundation/OpenColorIO](https://github.com/AcademySoftwareFoundation/OpenColorIO) |
| Source record ids | curated_language_routes-39547060b12ef5 |

## System Engineer Summary

Color-management system for film, animation, visual effects, and asset pipeline rendering
consistency.

## Operational Role

For a systems engineer, OpenColorIO belongs in the Assets inventory as part of ecosystem capability
...
- `curated_language_routes-39547060b12ef5` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| FFmpeg | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/assets-ffmpeg-66622130.md) |
| ImageMagick | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/assets-imagemagick-18263a94.md) |
| OpenImageIO | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/assets-openimageio-55659ba6.md) |
| Sharp | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/assets-sharp-22f8fbb8.md) |
