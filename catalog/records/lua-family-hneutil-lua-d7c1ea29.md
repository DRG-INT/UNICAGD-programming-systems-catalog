...
| Canonical URL | [https://luarocks.org/modules/hneutr/hneutil-lua](https://luarocks.org/modules/hneutr/hneutil-lua) |
| Source record ids | luarocks_root_manifest-740c628602e5f6 |

## System Engineer Summary

hneutil-lua is tracked as a library record in the Lua family branch. The source did not provide a
...
For a systems engineer, hneutil-lua belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-740c628602e5f6` from `luarocks_root_manifest` as `registry_expansion`
