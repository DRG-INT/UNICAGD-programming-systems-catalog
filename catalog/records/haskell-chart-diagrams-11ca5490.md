...
<!-- canonical: https://hackage.haskell.org/package/Chart-diagrams -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/Chart-diagrams](https://hackage.haskell.org/package/Chart-diagrams) |
| Source record ids | hackage_top_downloads-7a6fc00066878f |
...
For a systems engineer, Chart-diagrams belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.9.5.1 | 2023-10-23T04:22:09Z | [https://hackage.haskell.org/package/Chart-diagrams](https://hackage.haskell.org/package/Chart-diagrams) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/Chart-diagrams` at `2026-09-01T14:24:09+00:00`.
...
- `hackage_top_downloads-7a6fc00066878f` from `hackage_top_downloads` as `registry_expansion`
