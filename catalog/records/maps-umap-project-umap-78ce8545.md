...
<!-- canonical: https://github.com/umap-project/umap -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/umap-project/umap](https://github.com/umap-project/umap) |
| Source record ids | github_search_maps-2d7af93f8755d9 |
...
For a systems engineer, umap-project/umap belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T15:24:52Z | gh search repos topic:openstreetmap stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-2d7af93f8755d9` from `github_search_maps` as `registry_expansion`
