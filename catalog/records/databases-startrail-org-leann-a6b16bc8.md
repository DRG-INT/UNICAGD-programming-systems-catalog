...
<!-- canonical: https://github.com/StarTrail-org/LEANN -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/StarTrail-org/LEANN](https://github.com/StarTrail-org/LEANN) |
| Source record ids | github_search_databases-1f60f24d2885da |

## System Engineer Summary

MLsys2026 Best Paper: RAG on Everything with LEANN. Enjoy 97% storage savings while running a fast,
accurate, and 100% private RAG application on your personal device.

## Operational Role

For a systems engineer, StarTrail-org/LEANN belongs in the Databases inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-30T02:40:10Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-1f60f24d2885da` from `github_search_databases` as `registry_expansion`
