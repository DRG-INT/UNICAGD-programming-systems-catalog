...
<!-- canonical: https://luarocks.org/modules/luarocks/abelhas -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/luarocks/abelhas](https://luarocks.org/modules/luarocks/abelhas) |
| Source record ids | luarocks_root_manifest-a5e85783788e51 |
...
For a systems engineer, abelhas belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-a5e85783788e51` from `luarocks_root_manifest` as `registry_expansion`
