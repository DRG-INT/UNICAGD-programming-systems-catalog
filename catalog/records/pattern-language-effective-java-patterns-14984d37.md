...
<!-- canonical: https://github.com/HugoMatilla/Effective-JAVA-Summary -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/HugoMatilla/Effective-JAVA-Summary](https://github.com/HugoMatilla/Effective-JAVA-Summary) |
| Source record ids | awesome_list-3d7edb9b20986c |

## System Engineer Summary

patterns from the Effective Java book.

## Operational Role

For a systems engineer, effective-java patterns belongs in the Pattern language inventory as part of
...
- `awesome_list-3d7edb9b20986c` from `awesome_list` as `registry_expansion`
