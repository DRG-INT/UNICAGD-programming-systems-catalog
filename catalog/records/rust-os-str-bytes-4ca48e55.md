...
<!-- canonical: https://crates.io/crates/os_str_bytes -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/os_str_bytes](https://crates.io/crates/os_str_bytes) |
| Source record ids | crates_io-fe0771877b2512 |
...
For a systems engineer, os_str_bytes belongs in the Rust inventory as part of confidentiality,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.2.1 | 2026-07-16T02:47:19.792003Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-fe0771877b2512` from `crates_io` as `registry_expansion`
