# Starlark Language Site

## Navigation

[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Starlark](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/starlark.md) · [Category: Documentation](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/documentation.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://starlark-lang.org/](https://starlark-lang.org/) |
| Source record ids | curated_language_routes-c225842504e750 |

## System Engineer Summary

Official Starlark language site and overview for the Python-like embedded configuration language.

## Operational Role

For a systems engineer, Starlark Language Site belongs in the Starlark inventory as part of operator
...
- `curated_language_routes-c225842504e750` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Bazel Starlark Language | Documentation | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/starlark-bazel-starlark-language-ae7c8f4d.md) |
