...
<!-- canonical: https://cran.r-project.org/web/packages/hydroloom/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/hydroloom/index.html](https://cran.r-project.org/web/packages/hydroloom/index.html) |
| Source record ids | cran_packages_by_date-f6f68cd60f53b3 |
...
For a systems engineer, hydroloom belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.2 | 2026-09-13 23:30:02 UTC | [https://cran.r-project.org/web/packages/hydroloom/DESCRIPTION](https://cran.r-project.org/web/packages/hydroloom/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/hydroloom/DESCRIPTION` at `2026-09-14T00:28:12+00:00`.
...
- `cran_packages_by_date-f6f68cd60f53b3` from `cran_packages_by_date` as `registry_expansion`
