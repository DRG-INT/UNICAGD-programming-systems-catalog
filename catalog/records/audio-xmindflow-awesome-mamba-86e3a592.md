...
<!-- canonical: https://github.com/xmindflow/Awesome_Mamba -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/xmindflow/Awesome_Mamba](https://github.com/xmindflow/Awesome_Mamba) |
| Source record ids | github_search_audio-6a237e9ea0f883 |
...
For a systems engineer, xmindflow/Awesome_Mamba belongs in the Audio inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-07-22T06:12:27Z | gh search repos topic:speech-processing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-6a237e9ea0f883` from `github_search_audio` as `registry_expansion`
