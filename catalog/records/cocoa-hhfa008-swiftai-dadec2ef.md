...
<!-- canonical: https://github.com/hhfa008/SwiftAI -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/hhfa008/SwiftAI](https://github.com/hhfa008/SwiftAI) |
| Source record ids | github_search_cocoa-1dd95fb9df4aad |

## System Engineer Summary

SwiftAI, write Swift code smart. SwiftAI can generate Model class from JSON now. Codable and
HandyJSON is supported. More features will be add.

## Operational Role

For a systems engineer, hhfa008/SwiftAI belongs in the Cocoa inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-03-14T04:43:41Z | gh search repos topic:cocoa stars:>200 | gh_search_reports_activity_not_release_version |
...
| Evidence | Other; BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause; Apache License 2.0; https://api.github.com/licenses/apache-2.0; MIT License; https://api.github.com/licenses/mit |
...
- `github_search_cocoa-1dd95fb9df4aad` from `github_search_cocoa` as `registry_expansion`
...
| m8labs/WidgetKit | Serialization | [open](cocoa-m8labs-widgetkit-52747f23.md) |
