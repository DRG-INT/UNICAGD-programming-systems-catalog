...
| Canonical URL | [https://luarocks.org/modules/luarocks/ihelp](https://luarocks.org/modules/luarocks/ihelp) |
| Source record ids | luarocks_root_manifest-a64c73be31f0e9 |

## System Engineer Summary

ihelp is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, ihelp belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-a64c73be31f0e9` from `luarocks_root_manifest` as `registry_expansion`
