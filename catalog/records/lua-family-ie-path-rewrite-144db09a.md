...
| Canonical URL | [https://luarocks.org/modules/gx/ie-path-rewrite](https://luarocks.org/modules/gx/ie-path-rewrite) |
| Source record ids | luarocks_root_manifest-427a2beae50343 |

## System Engineer Summary

ie-path-rewrite is tracked as a filesystem os record in the Lua family branch. The source did not
...
For a systems engineer, ie-path-rewrite belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-427a2beae50343` from `luarocks_root_manifest` as `registry_expansion`
