...
| Source record ids | github_search_assets-ac2783d2bee4ba |
...
For a systems engineer, sahibjotsaggu/San-Francisco-Pro-Fonts belongs in the Assets inventory as
...
- `github_search_assets-ac2783d2bee4ba` from `github_search_assets` as `registry_expansion`
