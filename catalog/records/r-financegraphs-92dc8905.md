...
<!-- canonical: https://cran.r-project.org/web/packages/FinanceGraphs/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/FinanceGraphs/index.html](https://cran.r-project.org/web/packages/FinanceGraphs/index.html) |
| Source record ids | cran_packages_by_date-c571ffcda3e840 |
...
For a systems engineer, FinanceGraphs belongs in the R inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.21 | 2026-08-28 17:00:09 UTC | [https://cran.r-project.org/web/packages/FinanceGraphs/DESCRIPTION](https://cran.r-project.org/web/packages/FinanceGraphs/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/FinanceGraphs/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-c571ffcda3e840` from `cran_packages_by_date` as `registry_expansion`
