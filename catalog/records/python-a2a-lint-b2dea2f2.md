...
<!-- canonical: https://pypi.org/project/a2a-lint/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/a2a-lint/](https://pypi.org/project/a2a-lint/) |
| Source record ids | pypi_simple-0bde15d966a7a0 |

## System Engineer Summary

Conformance linter for A2A agents — agent card validation, live message/send probes, CI-friendly
exit codes.

## Operational Role

For a systems engineer, a2a-lint belongs in the Python inventory as part of static feedback, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1 | 2026-07-11T15:03:09.691706Z | [https://pypi.org/pypi/a2a-lint/json](https://pypi.org/pypi/a2a-lint/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/a2a-lint/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-0bde15d966a7a0` from `pypi_simple` as `registry_expansion`
