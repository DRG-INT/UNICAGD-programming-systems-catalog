...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Rust](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/rust.md) · [Category: Interop Bindings](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/interop-bindings.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Category | Interop Bindings |
| Source type |  |
| Verification | crates_io |
| Canonical URL | [https://crates.io/crates/unicase](https://crates.io/crates/unicase) |
| Source record ids | crates_io-19746dd8921bee |
...
For a systems engineer, unicase belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.9.0 | 2026-01-06T15:50:10.409065Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- Treat category as `interop_bindings` unless a later verified source gives a better classification.
...
| Name | Category | Page |
| --- | --- | --- |
| android_system_properties | Interop Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-android-system-properties-07a7d47c.md) |
| array-init | Interop Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-array-init-54773404.md) |
| atomic | Interop Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-atomic-abcd36f3.md) |
| bytesize | Interop Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-bytesize-06ab5161.md) |
| cxx | Interop Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-cxx-8005ea19.md) |
| dispatch | Interop Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-dispatch-d0b8d78c.md) |
| endian-type | Interop Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-endian-type-ec32f720.md) |
| filedescriptor | Interop Bindings | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-filedescriptor-39b88adf.md) |
