...
[Catalog index](../index.md) · [Language: Rust](../by-language/rust.md) · [Category: Interop Bindings](../by-category/interop-bindings.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://crates.io/crates/unicase -->
<!-- crawl-delay: 10 -->
...
| --- | --- | --- | --- |
| crates_io | registry-derived | 2026-09-11 | `{"kind": "crates_io", "retrieved": "2026-09-11", "status": "registry-derived"}` |
...
- `crates_io-19746dd8921bee` from `crates_io` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| android_system_properties | Interop Bindings | [open](rust-android-system-properties-07a7d47c.md) |
| array-init | Interop Bindings | [open](rust-array-init-54773404.md) |
| atomic | Interop Bindings | [open](rust-atomic-abcd36f3.md) |
| bytesize | Interop Bindings | [open](rust-bytesize-06ab5161.md) |
| cxx | Interop Bindings | [open](rust-cxx-8005ea19.md) |
| dispatch | Interop Bindings | [open](rust-dispatch-d0b8d78c.md) |
| endian-type | Interop Bindings | [open](rust-endian-type-ec32f720.md) |
| filedescriptor | Interop Bindings | [open](rust-filedescriptor-39b88adf.md) |
