...
<!-- canonical: https://github.com/karimnaaji/vectiler -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/karimnaaji/vectiler](https://github.com/karimnaaji/vectiler) |
| Source record ids | github_search_maps-4852f5b5967321 |

## System Engineer Summary

A vector tile, terrain and city 3d model builder and CLI exporter. Consider using its fully
integrated user interface at

## Operational Role

For a systems engineer, karimnaaji/vectiler belongs in the Maps inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-05-20T15:31:54Z | gh search repos topic:openstreetmap stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-4852f5b5967321` from `github_search_maps` as `registry_expansion`
