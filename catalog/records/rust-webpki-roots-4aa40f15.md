...
<!-- canonical: https://crates.io/crates/webpki-roots -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/webpki-roots](https://crates.io/crates/webpki-roots) |
| Source record ids | crates_io-94ef1ced76af3a |
...
For a systems engineer, webpki-roots belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.9 | 2026-07-18T09:30:44.802479Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-94ef1ced76af3a` from `crates_io` as `registry_expansion`
