...
<!-- canonical: https://github.com/jmstajim/Particlized -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jmstajim/Particlized](https://github.com/jmstajim/Particlized) |
| Source record ids | github_search_effects-a2b632df6ec0fe |

## System Engineer Summary

Turn text, emoji, or image into particles

## Operational Role

For a systems engineer, jmstajim/Particlized belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-09-18T20:30:44Z | gh search repos topic:particle-system stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-a2b632df6ec0fe` from `github_search_effects` as `registry_expansion`
