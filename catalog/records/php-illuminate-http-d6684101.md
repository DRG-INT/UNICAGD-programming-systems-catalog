...
<!-- canonical: https://packagist.org/packages/illuminate/http -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/illuminate/http](https://packagist.org/packages/illuminate/http) |
| Source record ids | packagist_search-9c2e98298ce3ae |
...
For a systems engineer, illuminate/http belongs in the PHP inventory as part of service
...
- `packagist_search-9c2e98298ce3ae` from `packagist_search` as `registry_expansion`
