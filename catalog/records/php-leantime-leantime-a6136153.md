...
<!-- canonical: https://packagist.org/packages/leantime/leantime -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/leantime/leantime](https://packagist.org/packages/leantime/leantime) |
| Source record ids | packagist_search-d7d8e0bf4cd03f |

## System Engineer Summary

Open source project management system for non-project managers. Simple like Trello, powerful like
Jira. Built with neurodiversity in mind.

## Operational Role

For a systems engineer, leantime/leantime belongs in the PHP inventory as part of state persistence,
...
- `packagist_search-d7d8e0bf4cd03f` from `packagist_search` as `registry_expansion`
