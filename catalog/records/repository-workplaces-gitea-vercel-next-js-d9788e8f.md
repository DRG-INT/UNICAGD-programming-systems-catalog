...
<!-- canonical: https://gitea.com/vercel/next.js -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/vercel/next.js](https://gitea.com/vercel/next.js) |
| Source record ids | gitea_repositories_api-76123716c8f1a1 |

## System Engineer Summary

Gitea: vercel/next.js is tracked as a compiler record in the Repository Workplaces branch. The
...
For a systems engineer, Gitea: vercel/next.js belongs in the Repository Workplaces inventory as part
of compiler selection, diagnostics behavior, target support, ABI expectations, and build
reproducibility.
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-18T13:46:43Z | [https://gitea.com/api/v1/repos/search?q=compiler&limit=50](https://gitea.com/api/v1/repos/search?q=compiler&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-76123716c8f1a1` from `gitea_repositories_api` as `registry_expansion`
