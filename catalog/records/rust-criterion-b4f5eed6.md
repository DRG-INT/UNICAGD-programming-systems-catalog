...
<!-- canonical: https://crates.io/crates/criterion -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/criterion](https://crates.io/crates/criterion) |
| Source record ids | crates_io-14b6c25e38317d |
...
For a systems engineer, criterion belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.2 | 2026-02-04T10:43:03.398729Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads` at `2026-09-08T18:23:34+00:00`.
...
- `crates_io-14b6c25e38317d` from `crates_io` as `registry_expansion`
