...
[Catalog index](../index.md) · [Language: Game Engines](../by-language/game-engines.md) · [Category: Concurrency Parallelism](../by-category/concurrency-parallelism.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/amethyst/specs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/amethyst/specs](https://github.com/amethyst/specs) |
| Source record ids | github_search_game_engines-7e2802e95d123e |

## System Engineer Summary

amethyst/specs is tracked as a concurrency parallelism record in the Game Engines branch. The source
...
For a systems engineer, amethyst/specs belongs in the Game Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-06-07T18:32:55Z | gh search repos topic:ecs stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-7e2802e95d123e` from `github_search_game_engines` as `registry_expansion`
