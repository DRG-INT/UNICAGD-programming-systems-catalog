...
<!-- canonical: https://gitlab.com/tim-m89/clr-haskell -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/tim-m89/clr-haskell](https://gitlab.com/tim-m89/clr-haskell) |
| Source record ids | gitlab_projects_api-ea96d46fda38d2 |

## System Engineer Summary

A bridge between Haskell and the common language runtime (.Net / Mono)

## Operational Role

For a systems engineer, tim-m89/clr-haskell belongs in the Repository Workplaces inventory as part
...
- `gitlab_projects_api-ea96d46fda38d2` from `gitlab_projects_api` as `registry_expansion`
