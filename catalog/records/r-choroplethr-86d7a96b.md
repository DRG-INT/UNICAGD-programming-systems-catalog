...
<!-- canonical: https://cran.r-project.org/web/packages/choroplethr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/choroplethr/index.html](https://cran.r-project.org/web/packages/choroplethr/index.html) |
| Source record ids | cran_packages_by_date-ff44f5e7a8c277 |
...
For a systems engineer, choroplethr belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.0.2 | 2026-09-11 20:10:33 UTC | [https://cran.r-project.org/web/packages/choroplethr/DESCRIPTION](https://cran.r-project.org/web/packages/choroplethr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/choroplethr/DESCRIPTION` at `2026-09-11T22:18:50+00:00`.
...
- `cran_packages_by_date-ff44f5e7a8c277` from `cran_packages_by_date` as `registry_expansion`
