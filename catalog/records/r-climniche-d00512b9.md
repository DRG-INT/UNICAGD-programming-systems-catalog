...
<!-- canonical: https://cran.r-project.org/web/packages/climniche/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/climniche/index.html](https://cran.r-project.org/web/packages/climniche/index.html) |
| Source record ids | cran_packages_by_date-b04f82189aaedc |

## System Engineer Summary

Climate Exposure Relative to a Species' Climatic Niche

## Operational Role

For a systems engineer, climniche belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.8 | 2026-08-28 08:40:02 UTC | [https://cran.r-project.org/web/packages/climniche/DESCRIPTION](https://cran.r-project.org/web/packages/climniche/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/climniche/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-b04f82189aaedc` from `cran_packages_by_date` as `registry_expansion`
