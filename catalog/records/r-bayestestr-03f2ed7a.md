...
<!-- canonical: https://cran.r-project.org/web/packages/bayestestR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/bayestestR/index.html](https://cran.r-project.org/web/packages/bayestestR/index.html) |
| Source record ids | cran_packages_by_date-90e3f9c406da0e |
...
For a systems engineer, bayestestR belongs in the R inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.19.0 | 2026-09-09 14:50:17 UTC | [https://cran.r-project.org/web/packages/bayestestR/DESCRIPTION](https://cran.r-project.org/web/packages/bayestestR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/bayestestR/DESCRIPTION` at `2026-09-09T16:21:56+00:00`.
...
- `cran_packages_by_date-90e3f9c406da0e` from `cran_packages_by_date` as `registry_expansion`
