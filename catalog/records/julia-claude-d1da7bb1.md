...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/Claude](https://github.com/JuliaRegistries/General/tree/master/C/Claude) |
| Source record ids | julia_general-9f906a694c1b22 |

## System Engineer Summary

Julia package registered in General at C/Claude.

## Operational Role

For a systems engineer, Claude belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/Claude", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-9f906a694c1b22` from `julia_general` as `registry_expansion`
