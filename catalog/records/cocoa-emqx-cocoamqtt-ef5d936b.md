...
<!-- canonical: https://github.com/emqx/CocoaMQTT -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/emqx/CocoaMQTT](https://github.com/emqx/CocoaMQTT) |
| Source record ids | github_search_cocoa-cb7568fe9429d6 |
...
For a systems engineer, emqx/CocoaMQTT belongs in the Cocoa inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-31T12:13:27Z | gh search repos topic:cocoapods stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-cb7568fe9429d6` from `github_search_cocoa` as `registry_expansion`
