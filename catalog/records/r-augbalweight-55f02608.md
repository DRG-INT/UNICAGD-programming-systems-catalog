...
<!-- canonical: https://cran.r-project.org/web/packages/AugBalWeight/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/AugBalWeight/index.html](https://cran.r-project.org/web/packages/AugBalWeight/index.html) |
| Source record ids | cran_packages_by_date-97d56a408cd1a5 |
...
For a systems engineer, AugBalWeight belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-21 12:41:17 UTC | [https://cran.r-project.org/web/packages/AugBalWeight/DESCRIPTION](https://cran.r-project.org/web/packages/AugBalWeight/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/AugBalWeight/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-97d56a408cd1a5` from `cran_packages_by_date` as `registry_expansion`
