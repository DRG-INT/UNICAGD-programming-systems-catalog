...
[Catalog index](../index.md) · [Language: Computer Graphics Software](../by-language/computer-graphics-software.md) · [Category: Benchmarking](../by-category/benchmarking.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/iamlukethedev/Claw3D -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/iamlukethedev/Claw3D](https://github.com/iamlukethedev/Claw3D) |
| Source record ids | github_search_computer_graphics_software-62e5e6e48143c1 |

## System Engineer Summary

Claw3D is an open source 3D engine built on OpenClaw for creating games, simulations, and high-
performance 3D applications.

## Operational Role

For a systems engineer, iamlukethedev/Claw3D belongs in the Computer Graphics Software inventory as
...
- `github_search_computer_graphics_software-62e5e6e48143c1` from `github_search_computer_graphics_software` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| TianZerL/Anime4KCPP | Benchmarking | [open](computer-graphics-software-tianzerl-anime4kcpp-64920d46.md) |
