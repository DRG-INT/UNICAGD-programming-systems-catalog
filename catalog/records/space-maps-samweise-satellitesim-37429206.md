...
<!-- canonical: https://github.com/SamWeise/SatelliteSim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SamWeise/SatelliteSim](https://github.com/SamWeise/SatelliteSim) |
| Source record ids | github_search_space_maps-e79bf223aaabee |

## System Engineer Summary

This repository consists of projects associated with designing a satellite test bed, including a
Star Catalog for identifying what a sensor is observing as well as a Star Sensor for identifying the
satellite's position and orientation in its orbit.

## Operational Role

For a systems engineer, SamWeise/SatelliteSim belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2015-10-05T19:35:51Z | gh search repos star catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-e79bf223aaabee` from `github_search_space_maps` as `registry_expansion`
