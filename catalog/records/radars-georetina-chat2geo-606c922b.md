...
| Source record ids | github_search_radars-d4aa945e1e9700 |
...
For a systems engineer, GeoRetina/chat2geo belongs in the Radars inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-09T18:33:38Z | gh search repos topic:remote-sensing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-d4aa945e1e9700` from `github_search_radars` as `registry_expansion`
