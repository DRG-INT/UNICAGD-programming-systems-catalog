...
<!-- canonical: https://hackage.haskell.org/package/tpdb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/tpdb](https://hackage.haskell.org/package/tpdb) |
| Source record ids | hackage_top_downloads-63bad55c534e82 |
...
For a systems engineer, tpdb belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.9.0 | 2026-06-06T15:00:42Z | [https://hackage.haskell.org/package/tpdb](https://hackage.haskell.org/package/tpdb) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/tpdb` at `2026-09-10T01:21:10+00:00`.
...
- `hackage_top_downloads-63bad55c534e82` from `hackage_top_downloads` as `registry_expansion`
