...
[Catalog index](../index.md) · [Language: Photography](../by-language/photography.md) · [Category: Language Specification](../by-category/language-specification.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/AcademySoftwareFoundation/openexr -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AcademySoftwareFoundation/openexr](https://github.com/AcademySoftwareFoundation/openexr) |
| Source record ids | github_search_photography-dbc097c84d026d |

## System Engineer Summary

The OpenEXR project provides the specification and reference implementation of the EXR file format,
the professional-grade image storage format of the motion picture industry.

## Operational Role

For a systems engineer, AcademySoftwareFoundation/openexr belongs in the Photography inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T15:19:38Z | gh search repos topic:hdr stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-dbc097c84d026d` from `github_search_photography` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| angelgladin/Photo_Exif_Toolkit | Language Specification | [open](photography-angelgladin-photo-exif-toolkit-754e1378.md) |
| dmotz/thing-translator | Language Specification | [open](photography-dmotz-thing-translator-7eb7907e.md) |
| dsoprea/go-exif | Language Specification | [open](photography-dsoprea-go-exif-58f74328.md) |
| halide/Halide | Language Specification | [open](photography-halide-halide-872dbb0e.md) |
| JaidedAI/EasyOCR | Language Specification | [open](photography-jaidedai-easyocr-4261194e.md) |
| mcrescas/veriv | Language Specification | [open](photography-mcrescas-veriv-fd04d504.md) |
| mv-lab/InstructIR | Language Specification | [open](photography-mv-lab-instructir-9bdb6aa5.md) |
| oozcitak/exiflibrary | Language Specification | [open](photography-oozcitak-exiflibrary-141e9e3c.md) |
