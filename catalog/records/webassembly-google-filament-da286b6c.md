...
<!-- canonical: https://github.com/google/filament -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/google/filament](https://github.com/google/filament) |
| Source record ids | github_search_webassembly-985339a0727b05 |

## System Engineer Summary

Filament is a real-time physically based rendering engine for Android, iOS, Windows, Linux, macOS,
and WebGL2

## Operational Role

For a systems engineer, google/filament belongs in the WebAssembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-12T08:12:32Z | gh search repos topic:wasm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-985339a0727b05` from `github_search_webassembly` as `registry_expansion`
