...
<!-- canonical: https://cran.r-project.org/web/packages/layeranalyzer/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/layeranalyzer/index.html](https://cran.r-project.org/web/packages/layeranalyzer/index.html) |
| Source record ids | cran_packages_by_date-e195e1915528c0 |
...
For a systems engineer, layeranalyzer belongs in the R inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.1 | 2026-08-28 09:50:08 UTC | [https://cran.r-project.org/web/packages/layeranalyzer/DESCRIPTION](https://cran.r-project.org/web/packages/layeranalyzer/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/layeranalyzer/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-e195e1915528c0` from `cran_packages_by_date` as `registry_expansion`
