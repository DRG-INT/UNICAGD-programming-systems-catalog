...
<!-- canonical: https://hackage.haskell.org/package/monoidmap -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/monoidmap](https://hackage.haskell.org/package/monoidmap) |
| Source record ids | hackage_top_downloads-96b1330988979d |
...
For a systems engineer, monoidmap belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.5.1 | 2026-04-19T07:23:45Z | [https://hackage.haskell.org/package/monoidmap](https://hackage.haskell.org/package/monoidmap) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/monoidmap` at `2026-09-01T14:24:25+00:00`.
...
- `hackage_top_downloads-96b1330988979d` from `hackage_top_downloads` as `registry_expansion`
