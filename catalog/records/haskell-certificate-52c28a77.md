...
<!-- canonical: https://hackage.haskell.org/package/certificate -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/certificate](https://hackage.haskell.org/package/certificate) |
| Source record ids | hackage_top_downloads-be521c5b53a5ef |
...
For a systems engineer, certificate belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.9 | 2013-10-07T02:19:04Z | [https://hackage.haskell.org/package/certificate](https://hackage.haskell.org/package/certificate) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/certificate` at `2026-09-01T14:24:09+00:00`.
...
- `hackage_top_downloads-be521c5b53a5ef` from `hackage_top_downloads` as `registry_expansion`
