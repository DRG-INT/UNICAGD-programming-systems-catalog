...
<!-- canonical: https://hackage.haskell.org/package/hspec-api -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/hspec-api](https://hackage.haskell.org/package/hspec-api) |
| Source record ids | hackage_top_downloads-7852fe7ad343d9 |
...
For a systems engineer, hspec-api belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.11.17 | 2026-03-04T18:02:10Z | [https://hackage.haskell.org/package/hspec-api](https://hackage.haskell.org/package/hspec-api) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/hspec-api` at `2026-09-01T14:24:21+00:00`.
...
- `hackage_top_downloads-7852fe7ad343d9` from `hackage_top_downloads` as `registry_expansion`
