...
<!-- canonical: https://cran.r-project.org/web/packages/ggcube/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ggcube/index.html](https://cran.r-project.org/web/packages/ggcube/index.html) |
| Source record ids | cran_packages_by_date-8096f14e3e243d |
...
For a systems engineer, ggcube belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-09-05 14:30:02 UTC | [https://cran.r-project.org/web/packages/ggcube/DESCRIPTION](https://cran.r-project.org/web/packages/ggcube/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ggcube/DESCRIPTION` at `2026-09-05T15:18:02+00:00`.
...
- `cran_packages_by_date-8096f14e3e243d` from `cran_packages_by_date` as `registry_expansion`
