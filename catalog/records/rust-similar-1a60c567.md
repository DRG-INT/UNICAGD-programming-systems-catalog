...
<!-- canonical: https://crates.io/crates/similar -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/similar](https://crates.io/crates/similar) |
| Source record ids | crates_io-2963262527444d |

## System Engineer Summary

similar is tracked as a library record in the Rust branch. The source did not provide a long
...
For a systems engineer, similar belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.2.0 | 2026-08-17T09:45:01.478395Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-2963262527444d` from `crates_io` as `registry_expansion`
