...
<!-- canonical: https://www.npmjs.com/package/@use-voltra/server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@use-voltra/server](https://www.npmjs.com/package/@use-voltra/server) |
| Source record ids | npm_registry-0553be7d785aa7 |

## System Engineer Summary

Shared server rendering foundation for Voltra

## Operational Role

For a systems engineer, @use-voltra/server belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2.0 | 2026-08-03T13:15:46.999Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-0553be7d785aa7` from `npm_registry` as `registry_expansion`
