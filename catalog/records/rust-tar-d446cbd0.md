...
<!-- canonical: https://crates.io/crates/tar -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/tar](https://crates.io/crates/tar) |
| Source record ids | crates_io-c481015a13f217 |

## System Engineer Summary

A Rust implementation of a TAR file reader and writer. This library does not currently handle
...
For a systems engineer, tar belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.46 | 2026-05-18T19:12:11.033813Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
- `crates_io-c481015a13f217` from `crates_io` as `registry_expansion`
