...
<!-- canonical: https://www.npmjs.com/package/expo-server-sdk -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/expo-server-sdk](https://www.npmjs.com/package/expo-server-sdk) |
| Source record ids | npm_registry-b501afba17e5d7 |
...
For a systems engineer, expo-server-sdk belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.2.0 | 2026-08-24T06:35:13.660Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-b501afba17e5d7` from `npm_registry` as `registry_expansion`
