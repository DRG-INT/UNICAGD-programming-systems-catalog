...
<!-- canonical: https://github.com/Prothom7/Stella -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Prothom7/Stella](https://github.com/Prothom7/Stella) |
| Source record ids | github_search_space_maps-560de60149ecab |

## System Engineer Summary

Discover the wonders of the cosmos with Stella, an interactive astronomy learning app for iOS.
Designed for students, beginners, and space enthusiasts, Stella lets you explore planets, stars,
constellations, and other celestial objects in augmented reality or through a beautiful, interactive
3D sky map.

## Operational Role

For a systems engineer, Prothom7/Stella belongs in the Space Maps inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-06T08:12:16Z | gh search repos astronomy sky map | gh_search_reports_activity_not_release_version |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; {"key": "", "name": "", "url": ""} |
...
- `github_search_space_maps-560de60149ecab` from `github_search_space_maps` as `registry_expansion`
