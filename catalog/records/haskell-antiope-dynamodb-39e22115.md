...
<!-- canonical: https://hackage.haskell.org/package/antiope-dynamodb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/antiope-dynamodb](https://hackage.haskell.org/package/antiope-dynamodb) |
| Source record ids | hackage_top_downloads-917c132ca659f6 |
...
For a systems engineer, antiope-dynamodb belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.5.3 | 2020-10-22T11:56:17Z | [https://hackage.haskell.org/package/antiope-dynamodb](https://hackage.haskell.org/package/antiope-dynamodb) |  |
| candidate | partial | 7.0.1 |  | [https://hackage.haskell.org/package/antiope-dynamodb](https://hackage.haskell.org/package/antiope-dynamodb) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/antiope-dynamodb` at `2026-09-01T14:24:06+00:00`.
...
- `hackage_top_downloads-917c132ca659f6` from `hackage_top_downloads` as `registry_expansion`
