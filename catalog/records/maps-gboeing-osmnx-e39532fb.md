...
<!-- canonical: https://github.com/gboeing/osmnx -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gboeing/osmnx](https://github.com/gboeing/osmnx) |
| Source record ids | github_search_maps-9bbd110af8f91b |

## System Engineer Summary

Download, model, analyze, and visualize street networks and other geospatial features from
OpenStreetMap.

## Operational Role

For a systems engineer, gboeing/osmnx belongs in the Maps inventory as part of defect discovery,
...
- `github_search_maps-9bbd110af8f91b` from `github_search_maps` as `registry_expansion`
...
| jblindsay/whitebox-tools | Static Analyzer | [open](maps-jblindsay-whitebox-tools-802abb76.md) |
