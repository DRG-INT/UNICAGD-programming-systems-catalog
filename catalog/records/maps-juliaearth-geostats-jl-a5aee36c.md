...
<!-- canonical: https://github.com/JuliaEarth/GeoStats.jl -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JuliaEarth/GeoStats.jl](https://github.com/JuliaEarth/GeoStats.jl) |
| Source record ids | github_search_maps-1ce315b1f0abae |

## System Engineer Summary

An extensible framework for geospatial data science and geostatistical modeling fully written in
Julia

## Operational Role

For a systems engineer, JuliaEarth/GeoStats.jl belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-27T21:04:21Z | gh search repos topic:gis stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-1ce315b1f0abae` from `github_search_maps` as `registry_expansion`
