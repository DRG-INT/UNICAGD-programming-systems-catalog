...
<!-- canonical: https://github.com/atlasr-org/atlasr -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/atlasr-org/atlasr](https://github.com/atlasr-org/atlasr) |
| Source record ids | github_search_maps-023af4bdafb156 |
...
For a systems engineer, atlasr-org/atlasr belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-12-05T08:36:40Z | gh search repos topic:geocoding stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-023af4bdafb156` from `github_search_maps` as `registry_expansion`
