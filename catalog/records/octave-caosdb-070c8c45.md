...
<!-- canonical: https://gnu-octave.github.io/packages/caosdb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gnu-octave.github.io/packages/caosdb](https://gnu-octave.github.io/packages/caosdb) |
| Source record ids | octave_packages_index-54797f1c750338 |

## System Engineer Summary

This package contains utility functions to interact with CaosDB, the open scientific data management
toolkit. It makes use of libcaosdb, which must be installed on the system. libcaosdb can be obtained
at

## Operational Role

For a systems engineer, caosdb belongs in the Octave inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2023-02-17 | [https://gnu-octave.github.io/packages/](https://gnu-octave.github.io/packages/) |  |
...
- `octave_packages_index-54797f1c750338` from `octave_packages_index` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| coder | Build System | [open](octave-coder-34750291.md) |
