...
<!-- canonical: https://github.com/deislabs/wasi-experimental-http -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/deislabs/wasi-experimental-http](https://github.com/deislabs/wasi-experimental-http) |
| Source record ids | github_search_webassembly-6999cca3ca2ce2 |
...
For a systems engineer, deislabs/wasi-experimental-http belongs in the WebAssembly inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-03-14T17:13:55Z | gh search repos topic:wasi stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-6999cca3ca2ce2` from `github_search_webassembly` as `registry_expansion`
