...
<!-- canonical: https://github.com/long2ice/asyncmy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/long2ice/asyncmy](https://github.com/long2ice/asyncmy) |
| Source record ids | github_search_databases-1da966eacb7c3a |

## System Engineer Summary

The fastest asyncio MySQL/MariaDB driver — Cython-powered protocol core, aiomysql-compatible API,
built-in connection pool, and binlog replication support

## Operational Role

For a systems engineer, long2ice/asyncmy belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-16T04:11:12Z | gh search repos topic:database-driver stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-1da966eacb7c3a` from `github_search_databases` as `registry_expansion`
