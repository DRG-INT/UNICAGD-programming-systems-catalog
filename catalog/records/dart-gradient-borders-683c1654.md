...
<!-- canonical: https://pub.dev/packages/gradient_borders -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/gradient_borders](https://pub.dev/packages/gradient_borders) |
| Source record ids | pub_dev-c623a5a302ecbb |

## System Engineer Summary

Gradient borders for inputs and containers. Borders package integrated with a basic flutter widgets
as a container and input decorations. Easy in use, platform independent.

## Operational Role

For a systems engineer, gradient_borders belongs in the Dart inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.4 | 2026-05-28T10:11:39.846127Z | [https://pub.dev/api/packages/gradient_borders](https://pub.dev/api/packages/gradient_borders) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/gradient_borders` at `2026-09-01T15:35:56+00:00`.
...
- `pub_dev-c623a5a302ecbb` from `pub_dev` as `registry_expansion`
