...
<!-- canonical: https://cran.r-project.org/web/packages/corrgram/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/corrgram/index.html](https://cran.r-project.org/web/packages/corrgram/index.html) |
| Source record ids | cran_packages_by_date-b6862d565237a8 |

## System Engineer Summary

corrgram is tracked as a logging observability record in the R branch. The source did not provide a
...
For a systems engineer, corrgram belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.16 | 2026-09-02 19:40:02 UTC | [https://cran.r-project.org/web/packages/corrgram/DESCRIPTION](https://cran.r-project.org/web/packages/corrgram/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/corrgram/DESCRIPTION` at `2026-09-02T20:20:11+00:00`.
...
- `cran_packages_by_date-b6862d565237a8` from `cran_packages_by_date` as `registry_expansion`
