...
[Catalog index](../index.md) · [Language: Icons and Logos](../by-language/icons-and-logos.md) · [Category: Precommit Ci Quality](../by-category/precommit-ci-quality.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/victor-valencia/bootstrap-iconpicker -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/victor-valencia/bootstrap-iconpicker](https://github.com/victor-valencia/bootstrap-iconpicker) |
| Source record ids | github_search_icons_and_logos-eb046828d264a2 |

## System Engineer Summary

victor-valencia/bootstrap-iconpicker is tracked as a precommit ci quality record in the Icons and
Logos branch. The source did not provide a long description, so this page keeps the identity,
release state, provenance, and operational classification explicit for later enrichment.

## Operational Role

For a systems engineer, victor-valencia/bootstrap-iconpicker belongs in the Icons and Logos
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-12-07T05:11:42Z | gh search repos topic:icon-font stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-eb046828d264a2` from `github_search_icons_and_logos` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| box-icons/boxicons | Precommit Ci Quality | [open](icons-and-logos-box-icons-boxicons-255f0704.md) |
| file-icons/atom | Precommit Ci Quality | [open](icons-and-logos-file-icons-atom-db3f7eaf.md) |
| keremciu/sketch-iconfont | Precommit Ci Quality | [open](icons-and-logos-keremciu-sketch-iconfont-96a1e86b.md) |
| tabler/tabler-icons | Precommit Ci Quality | [open](icons-and-logos-tabler-tabler-icons-18e4dc06.md) |
