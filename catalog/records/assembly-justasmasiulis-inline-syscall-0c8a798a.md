...
<!-- canonical: https://github.com/JustasMasiulis/inline_syscall -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JustasMasiulis/inline_syscall](https://github.com/JustasMasiulis/inline_syscall) |
| Source record ids | github_search_assembly-6d011e690d010d |
...
For a systems engineer, JustasMasiulis/inline_syscall belongs in the Assembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-06-21T00:26:33Z | gh search repos topic:assembly stars:>300 | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-6d011e690d010d` from `github_search_assembly` as `registry_expansion`
