...
<!-- canonical: https://github.com/anasfik/SlowedLab -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/anasfik/SlowedLab](https://github.com/anasfik/SlowedLab) |
| Source record ids | github_search_effects-38874f54f8eeb0 |

## System Engineer Summary

An advanced real-time audio player supporting all effects (slow, reverb) that elevate your
music/audio playing to next level

## Operational Role

For a systems engineer, anasfik/SlowedLab belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-10T17:56:59Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-38874f54f8eeb0` from `github_search_effects` as `registry_expansion`
