...
[Catalog index](../index.md) · [Language: Game Engines](../by-language/game-engines.md) · [Category: Dependency Manager](../by-category/dependency-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/KilledByAPixel/LittleJS -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/KilledByAPixel/LittleJS](https://github.com/KilledByAPixel/LittleJS) |
| Source record ids | github_search_game_engines-c7eb8be5ec70f0 |
...
For a systems engineer, KilledByAPixel/LittleJS belongs in the Game Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T19:38:25Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-c7eb8be5ec70f0` from `github_search_game_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ocornut/imgui | Dependency Manager | [open](game-engines-ocornut-imgui-7b3f1ea5.md) |
