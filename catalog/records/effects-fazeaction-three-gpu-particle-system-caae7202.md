# fazeaction/three-gpu-particle-system
...
<!-- canonical: https://github.com/fazeaction/three-gpu-particle-system -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/fazeaction/three-gpu-particle-system](https://github.com/fazeaction/three-gpu-particle-system) |
| Source record ids | github_search_effects-50e381fd1b8371 |

## System Engineer Summary

GPU based particle system for three.js. Heavily based on tdl library

## Operational Role

For a systems engineer, fazeaction/three-gpu-particle-system belongs in the Effects inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-03-06T02:46:39Z | gh search repos particle system | gh_search_reports_activity_not_release_version |
...
| --- | --- |
| Detected family | MIT |
| Evidence | MIT No Attribution; https://api.github.com/licenses/mit-0; {"key": "", "name": "", "url": ""} |
...
- `github_search_effects-50e381fd1b8371` from `github_search_effects` as `registry_expansion`
