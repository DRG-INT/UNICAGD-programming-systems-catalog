...
<!-- canonical: https://crates.io/crates/wayland-client -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/wayland-client](https://crates.io/crates/wayland-client) |
| Source record ids | crates_io-38ffe771437cbe |
...
For a systems engineer, wayland-client belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.31.15 | 2026-07-22T20:35:54.669482Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- `crates_io-38ffe771437cbe` from `crates_io` as `registry_expansion`
