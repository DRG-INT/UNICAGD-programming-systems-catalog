...
| Source record ids | github_search_swift-7237ef4023fe22 |
...
For a systems engineer, ipader/SwiftGuide belongs in the Swift inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.0 | 2026-03-12T11:57:05Z | [https://api.github.com/repos/ipader/SwiftGuide/releases/latest](https://api.github.com/repos/ipader/SwiftGuide/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/ipader/SwiftGuide/releases/latest` at `2026-09-01T10:26:04+00:00`.
...
- `github_search_swift-7237ef4023fe22` from `github_search_swift` as `registry_expansion`
