# iuliagalatan/Star-Catalogue-App
...
<!-- canonical: https://github.com/iuliagalatan/Star-Catalogue-App -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/iuliagalatan/Star-Catalogue-App](https://github.com/iuliagalatan/Star-Catalogue-App) |
| Source record ids | github_search_space_maps-1c7670c3d55426 |

## System Engineer Summary

C++ combined with Qt in order to create an application which simulates a "star-catalogue". This was
my final exam for the OOP course. Time:3 hours, Graded:10

## Operational Role

For a systems engineer, iuliagalatan/Star-Catalogue-App belongs in the Space Maps inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-07-30T13:18:47Z | gh search repos star catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-1c7670c3d55426` from `github_search_space_maps` as `registry_expansion`
