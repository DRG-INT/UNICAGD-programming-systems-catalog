...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Rust](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/rust.md) · [Category: Codegen Codemod Refactoring](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/codegen-codemod-refactoring.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://crates.io/crates/phf_codegen](https://crates.io/crates/phf_codegen) |
| Source record ids | crates_io-4c4bd681a14e31 |
...
For a systems engineer, phf_codegen belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.14.0 | 2026-06-21T00:38:01.280165Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
| Name | Category | Page |
| --- | --- | --- |
| aws-smithy-types | Codegen Codemod Refactoring | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-aws-smithy-types-0b48826d.md) |
| cranelift-codegen | Codegen Codemod Refactoring | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-cranelift-codegen-302a3878.md) |
| cranelift-codegen-meta | Codegen Codemod Refactoring | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-cranelift-codegen-meta-d42c17e1.md) |
| cranelift-codegen-shared | Codegen Codemod Refactoring | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-cranelift-codegen-shared-08f5a977.md) |
| napi-derive-backend | Codegen Codemod Refactoring | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-napi-derive-backend-b5113b72.md) |
| string_cache_codegen | Codegen Codemod Refactoring | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-string-cache-codegen-53d8cbc0.md) |
