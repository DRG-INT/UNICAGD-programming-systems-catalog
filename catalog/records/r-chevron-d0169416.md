...
<!-- canonical: https://cran.r-project.org/web/packages/chevron/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/chevron/index.html](https://cran.r-project.org/web/packages/chevron/index.html) |
| Source record ids | cran_packages_by_date-de8e8115f65395 |
...
For a systems engineer, chevron belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.14 | 2026-09-16 06:10:02 UTC | [https://cran.r-project.org/web/packages/chevron/DESCRIPTION](https://cran.r-project.org/web/packages/chevron/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/chevron/DESCRIPTION` at `2026-09-16T06:26:24+00:00`.
...
- `cran_packages_by_date-de8e8115f65395` from `cran_packages_by_date` as `registry_expansion`
