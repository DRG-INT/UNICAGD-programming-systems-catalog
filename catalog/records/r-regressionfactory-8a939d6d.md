...
<!-- canonical: https://cran.r-project.org/web/packages/RegressionFactory/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/RegressionFactory/index.html](https://cran.r-project.org/web/packages/RegressionFactory/index.html) |
| Source record ids | cran_packages_by_date-11c9f63341c86c |

## System Engineer Summary

Expander Functions for Generating Full Gradient and Hessian from Single-Slot and Multi-Slot Base
Distributions

## Operational Role

For a systems engineer, RegressionFactory belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.5 | 2026-09-02 12:30:08 UTC | [https://cran.r-project.org/web/packages/RegressionFactory/DESCRIPTION](https://cran.r-project.org/web/packages/RegressionFactory/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/RegressionFactory/DESCRIPTION` at `2026-09-02T14:20:11+00:00`.
...
- `cran_packages_by_date-11c9f63341c86c` from `cran_packages_by_date` as `registry_expansion`
