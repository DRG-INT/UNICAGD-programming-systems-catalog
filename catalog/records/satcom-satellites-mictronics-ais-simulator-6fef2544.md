...
<!-- canonical: https://github.com/Mictronics/ais-simulator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Mictronics/ais-simulator](https://github.com/Mictronics/ais-simulator) |
| Source record ids | github_search_satcom_satellites-5c828455ada2a7 |

## System Engineer Summary

Create and transmit AIS frames via gnuradio toolchain and web application in browser. Provides a
websocket to PDU message block to change frame content on runtime. Works in burst mode, a frame is
send on change immediately, one time. Transmitter remains silent until next change event.

## Operational Role

For a systems engineer, Mictronics/ais-simulator belongs in the SatCom Satellites inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-06T07:43:56Z | gh search repos topic:gnuradio stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-5c828455ada2a7` from `github_search_satcom_satellites` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| bastibl/gr-sched | Interpreter Runtime | [open](satcom-satellites-bastibl-gr-sched-f9a9e30b.md) |
