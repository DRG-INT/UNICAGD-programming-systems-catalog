...
<!-- canonical: https://packagist.org/packages/tcdent/php-restclient -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/tcdent/php-restclient](https://packagist.org/packages/tcdent/php-restclient) |
| Source record ids | packagist_search-cbe25cc1afaf1d |
...
For a systems engineer, tcdent/php-restclient belongs in the PHP inventory as part of wire formats,
...
- `packagist_search-cbe25cc1afaf1d` from `packagist_search` as `registry_expansion`
