...
[Catalog index](../index.md) · [Language: C-Sharp](../by-language/c-sharp.md) · [Category: Ffi Bindings](../by-category/ffi-bindings.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://www.nuget.org/packages/Microsoft.Azure.WebJobs.Extensions.Http -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Microsoft.Azure.WebJobs.Extensions.Http](https://www.nuget.org/packages/Microsoft.Azure.WebJobs.Extensions.Http) |
| Source record ids | nuget_search-c9aff55e1cfc4d |
...
For a systems engineer, Microsoft.Azure.WebJobs.Extensions.Http belongs in the C-Sharp inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.3.0 | 2025-12-10T05:49:24.32+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/microsoft.azure.webjobs.extensions.http/index.json](https://api.nuget.org/v3/registration5-gz-semver2/microsoft.azure.webjobs.extensions.http/index.json) |  |
| preview | known | 3.0.0-rc1 | 2018-09-14T00:05:20.397+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/microsoft.azure.webjobs.extensions.http/index.json](https://api.nuget.org/v3/registration5-gz-semver2/microsoft.azure.webjobs.extensions.http/index.json) |  |
...
| Evidence | GPL (>= 2); MIT License; https://api.github.com/licenses/mit; MIT; https://www.nuget.org/packages/Microsoft.Azure.WebJobs.Extensions.Http/3.3.0/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/microsoft.azure.webjobs.extensions.http/index.json` at `2026-09-01T07:23:58+00:00`.
...
- `nuget_search-c9aff55e1cfc4d` from `nuget_search` as `registry_expansion`
