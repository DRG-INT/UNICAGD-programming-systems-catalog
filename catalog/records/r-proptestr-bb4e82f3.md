...
<!-- canonical: https://cran.r-project.org/web/packages/PropTestR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/PropTestR/index.html](https://cran.r-project.org/web/packages/PropTestR/index.html) |
| Source record ids | cran_packages_by_date-94dcd3cdec20a1 |

## System Engineer Summary

Comprehensive Two-Proportion Inference

## Operational Role

For a systems engineer, PropTestR belongs in the R inventory as part of unit/integration validation,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-08-31 12:30:08 UTC | [https://cran.r-project.org/web/packages/PropTestR/DESCRIPTION](https://cran.r-project.org/web/packages/PropTestR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/PropTestR/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-94dcd3cdec20a1` from `cran_packages_by_date` as `registry_expansion`
