...
<!-- canonical: https://luarocks.org/modules/willkurt/csv2tensor -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/willkurt/csv2tensor](https://luarocks.org/modules/willkurt/csv2tensor) |
| Source record ids | luarocks_root_manifest-d1a76c93a40605 |
...
For a systems engineer, csv2tensor belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-d1a76c93a40605` from `luarocks_root_manifest` as `registry_expansion`
