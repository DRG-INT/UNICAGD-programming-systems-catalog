...
| Canonical URL | [https://crates.io/crates/wry](https://crates.io/crates/wry) |
| Source record ids | crates_io-daa5f8af36d903 |
...
For a systems engineer, wry belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.56.1 | 2026-08-13T11:07:20.418171Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-daa5f8af36d903` from `crates_io` as `registry_expansion`
