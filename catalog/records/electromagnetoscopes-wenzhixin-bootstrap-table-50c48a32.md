...
<!-- canonical: https://github.com/wenzhixin/bootstrap-table -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/wenzhixin/bootstrap-table](https://github.com/wenzhixin/bootstrap-table) |
| Source record ids | github_search_electromagnetoscopes-94b41e13f9a224 |

## System Engineer Summary

An extended table for integration with some of the most widely used CSS frameworks. (Supports
Bootstrap, Semantic UI, Bulma, Material Design, Foundation, Vue.js)

## Operational Role

For a systems engineer, wenzhixin/bootstrap-table belongs in the Electromagnetoscopes inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.27.3 | 2026-04-23T23:57:13Z | [https://api.github.com/repos/wenzhixin/bootstrap-table/releases/latest](https://api.github.com/repos/wenzhixin/bootstrap-table/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/wenzhixin/bootstrap-table/releases/latest` at `2026-09-01T08:26:43+00:00`.
...
- `github_search_electromagnetoscopes-94b41e13f9a224` from `github_search_electromagnetoscopes` as `registry_expansion`
