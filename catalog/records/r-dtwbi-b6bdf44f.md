...
<!-- canonical: https://cran.r-project.org/web/packages/DTWBI/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/DTWBI/index.html](https://cran.r-project.org/web/packages/DTWBI/index.html) |
| Source record ids | cran_packages_by_date-e10f4f5f663093 |
...
For a systems engineer, DTWBI belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2 | 2026-09-09 08:50:09 UTC | [https://cran.r-project.org/web/packages/DTWBI/DESCRIPTION](https://cran.r-project.org/web/packages/DTWBI/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/DTWBI/DESCRIPTION` at `2026-09-09T10:21:05+00:00`.
...
- `cran_packages_by_date-e10f4f5f663093` from `cran_packages_by_date` as `registry_expansion`
