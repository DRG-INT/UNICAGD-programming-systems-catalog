...
<!-- canonical: https://github.com/devkcud/VesperaFX -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/devkcud/VesperaFX](https://github.com/devkcud/VesperaFX) |
| Source record ids | github_search_effects-27f02e2b628192 |

## System Engineer Summary

Stylized post-processing shaders for Godot 4. Modular FX for retro visuals, pixelation, dithering,
and palette mapping.

## Operational Role

For a systems engineer, devkcud/VesperaFX belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-20T13:45:49Z | gh search repos post processing shader | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-27f02e2b628192` from `github_search_effects` as `registry_expansion`
