...
<!-- canonical: https://www.npmjs.com/package/@astrojs/language-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@astrojs/language-server](https://www.npmjs.com/package/@astrojs/language-server) |
| Source record ids | npm_registry-a0762929d96105 |

## System Engineer Summary

The Astro language server, implement the

## Operational Role

For a systems engineer, @astrojs/language-server belongs in the Node.js/JavaScript inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.16.16 | 2026-08-31T19:37:41.058Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-a0762929d96105` from `npm_registry` as `registry_expansion`
