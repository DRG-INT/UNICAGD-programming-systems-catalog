...
| Source record ids | github_search_satcom_satellites-1a8179dc186784 |
...
For a systems engineer, emidan19/deep-tempest belongs in the SatCom Satellites inventory as part of
...
| --- | --- |
| Detected family | MIT |
| Evidence | MIT; BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause; Other |
...
- `github_search_satcom_satellites-1a8179dc186784` from `github_search_satcom_satellites` as `registry_expansion`
