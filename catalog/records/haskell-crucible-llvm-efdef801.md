...
<!-- canonical: https://hackage.haskell.org/package/crucible-llvm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/crucible-llvm](https://hackage.haskell.org/package/crucible-llvm) |
| Source record ids | hackage_recent-156ad8609c0454 |
...
For a systems engineer, crucible-llvm belongs in the Haskell inventory as part of compiler
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10 | 2026-09-11T16:16:41Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-156ad8609c0454` from `hackage_recent` as `registry_expansion`
