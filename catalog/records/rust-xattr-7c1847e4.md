...
<!-- canonical: https://crates.io/crates/xattr -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/xattr](https://crates.io/crates/xattr) |
| Source record ids | crates_io-07d7678f397d62 |
...
For a systems engineer, xattr belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.6.1 | 2025-09-21T02:52:23.909474Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
- `crates_io-07d7678f397d62` from `crates_io` as `registry_expansion`
