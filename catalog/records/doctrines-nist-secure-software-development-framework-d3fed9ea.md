...
<!-- canonical: https://csrc.nist.gov/Projects/ssdf -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://csrc.nist.gov/Projects/ssdf](https://csrc.nist.gov/Projects/ssdf) |
| Source record ids | curated_language_routes-e2308073a8a006 |

## System Engineer Summary

Secure software development doctrine for organizational controls, practices, supply-chain
expectations, and software assurance.

## Operational Role

For a systems engineer, NIST Secure Software Development Framework belongs in the Doctrines
...
- `curated_language_routes-e2308073a8a006` from `curated_language_routes` as `registry_expansion`
