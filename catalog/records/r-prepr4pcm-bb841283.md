...
<!-- canonical: https://cran.r-project.org/web/packages/prepR4pcm/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/prepR4pcm/index.html](https://cran.r-project.org/web/packages/prepR4pcm/index.html) |
| Source record ids | cran_packages_by_date-c352ff5918507d |
...
For a systems engineer, prepR4pcm belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.2 | 2026-08-25 13:10:02 UTC | [https://cran.r-project.org/web/packages/prepR4pcm/DESCRIPTION](https://cran.r-project.org/web/packages/prepR4pcm/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/prepR4pcm/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-c352ff5918507d` from `cran_packages_by_date` as `registry_expansion`
