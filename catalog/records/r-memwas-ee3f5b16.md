...
<!-- canonical: https://cran.r-project.org/web/packages/MEMWAS/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/MEMWAS/index.html](https://cran.r-project.org/web/packages/MEMWAS/index.html) |
| Source record ids | cran_packages_by_date-aedf27b5a9e496 |
...
For a systems engineer, MEMWAS belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.5 | 2026-08-22 15:40:02 UTC | [https://cran.r-project.org/web/packages/MEMWAS/DESCRIPTION](https://cran.r-project.org/web/packages/MEMWAS/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/MEMWAS/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-aedf27b5a9e496` from `cran_packages_by_date` as `registry_expansion`
