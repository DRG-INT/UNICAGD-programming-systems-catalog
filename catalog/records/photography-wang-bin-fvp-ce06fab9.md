...
<!-- canonical: https://github.com/wang-bin/fvp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/wang-bin/fvp](https://github.com/wang-bin/fvp) |
| Source record ids | github_search_photography-b154b5c9c16cd7 |

## System Engineer Summary

Flutter video player plugin for all desktop+mobile platforms. download prebuilt examples from github
actions.

## Operational Role

For a systems engineer, wang-bin/fvp belongs in the Photography inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-27T02:44:40Z | gh search repos topic:hdr stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-b154b5c9c16cd7` from `github_search_photography` as `registry_expansion`
