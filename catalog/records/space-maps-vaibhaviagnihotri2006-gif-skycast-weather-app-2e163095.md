# vaibhaviagnihotri2006-gif/SkyCast-Weather-App
...
<!-- canonical: https://github.com/vaibhaviagnihotri2006-gif/SkyCast-Weather-App -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/vaibhaviagnihotri2006-gif/SkyCast-Weather-App](https://github.com/vaibhaviagnihotri2006-gif/SkyCast-Weather-App) |
| Source record ids | github_search_space_maps-d00cc3ffc010ac |

## System Engineer Summary

Modern full-stack weather application built with HTML, CSS, JavaScript, Node.js & Express featuring
real-time forecasts, AQI, maps, astronomy, and responsive UI.

## Operational Role

For a systems engineer, vaibhaviagnihotri2006-gif/SkyCast-Weather-App belongs in the Space Maps
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-06T16:08:24Z | gh search repos astronomy sky map | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-d00cc3ffc010ac` from `github_search_space_maps` as `registry_expansion`
