...
<!-- canonical: https://github.com/diqezit/SpectrumCpp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/diqezit/SpectrumCpp](https://github.com/diqezit/SpectrumCpp) |
| Source record ids | github_search_electromagnetoscopes-2c16b6a567f395 |

## System Engineer Summary

lightweight real-time audio spectrum visualizer for Windows with a seamless overlay mode. Now on C++

## Operational Role

For a systems engineer, diqezit/SpectrumCpp belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-10T16:33:15Z | gh search repos topic:spectrum-analyzer stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-2c16b6a567f395` from `github_search_electromagnetoscopes` as `registry_expansion`
