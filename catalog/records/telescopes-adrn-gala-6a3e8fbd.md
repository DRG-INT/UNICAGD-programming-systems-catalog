...
| Source record ids | github_search_telescopes-8a361b13cd52b9 |
...
For a systems engineer, adrn/gala belongs in the Telescopes inventory as part of language tooling,
...
- `github_search_telescopes-8a361b13cd52b9` from `github_search_telescopes` as `registry_expansion`
