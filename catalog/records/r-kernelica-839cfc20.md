...
<!-- canonical: https://cran.r-project.org/web/packages/KernelICA/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/KernelICA/index.html](https://cran.r-project.org/web/packages/KernelICA/index.html) |
| Source record ids | cran_packages_by_date-392cae6a1fb900 |
...
For a systems engineer, KernelICA belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2026-08-04 08:50:12 UTC | [https://cran.r-project.org/web/packages/KernelICA/DESCRIPTION](https://cran.r-project.org/web/packages/KernelICA/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/KernelICA/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-392cae6a1fb900` from `cran_packages_by_date` as `registry_expansion`
