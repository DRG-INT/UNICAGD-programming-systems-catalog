...
| Canonical URL | [https://crates.io/crates/quote-use](https://crates.io/crates/quote-use) |
| Source record ids | crates_io-d7cac82d10fa6d |
...
For a systems engineer, quote-use belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.4 | 2024-08-25T12:48:21.606477Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-d7cac82d10fa6d` from `crates_io` as `registry_expansion`
