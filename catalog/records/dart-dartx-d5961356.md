...
<!-- canonical: https://pub.dev/packages/dartx -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/dartx](https://pub.dev/packages/dartx) |
| Source record ids | pub_dev-d7a5512a5c2d23 |
...
For a systems engineer, dartx belongs in the Dart inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0 | 2023-07-18T12:22:08.941213Z | [https://pub.dev/api/packages/dartx](https://pub.dev/api/packages/dartx) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/dartx` at `2026-09-01T07:20:10+00:00`.
...
- `pub_dev-d7a5512a5c2d23` from `pub_dev` as `registry_expansion`
