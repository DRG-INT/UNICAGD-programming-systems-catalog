...
<!-- canonical: https://luarocks.org/modules/types/computer-craft-tl-type -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/types/computer-craft-tl-type](https://luarocks.org/modules/types/computer-craft-tl-type) |
| Source record ids | luarocks_root_manifest-038667f5026dc0 |

## System Engineer Summary

Teal type definition files for computer-craft

## Operational Role

For a systems engineer, computer-craft-tl-type belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-038667f5026dc0` from `luarocks_root_manifest` as `registry_expansion`
