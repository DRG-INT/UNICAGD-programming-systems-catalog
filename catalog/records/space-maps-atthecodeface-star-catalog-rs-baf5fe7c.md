...
<!-- canonical: https://github.com/atthecodeface/star-catalog-rs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/atthecodeface/star-catalog-rs](https://github.com/atthecodeface/star-catalog-rs) |
| Source record ids | github_search_space_maps-bc3dc95c76ffd0 |

## System Engineer Summary

Star catalog Rust library including Hipparcos location/brightness data and IAU names

## Operational Role

For a systems engineer, atthecodeface/star-catalog-rs belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-18T09:35:57Z | gh search repos star catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-bc3dc95c76ffd0` from `github_search_space_maps` as `registry_expansion`
...
| Azure-Samples/data-catalog-dotnet-service-principal-get-started | Logging Observability | [open](space-maps-azure-samples-data-catalog-dotnet-service-principal-get-started-85f4f283.md) |
