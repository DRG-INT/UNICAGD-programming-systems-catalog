...
<!-- canonical: https://github.com/synctv-org/synctv -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/synctv-org/synctv](https://github.com/synctv-org/synctv) |
| Source record ids | github_search_video-549517d694d2e0 |
...
For a systems engineer, synctv-org/synctv belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T04:02:17Z | gh search repos topic:webrtc stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-549517d694d2e0` from `github_search_video` as `registry_expansion`
