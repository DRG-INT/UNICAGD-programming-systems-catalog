...
| Canonical URL | [https://luarocks.org/modules/spill/immutable-table](https://luarocks.org/modules/spill/immutable-table) |
| Source record ids | luarocks_root_manifest-f36352f9acae96 |
...
For a systems engineer, immutable-table belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-f36352f9acae96` from `luarocks_root_manifest` as `registry_expansion`
