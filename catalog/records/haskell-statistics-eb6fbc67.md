...
<!-- canonical: https://hackage.haskell.org/package/statistics -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/statistics](https://hackage.haskell.org/package/statistics) |
| Source record ids | hackage_top_downloads-d264ea6c514a97 |
...
For a systems engineer, statistics belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.16.5.0 | 2026-01-09T12:35:21Z | [https://hackage.haskell.org/package/statistics](https://hackage.haskell.org/package/statistics) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/statistics` at `2026-09-01T14:24:31+00:00`.
...
- `hackage_top_downloads-d264ea6c514a97` from `hackage_top_downloads` as `registry_expansion`
