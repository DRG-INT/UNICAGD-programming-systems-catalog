...
<!-- canonical: https://cran.r-project.org/web/packages/proustr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/proustr/index.html](https://cran.r-project.org/web/packages/proustr/index.html) |
| Source record ids | cran_packages_by_date-cae251d7f99321 |
...
For a systems engineer, proustr belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.1 | 2026-09-03 15:00:02 UTC | [https://cran.r-project.org/web/packages/proustr/DESCRIPTION](https://cran.r-project.org/web/packages/proustr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/proustr/DESCRIPTION` at `2026-09-03T15:23:21+00:00`.
...
- `cran_packages_by_date-cae251d7f99321` from `cran_packages_by_date` as `registry_expansion`
