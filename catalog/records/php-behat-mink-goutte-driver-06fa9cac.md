...
<!-- canonical: https://packagist.org/packages/behat/mink-goutte-driver -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/behat/mink-goutte-driver](https://packagist.org/packages/behat/mink-goutte-driver) |
| Source record ids | packagist_search-f1257ca082163d |
...
For a systems engineer, behat/mink-goutte-driver belongs in the PHP inventory as part of
...
- `packagist_search-f1257ca082163d` from `packagist_search` as `registry_expansion`
