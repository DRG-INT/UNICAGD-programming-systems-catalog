...
<!-- canonical: https://pypi.org/project/abyss-security/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/abyss-security/](https://pypi.org/project/abyss-security/) |
| Source record ids | pypi_simple-ca9051c4949cad |

## System Engineer Summary

ABYSS -- Hybrid ML Malware Detection & Incident Response CLI

## Operational Role

For a systems engineer, abyss-security belongs in the Python inventory as part of supply-chain
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-07-25T07:38:42.167297Z | [https://pypi.org/pypi/abyss-security/json](https://pypi.org/pypi/abyss-security/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/abyss-security/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-ca9051c4949cad` from `pypi_simple` as `registry_expansion`
