...
<!-- canonical: https://github.com/yenom/BitcoinKit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/yenom/BitcoinKit](https://github.com/yenom/BitcoinKit) |
| Source record ids | awesome_list-bc31a8bd909838 |

## System Engineer Summary

Bitcoin protocol toolkit for Swift, BitcoinKit implements Bitcoin protocol in Swift. It is an
implementation of the Bitcoin SPV protocol written in swift.

## Operational Role

For a systems engineer, BitcoinKit belongs in the Cocoa inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.1.0 | 2019-09-29T11:56:36Z | [https://api.github.com/repos/yenom/BitcoinKit/releases/latest](https://api.github.com/repos/yenom/BitcoinKit/releases/latest) |  |
| preview | known | v1.1.0-beta3 | 2018-09-27T01:01:07Z | [https://api.github.com/repos/yenom/BitcoinKit/releases?per_page=10](https://api.github.com/repos/yenom/BitcoinKit/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/yenom/BitcoinKit/releases/latest` at `2026-09-01T07:24:05+00:00`.
...
- `awesome_list-bc31a8bd909838` from `awesome_list` as `registry_expansion`
