...
<!-- canonical: https://hackage.haskell.org/package/json-stream -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/json-stream](https://hackage.haskell.org/package/json-stream) |
| Source record ids | hackage_top_downloads-b047cb05c413db |
...
For a systems engineer, json-stream belongs in the Haskell inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.6.1 | 2026-05-31T21:26:07Z | [https://hackage.haskell.org/package/json-stream](https://hackage.haskell.org/package/json-stream) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/json-stream` at `2026-09-01T14:24:22+00:00`.
...
- `hackage_top_downloads-b047cb05c413db` from `hackage_top_downloads` as `registry_expansion`
