...
<!-- canonical: https://hackage.haskell.org/package/uniplate -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/uniplate](https://hackage.haskell.org/package/uniplate) |
| Source record ids | hackage_top_downloads-9957e2a1cd8a43 |
...
For a systems engineer, uniplate belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.6.13 | 2020-11-07T19:53:43Z | [https://hackage.haskell.org/package/uniplate](https://hackage.haskell.org/package/uniplate) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/uniplate` at `2026-09-01T14:24:36+00:00`.
...
- `hackage_top_downloads-9957e2a1cd8a43` from `hackage_top_downloads` as `registry_expansion`
