...
| Canonical URL | [https://github.com/openhwgroup/cva6](https://github.com/openhwgroup/cva6) |
| Source record ids | github_search_assembly-764ced6f555880 |

## System Engineer Summary

The CORE-V CVA6 is a highly configurable, 6-stage RISC-V core for both application and embedded
applications. Application class configurations are capable of booting Linux.

## Operational Role

For a systems engineer, openhwgroup/cva6 belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v5.3.0 | 2025-02-03T14:45:13Z | [https://api.github.com/repos/openhwgroup/cva6/releases/latest](https://api.github.com/repos/openhwgroup/cva6/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/openhwgroup/cva6/releases/latest` at `2026-09-01T07:24:29+00:00`.
...
- `github_search_assembly-764ced6f555880` from `github_search_assembly` as `registry_expansion`
