...
<!-- canonical: https://crates.io/crates/async-compression -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/async-compression](https://crates.io/crates/async-compression) |
| Source record ids | crates_io-f5727fce8b82c8 |
...
For a systems engineer, async-compression belongs in the Rust inventory as part of concurrency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.44 | 2026-09-02T16:05:28.674815Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
| Evidence | Apache-2.0; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0 |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads` at `2026-09-02T17:18:31+00:00`.
...
- `crates_io-f5727fce8b82c8` from `crates_io` as `registry_expansion`
