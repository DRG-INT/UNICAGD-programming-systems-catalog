...
<!-- canonical: https://github.com/anilbas/3DMMasSTN -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/anilbas/3DMMasSTN](https://github.com/anilbas/3DMMasSTN) |
| Source record ids | github_search_matlab-7edf3aa5954de2 |

## System Engineer Summary

MatConvNet implementation for incorporating a 3D Morphable Model (3DMM) into a Spatial Transformer
Network (STN)

## Operational Role

For a systems engineer, anilbas/3DMMasSTN belongs in the Matlab inventory as part of ecosystem
...
- `github_search_matlab-7edf3aa5954de2` from `github_search_matlab` as `registry_expansion`
