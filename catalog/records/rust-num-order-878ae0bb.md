...
<!-- canonical: https://crates.io/crates/num-order -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/num-order](https://crates.io/crates/num-order) |
| Source record ids | crates_io-1f73ef6e7bccb9 |

## System Engineer Summary

Numerically consistent `Eq`, `Ord` and `Hash` implementations for various `num` types (`u32`, `f64`,
`num_bigint::BigInt`, etc.)

## Operational Role

For a systems engineer, num-order belongs in the Rust inventory as part of confidentiality,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0 | 2023-08-31T02:53:04.243144Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
| --- | --- |
| Detected family | MIT |
| Evidence | MIT + file LICENSE; Other; {"key": "", "name": "", "url": ""}; MIT License; https://api.github.com/licenses/mit |
