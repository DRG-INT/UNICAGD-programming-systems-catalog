...
<!-- canonical: https://crates.io/crates/redis -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/redis](https://crates.io/crates/redis) |
| Source record ids | crates_io-011ce56c118cc5 |

## System Engineer Summary

redis is tracked as a database datastore record in the Rust branch. The source did not provide a
...
For a systems engineer, redis belongs in the Rust inventory as part of state persistence,
...
- `crates_io-011ce56c118cc5` from `crates_io` as `registry_expansion`
