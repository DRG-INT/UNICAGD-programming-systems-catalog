...
<!-- canonical: https://cran.r-project.org/web/packages/extRC/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/extRC/index.html](https://cran.r-project.org/web/packages/extRC/index.html) |
| Source record ids | cran_packages_by_date-1c0c7826405d0f |
...
For a systems engineer, extRC belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3 | 2026-09-14 09:30:08 UTC | [https://cran.r-project.org/web/packages/extRC/DESCRIPTION](https://cran.r-project.org/web/packages/extRC/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/extRC/DESCRIPTION` at `2026-09-14T10:20:50+00:00`.
...
- `cran_packages_by_date-1c0c7826405d0f` from `cran_packages_by_date` as `registry_expansion`
