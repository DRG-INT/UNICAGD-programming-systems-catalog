...
<!-- canonical: https://github.com/gpelouze/spice_stew -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gpelouze/spice_stew](https://github.com/gpelouze/spice_stew) |
| Source record ids | github_search_space_maps-d0555e619bee09 |

## System Engineer Summary

Correct the pointing of SolarOrbiter/SPICE for each slit position using pointing information from
the SPICE toolkit kernels

## Operational Role

For a systems engineer, gpelouze/spice_stew belongs in the Space Maps inventory as part of low-noise
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-12-01T16:34:24Z | gh search repos SPICE kernels | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-d0555e619bee09` from `github_search_space_maps` as `registry_expansion`
