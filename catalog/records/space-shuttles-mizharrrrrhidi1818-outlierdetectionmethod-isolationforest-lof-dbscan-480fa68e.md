# Mizharrrrrhidi1818/OutlierDetectionMethod-IsolationForest-LOF-DBSCAN
...
<!-- canonical: https://github.com/Mizharrrrrhidi1818/OutlierDetectionMethod-IsolationForest-LOF-DBSCAN -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Mizharrrrrhidi1818/OutlierDetectionMethod-IsolationForest-LOF-DBSCAN](https://github.com/Mizharrrrrhidi1818/OutlierDetectionMethod-IsolationForest-LOF-DBSCAN) |
| Source record ids | github_search_space_shuttles-bfc902d8739bfc |

## System Engineer Summary

This project implements and compares three different unsupervised outlier detection algorithms on
the Space Shuttle Telemetry dataset. The goal is to identify fault conditions (anomalies) in the
shuttle's attitude control system sensor readings.

## Operational Role

For a systems engineer, Mizharrrrrhidi1818/OutlierDetectionMethod-IsolationForest-LOF-DBSCAN belongs
in the Space Shuttles inventory as part of defect discovery, security review, undefined-state
detection, and regression prevention.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-13T20:08:31Z | gh search repos space shuttle telemetry | gh_search_reports_activity_not_release_version |
...
| Evidence | {"key": "", "name": "", "url": ""}; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; Other; MIT License; https://api.github.com/licenses/mit |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-10 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "space shuttle telemetry", "retrieved": "2026-09-10", "status": "forge-cli-derived"}` |
...
- `github_search_space_shuttles-bfc902d8739bfc` from `github_search_space_shuttles` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| DavidR-21/Space-Shuttle-Reentry-Analysis | Static Analyzer | [open](space-shuttles-davidr-21-space-shuttle-reentry-analysis-885e7731.md) |
