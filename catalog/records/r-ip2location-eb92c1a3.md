...
<!-- canonical: https://cran.r-project.org/web/packages/ip2location/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ip2location/index.html](https://cran.r-project.org/web/packages/ip2location/index.html) |
| Source record ids | cran_packages_by_date-51aa4fa41f3fbb |
...
For a systems engineer, ip2location belongs in the R inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 8.1.4 | 2026-08-05 08:50:02 UTC | [https://cran.r-project.org/web/packages/ip2location/DESCRIPTION](https://cran.r-project.org/web/packages/ip2location/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ip2location/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-51aa4fa41f3fbb` from `cran_packages_by_date` as `registry_expansion`
