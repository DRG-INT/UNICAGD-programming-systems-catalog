...
<!-- canonical: https://packagist.org/packages/neomerx/json-api -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/neomerx/json-api](https://packagist.org/packages/neomerx/json-api) |
| Source record ids | packagist_search-d405487e4d4c1e |
...
For a systems engineer, neomerx/json-api belongs in the PHP inventory as part of wire formats,
...
- `packagist_search-d405487e4d4c1e` from `packagist_search` as `registry_expansion`
