...
<!-- canonical: https://github.com/matlab-deep-learning/llms-with-matlab -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/matlab-deep-learning/llms-with-matlab](https://github.com/matlab-deep-learning/llms-with-matlab) |
| Source record ids | github_search_matlab-63561ed6b1adb3 |
...
For a systems engineer, matlab-deep-learning/llms-with-matlab belongs in the Matlab inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-15T10:30:40Z | gh search repos language:MATLAB topic:matlab | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-63561ed6b1adb3` from `github_search_matlab` as `registry_expansion`
