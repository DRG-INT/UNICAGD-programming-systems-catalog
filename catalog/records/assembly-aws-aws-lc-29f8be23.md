...
| Canonical URL | [https://github.com/aws/aws-lc](https://github.com/aws/aws-lc) |
| Source record ids | github_search_assembly-900afc820cc332 |
...
For a systems engineer, aws/aws-lc belongs in the Assembly inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v5.7.0 | 2026-08-31T19:25:53Z | [https://api.github.com/repos/aws/aws-lc/releases/latest](https://api.github.com/repos/aws/aws-lc/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/aws/aws-lc/releases/latest` at `2026-09-01T10:25:48+00:00`.
...
- `github_search_assembly-900afc820cc332` from `github_search_assembly` as `registry_expansion`
