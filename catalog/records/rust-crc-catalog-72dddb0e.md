...
<!-- canonical: https://crates.io/crates/crc-catalog -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/crc-catalog](https://crates.io/crates/crc-catalog) |
| Source record ids | crates_io-cd1f5d42f21780 |

## System Engineer Summary

Catalog of CRC algorithms expressed as simple Rust structs.

## Operational Role

For a systems engineer, crc-catalog belongs in the Rust inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.5.0 | 2026-04-24T18:44:55.973498Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
- `crates_io-cd1f5d42f21780` from `crates_io` as `registry_expansion`
