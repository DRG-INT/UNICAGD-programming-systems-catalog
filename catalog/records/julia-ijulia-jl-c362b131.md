...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Julia](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/julia.md) · [Category: Ide Editor Integration](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/ide-editor-integration.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source type | ide_editor_integration |
| Verification | catalog_seed |
| Canonical URL | unknown |
| Source record ids | master-5b25aa49d61f |
...
For a systems engineer, IJulia.jl belongs in the Julia inventory as part of ecosystem capability
...
- `master-5b25aa49d61f` from `master_json` as `ide_editor_integration`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| AbidesMarkets | Ide Editor Integration | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-abidesmarkets-f5308285.md) |
| AcademicIdentifiers | Ide Editor Integration | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-academicidentifiers-8009b102.md) |
| ApproximateVanishingIdeals | Ide Editor Integration | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-approximatevanishingideals-b1dcb4ee.md) |
| ArtifactOverrides | Ide Editor Integration | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-artifactoverrides-3887e012.md) |
| AutomationLabsIdentification | Ide Editor Integration | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-automationlabsidentification-c756b8f2.md) |
| BinaryProvider | Ide Editor Integration | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-binaryprovider-ed7fb119.md) |
| BioIdentifiers | Ide Editor Integration | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-bioidentifiers-137a927f.md) |
| ChemicalIdentifiers | Ide Editor Integration | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-chemicalidentifiers-488cf3b4.md) |
