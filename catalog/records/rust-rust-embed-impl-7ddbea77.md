...
| Canonical URL | [https://crates.io/crates/rust-embed-impl](https://crates.io/crates/rust-embed-impl) |
| Source record ids | crates_io-4d1f29389b247e |
...
For a systems engineer, rust-embed-impl belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 8.12.0 | 2026-07-08T06:05:02.247784Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- `crates_io-4d1f29389b247e` from `crates_io` as `registry_expansion`
