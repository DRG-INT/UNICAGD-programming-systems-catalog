...
<!-- canonical: https://github.com/MarcinWachowiak/gr-aoa -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/MarcinWachowiak/gr-aoa](https://github.com/MarcinWachowiak/gr-aoa) |
| Source record ids | github_search_satcom_satellites-0950afbf8d1c86 |

## System Engineer Summary

GNU Radio package implementing MUSIC and root MUSIC angle of arrival algorithms with blocks
necessary to provide phase synchronization of USRP devices

## Operational Role

For a systems engineer, MarcinWachowiak/gr-aoa belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-03-19T19:25:05Z | gh search repos topic:gnuradio stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-0950afbf8d1c86` from `github_search_satcom_satellites` as `registry_expansion`
