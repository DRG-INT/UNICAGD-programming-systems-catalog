...
[Catalog index](../index.md) · [Language: SatCom Satellites](../by-language/satcom-satellites.md) · [Category: Ide Editor Integration](../by-category/ide-editor-integration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/777arc/PySDR -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/777arc/PySDR](https://github.com/777arc/PySDR) |
| Source record ids | github_search_satcom_satellites-12e8337e4b6ccb |

## System Engineer Summary

PySDR is a guide to software-defined radio (SDR) and RF signal processing using Python, live at

## Operational Role

For a systems engineer, 777arc/PySDR belongs in the SatCom Satellites inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-05T22:35:11Z | gh search repos topic:sdr stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-12e8337e4b6ccb` from `github_search_satcom_satellites` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| AresValley/Artemis | Ide Editor Integration | [open](satcom-satellites-aresvalley-artemis-bffe8427.md) |
| bellingcat/sar-interference-tracker | Ide Editor Integration | [open](satcom-satellites-bellingcat-sar-interference-tracker-812a2aa7.md) |
| cbassa/stvid | Ide Editor Integration | [open](satcom-satellites-cbassa-stvid-b0821bf9.md) |
| CScorza/GEOINTInvestigation | Ide Editor Integration | [open](satcom-satellites-cscorza-geointinvestigation-97ccfead.md) |
| dividebysandwich/sdroxide | Ide Editor Integration | [open](satcom-satellites-dividebysandwich-sdroxide-b0d1a434.md) |
| JonaNorman/HDRSample | Ide Editor Integration | [open](satcom-satellites-jonanorman-hdrsample-b3b07c40.md) |
| jx9527/FHSS-Hopping-Estimation | Ide Editor Integration | [open](satcom-satellites-jx9527-fhss-hopping-estimation-df3390c6.md) |
| MarcinWachowiak/gr-aoa | Ide Editor Integration | [open](satcom-satellites-marcinwachowiak-gr-aoa-f666d650.md) |
