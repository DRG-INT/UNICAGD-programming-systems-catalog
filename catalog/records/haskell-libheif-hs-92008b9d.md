...
<!-- canonical: https://hackage.haskell.org/package/libheif-hs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/libheif-hs](https://hackage.haskell.org/package/libheif-hs) |
| Source record ids | hackage_recent-394e34f595c790 |

## System Engineer Summary

Hackage package recently uploaded by fusion5.

## Operational Role

For a systems engineer, libheif-hs belongs in the Haskell inventory as part of ecosystem capability
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/libheif-hs` at `2026-09-10T00:31:04+00:00`.
...
- `hackage_recent-394e34f595c790` from `hackage_recent` as `registry_expansion`
