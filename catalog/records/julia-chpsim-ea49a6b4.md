...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/ChpSim](https://github.com/JuliaRegistries/General/tree/master/C/ChpSim) |
| Source record ids | julia_general-10bf6557c2031a |

## System Engineer Summary

Julia package registered in General at C/ChpSim.

## Operational Role

For a systems engineer, ChpSim belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/ChpSim", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-10bf6557c2031a` from `julia_general` as `registry_expansion`
