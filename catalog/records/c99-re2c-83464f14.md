...
| Source record ids | corpus-e0e0a5108f9f7f |

## System Engineer Summary

re2c is tracked as a parser lexer ast record in the C99 branch. The source did not provide a long
...
For a systems engineer, re2c belongs in the C99 inventory as part of language tooling, code
...
- `corpus-e0e0a5108f9f7f` from `master_json` as `parser_lexer_ast`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Bison | Parser Lexer Ast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-bison-7a04410b.md) |
