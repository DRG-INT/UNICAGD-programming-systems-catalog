...
[Catalog index](../index.md) · [Language: C++23](../by-language/c-23.md) · [Category: Cli](../by-category/cli.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Source record ids | corpus-005777d5602469 |

## System Engineer Summary

cxxopts is tracked as a cli record in the C++23 branch. The source did not provide a long
...
For a systems engineer, cxxopts belongs in the C++23 inventory as part of ecosystem capability
...
- `corpus-005777d5602469` from `master_json` as `cli`
...
| Name | Category | Page |
| --- | --- | --- |
| Boost.Program_options | Cli | [open](c-23-boost-program-options-cac73de7.md) |
| CLI11 | Cli | [open](c-23-cli11-ff7c973a.md) |
