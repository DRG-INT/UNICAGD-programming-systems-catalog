...
<!-- canonical: https://cran.r-project.org/web/packages/sims/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/sims/index.html](https://cran.r-project.org/web/packages/sims/index.html) |
| Source record ids | cran_packages_by_date-26c1c80f79475b |
...
For a systems engineer, sims belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.5 | 2026-08-25 21:20:02 UTC | [https://cran.r-project.org/web/packages/sims/DESCRIPTION](https://cran.r-project.org/web/packages/sims/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/sims/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-26c1c80f79475b` from `cran_packages_by_date` as `registry_expansion`
