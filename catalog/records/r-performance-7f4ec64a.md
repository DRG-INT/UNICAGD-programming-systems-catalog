...
<!-- canonical: https://cran.r-project.org/web/packages/performance/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/performance/index.html](https://cran.r-project.org/web/packages/performance/index.html) |
| Source record ids | cran_packages_by_date-3202e87bc70639 |
...
For a systems engineer, performance belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.18.1 | 2026-09-01 09:50:02 UTC | [https://cran.r-project.org/web/packages/performance/DESCRIPTION](https://cran.r-project.org/web/packages/performance/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/performance/DESCRIPTION` at `2026-09-01T10:21:44+00:00`.
...
- `cran_packages_by_date-3202e87bc70639` from `cran_packages_by_date` as `registry_expansion`
