...
<!-- canonical: https://packagist.org/packages/psr/http-client -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/psr/http-client](https://packagist.org/packages/psr/http-client) |
| Source record ids | packagist_search-6dc8064dca16d2 |
...
For a systems engineer, psr/http-client belongs in the PHP inventory as part of service
...
- `packagist_search-6dc8064dca16d2` from `packagist_search` as `registry_expansion`
