...
<!-- canonical: https://hackage.haskell.org/package/mysql -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/mysql](https://hackage.haskell.org/package/mysql) |
| Source record ids | hackage_top_downloads-6432adc5c60c38 |
...
For a systems engineer, mysql belongs in the Haskell inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2021-10-20T17:06:53Z | [https://hackage.haskell.org/package/mysql](https://hackage.haskell.org/package/mysql) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/mysql` at `2026-09-01T14:24:25+00:00`.
...
- `hackage_top_downloads-6432adc5c60c38` from `hackage_top_downloads` as `registry_expansion`
