...
<!-- canonical: https://cran.r-project.org/web/packages/AdaptHyCensor/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/AdaptHyCensor/index.html](https://cran.r-project.org/web/packages/AdaptHyCensor/index.html) |
| Source record ids | cran_packages_by_date-9a0686a9408ec9 |
...
For a systems engineer, AdaptHyCensor belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-04 14:10:45 UTC | [https://cran.r-project.org/web/packages/AdaptHyCensor/DESCRIPTION](https://cran.r-project.org/web/packages/AdaptHyCensor/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/AdaptHyCensor/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-9a0686a9408ec9` from `cran_packages_by_date` as `registry_expansion`
