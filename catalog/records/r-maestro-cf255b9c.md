...
<!-- canonical: https://cran.r-project.org/web/packages/maestro/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/maestro/index.html](https://cran.r-project.org/web/packages/maestro/index.html) |
| Source record ids | cran_packages_by_date-2b602d3bf64e6a |
...
For a systems engineer, maestro belongs in the R inventory as part of dependency acquisition,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.0 | 2026-08-31 20:30:02 UTC | [https://cran.r-project.org/web/packages/maestro/DESCRIPTION](https://cran.r-project.org/web/packages/maestro/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/maestro/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-2b602d3bf64e6a` from `cran_packages_by_date` as `registry_expansion`
