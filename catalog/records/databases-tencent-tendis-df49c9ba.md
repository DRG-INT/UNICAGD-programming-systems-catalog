...
<!-- canonical: https://github.com/Tencent/Tendis -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Tencent/Tendis](https://github.com/Tencent/Tendis) |
| Source record ids | github_search_databases-12bd7e49ea6707 |
...
For a systems engineer, Tencent/Tendis belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-26T07:42:59Z | gh search repos topic:nosql stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-12bd7e49ea6707` from `github_search_databases` as `registry_expansion`
