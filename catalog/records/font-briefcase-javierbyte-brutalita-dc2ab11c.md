...
| Source record ids | github_search_font_briefcase-8d8ac2a2924451 |
...
For a systems engineer, javierbyte/brutalita belongs in the Font Briefcase inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-30T15:17:52Z | gh search repos topic:typeface stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_font_briefcase-8d8ac2a2924451` from `github_search_font_briefcase` as `registry_expansion`
