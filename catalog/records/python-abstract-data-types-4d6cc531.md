...
<!-- canonical: https://pypi.org/project/abstract-data-types/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/abstract-data-types/](https://pypi.org/project/abstract-data-types/) |
| Source record ids | pypi_simple-f6e131f03fd8ff |
...
For a systems engineer, abstract-data-types belongs in the Python inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.1 | 2022-03-21T01:03:50.305210Z | [https://pypi.org/pypi/abstract-data-types/json](https://pypi.org/pypi/abstract-data-types/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/abstract-data-types/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-f6e131f03fd8ff` from `pypi_simple` as `registry_expansion`
