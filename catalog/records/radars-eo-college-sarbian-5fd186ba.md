...
<!-- canonical: https://github.com/EO-College/sarbian -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/EO-College/sarbian](https://github.com/EO-College/sarbian) |
| Source record ids | github_search_radars-a929f431f12bdc |

## System Engineer Summary

We’ve built a plug’n play Operation System (based on Debian Linux) with all the freely and openly
available SAR processing software. No knowledge of installation steps needed, just download and get
started with SAR data processing. SARbian is free for use in research, education or operational
work.

## Operational Role

For a systems engineer, EO-College/sarbian belongs in the Radars inventory as part of model
...
- `github_search_radars-a929f431f12bdc` from `github_search_radars` as `registry_expansion`
