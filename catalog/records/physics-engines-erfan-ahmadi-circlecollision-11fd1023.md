...
[Catalog index](../index.md) · [Language: Physics Engines](../by-language/physics-engines.md) · [Category: Logging Observability](../by-category/logging-observability.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Erfan-Ahmadi/CircleCollision -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Erfan-Ahmadi/CircleCollision](https://github.com/Erfan-Ahmadi/CircleCollision) |
| Source record ids | github_search_physics_engines-5119739ff638f1 |

## System Engineer Summary

Implementing Different Methods of Circle to Circle Collision Detection using variety of new
Technologies: Vulkan Graphics/Compute API, AVX2/AVX-512

## Operational Role

For a systems engineer, Erfan-Ahmadi/CircleCollision belongs in the Physics Engines inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-12-28T14:58:06Z | gh search repos topic:collision-detection stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-5119739ff638f1` from `github_search_physics_engines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| acrlw/Physics2D | Logging Observability | [open](physics-engines-acrlw-physics2d-b799a4ca.md) |
| GuilhermeRossato/3D-Redstone-Simulator | Logging Observability | [open](physics-engines-guilhermerossato-3d-redstone-simulator-ab4487ec.md) |
| Unity-Technologies/articulations-robot-demo | Logging Observability | [open](physics-engines-unity-technologies-articulations-robot-demo-cb42297d.md) |
| Unity-Technologies/PhysicsExamples2D | Logging Observability | [open](physics-engines-unity-technologies-physicsexamples2d-c6aaad56.md) |
| XXHolic/blog | Logging Observability | [open](physics-engines-xxholic-blog-19ccc801.md) |
