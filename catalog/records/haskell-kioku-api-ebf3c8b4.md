...
| Canonical URL | [https://hackage.haskell.org/package/kioku-api](https://hackage.haskell.org/package/kioku-api) |
| Source record ids | hackage_recent-6a3519652d8827 |
...
For a systems engineer, kioku-api belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.2.0 | 2026-09-01T03:54:32Z | [https://hackage.haskell.org/package/kioku-api](https://hackage.haskell.org/package/kioku-api) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/kioku-api` at `2026-09-01T07:24:07+00:00`.
...
- `hackage_recent-6a3519652d8827` from `hackage_recent` as `registry_expansion`
