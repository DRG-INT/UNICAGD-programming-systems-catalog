...
<!-- canonical: https://github.com/iTowns/itowns -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/iTowns/itowns](https://github.com/iTowns/itowns) |
| Source record ids | github_search_maps-13ec36ac4e9b8d |
...
For a systems engineer, iTowns/itowns belongs in the Maps inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T22:23:33Z | gh search repos topic:vector-tiles stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-13ec36ac4e9b8d` from `github_search_maps` as `registry_expansion`
