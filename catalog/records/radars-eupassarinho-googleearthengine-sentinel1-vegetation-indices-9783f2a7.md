...
<!-- canonical: https://github.com/eupassarinho/GoogleEarthEngine-sentinel1-vegetation-indices -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/eupassarinho/GoogleEarthEngine-sentinel1-vegetation-indices](https://github.com/eupassarinho/GoogleEarthEngine-sentinel1-vegetation-indices) |
| Source record ids | github_search_radars-3824164f11a11a |

## System Engineer Summary

It contains Google Earth Engine codes (JavaScript API) to process Sentinel-1 and Landsat 8 images to
compute SAR and optical vegetation indices.

## Operational Role

For a systems engineer, eupassarinho/GoogleEarthEngine-sentinel1-vegetation-indices belongs in the
Radars inventory as part of model pipelines, numerical runtime constraints, and data/deployment
interfaces.
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-07-25T15:33:25Z | gh search repos topic:sar stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-3824164f11a11a` from `github_search_radars` as `registry_expansion`
