...
<!-- canonical: https://github.com/raceintospace/raceintospace -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/raceintospace/raceintospace](https://github.com/raceintospace/raceintospace) |
| Source record ids | github_search_satcom_satellites-21806a59322dcc |

## System Engineer Summary

This is the GitHub home of Race Into Space, the computer version of the Liftoff! board game by Fritz
Bronner. It was developed by Strategic Visions and published by Interplay as a disk-based game in
1993 and a CD-ROM in 1994. It was open-sourced in 2005 and a number of improvements have been made
over the original.

## Operational Role

For a systems engineer, raceintospace/raceintospace belongs in the SatCom Satellites inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.0.0 | 2025-03-27T17:48:52Z | [https://api.github.com/repos/raceintospace/raceintospace/releases/latest](https://api.github.com/repos/raceintospace/raceintospace/releases/latest) |  |
| preview | known | v.2.0beta | 2022-09-15T18:44:19Z | [https://api.github.com/repos/raceintospace/raceintospace/releases?per_page=10](https://api.github.com/repos/raceintospace/raceintospace/releases?per_page=10) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/raceintospace/raceintospace/releases/latest` at `2026-09-01T08:26:37+00:00`.
...
- `github_search_satcom_satellites-21806a59322dcc` from `github_search_satcom_satellites` as `registry_expansion`
