...
<!-- canonical: https://github.com/DonaldSBosley/MATLAB_DSP -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/DonaldSBosley/MATLAB_DSP](https://github.com/DonaldSBosley/MATLAB_DSP) |
| Source record ids | github_search_effects-920075dc3f777f |

## System Engineer Summary

Tools for sound generation, analysis, audio effects, etc...

## Operational Role

For a systems engineer, DonaldSBosley/MATLAB_DSP belongs in the Effects inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2014-03-12T07:24:56Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-920075dc3f777f` from `github_search_effects` as `registry_expansion`
