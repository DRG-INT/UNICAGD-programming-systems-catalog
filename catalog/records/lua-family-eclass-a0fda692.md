...
<!-- canonical: https://luarocks.org/modules/liaozhaoyan/eclass -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/liaozhaoyan/eclass](https://luarocks.org/modules/liaozhaoyan/eclass) |
| Source record ids | luarocks_root_manifest-31ec2ffa2cd5a5 |
...
For a systems engineer, eclass belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-31ec2ffa2cd5a5` from `luarocks_root_manifest` as `registry_expansion`
