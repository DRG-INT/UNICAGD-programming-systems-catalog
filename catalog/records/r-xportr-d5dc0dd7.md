...
<!-- canonical: https://cran.r-project.org/web/packages/xportr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/xportr/index.html](https://cran.r-project.org/web/packages/xportr/index.html) |
| Source record ids | cran_packages_by_date-dd2523c567f1d4 |
...
For a systems engineer, xportr belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.0 | 2026-09-01 02:20:02 UTC | [https://cran.r-project.org/web/packages/xportr/DESCRIPTION](https://cran.r-project.org/web/packages/xportr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/xportr/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-dd2523c567f1d4` from `cran_packages_by_date` as `registry_expansion`
