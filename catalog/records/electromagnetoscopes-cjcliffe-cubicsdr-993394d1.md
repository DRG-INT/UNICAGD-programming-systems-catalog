...
| Source record ids | github_search_electromagnetoscopes-2d905339506c90 |
...
For a systems engineer, cjcliffe/CubicSDR belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T02:19:48Z | gh search repos topic:spectrum-analyzer stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-2d905339506c90` from `github_search_electromagnetoscopes` as `registry_expansion`
