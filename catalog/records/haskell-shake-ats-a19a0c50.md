...
<!-- canonical: https://hackage.haskell.org/package/shake-ats -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/shake-ats](https://hackage.haskell.org/package/shake-ats) |
| Source record ids | hackage_top_downloads-b98816dfbf3a26 |
...
For a systems engineer, shake-ats belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.10.4.2 | 2020-07-24T02:34:25Z | [https://hackage.haskell.org/package/shake-ats](https://hackage.haskell.org/package/shake-ats) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/shake-ats` at `2026-09-01T14:24:30+00:00`.
...
- `hackage_top_downloads-b98816dfbf3a26` from `hackage_top_downloads` as `registry_expansion`
