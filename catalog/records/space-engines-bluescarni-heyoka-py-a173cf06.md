...
| Canonical URL | [https://github.com/bluescarni/heyoka.py](https://github.com/bluescarni/heyoka.py) |
| Source record ids | github_search_space_engines-463a737c6805bc |
...
For a systems engineer, bluescarni/heyoka.py belongs in the Space Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v7.12.1 | 2026-07-22T10:54:03Z | [https://api.github.com/repos/bluescarni/heyoka.py/releases/latest](https://api.github.com/repos/bluescarni/heyoka.py/releases/latest) |  |
...
| Evidence | License :: OSI Approved :: MIT License; Mozilla Public License 2.0; https://api.github.com/licenses/mpl-2.0 |
...
- Latest stable metadata was observed from `https://api.github.com/repos/bluescarni/heyoka.py/releases/latest` at `2026-09-01T07:24:16+00:00`.
...
- `github_search_space_engines-463a737c6805bc` from `github_search_space_engines` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| bluescarni/heyoka | Compiler | [open](space-engines-bluescarni-heyoka-0a38e447.md) |
