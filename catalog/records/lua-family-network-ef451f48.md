...
| Source record ids | lua-source-35 |

## System Engineer Summary

Network is tracked as a networking http record in the Lua family branch. The source did not provide
...
For a systems engineer, Network belongs in the Lua family inventory as part of service
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 35}}` |

## Evidence

Evidence records merged into this identity: `1`.

- `lua-source-35` from `master_json` as `source_list_item`
