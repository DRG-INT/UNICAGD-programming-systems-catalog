...
<!-- canonical: https://github.com/aMarCruz/react-native-text-size -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/aMarCruz/react-native-text-size](https://github.com/aMarCruz/react-native-text-size) |
| Source record ids | github_search_assets-a66612c0450d01 |
...
For a systems engineer, aMarCruz/react-native-text-size belongs in the Assets inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-07-17T10:20:57Z | gh search repos topic:fonts stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-a66612c0450d01` from `github_search_assets` as `registry_expansion`
