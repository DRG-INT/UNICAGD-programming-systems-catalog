...
<!-- canonical: https://github.com/brandonp2412/Quitter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/brandonp2412/Quitter](https://github.com/brandonp2412/Quitter) |
| Source record ids | github_search_magazines-7d1bdd456dffdf |

## System Engineer Summary

Private, offline addiction-recovery and sobriety tracker with milestones, journaling, notifications,
and custom quit journeys.

## Operational Role

For a systems engineer, brandonp2412/Quitter belongs in the Magazines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-30T01:50:52Z | gh search repos topic:journal stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-7d1bdd456dffdf` from `github_search_magazines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| krrishd/write | Visualization Gui | [open](magazines-krrishd-write-37bef373.md) |
