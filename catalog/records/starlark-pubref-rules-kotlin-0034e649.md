...
<!-- canonical: https://github.com/pubref/rules_kotlin -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pubref/rules_kotlin](https://github.com/pubref/rules_kotlin) |
| Source record ids | github_search_starlark-9aef80651070b2 |

## System Engineer Summary

pubref/rules_kotlin is tracked as a build system record in the Starlark branch. The source did not
...
For a systems engineer, pubref/rules_kotlin belongs in the Starlark inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-06-03T18:25:58Z | gh search repos topic:bazel rules stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_starlark-9aef80651070b2` from `github_search_starlark` as `registry_expansion`
