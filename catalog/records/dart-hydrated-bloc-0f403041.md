...
<!-- canonical: https://pub.dev/packages/hydrated_bloc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/hydrated_bloc](https://pub.dev/packages/hydrated_bloc) |
| Source record ids | pub_dev-8b165713003834 |

## System Engineer Summary

An extension to the bloc state management library which automatically persists and restores bloc
states.

## Operational Role

For a systems engineer, hydrated_bloc belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 11.0.0 | 2026-03-22T20:10:52.627950Z | [https://pub.dev/api/packages/hydrated_bloc](https://pub.dev/api/packages/hydrated_bloc) |  |
| preview | known | 9.0.0-dev.3 | 2022-08-06T03:59:15.623339Z | [https://pub.dev/api/packages/hydrated_bloc](https://pub.dev/api/packages/hydrated_bloc) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/hydrated_bloc` at `2026-09-01T15:35:55+00:00`.
...
- `pub_dev-8b165713003834` from `pub_dev` as `registry_expansion`
