...
<!-- canonical: https://github.com/gemengtju/Tutorial_Speech_Signal_Processing -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gemengtju/Tutorial_Speech_Signal_Processing](https://github.com/gemengtju/Tutorial_Speech_Signal_Processing) |
| Source record ids | github_search_audio-c58ab90e4bd10a |

## System Engineer Summary

This repo summarizes the courses and materials for speech signal processing. You are kindly invited
to pull requests.

## Operational Role

For a systems engineer, gemengtju/Tutorial_Speech_Signal_Processing belongs in the Audio inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-07-20T11:33:47Z | gh search repos topic:speech-processing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-c58ab90e4bd10a` from `github_search_audio` as `registry_expansion`
