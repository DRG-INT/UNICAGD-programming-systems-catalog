...
<!-- canonical: https://crates.io/crates/icu_normalizer_data -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/icu_normalizer_data](https://crates.io/crates/icu_normalizer_data) |
| Source record ids | crates_io-db6b3a0076c3d7 |
...
For a systems engineer, icu_normalizer_data belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.0 | 2026-08-13T23:28:53.835366Z | [https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=3&per_page=100&sort=downloads) |  |
...
- `crates_io-db6b3a0076c3d7` from `crates_io` as `registry_expansion`
