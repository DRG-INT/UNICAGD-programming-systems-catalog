...
<!-- canonical: https://crates.io/crates/futures-task -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/futures-task](https://crates.io/crates/futures-task) |
| Source record ids | crates_io-f543e1a59765e3 |
...
For a systems engineer, futures-task belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.34 | 2026-08-11T12:13:07.886026Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-f543e1a59765e3` from `crates_io` as `registry_expansion`
