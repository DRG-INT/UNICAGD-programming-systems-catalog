...
<!-- canonical: https://www.npmjs.com/package/@netlify/database-proxy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@netlify/database-proxy](https://www.npmjs.com/package/@netlify/database-proxy) |
| Source record ids | npm_registry-0911fbd94cadf0 |

## System Engineer Summary

Transparent PostgreSQL proxy for Netlify Database with dynamic provisioning

## Operational Role

For a systems engineer, @netlify/database-proxy belongs in the Node.js/JavaScript inventory as part
of state persistence, migrations, performance, and operational recovery.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2026-08-27T19:42:26.549Z | [https://registry.npmjs.org/-/v1/search?text=database&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=database&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-0911fbd94cadf0` from `npm_registry` as `registry_expansion`
