...
<!-- canonical: https://cran.r-project.org/web/packages/AIDA/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/AIDA/index.html](https://cran.r-project.org/web/packages/AIDA/index.html) |
| Source record ids | cran_packages_by_date-29347b0a171f45 |
...
For a systems engineer, AIDA belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2026-09-04 12:10:02 UTC | [https://cran.r-project.org/web/packages/AIDA/DESCRIPTION](https://cran.r-project.org/web/packages/AIDA/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/AIDA/DESCRIPTION` at `2026-09-04T12:25:08+00:00`.
...
- `cran_packages_by_date-29347b0a171f45` from `cran_packages_by_date` as `registry_expansion`
...
| AMRsurveilR | Static Analyzer | [open](r-amrsurveilr-c20d9f6e.md) |
