...
| Source record ids | github_search_assets-1281f5e2136b62 |
...
For a systems engineer, SerCeMan/fontogen belongs in the Assets inventory as part of build graph
...
- `github_search_assets-1281f5e2136b62` from `github_search_assets` as `registry_expansion`
