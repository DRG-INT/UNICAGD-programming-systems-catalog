...
<!-- canonical: https://pub.dev/packages/responsive_sizer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/responsive_sizer](https://pub.dev/packages/responsive_sizer) |
| Source record ids | pub_dev-34000bde8244b9 |
...
For a systems engineer, responsive_sizer belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.3.1 | 2024-03-24T08:17:07.092780Z | [https://pub.dev/api/packages/responsive_sizer](https://pub.dev/api/packages/responsive_sizer) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/responsive_sizer` at `2026-09-01T16:41:08+00:00`.
...
- `pub_dev-34000bde8244b9` from `pub_dev` as `registry_expansion`
