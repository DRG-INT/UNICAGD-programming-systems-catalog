...
<!-- canonical: https://github.com/qrdate/tinywasi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/qrdate/tinywasi](https://github.com/qrdate/tinywasi) |
| Source record ids | github_search_webassembly-11467828c8b679 |
...
For a systems engineer, qrdate/tinywasi belongs in the WebAssembly inventory as part of runtime
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-03-27T10:59:01Z | gh search repos topic:wasi stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-11467828c8b679` from `github_search_webassembly` as `registry_expansion`
