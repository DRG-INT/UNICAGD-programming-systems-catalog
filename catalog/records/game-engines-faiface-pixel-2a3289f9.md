...
| Source record ids | github_search_game_engines-f519265577e6be |
...
For a systems engineer, faiface/pixel belongs in the Game Engines inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-05-23T19:26:29Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-f519265577e6be` from `github_search_game_engines` as `registry_expansion`
...
| nicolasgramlich/AndEngine | Machine Learning | [open](game-engines-nicolasgramlich-andengine-8b5e9d9b.md) |
