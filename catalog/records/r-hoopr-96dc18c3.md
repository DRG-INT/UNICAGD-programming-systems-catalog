...
<!-- canonical: https://cran.r-project.org/web/packages/hoopR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/hoopR/index.html](https://cran.r-project.org/web/packages/hoopR/index.html) |
| Source record ids | cran_packages_by_date-8615cb848da009 |
...
For a systems engineer, hoopR belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.1.0 | 2026-08-25 08:00:02 UTC | [https://cran.r-project.org/web/packages/hoopR/DESCRIPTION](https://cran.r-project.org/web/packages/hoopR/DESCRIPTION) |  |
...
| --- | --- |
| Detected family | MIT |
| Evidence | ISC License; https://api.github.com/licenses/isc; BSD 3-Clause "New" or "Revised" License; https://api.github.com/licenses/bsd-3-clause; MIT License; https://api.github.com/licenses/mit |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/hoopR/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-8615cb848da009` from `cran_packages_by_date` as `registry_expansion`
