...
<!-- canonical: https://hackage.haskell.org/package/quic-simple -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/quic-simple](https://hackage.haskell.org/package/quic-simple) |
| Source record ids | hackage_recent-36d21c9436a774 |
...
For a systems engineer, quic-simple belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.2.0 | 2026-09-03T18:26:27Z | [https://hackage.haskell.org/package/quic-simple](https://hackage.haskell.org/package/quic-simple) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/quic-simple` at `2026-09-04T13:25:57+00:00`.
...
- `hackage_recent-36d21c9436a774` from `hackage_recent` as `registry_expansion`
