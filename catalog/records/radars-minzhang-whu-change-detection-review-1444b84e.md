...
<!-- canonical: https://github.com/MinZHANG-WHU/Change-Detection-Review -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/MinZHANG-WHU/Change-Detection-Review](https://github.com/MinZHANG-WHU/Change-Detection-Review) |
| Source record ids | github_search_radars-7013ea22ae3303 |

## System Engineer Summary

A review of change detection methods, including codes and open data sets for deep learning. From
paper: change detection based on artificial intelligence: state-of-the-art and challenges.

## Operational Role

For a systems engineer, MinZHANG-WHU/Change-Detection-Review belongs in the Radars inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-07-30T13:43:15Z | gh search repos topic:remote-sensing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-7013ea22ae3303` from `github_search_radars` as `registry_expansion`
