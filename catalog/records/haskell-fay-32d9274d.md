...
<!-- canonical: https://hackage.haskell.org/package/fay -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/fay](https://hackage.haskell.org/package/fay) |
| Source record ids | hackage_top_downloads-a511dbe94665ae |
...
For a systems engineer, fay belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.24.2.0 | 2021-01-10T20:41:58Z | [https://hackage.haskell.org/package/fay](https://hackage.haskell.org/package/fay) |  |
| candidate | partial | 0.23.2.0 |  | [https://hackage.haskell.org/package/fay](https://hackage.haskell.org/package/fay) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/fay` at `2026-09-01T07:24:00+00:00`.
...
- `hackage_top_downloads-a511dbe94665ae` from `hackage_top_downloads` as `registry_expansion`
