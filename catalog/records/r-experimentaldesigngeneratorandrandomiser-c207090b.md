...
<!-- canonical: https://cran.r-project.org/web/packages/ExperimentalDesignGeneratorandRandomiser/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ExperimentalDesignGeneratorandRandomiser/index.html](https://cran.r-project.org/web/packages/ExperimentalDesignGeneratorandRandomiser/index.html) |
| Source record ids | cran_packages_by_date-15a184903b37ba |
...
For a systems engineer, ExperimentalDesignGeneratorandRandomiser belongs in the R inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-02 12:30:13 UTC | [https://cran.r-project.org/web/packages/ExperimentalDesignGeneratorandRandomiser/DESCRIPTION](https://cran.r-project.org/web/packages/ExperimentalDesignGeneratorandRandomiser/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ExperimentalDesignGeneratorandRandomiser/DESCRIPTION` at `2026-09-02T14:20:11+00:00`.
...
- `cran_packages_by_date-15a184903b37ba` from `cran_packages_by_date` as `registry_expansion`
