...
<!-- canonical: https://cran.r-project.org/web/packages/libcmaesr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/libcmaesr/index.html](https://cran.r-project.org/web/packages/libcmaesr/index.html) |
| Source record ids | cran_packages_by_date-b143252c05ad78 |
...
For a systems engineer, libcmaesr belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-07 10:30:02 UTC | [https://cran.r-project.org/web/packages/libcmaesr/DESCRIPTION](https://cran.r-project.org/web/packages/libcmaesr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/libcmaesr/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-b143252c05ad78` from `cran_packages_by_date` as `registry_expansion`
