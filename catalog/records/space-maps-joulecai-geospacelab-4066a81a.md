...
<!-- canonical: https://github.com/JouleCai/geospacelab -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JouleCai/geospacelab](https://github.com/JouleCai/geospacelab) |
| Source record ids | github_search_space_maps-47fa79cea64429 |

## System Engineer Summary

A python-based library to collect, manage, and visualize geospace data (e.g. OMNI, geomagnetic
indices, EISCAT, DMSP, SWARM, TEC, AMPERE, etc.).

## Operational Role

For a systems engineer, JouleCai/geospacelab belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-30T07:28:01Z | gh search repos space visualization | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-47fa79cea64429` from `github_search_space_maps` as `registry_expansion`
