...
<!-- canonical: https://pub.dev/packages/openai_dart -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/openai_dart](https://pub.dev/packages/openai_dart) |
| Source record ids | pub_dev-007526166d1576 |

## System Engineer Summary

Dart client for the OpenAI REST APIs and realtime WebSocket/WebRTC workflows with type-safe access
to GPT, image, audio, and Responses APIs.

## Operational Role

For a systems engineer, openai_dart belongs in the Dart inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 8.1.0 | 2026-08-27T15:49:19.235624Z | [https://pub.dev/api/packages/openai_dart](https://pub.dev/api/packages/openai_dart) |  |
| preview | known | 0.0.1-dev.1 | 2023-10-31T22:24:03.904638Z | [https://pub.dev/api/packages/openai_dart](https://pub.dev/api/packages/openai_dart) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/openai_dart` at `2026-09-01T15:35:58+00:00`.
...
- `pub_dev-007526166d1576` from `pub_dev` as `registry_expansion`
