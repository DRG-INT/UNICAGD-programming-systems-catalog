...
<!-- canonical: https://cran.r-project.org/web/packages/BayesQRCount/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/BayesQRCount/index.html](https://cran.r-project.org/web/packages/BayesQRCount/index.html) |
| Source record ids | cran_packages_by_date-c1bebddb235156 |
...
For a systems engineer, BayesQRCount belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-05 09:30:08 UTC | [https://cran.r-project.org/web/packages/BayesQRCount/DESCRIPTION](https://cran.r-project.org/web/packages/BayesQRCount/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/BayesQRCount/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-c1bebddb235156` from `cran_packages_by_date` as `registry_expansion`
