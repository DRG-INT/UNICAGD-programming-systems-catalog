...
[Catalog index](../index.md) · [Language: Font Briefcase](../by-language/font-briefcase.md) · [Category: Utility Library](../by-category/utility-library.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/peterhinch/micropython-font-to-py -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/peterhinch/micropython-font-to-py](https://github.com/peterhinch/micropython-font-to-py) |
| Source record ids | github_search_font_briefcase-f6d995c0ac6a94 |
...
For a systems engineer, peterhinch/micropython-font-to-py belongs in the Font Briefcase inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-05-28T09:18:59Z | gh search repos topic:fonts stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_font_briefcase-f6d995c0ac6a94` from `github_search_font_briefcase` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| fontTools | Utility Library | [open](font-briefcase-fonttools-f6d609cf.md) |
