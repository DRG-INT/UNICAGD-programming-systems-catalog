...
<!-- canonical: https://github.com/rnissel/Channel-Estimation -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rnissel/Channel-Estimation](https://github.com/rnissel/Channel-Estimation) |
| Source record ids | github_search_matlab-739cafc461082c |

## System Engineer Summary

Simulates an FBMC and OFDM transmission over a doubly-selective channel. Allows to reproduce all
figures from "Doubly-Selective Channel Estimation in FBMC-OQAM and OFDM Systems", IEEE VTC Fall,
2018

## Operational Role

For a systems engineer, rnissel/Channel-Estimation belongs in the Matlab inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-07-02T18:52:13Z | gh search repos language:MATLAB topic:signal-processing | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-739cafc461082c` from `github_search_matlab` as `registry_expansion`
