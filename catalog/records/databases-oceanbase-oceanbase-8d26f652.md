...
<!-- canonical: https://github.com/oceanbase/oceanbase -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/oceanbase/oceanbase](https://github.com/oceanbase/oceanbase) |
| Source record ids | github_search_databases-f69f0bc9495615 |

## System Engineer Summary

OceanBase is the unified distributed database for the AI era — open-source, multi-model, one engine
for your most demanding workloads.

## Operational Role

For a systems engineer, oceanbase/oceanbase belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T01:00:58Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-f69f0bc9495615` from `github_search_databases` as `registry_expansion`
