...
| Canonical URL | [https://crates.io/crates/xdg](https://crates.io/crates/xdg) |
| Source record ids | crates_io-1615574139b9bd |
...
For a systems engineer, xdg belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.0 | 2025-05-04T10:42:18.850350Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
- `crates_io-1615574139b9bd` from `crates_io` as `registry_expansion`
