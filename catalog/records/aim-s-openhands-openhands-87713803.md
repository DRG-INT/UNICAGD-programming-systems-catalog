...
<!-- canonical: https://github.com/OpenHands/OpenHands -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/OpenHands/OpenHands](https://github.com/OpenHands/OpenHands) |
| Source record ids | github_search_aims-7a35b632160eac |
...
For a systems engineer, OpenHands/OpenHands belongs in the "aim's" inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-05T13:05:42Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-7a35b632160eac` from `github_search_aims` as `registry_expansion`
