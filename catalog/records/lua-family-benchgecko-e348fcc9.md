...
<!-- canonical: https://luarocks.org/modules/dropthe/benchgecko -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/dropthe/benchgecko](https://luarocks.org/modules/dropthe/benchgecko) |
| Source record ids | luarocks_root_manifest-7121ab2f15aa4f |

## System Engineer Summary

Official Lua SDK for the BenchGecko API

## Operational Role

For a systems engineer, benchgecko belongs in the Lua family inventory as part of cross-language
...
- `luarocks_root_manifest-7121ab2f15aa4f` from `luarocks_root_manifest` as `registry_expansion`
