...
<!-- canonical: https://www.nuget.org/packages/Amazon.Lambda.Serialization.Json -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Amazon.Lambda.Serialization.Json](https://www.nuget.org/packages/Amazon.Lambda.Serialization.Json) |
| Source record ids | nuget_search-cd15ac0fad8250 |
...
For a systems engineer, Amazon.Lambda.Serialization.Json belongs in the C-Sharp inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.0 | 2026-05-07T15:58:31.483+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/amazon.lambda.serialization.json/index.json](https://api.nuget.org/v3/registration5-gz-semver2/amazon.lambda.serialization.json/index.json) |  |
...
| Evidence | GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; Apache-2.0; https://www.nuget.org/packages/Amazon.Lambda.Serialization.Json/3.0.0/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/amazon.lambda.serialization.json/index.json` at `2026-09-01T07:23:57+00:00`.
...
- `nuget_search-cd15ac0fad8250` from `nuget_search` as `registry_expansion`
