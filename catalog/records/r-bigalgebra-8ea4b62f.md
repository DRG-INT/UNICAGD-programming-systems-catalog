...
<!-- canonical: https://cran.r-project.org/web/packages/bigalgebra/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/bigalgebra/index.html](https://cran.r-project.org/web/packages/bigalgebra/index.html) |
| Source record ids | cran_packages_by_date-51db9c114f6fc9 |
...
For a systems engineer, bigalgebra belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.1.1 | 2026-09-09 10:30:03 UTC | [https://cran.r-project.org/web/packages/bigalgebra/DESCRIPTION](https://cran.r-project.org/web/packages/bigalgebra/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/bigalgebra/DESCRIPTION` at `2026-09-09T12:25:57+00:00`.
...
- `cran_packages_by_date-51db9c114f6fc9` from `cran_packages_by_date` as `registry_expansion`
