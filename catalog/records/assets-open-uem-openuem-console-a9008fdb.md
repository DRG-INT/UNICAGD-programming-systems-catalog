...
<!-- canonical: https://github.com/open-uem/openuem-console -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/open-uem/openuem-console](https://github.com/open-uem/openuem-console) |
| Source record ids | github_search_assets-124eb8b7309d60 |

## System Engineer Summary

Repository containing the OpenUEM web user interface used to manage endpoints and agents

## Operational Role

For a systems engineer, open-uem/openuem-console belongs in the Assets inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-02T12:17:23Z | gh search repos topic:assets stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-124eb8b7309d60` from `github_search_assets` as `registry_expansion`
