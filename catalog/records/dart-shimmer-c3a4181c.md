...
<!-- canonical: https://pub.dev/packages/shimmer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/shimmer](https://pub.dev/packages/shimmer) |
| Source record ids | pub_dev-23ee021d6345f9 |

## System Engineer Summary

A lightweight Flutter widget that paints a moving highlight over skeleton placeholders and call-to-
action text.

## Operational Role

For a systems engineer, shimmer belongs in the Dart inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.0.0 | 2026-08-21T04:57:50.840535Z | [https://pub.dev/api/packages/shimmer](https://pub.dev/api/packages/shimmer) |  |
| preview | known | 2.0.0-nullsafety.0 | 2021-01-25T04:49:10.361814Z | [https://pub.dev/api/packages/shimmer](https://pub.dev/api/packages/shimmer) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/shimmer` at `2026-09-01T16:41:06+00:00`.
...
- `pub_dev-23ee021d6345f9` from `pub_dev` as `registry_expansion`
