...
<!-- canonical: https://cran.r-project.org/web/packages/evoFE/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/evoFE/index.html](https://cran.r-project.org/web/packages/evoFE/index.html) |
| Source record ids | cran_packages_by_date-273df106ce8bb6 |
...
For a systems engineer, evoFE belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-08-25 12:30:02 UTC | [https://cran.r-project.org/web/packages/evoFE/DESCRIPTION](https://cran.r-project.org/web/packages/evoFE/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/evoFE/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-273df106ce8bb6` from `cran_packages_by_date` as `registry_expansion`
