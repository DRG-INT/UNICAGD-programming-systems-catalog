...
<!-- canonical: https://pypi.org/project/aadc-cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/aadc-cli/](https://pypi.org/project/aadc-cli/) |
| Source record ids | pypi_simple-3afcf2c0eaf2bd |
...
For a systems engineer, aadc-cli belongs in the Python inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.9.6 | 2025-12-07T08:24:32.757273Z | [https://pypi.org/pypi/aadc-cli/json](https://pypi.org/pypi/aadc-cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/aadc-cli/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-3afcf2c0eaf2bd` from `pypi_simple` as `registry_expansion`
