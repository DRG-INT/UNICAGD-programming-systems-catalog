...
<!-- canonical: https://github.com/brimworks/lua-zip -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/brimworks/lua-zip](https://github.com/brimworks/lua-zip) |
| Source record ids | lua-source-279 |
...
For a systems engineer, lua-zip belongs in the Lua family inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 279}}` |
...
- `lua-source-279` from `master_json` as `source_list_item`
