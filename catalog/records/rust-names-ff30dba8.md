...
| Canonical URL | [https://crates.io/crates/names](https://crates.io/crates/names) |
| Source record ids | crates_io-5c5c5c7331e62e |

## System Engineer Summary

A random name generator with names suitable for use in container instances, project names,
application instances, etc.

## Operational Role

For a systems engineer, names belongs in the Rust inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.14.0 | 2022-06-28T20:26:29.163977Z | [https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads) |  |
...
- `crates_io-5c5c5c7331e62e` from `crates_io` as `registry_expansion`
