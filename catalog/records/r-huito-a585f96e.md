...
<!-- canonical: https://cran.r-project.org/web/packages/huito/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/huito/index.html](https://cran.r-project.org/web/packages/huito/index.html) |
| Source record ids | cran_packages_by_date-5e3024028afc9b |
...
For a systems engineer, huito belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.7 | 2026-08-21 05:42:43 UTC | [https://cran.r-project.org/web/packages/huito/DESCRIPTION](https://cran.r-project.org/web/packages/huito/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/huito/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-5e3024028afc9b` from `cran_packages_by_date` as `registry_expansion`
