...
| Source record ids | github_search_radars-17f9fe4a90a640 |
...
For a systems engineer, davidscmx/radar-target-generation-and-detection belongs in the Radars
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-09-12T09:48:22Z | gh search repos topic:radar stars:>20 | gh_search_reports_activity_not_release_version |
...
| Evidence | Apache-2.0 OR MIT; {"key": "", "name": "", "url": ""} |
...
- `github_search_radars-17f9fe4a90a640` from `github_search_radars` as `registry_expansion`
