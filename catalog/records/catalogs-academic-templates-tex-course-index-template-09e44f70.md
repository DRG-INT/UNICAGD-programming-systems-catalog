...
<!-- canonical: https://github.com/academic-templates/tex-course-index-template -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/academic-templates/tex-course-index-template](https://github.com/academic-templates/tex-course-index-template) |
| Source record ids | github_search_catalogs-ce01adce666565 |
...
For a systems engineer, academic-templates/tex-course-index-template belongs in the Catalogs
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-04T21:24:16Z | gh search repos topic:index stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-ce01adce666565` from `github_search_catalogs` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| google/casa-android | Project Scaffolding | [open](catalogs-google-casa-android-f11de6d3.md) |
