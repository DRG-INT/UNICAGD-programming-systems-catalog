...
<!-- canonical: https://cran.r-project.org/web/packages/ConsTree/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ConsTree/index.html](https://cran.r-project.org/web/packages/ConsTree/index.html) |
| Source record ids | cran_packages_by_date-931b6afe8d5ad2 |
...
For a systems engineer, ConsTree belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-09-15 12:10:19 UTC | [https://cran.r-project.org/web/packages/ConsTree/DESCRIPTION](https://cran.r-project.org/web/packages/ConsTree/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ConsTree/DESCRIPTION` at `2026-09-15T12:24:49+00:00`.
...
- `cran_packages_by_date-931b6afe8d5ad2` from `cran_packages_by_date` as `registry_expansion`
