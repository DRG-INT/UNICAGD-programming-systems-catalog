...
<!-- canonical: https://www.npmjs.com/package/@redocly/mock-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@redocly/mock-server](https://www.npmjs.com/package/@redocly/mock-server) |
| Source record ids | npm_registry-27a79235e3e8f2 |

## System Engineer Summary

@redocly/mock-server is tracked as an assertion mocking record in the Node.js/JavaScript branch. The
...
For a systems engineer, @redocly/mock-server belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.10.0 | 2026-08-13T11:02:23.091Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-27a79235e3e8f2` from `npm_registry` as `registry_expansion`
