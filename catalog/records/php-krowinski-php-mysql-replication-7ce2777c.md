...
<!-- canonical: https://packagist.org/packages/krowinski/php-mysql-replication -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/krowinski/php-mysql-replication](https://packagist.org/packages/krowinski/php-mysql-replication) |
| Source record ids | packagist_search-cea89ed204098b |

## System Engineer Summary

Pure PHP Implementation of MySQL replication protocol. This allow you to receive event like insert,
update, delete with their data and raw SQL queries.

## Operational Role

For a systems engineer, krowinski/php-mysql-replication belongs in the PHP inventory as part of
...
- `packagist_search-cea89ed204098b` from `packagist_search` as `registry_expansion`
