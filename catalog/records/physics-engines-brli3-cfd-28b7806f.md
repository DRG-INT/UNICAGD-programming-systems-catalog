...
<!-- canonical: https://github.com/brli3/CFD -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/brli3/CFD](https://github.com/brli3/CFD) |
| Source record ids | github_search_physics_engines-bcf6a3c177c383 |

## System Engineer Summary

Basic Computational Fluid Dynamics (CFD) schemes implemented in FORTRAN using Finite-Volume and
Finite-Difference Methods. Sample simulations and figures are provided.

## Operational Role

For a systems engineer, brli3/CFD belongs in the Physics Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-07-25T06:27:43Z | gh search repos topic:fluid-simulation stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-bcf6a3c177c383` from `github_search_physics_engines` as `registry_expansion`
