...
<!-- canonical: https://pub.dev/packages/flutter_staggered_animations -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_staggered_animations](https://pub.dev/packages/flutter_staggered_animations) |
| Source record ids | pub_dev-005d17bbd01df6 |

## System Engineer Summary

Easily add staggered animations to your ListView, GridView, Column and Row children as shown in
Material Design guidelines

## Operational Role

For a systems engineer, flutter_staggered_animations belongs in the Dart inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.1 | 2022-08-23T15:50:16.823872Z | [https://pub.dev/api/packages/flutter_staggered_animations](https://pub.dev/api/packages/flutter_staggered_animations) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_staggered_animations` at `2026-09-01T14:20:29+00:00`.
...
- `pub_dev-005d17bbd01df6` from `pub_dev` as `registry_expansion`
