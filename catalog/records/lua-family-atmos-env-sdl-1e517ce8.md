...
<!-- canonical: https://luarocks.org/modules/fsantanna/atmos-env-sdl -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/fsantanna/atmos-env-sdl](https://luarocks.org/modules/fsantanna/atmos-env-sdl) |
| Source record ids | luarocks_root_manifest-89e4cee7dfd73c |

## System Engineer Summary

SDL environment for Atmos

## Operational Role

For a systems engineer, atmos-env-sdl belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-89e4cee7dfd73c` from `luarocks_root_manifest` as `registry_expansion`
