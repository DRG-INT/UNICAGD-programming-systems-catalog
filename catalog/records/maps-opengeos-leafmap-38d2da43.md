...
<!-- canonical: https://github.com/opengeos/leafmap -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/opengeos/leafmap](https://github.com/opengeos/leafmap) |
| Source record ids | github_search_maps-6acf1dbb5a6377 |

## System Engineer Summary

A Python package for interactive mapping and geospatial analysis with minimal coding in a Jupyter
environment

## Operational Role

For a systems engineer, opengeos/leafmap belongs in the Maps inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T21:25:08Z | gh search repos topic:geospatial stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-6acf1dbb5a6377` from `github_search_maps` as `registry_expansion`
