...
<!-- canonical: https://github.com/jameshball/osci-render -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jameshball/osci-render](https://github.com/jameshball/osci-render) |
| Source record ids | github_search_audio-f7ffc2b5e9d503 |
...
For a systems engineer, jameshball/osci-render belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.8.9.18 | 2026-04-19T21:32:42Z | [https://api.github.com/repos/jameshball/osci-render/releases/latest](https://api.github.com/repos/jameshball/osci-render/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/jameshball/osci-render/releases/latest` at `2026-09-01T11:21:39+00:00`.
...
- `github_search_audio-f7ffc2b5e9d503` from `github_search_audio` as `registry_expansion`
