...
<!-- canonical: https://github.com/geoffleyland/luatrace -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/geoffleyland/luatrace](https://github.com/geoffleyland/luatrace) |
| Source record ids | lua-source-88 |
...
For a systems engineer, luatrace belongs in the Lua family inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 88}}` |
...
- `lua-source-88` from `master_json` as `source_list_item`
