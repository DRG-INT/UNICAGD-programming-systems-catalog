...
<!-- canonical: https://hackage.haskell.org/package/preamble -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/preamble](https://hackage.haskell.org/package/preamble) |
| Source record ids | hackage_top_downloads-0ef45a938f8afa |
...
For a systems engineer, preamble belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.65 | 2018-10-11T04:51:51Z | [https://hackage.haskell.org/package/preamble](https://hackage.haskell.org/package/preamble) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/preamble` at `2026-09-01T14:24:27+00:00`.
...
- `hackage_top_downloads-0ef45a938f8afa` from `hackage_top_downloads` as `registry_expansion`
