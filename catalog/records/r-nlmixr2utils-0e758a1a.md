...
<!-- canonical: https://cran.r-project.org/web/packages/nlmixr2utils/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/nlmixr2utils/index.html](https://cran.r-project.org/web/packages/nlmixr2utils/index.html) |
| Source record ids | cran_packages_by_date-a591c307929956 |

## System Engineer Summary

Shared Infrastructure for 'nlmixr2' Extension Packages

## Operational Role

For a systems engineer, nlmixr2utils belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.1 | 2026-09-09 12:30:02 UTC | [https://cran.r-project.org/web/packages/nlmixr2utils/DESCRIPTION](https://cran.r-project.org/web/packages/nlmixr2utils/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/nlmixr2utils/DESCRIPTION` at `2026-09-09T14:20:36+00:00`.
...
- `cran_packages_by_date-a591c307929956` from `cran_packages_by_date` as `registry_expansion`
