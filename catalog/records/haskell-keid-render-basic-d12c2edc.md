...
<!-- canonical: https://hackage.haskell.org/package/keid-render-basic -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/keid-render-basic](https://hackage.haskell.org/package/keid-render-basic) |
| Source record ids | hackage_top_downloads-3df5a920067541 |
...
For a systems engineer, keid-render-basic belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.10.0 | 2025-11-06T23:22:46Z | [https://hackage.haskell.org/package/keid-render-basic](https://hackage.haskell.org/package/keid-render-basic) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/keid-render-basic` at `2026-09-01T14:24:22+00:00`.
...
- `hackage_top_downloads-3df5a920067541` from `hackage_top_downloads` as `registry_expansion`
