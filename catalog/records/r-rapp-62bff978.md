...
<!-- canonical: https://cran.r-project.org/web/packages/Rapp/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/Rapp/index.html](https://cran.r-project.org/web/packages/Rapp/index.html) |
| Source record ids | cran_packages_by_date-b35401febabf22 |
...
For a systems engineer, Rapp belongs in the R inventory as part of build graph control, artifact
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.1 | 2026-08-24 19:50:02 UTC | [https://cran.r-project.org/web/packages/Rapp/DESCRIPTION](https://cran.r-project.org/web/packages/Rapp/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/Rapp/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-b35401febabf22` from `cran_packages_by_date` as `registry_expansion`
