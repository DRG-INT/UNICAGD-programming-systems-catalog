...
<!-- canonical: https://github.com/vincenzo-afk/chaos-vpn -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/vincenzo-afk/chaos-vpn](https://github.com/vincenzo-afk/chaos-vpn) |
| Source record ids | github_search_effects-f086c6b592d228 |

## System Engineer Summary

Extreme real-time voice distortion engine for Android and iOS. Features 18+ chaos effects including
bit-scrambling, vocoding, and reverse glitches for Discord, WhatsApp, and gaming.

## Operational Role

For a systems engineer, vincenzo-afk/chaos-vpn belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-22T01:48:06Z | gh search repos topic:audio-effects stars:>20 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-01 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:audio-effects stars:>20", "retrieved": "2026-09-01", "status": "forge-cli-derived"}` |
...
- `github_search_effects-f086c6b592d228` from `github_search_effects` as `registry_expansion`
...
| Ariakim-Taiyo/GeoFS-Shaders-Repository | Filesystem Os | [open](effects-ariakim-taiyo-geofs-shaders-repository-e1d48b19.md) |
| Arnklit/godot-paint-postprocessing | Filesystem Os | [open](effects-arnklit-godot-paint-postprocessing-45e455ab.md) |
| artyommihailovich/RealityKitPostProcessingLUT | Filesystem Os | [open](effects-artyommihailovich-realitykitpostprocessinglut-94c47d97.md) |
