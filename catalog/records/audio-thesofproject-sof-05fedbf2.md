...
| Source record ids | github_search_audio-b466522a0f7211 |

## System Engineer Summary

thesofproject/sof is tracked as an image audio dsp record in the Audio branch. The source did not
...
For a systems engineer, thesofproject/sof belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.14.3 | 2026-01-27T16:23:07Z | [https://api.github.com/repos/thesofproject/sof/releases/latest](https://api.github.com/repos/thesofproject/sof/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/thesofproject/sof/releases/latest` at `2026-09-01T09:23:20+00:00`.
...
- `github_search_audio-b466522a0f7211` from `github_search_audio` as `registry_expansion`
