...
<!-- canonical: https://crates.io/crates/include_dir -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/include_dir](https://crates.io/crates/include_dir) |
| Source record ids | crates_io-a7f58f4fa73926 |
...
For a systems engineer, include_dir belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.4 | 2024-06-17T14:46:19.491634Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- `crates_io-a7f58f4fa73926` from `crates_io` as `registry_expansion`
