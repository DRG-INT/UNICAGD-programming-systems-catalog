...
| Canonical URL | [https://luarocks.org/modules/sveyret/expect-spy](https://luarocks.org/modules/sveyret/expect-spy) |
| Source record ids | luarocks_root_manifest-2ccc2a3e5ac3ec |
...
For a systems engineer, expect-spy belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-2ccc2a3e5ac3ec` from `luarocks_root_manifest` as `registry_expansion`
