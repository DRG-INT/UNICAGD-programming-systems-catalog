...
<!-- canonical: https://hackage.haskell.org/package/gi-notify -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/gi-notify](https://hackage.haskell.org/package/gi-notify) |
| Source record ids | hackage_top_downloads-cea75360de2635 |
...
For a systems engineer, gi-notify belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.29 | 2025-10-26T13:53:52Z | [https://hackage.haskell.org/package/gi-notify](https://hackage.haskell.org/package/gi-notify) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/gi-notify` at `2026-09-09T00:35:00+00:00`.
...
- `hackage_top_downloads-cea75360de2635` from `hackage_top_downloads` as `registry_expansion`
