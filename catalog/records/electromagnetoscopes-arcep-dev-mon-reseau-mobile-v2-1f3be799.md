# ARCEP-dev/Mon-Reseau-Mobile-v2
...
<!-- canonical: https://github.com/ARCEP-dev/Mon-Reseau-Mobile-v2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ARCEP-dev/Mon-Reseau-Mobile-v2](https://github.com/ARCEP-dev/Mon-Reseau-Mobile-v2) |
| Source record ids | github_search_electromagnetoscopes-d05b659645a361 |

## System Engineer Summary

This repository contains the source code for the “Mon reseau mobile” website. The website provides
maps of mobile telecommunications data, provided by the French regulatory authority (Arcep).

## Operational Role

For a systems engineer, ARCEP-dev/Mon-Reseau-Mobile-v2 belongs in the Electromagnetoscopes inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-02T12:50:46Z | gh search repos topic:antenna stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-d05b659645a361` from `github_search_electromagnetoscopes` as `registry_expansion`
