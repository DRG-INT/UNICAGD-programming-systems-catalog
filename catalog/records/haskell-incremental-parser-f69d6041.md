...
<!-- canonical: https://hackage.haskell.org/package/incremental-parser -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/incremental-parser](https://hackage.haskell.org/package/incremental-parser) |
| Source record ids | hackage_top_downloads-e8caf67356dc30 |
...
For a systems engineer, incremental-parser belongs in the Haskell inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.1 | 2023-12-19T15:36:12Z | [https://hackage.haskell.org/package/incremental-parser](https://hackage.haskell.org/package/incremental-parser) |  |
| candidate | partial | 0.2.3.3 |  | [https://hackage.haskell.org/package/incremental-parser](https://hackage.haskell.org/package/incremental-parser) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/incremental-parser` at `2026-09-01T14:24:22+00:00`.
...
- `hackage_top_downloads-e8caf67356dc30` from `hackage_top_downloads` as `registry_expansion`
