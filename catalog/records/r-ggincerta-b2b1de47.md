...
<!-- canonical: https://cran.r-project.org/web/packages/ggincerta/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ggincerta/index.html](https://cran.r-project.org/web/packages/ggincerta/index.html) |
| Source record ids | cran_packages_by_date-de38c6dabdd112 |
...
For a systems engineer, ggincerta belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2026-09-14 05:00:02 UTC | [https://cran.r-project.org/web/packages/ggincerta/DESCRIPTION](https://cran.r-project.org/web/packages/ggincerta/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ggincerta/DESCRIPTION` at `2026-09-14T05:19:48+00:00`.
...
- `cran_packages_by_date-de38c6dabdd112` from `cran_packages_by_date` as `registry_expansion`
