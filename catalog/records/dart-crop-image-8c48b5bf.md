...
<!-- canonical: https://pub.dev/packages/crop_image -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/crop_image](https://pub.dev/packages/crop_image) |
| Source record ids | pub_dev-eaf1b102cfa1eb |
...
For a systems engineer, crop_image belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.17 | 2025-12-26T21:39:19.326991Z | [https://pub.dev/api/packages/crop_image](https://pub.dev/api/packages/crop_image) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/crop_image` at `2026-09-01T07:20:13+00:00`.
...
- `pub_dev-eaf1b102cfa1eb` from `pub_dev` as `registry_expansion`
