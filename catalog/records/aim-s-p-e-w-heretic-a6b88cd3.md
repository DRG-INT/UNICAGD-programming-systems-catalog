...
<!-- canonical: https://github.com/p-e-w/heretic -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/p-e-w/heretic](https://github.com/p-e-w/heretic) |
| Source record ids | github_search_aims-b4fa2ddcee2812 |
...
For a systems engineer, p-e-w/heretic belongs in the "aim's" inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T13:46:27Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-b4fa2ddcee2812` from `github_search_aims` as `registry_expansion`
