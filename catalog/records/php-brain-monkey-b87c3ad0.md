...
<!-- canonical: https://packagist.org/packages/brain/monkey -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/brain/monkey](https://packagist.org/packages/brain/monkey) |
| Source record ids | packagist_search-8424bd09e8b66f |
...
For a systems engineer, brain/monkey belongs in the PHP inventory as part of unit/integration
...
- `packagist_search-8424bd09e8b66f` from `packagist_search` as `registry_expansion`
