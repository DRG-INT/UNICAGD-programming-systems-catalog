...
<!-- canonical: https://cran.r-project.org/web/packages/spaMM/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/spaMM/index.html](https://cran.r-project.org/web/packages/spaMM/index.html) |
| Source record ids | cran_packages_by_date-3e825124711c9d |
...
For a systems engineer, spaMM belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.7.0 | 2026-09-09 23:40:02 UTC | [https://cran.r-project.org/web/packages/spaMM/DESCRIPTION](https://cran.r-project.org/web/packages/spaMM/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/spaMM/DESCRIPTION` at `2026-09-10T00:26:07+00:00`.
...
- `cran_packages_by_date-3e825124711c9d` from `cran_packages_by_date` as `registry_expansion`
