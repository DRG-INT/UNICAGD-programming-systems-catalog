...
<!-- canonical: https://github.com/IliaZenkov/async-pubmed-scraper -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/IliaZenkov/async-pubmed-scraper](https://github.com/IliaZenkov/async-pubmed-scraper) |
| Source record ids | github_search_magazines-8fe2cb3030fc75 |

## System Engineer Summary

PubMed scraper for async search on a list of keywords and concurrent extraction of all found URLs,
returning a DataFrame/CSV containing all article data (title, abstract, authors, affiliations, etc)

## Operational Role

For a systems engineer, IliaZenkov/async-pubmed-scraper belongs in the Magazines inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-11-05T21:41:22Z | gh search repos topic:journal stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-8fe2cb3030fc75` from `github_search_magazines` as `registry_expansion`
