...
<!-- canonical: https://pub.dev/packages/mailto -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/mailto](https://pub.dev/packages/mailto) |
| Source record ids | pub_dev-f9b483f38f7a56 |
...
For a systems engineer, mailto belongs in the Dart inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2021-04-13T19:50:22.573797Z | [https://pub.dev/api/packages/mailto](https://pub.dev/api/packages/mailto) |  |
| preview | known | 2.0.0-nullsafety.0 | 2021-01-11T13:13:33.703821Z | [https://pub.dev/api/packages/mailto](https://pub.dev/api/packages/mailto) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/mailto` at `2026-09-01T15:35:59+00:00`.
...
- `pub_dev-f9b483f38f7a56` from `pub_dev` as `registry_expansion`
