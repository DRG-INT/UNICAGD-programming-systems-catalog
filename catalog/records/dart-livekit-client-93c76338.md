...
<!-- canonical: https://pub.dev/packages/livekit_client -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/livekit_client](https://pub.dev/packages/livekit_client) |
| Source record ids | pub_dev-ce57f41479c390 |

## System Engineer Summary

Flutter Client SDK for LiveKit. Build real-time video and audio into your apps. Supports iOS,
Android, and Web.

## Operational Role

For a systems engineer, livekit_client belongs in the Dart inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.12.0 | 2026-09-07T12:59:08.477421Z | [https://pub.dev/api/packages/livekit_client](https://pub.dev/api/packages/livekit_client) |  |
| preview | known | 2.9.0-dev.0 | 2026-06-20T01:17:35.744357Z | [https://pub.dev/api/packages/livekit_client](https://pub.dev/api/packages/livekit_client) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/livekit_client` at `2026-09-08T06:25:56+00:00`.
...
- `pub_dev-ce57f41479c390` from `pub_dev` as `registry_expansion`
