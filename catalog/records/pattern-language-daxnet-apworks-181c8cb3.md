...
<!-- canonical: https://github.com/daxnet/Apworks -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/daxnet/Apworks](https://github.com/daxnet/Apworks) |
| Source record ids | github_search_pattern_language-3cded70e878dc7 |

## System Engineer Summary

Apworks is a flexible, scalable, configurable and efficient .NET based application development
framework that helps software developers to easily build enterprise applications by applying either
Classic Layering or Command-Query Responsibility Segregation (CQRS) architectural patterns.

## Operational Role

For a systems engineer, daxnet/Apworks belongs in the Pattern language inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2017-06-13T12:44:13Z | gh search repos software architecture patterns stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; Boost Software License 1.0; https://api.github.com/licenses/bsl-1.0; {"key": "", "name": "", "url": ""} |
...
- `github_search_pattern_language-3cded70e878dc7` from `github_search_pattern_language` as `registry_expansion`
...
| nilbuild/design-patterns-for-humans | Build System | [open](pattern-language-nilbuild-design-patterns-for-humans-38fea4c2.md) |
