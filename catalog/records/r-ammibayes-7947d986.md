...
<!-- canonical: https://cran.r-project.org/web/packages/ammiBayes/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ammiBayes/index.html](https://cran.r-project.org/web/packages/ammiBayes/index.html) |
| Source record ids | cran_packages_by_date-fd3e59a62c8389 |
...
For a systems engineer, ammiBayes belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2-0 | 2026-08-24 16:50:12 UTC | [https://cran.r-project.org/web/packages/ammiBayes/DESCRIPTION](https://cran.r-project.org/web/packages/ammiBayes/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ammiBayes/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-fd3e59a62c8389` from `cran_packages_by_date` as `registry_expansion`
