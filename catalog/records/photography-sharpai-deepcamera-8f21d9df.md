...
<!-- canonical: https://github.com/SharpAI/DeepCamera -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SharpAI/DeepCamera](https://github.com/SharpAI/DeepCamera) |
| Source record ids | github_search_photography-4ecac8b5e1e3aa |

## System Engineer Summary

Open-Source AI Camera Skills Platform, AI NVR & CCTV Surveillance. Local VLM video analysis with
Qwen, DeepSeek, SmolVLM, LLaVA, YOLO26. LLM-powered agentic security camera agent — watches,
understands, remembers & guards your home via Telegram, Discord or Slack. Pluggable AI skills.
OpenAI, Google, Anthropic or local AI. Runs on Mac Mini & AI PC.

## Operational Role

For a systems engineer, SharpAI/DeepCamera belongs in the Photography inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-18T04:37:54Z | gh search repos topic:camera stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-4ecac8b5e1e3aa` from `github_search_photography` as `registry_expansion`
