...
<!-- canonical: https://hackage.haskell.org/package/cryptocipher -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/cryptocipher](https://hackage.haskell.org/package/cryptocipher) |
| Source record ids | hackage_top_downloads-55698764491d64 |
...
For a systems engineer, cryptocipher belongs in the Haskell inventory as part of confidentiality,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.2 | 2013-10-25T01:06:21Z | [https://hackage.haskell.org/package/cryptocipher](https://hackage.haskell.org/package/cryptocipher) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/cryptocipher` at `2026-09-01T14:24:12+00:00`.
...
- `hackage_top_downloads-55698764491d64` from `hackage_top_downloads` as `registry_expansion`
