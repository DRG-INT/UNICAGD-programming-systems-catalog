# tantaneity/unity-urp-outline-postprocess
...
<!-- canonical: https://github.com/tantaneity/unity-urp-outline-postprocess -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tantaneity/unity-urp-outline-postprocess](https://github.com/tantaneity/unity-urp-outline-postprocess) |
| Source record ids | github_search_effects-27c2638a09f286 |
...
For a systems engineer, tantaneity/unity-urp-outline-postprocess belongs in the Effects inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-07T10:47:43Z | gh search repos post processing shader | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-27c2638a09f286` from `github_search_effects` as `registry_expansion`
