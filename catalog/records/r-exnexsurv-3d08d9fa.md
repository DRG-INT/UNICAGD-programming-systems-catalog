...
<!-- canonical: https://cran.r-project.org/web/packages/exnexSurv/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/exnexSurv/index.html](https://cran.r-project.org/web/packages/exnexSurv/index.html) |
| Source record ids | cran_packages_by_date-c28f47d63c442a |

## System Engineer Summary

Bayesian EXNEX Models for Survival Analysis in Basket Trials

## Operational Role

For a systems engineer, exnexSurv belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.0 | 2026-09-10 14:20:15 UTC | [https://cran.r-project.org/web/packages/exnexSurv/DESCRIPTION](https://cran.r-project.org/web/packages/exnexSurv/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/exnexSurv/DESCRIPTION` at `2026-09-10T15:20:55+00:00`.
...
- `cran_packages_by_date-c28f47d63c442a` from `cran_packages_by_date` as `registry_expansion`
