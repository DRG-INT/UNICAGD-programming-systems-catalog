...
<!-- canonical: https://hackage.haskell.org/package/hsinstall -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/hsinstall](https://hackage.haskell.org/package/hsinstall) |
| Source record ids | hackage_recent-37353658c3dd2d |

## System Engineer Summary

Hackage package recently uploaded by DinoMorelli.

## Operational Role

For a systems engineer, hsinstall belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.2 | 2026-09-06T20:04:48Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
| Evidence | GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; MIT License; https://api.github.com/licenses/mit; {"key": "", "name": "", "url": ""} |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/packages/recent` at `2026-09-06T20:19:16+00:00`.
...
- `hackage_recent-37353658c3dd2d` from `hackage_recent` as `registry_expansion`
