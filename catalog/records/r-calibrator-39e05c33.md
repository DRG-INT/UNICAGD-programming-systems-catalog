...
<!-- canonical: https://cran.r-project.org/web/packages/calibrator/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/calibrator/index.html](https://cran.r-project.org/web/packages/calibrator/index.html) |
| Source record ids | cran_packages_by_date-75d27211b30eb9 |
...
For a systems engineer, calibrator belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2-9 | 2026-09-13 15:40:02 UTC | [https://cran.r-project.org/web/packages/calibrator/DESCRIPTION](https://cran.r-project.org/web/packages/calibrator/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/calibrator/DESCRIPTION` at `2026-09-13T16:19:40+00:00`.
...
- `cran_packages_by_date-75d27211b30eb9` from `cran_packages_by_date` as `registry_expansion`
