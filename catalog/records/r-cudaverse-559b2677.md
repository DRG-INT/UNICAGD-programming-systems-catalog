...
<!-- canonical: https://cran.r-project.org/web/packages/cudaverse/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/cudaverse/index.html](https://cran.r-project.org/web/packages/cudaverse/index.html) |
| Source record ids | cran_packages_by_date-80dc0cd6e1640f |
...
For a systems engineer, cudaverse belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.1 | 2026-09-10 09:30:02 UTC | [https://cran.r-project.org/web/packages/cudaverse/DESCRIPTION](https://cran.r-project.org/web/packages/cudaverse/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/cudaverse/DESCRIPTION` at `2026-09-10T10:20:58+00:00`.
...
- `cran_packages_by_date-80dc0cd6e1640f` from `cran_packages_by_date` as `registry_expansion`
...
| cpge | Math Numeric Scientific | [open](r-cpge-2d2eddf7.md) |
