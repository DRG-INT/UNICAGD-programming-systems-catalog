...
| Canonical URL | [https://crates.io/crates/ratelimit](https://crates.io/crates/ratelimit) |
| Source record ids | crates_io-ff351076783ccc |
...
For a systems engineer, ratelimit belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2026-04-21T18:23:33.708724Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
- `crates_io-ff351076783ccc` from `crates_io` as `registry_expansion`
