...
<!-- canonical: https://github.com/cvde/RoomReverb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cvde/RoomReverb](https://github.com/cvde/RoomReverb) |
| Source record ids | github_search_audio-c43885a004bebb |

## System Engineer Summary

Room Reverb is a mono/stereo to stereo algorithmic reverb audio plugin with many presets that lets
you add reverberation to your recordings in your DAW.

## Operational Role

For a systems engineer, cvde/RoomReverb belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-09-15T17:11:38Z | gh search repos topic:audio-plugin stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-c43885a004bebb` from `github_search_audio` as `registry_expansion`
