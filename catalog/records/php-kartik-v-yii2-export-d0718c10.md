...
<!-- canonical: https://packagist.org/packages/kartik-v/yii2-export -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/kartik-v/yii2-export](https://packagist.org/packages/kartik-v/yii2-export) |
| Source record ids | packagist_search-d0e6bd5147e345 |

## System Engineer Summary

A library to export server/db data in various formats

## Operational Role

For a systems engineer, kartik-v/yii2-export belongs in the PHP inventory as part of low-noise code
...
- `packagist_search-d0e6bd5147e345` from `packagist_search` as `registry_expansion`
