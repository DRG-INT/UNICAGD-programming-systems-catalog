...
[Catalog index](../index.md) · [Language: Effects](../by-language/effects.md) · [Category: Tutorial Book Styleguide](../by-category/tutorial-book-styleguide.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://thebookofshaders.com/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://thebookofshaders.com/](https://thebookofshaders.com/) |
| Source record ids | curated_language_routes-45966b30a5f88d |

## System Engineer Summary

Educational shader programming route for procedural visual effects and GLSL concepts.

## Operational Role

For a systems engineer, The Book of Shaders belongs in the Effects inventory as part of ecosystem
...
- `curated_language_routes-45966b30a5f88d` from `curated_language_routes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ColinKennedy/USD-Cookbook | Tutorial Book Styleguide | [open](effects-colinkennedy-usd-cookbook-c0dce363.md) |
| gtibo/VFX-sketchbook-Godot-3.x | Tutorial Book Styleguide | [open](effects-gtibo-vfx-sketchbook-godot-3-x-818c8d15.md) |
| jtomori/vfx_good_night_reading | Tutorial Book Styleguide | [open](effects-jtomori-vfx-good-night-reading-fcbf70e5.md) |
