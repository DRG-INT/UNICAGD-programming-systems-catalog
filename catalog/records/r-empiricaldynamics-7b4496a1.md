...
<!-- canonical: https://cran.r-project.org/web/packages/EmpiricalDynamics/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/EmpiricalDynamics/index.html](https://cran.r-project.org/web/packages/EmpiricalDynamics/index.html) |
| Source record ids | cran_packages_by_date-ef026438a35d0c |
...
For a systems engineer, EmpiricalDynamics belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.9 | 2026-08-20 00:50:02 UTC | [https://cran.r-project.org/web/packages/EmpiricalDynamics/DESCRIPTION](https://cran.r-project.org/web/packages/EmpiricalDynamics/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/EmpiricalDynamics/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-ef026438a35d0c` from `cran_packages_by_date` as `registry_expansion`
