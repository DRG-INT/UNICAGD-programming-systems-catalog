...
| Canonical URL | [https://crates.io/crates/swc_ecma_parser](https://crates.io/crates/swc_ecma_parser) |
| Source record ids | crates_io-dc63808f093d1c |
...
For a systems engineer, swc_ecma_parser belongs in the Rust inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 45.1.1 | 2026-08-27T20:00:48.001086Z | [https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads) |  |
...
- `crates_io-dc63808f093d1c` from `crates_io` as `registry_expansion`
