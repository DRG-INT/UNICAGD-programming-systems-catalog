...
| Source record ids | github_search_effects-a296c9f53578e5 |
...
For a systems engineer, kfrlib/kfr belongs in the Effects inventory as part of language tooling,
...
| Evidence | MIT License; https://api.github.com/licenses/mit; {"key": "", "name": "", "url": ""}; Apache License 2.0; https://api.github.com/licenses/apache-2.0; GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0 |
...
- `github_search_effects-a296c9f53578e5` from `github_search_effects` as `registry_expansion`
