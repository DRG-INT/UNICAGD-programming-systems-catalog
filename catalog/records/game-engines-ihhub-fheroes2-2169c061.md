...
<!-- canonical: https://github.com/ihhub/fheroes2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ihhub/fheroes2](https://github.com/ihhub/fheroes2) |
| Source record ids | github_search_game_engines-be450b2d8da9dc |
...
For a systems engineer, ihhub/fheroes2 belongs in the Game Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T12:03:24Z | gh search repos topic:game-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_game_engines-be450b2d8da9dc` from `github_search_game_engines` as `registry_expansion`
