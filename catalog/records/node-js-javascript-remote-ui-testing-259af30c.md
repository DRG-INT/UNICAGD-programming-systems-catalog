...
<!-- canonical: https://www.npmjs.com/package/@remote-ui/testing -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@remote-ui/testing](https://www.npmjs.com/package/@remote-ui/testing) |
| Source record ids | npm_registry-8f47ff0f7a25b0 |

## System Engineer Summary

This library provides a unit testing framework for code that uses `@remote-ui/core`. Its API is
heavily inspired by the Shopify’s .

## Operational Role

For a systems engineer, @remote-ui/testing belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.6 | 2025-06-13T07:48:42.233Z | [https://registry.npmjs.org/-/v1/search?text=testing&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=testing&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-8f47ff0f7a25b0` from `npm_registry` as `registry_expansion`
