...
<!-- canonical: https://cran.r-project.org/web/packages/rcontroll/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rcontroll/index.html](https://cran.r-project.org/web/packages/rcontroll/index.html) |
| Source record ids | cran_packages_by_date-eb8f6940e631c5 |
...
For a systems engineer, rcontroll belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.3 | 2026-08-04 08:40:08 UTC | [https://cran.r-project.org/web/packages/rcontroll/DESCRIPTION](https://cran.r-project.org/web/packages/rcontroll/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rcontroll/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-eb8f6940e631c5` from `cran_packages_by_date` as `registry_expansion`
