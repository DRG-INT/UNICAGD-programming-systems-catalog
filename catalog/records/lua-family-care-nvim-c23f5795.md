...
<!-- canonical: https://luarocks.org/modules/max397574/care.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/max397574/care.nvim](https://luarocks.org/modules/max397574/care.nvim) |
| Source record ids | luarocks_root_manifest-550fc7c0e6e4bc |

## System Engineer Summary

care.nvim - Completion And Recommendation Engine for Neovim

## Operational Role

For a systems engineer, care.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-550fc7c0e6e4bc` from `luarocks_root_manifest` as `registry_expansion`
