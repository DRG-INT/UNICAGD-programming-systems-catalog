...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Rust](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/rust.md) · [Category: Filesystem Os](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/filesystem-os.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://crates.io/crates/zbus_macros](https://crates.io/crates/zbus_macros) |
| Source record ids | crates_io-c78f7b88948237 |

## System Engineer Summary

zbus_macros is tracked as a filesystem os record in the Rust branch. The source did not provide a
...
For a systems engineer, zbus_macros belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.19.0 | 2026-08-09T17:48:14.994171Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
| Name | Category | Page |
| --- | --- | --- |
| actix-cors | Filesystem Os | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-actix-cors-a4813363.md) |
| actix-utils | Filesystem Os | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-actix-utils-4c94a8a9.md) |
| addr2line | Filesystem Os | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-addr2line-822b58a0.md) |
| alloca | Filesystem Os | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-alloca-113b2fd1.md) |
| alloy-sol-macro-input | Filesystem Os | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-alloy-sol-macro-input-462ea342.md) |
| ark-ff-macros | Filesystem Os | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-ark-ff-macros-5ecdc709.md) |
| arrayref | Filesystem Os | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-arrayref-3be2f129.md) |
| asn1-rs-derive | Filesystem Os | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-asn1-rs-derive-919456da.md) |
