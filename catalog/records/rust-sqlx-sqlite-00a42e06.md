...
<!-- canonical: https://crates.io/crates/sqlx-sqlite -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/sqlx-sqlite](https://crates.io/crates/sqlx-sqlite) |
| Source record ids | crates_io-07f4749b6af10b |
...
For a systems engineer, sqlx-sqlite belongs in the Rust inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.0 | 2026-05-21T17:34:25.569561Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- `crates_io-07f4749b6af10b` from `crates_io` as `registry_expansion`
