...
<!-- canonical: https://github.com/sthavishtha/list-lattice-Boltzmann-codes -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/sthavishtha/list-lattice-Boltzmann-codes](https://github.com/sthavishtha/list-lattice-Boltzmann-codes) |
| Source record ids | github_search_physics_engines-e64bb373d02945 |
...
For a systems engineer, sthavishtha/list-lattice-Boltzmann-codes belongs in the Physics Engines
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-07-10T05:14:29Z | gh search repos topic:fluid-simulation stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-e64bb373d02945` from `github_search_physics_engines` as `registry_expansion`
