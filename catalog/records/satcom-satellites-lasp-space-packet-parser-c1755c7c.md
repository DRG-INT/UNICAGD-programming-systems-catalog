...
<!-- canonical: https://github.com/lasp/space_packet_parser -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lasp/space_packet_parser](https://github.com/lasp/space_packet_parser) |
| Source record ids | github_search_satcom_satellites-39a7d867e29629 |
...
For a systems engineer, lasp/space_packet_parser belongs in the SatCom Satellites inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-24T17:48:59Z | gh search repos topic:ccsds stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-39a7d867e29629` from `github_search_satcom_satellites` as `registry_expansion`
