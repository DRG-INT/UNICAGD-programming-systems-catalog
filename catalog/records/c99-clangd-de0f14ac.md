...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: C99](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/c99.md) · [Category: Language Server](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/language-server.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | master-00acc933259a |

## System Engineer Summary

clangd is tracked as a language server record in the C99 branch. The source did not provide a long
...
For a systems engineer, clangd belongs in the C99 inventory as part of editor intelligence,
...
- `master-00acc933259a` from `master_json` as `language_server`
