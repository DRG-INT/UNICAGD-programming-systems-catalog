# OS2World/DEV-SAMPLES-C-PM-ctrldes
...
<!-- canonical: https://github.com/OS2World/DEV-SAMPLES-C-PM-ctrldes -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/OS2World/DEV-SAMPLES-C-PM-ctrldes](https://github.com/OS2World/DEV-SAMPLES-C-PM-ctrldes) |
| Source record ids | github_search_magazines-ae4a5c630cdd84 |

## System Engineer Summary

Custom controls demystified. Sample custom controls. Can be used as the basis for other custom
controls. OS/2 Developer Magazine, Issue: Spring '93, page 72.

## Operational Role

For a systems engineer, OS2World/DEV-SAMPLES-C-PM-ctrldes belongs in the Magazines inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.01 | 2023-05-22T21:49:53Z | [https://api.github.com/repos/OS2World/DEV-SAMPLES-C-PM-ctrldes/releases/latest](https://api.github.com/repos/OS2World/DEV-SAMPLES-C-PM-ctrldes/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/OS2World/DEV-SAMPLES-C-PM-ctrldes/releases/latest` at `2026-09-01T10:25:46+00:00`.
...
- `github_search_magazines-ae4a5c630cdd84` from `github_search_magazines` as `registry_expansion`
