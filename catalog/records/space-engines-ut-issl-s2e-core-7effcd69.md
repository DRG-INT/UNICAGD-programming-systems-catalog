...
| Canonical URL | [https://github.com/ut-issl/s2e-core](https://github.com/ut-issl/s2e-core) |
| Source record ids | github_search_space_engines-4a52ad929041c4 |
...
For a systems engineer, ut-issl/s2e-core belongs in the Space Engines inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v9.0.1 | 2026-08-17T07:40:25Z | [https://api.github.com/repos/ut-issl/s2e-core/releases/latest](https://api.github.com/repos/ut-issl/s2e-core/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/ut-issl/s2e-core/releases/latest` at `2026-09-01T07:24:20+00:00`.
...
- `github_search_space_engines-4a52ad929041c4` from `github_search_space_engines` as `registry_expansion`
