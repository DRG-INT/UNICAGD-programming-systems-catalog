...
<!-- canonical: https://github.com/hjdhjd/homebridge-unifi-protect -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/hjdhjd/homebridge-unifi-protect](https://github.com/hjdhjd/homebridge-unifi-protect) |
| Source record ids | github_search_photography-c4daa614047345 |

## System Engineer Summary

:video_camera: Complete HomeKit integration for all UniFi Protect device types with full support for
most features including HomeKit Secure Video, and more.

## Operational Role

For a systems engineer, hjdhjd/homebridge-unifi-protect belongs in the Photography inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-19T20:47:25Z | gh search repos topic:camera stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-c4daa614047345` from `github_search_photography` as `registry_expansion`
