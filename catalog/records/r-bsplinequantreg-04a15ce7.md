...
<!-- canonical: https://cran.r-project.org/web/packages/BsplineQuantReg/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/BsplineQuantReg/index.html](https://cran.r-project.org/web/packages/BsplineQuantReg/index.html) |
| Source record ids | cran_packages_by_date-f9f58b9678594c |
...
For a systems engineer, BsplineQuantReg belongs in the R inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.5 | 2026-08-20 10:32:14 UTC | [https://cran.r-project.org/web/packages/BsplineQuantReg/DESCRIPTION](https://cran.r-project.org/web/packages/BsplineQuantReg/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/BsplineQuantReg/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-f9f58b9678594c` from `cran_packages_by_date` as `registry_expansion`
