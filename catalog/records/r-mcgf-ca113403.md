...
<!-- canonical: https://cran.r-project.org/web/packages/mcgf/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mcgf/index.html](https://cran.r-project.org/web/packages/mcgf/index.html) |
| Source record ids | cran_packages_by_date-384e781fae1038 |
...
For a systems engineer, mcgf belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0 | 2026-08-21 21:00:16 UTC | [https://cran.r-project.org/web/packages/mcgf/DESCRIPTION](https://cran.r-project.org/web/packages/mcgf/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mcgf/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-384e781fae1038` from `cran_packages_by_date` as `registry_expansion`
