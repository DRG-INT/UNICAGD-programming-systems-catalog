...
<!-- canonical: https://crates.io/crates/flume -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/flume](https://crates.io/crates/flume) |
| Source record ids | crates_io-20a5f8bd693fe8 |
...
For a systems engineer, flume belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.12.0 | 2025-12-08T17:22:31.630716Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
- `crates_io-20a5f8bd693fe8` from `crates_io` as `registry_expansion`
