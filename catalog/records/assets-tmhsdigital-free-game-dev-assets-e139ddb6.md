# TMHSDigital/Free-Game-Dev-Assets

## Navigation

[Catalog index](../index.md) · [Language: Assets](../by-language/assets.md) · [Category: Logging Observability](../by-category/logging-observability.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/TMHSDigital/Free-Game-Dev-Assets -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/TMHSDigital/Free-Game-Dev-Assets](https://github.com/TMHSDigital/Free-Game-Dev-Assets) |
| Source record ids | github_search_assets-e09f847df1e74f |

## System Engineer Summary

Curated catalog of free and commercially usable game assets, libraries, and tools. Links and license
metadata only — no rehosted binaries.

## Operational Role

For a systems engineer, TMHSDigital/Free-Game-Dev-Assets belongs in the Assets inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-06T15:48:08Z | gh search repos topic:game-assets stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-e09f847df1e74f` from `github_search_assets` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| raphaelhanneken/iconizer | Logging Observability | [open](assets-raphaelhanneken-iconizer-867b9d26.md) |
| unjs/fontaine | Logging Observability | [open](assets-unjs-fontaine-adf8d9fd.md) |
| vorillaz/devicons | Logging Observability | [open](assets-vorillaz-devicons-ab704e06.md) |
