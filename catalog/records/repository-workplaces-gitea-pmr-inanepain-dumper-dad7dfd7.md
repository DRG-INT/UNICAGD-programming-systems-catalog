# Gitea: pmr-inanepain/dumper

## Navigation

[Catalog index](../index.md) · [Language: Repository Workplaces](../by-language/repository-workplaces.md) · [Category: Debugger](../by-category/debugger.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://gitea.com/pmr-inanepain/dumper -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/pmr-inanepain/dumper](https://gitea.com/pmr-inanepain/dumper) |
| Source record ids | gitea_repositories_api-67387b90664563 |

## System Engineer Summary

A little tool to help with debugging by writing a `var_dump` like message unobtrusively into a
collapsible panel at the bottom of a page.

## Operational Role

For a systems engineer, Gitea: pmr-inanepain/dumper belongs in the Repository Workplaces inventory
as part of fault isolation, live inspection, breakpoints, and production-adjacent diagnosis.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-08-27T16:20:34Z | [https://gitea.com/api/v1/repos/search?q=library&limit=50](https://gitea.com/api/v1/repos/search?q=library&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-67387b90664563` from `gitea_repositories_api` as `registry_expansion`
