...
<!-- canonical: https://cran.r-project.org/web/packages/pedFamilias/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/pedFamilias/index.html](https://cran.r-project.org/web/packages/pedFamilias/index.html) |
| Source record ids | cran_packages_by_date-fca885d911d20d |
...
For a systems engineer, pedFamilias belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.6 | 2026-09-11 12:20:07 UTC | [https://cran.r-project.org/web/packages/pedFamilias/DESCRIPTION](https://cran.r-project.org/web/packages/pedFamilias/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/pedFamilias/DESCRIPTION` at `2026-09-11T12:25:27+00:00`.
...
- `cran_packages_by_date-fca885d911d20d` from `cran_packages_by_date` as `registry_expansion`
