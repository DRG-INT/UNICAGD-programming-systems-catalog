...
| Canonical URL | [https://cacm.acm.org/](https://cacm.acm.org/) |
| Source record ids | curated_language_routes-dcef7caed6af7f |

## System Engineer Summary

ACM magazine route for computing research, practice, systems, programming, and technology context.

## Operational Role

For a systems engineer, Communications of the ACM belongs in the Magazines inventory as part of
...
- `curated_language_routes-dcef7caed6af7f` from `curated_language_routes` as `registry_expansion`
