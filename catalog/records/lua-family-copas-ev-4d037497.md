...
<!-- canonical: https://luarocks.org/modules/saucisson/copas-ev -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/saucisson/copas-ev](https://luarocks.org/modules/saucisson/copas-ev) |
| Source record ids | luarocks_root_manifest-6d43ceb7cfd9bd |

## System Engineer Summary

copas-ev is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, copas-ev belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-6d43ceb7cfd9bd` from `luarocks_root_manifest` as `registry_expansion`
