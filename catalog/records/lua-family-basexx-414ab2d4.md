...
<!-- canonical: https://luarocks.org/modules/aiq/basexx -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/aiq/basexx](https://luarocks.org/modules/aiq/basexx) |
| Source record ids | luarocks_root_manifest-1b357623d67c66 |

## System Engineer Summary

A Lua library which provides base2(bitfield), base16(hex), base32(crockford/rfc), base64(rfc/url),
base85(z85) decoding and encoding.

## Operational Role

For a systems engineer, basexx belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-1b357623d67c66` from `luarocks_root_manifest` as `registry_expansion`
