...
<!-- canonical: https://github.com/skerkour/markdown-ninja -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/skerkour/markdown-ninja](https://github.com/skerkour/markdown-ninja) |
| Source record ids | github_search_magazines-0de0337f9edcb0 |

## System Engineer Summary

Markdown-first CMS for bloggers, minimalists and startups. Open Source alternative to Medium,
Mailchimp and Substack -

## Operational Role

For a systems engineer, skerkour/markdown-ninja belongs in the Magazines inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-09T16:21:37Z | gh search repos topic:newsletter stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-0de0337f9edcb0` from `github_search_magazines` as `registry_expansion`
