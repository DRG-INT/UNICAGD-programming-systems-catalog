...
<!-- canonical: https://cran.r-project.org/web/packages/bayprior/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/bayprior/index.html](https://cran.r-project.org/web/packages/bayprior/index.html) |
| Source record ids | cran_packages_by_date-6e2e40a81810b5 |

## System Engineer Summary

Bayesian Prior Elicitation and Diagnostics for Clinical Trials

## Operational Role

For a systems engineer, bayprior belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.2 | 2026-08-19 14:10:03 UTC | [https://cran.r-project.org/web/packages/bayprior/DESCRIPTION](https://cran.r-project.org/web/packages/bayprior/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/bayprior/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-6e2e40a81810b5` from `cran_packages_by_date` as `registry_expansion`
