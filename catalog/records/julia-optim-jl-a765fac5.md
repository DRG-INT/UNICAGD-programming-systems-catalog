...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/O/Optim](https://github.com/JuliaRegistries/General/tree/master/O/Optim) |
| Source record ids | corpus-69ac43393ceb0a |

## System Engineer Summary

Optim.jl is tracked as a math numeric scientific record in the Julia branch. The source did not
...
For a systems engineer, Optim.jl belongs in the Julia inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial | 2.2.2 |  | [https://raw.githubusercontent.com/JuliaRegistries/General/master/O/Optim/Versions.toml](https://raw.githubusercontent.com/JuliaRegistries/General/master/O/Optim/Versions.toml) | julia_registry_versions_do_not_include_release_dates |
...
- `corpus-69ac43393ceb0a` from `master_json` as `math_numeric_scientific`
