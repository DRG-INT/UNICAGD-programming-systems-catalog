...
| Canonical URL | [https://crates.io/crates/thread-id](https://crates.io/crates/thread-id) |
| Source record ids | crates_io-b21c75fc5d608d |

## System Engineer Summary

thread-id is tracked as a concurrency parallelism record in the Rust branch. The source did not
...
For a systems engineer, thread-id belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.1.0 | 2026-01-10T21:17:07.837054Z | [https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads) |  |
...
- `crates_io-b21c75fc5d608d` from `crates_io` as `registry_expansion`
