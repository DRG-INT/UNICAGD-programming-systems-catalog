...
<!-- canonical: https://cran.r-project.org/web/packages/TCpRepDesigns/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/TCpRepDesigns/index.html](https://cran.r-project.org/web/packages/TCpRepDesigns/index.html) |
| Source record ids | cran_packages_by_date-cd69f7fa2fdc6b |
...
For a systems engineer, TCpRepDesigns belongs in the R inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.2 | 2026-08-20 11:52:04 UTC | [https://cran.r-project.org/web/packages/TCpRepDesigns/DESCRIPTION](https://cran.r-project.org/web/packages/TCpRepDesigns/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/TCpRepDesigns/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-cd69f7fa2fdc6b` from `cran_packages_by_date` as `registry_expansion`
