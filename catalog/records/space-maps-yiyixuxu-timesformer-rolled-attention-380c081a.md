...
<!-- canonical: https://github.com/yiyixuxu/TimeSformer-rolled-attention -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/yiyixuxu/TimeSformer-rolled-attention](https://github.com/yiyixuxu/TimeSformer-rolled-attention) |
| Source record ids | github_search_space_maps-8aebcf2994d45f |
...
For a systems engineer, yiyixuxu/TimeSformer-rolled-attention belongs in the Space Maps inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-04-01T20:19:05Z | gh search repos space visualization | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-8aebcf2994d45f` from `github_search_space_maps` as `registry_expansion`
