...
<!-- canonical: https://gitlab.com/gitlab-org/security-products/analyzers/container-scanning -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/gitlab-org/security-products/analyzers/container-scanning](https://gitlab.com/gitlab-org/security-products/analyzers/container-scanning) |
| Source record ids | gitlab_projects_api-88d54fcfb6ac8e |

## System Engineer Summary

Container scanning analyzer for container images based on

## Operational Role

For a systems engineer, gitlab-org/security-products/analyzers/container-scanning belongs in the
...
- `gitlab_projects_api-88d54fcfb6ac8e` from `gitlab_projects_api` as `registry_expansion`
