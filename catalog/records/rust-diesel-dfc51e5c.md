...
| Canonical URL | [https://crates.io/crates/Diesel](https://crates.io/crates/Diesel) |
| Source record ids | master-134d9446a32d |

## System Engineer Summary

Diesel is tracked as a database datastore record in the Rust branch. The source did not provide a
...
For a systems engineer, Diesel belongs in the Rust inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.12 | 2026-08-07T06:06:05.809042Z | [https://crates.io/api/v1/crates/Diesel](https://crates.io/api/v1/crates/Diesel) |  |
| preview | known | 2.0.0-rc.1 | 2022-07-22T07:57:21.356322Z | [https://crates.io/api/v1/crates/Diesel](https://crates.io/api/v1/crates/Diesel) |  |

## Engineering Notes

- Treat category as `database_datastore` unless a later verified source gives a better classification.
- Keep provenance attached when merging duplicate identities; source evidence is not disposable.
- Latest stable metadata was observed from `https://crates.io/api/v1/crates/Diesel` at `2026-09-01T02:12:58+00:00`.
...
- `master-134d9446a32d` from `master_json` as `database_datastore`
