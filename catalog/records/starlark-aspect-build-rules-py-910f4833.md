...
<!-- canonical: https://github.com/aspect-build/rules_py -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/aspect-build/rules_py](https://github.com/aspect-build/rules_py) |
| Source record ids | github_search_starlark-f76782d5c3eea8 |
...
For a systems engineer, aspect-build/rules_py belongs in the Starlark inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T22:59:27Z | gh search repos topic:bazel rules stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_starlark-f76782d5c3eea8` from `github_search_starlark` as `registry_expansion`
