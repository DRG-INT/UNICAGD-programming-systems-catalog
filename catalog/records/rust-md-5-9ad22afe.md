...
<!-- canonical: https://crates.io/crates/md-5 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/md-5](https://crates.io/crates/md-5) |
| Source record ids | crates_io-d8e23a902c2b67 |

## System Engineer Summary

md-5 is tracked as a cryptography record in the Rust branch. The source did not provide a long
...
For a systems engineer, md-5 belongs in the Rust inventory as part of confidentiality, integrity,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.11.0 | 2026-03-27T14:59:39.677170Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- `crates_io-d8e23a902c2b67` from `crates_io` as `registry_expansion`
