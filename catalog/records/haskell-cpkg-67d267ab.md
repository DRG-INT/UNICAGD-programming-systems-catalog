...
[Catalog index](../index.md) · [Language: Haskell](../by-language/haskell.md) · [Category: Package Manager](../by-category/package-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://hackage.haskell.org/package/cpkg -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/cpkg](https://hackage.haskell.org/package/cpkg) |
| Source record ids | hackage_top_downloads-1445ecfb1da8f3 |
...
For a systems engineer, cpkg belongs in the Haskell inventory as part of dependency acquisition,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.5.8 | 2023-11-06T15:59:13Z | [https://hackage.haskell.org/package/cpkg](https://hackage.haskell.org/package/cpkg) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/cpkg` at `2026-09-01T14:24:12+00:00`.
...
- `hackage_top_downloads-1445ecfb1da8f3` from `hackage_top_downloads` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| amazonka-datapipeline | Package Manager | [open](haskell-amazonka-datapipeline-28ac905e.md) |
| ats-pkg | Package Manager | [open](haskell-ats-pkg-cc50e091.md) |
| GPipe | Package Manager | [open](haskell-gpipe-6f68fd36.md) |
| pipes | Package Manager | [open](haskell-pipes-76ae72a4.md) |
| pipes-bytestring | Package Manager | [open](haskell-pipes-bytestring-1f37c2f8.md) |
| pipes-concurrency | Package Manager | [open](haskell-pipes-concurrency-ac7e0b04.md) |
| pipes-safe | Package Manager | [open](haskell-pipes-safe-16bf46e5.md) |
| pipes-text | Package Manager | [open](haskell-pipes-text-f39907cf.md) |
