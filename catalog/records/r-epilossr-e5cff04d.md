...
<!-- canonical: https://cran.r-project.org/web/packages/EpiLossR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/EpiLossR/index.html](https://cran.r-project.org/web/packages/EpiLossR/index.html) |
| Source record ids | cran_packages_by_date-3c7c51612b64aa |
...
For a systems engineer, EpiLossR belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-03 12:00:22 UTC | [https://cran.r-project.org/web/packages/EpiLossR/DESCRIPTION](https://cran.r-project.org/web/packages/EpiLossR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/EpiLossR/DESCRIPTION` at `2026-09-03T12:26:17+00:00`.
...
- `cran_packages_by_date-3c7c51612b64aa` from `cran_packages_by_date` as `registry_expansion`
