...
[Catalog index](../index.md) · [Language: Haskell](../by-language/haskell.md) · [Category: Cli](../by-category/cli.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://hackage.haskell.org/package/kioku-cli -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/kioku-cli](https://hackage.haskell.org/package/kioku-cli) |
| Source record ids | hackage_recent-c27fe6ee52d5b4 |

## System Engineer Summary

Hackage package recently uploaded by shinzui.

## Operational Role

For a systems engineer, kioku-cli belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.0.0 | 2026-09-08T20:45:30Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
| --- | --- | --- | --- |
| hackage_recent_uploads | registry-derived | 2026-09-09 | `{"kind": "hackage_recent_uploads", "retrieved": "2026-09-09", "status": "registry-derived"}` |
...
- `hackage_recent-c27fe6ee52d5b4` from `hackage_recent` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ansi-terminal | Cli | [open](haskell-ansi-terminal-2e957796.md) |
| ansi-terminal-game | Cli | [open](haskell-ansi-terminal-game-a0833edf.md) |
| commander-cli | Cli | [open](haskell-commander-cli-d49d9b59.md) |
| pandoc-cli | Cli | [open](haskell-pandoc-cli-85f047c4.md) |
| prettyprinter-ansi-terminal | Cli | [open](haskell-prettyprinter-ansi-terminal-f8e428da.md) |
| seihou-cli | Cli | [open](haskell-seihou-cli-27b5e8d8.md) |
| shell-monad | Cli | [open](haskell-shell-monad-d9f70614.md) |
| ShellCheck | Cli | [open](haskell-shellcheck-7b327ceb.md) |
