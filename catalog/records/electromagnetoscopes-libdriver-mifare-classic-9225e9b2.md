...
<!-- canonical: https://github.com/libdriver/mifare_classic -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/libdriver/mifare_classic](https://github.com/libdriver/mifare_classic) |
| Source record ids | github_search_electromagnetoscopes-ff54173c438b10 |

## System Engineer Summary

MIFARE Classic(S50, S70) full-featured driver library for general-purpose MCU and Linux.

## Operational Role

For a systems engineer, libdriver/mifare_classic belongs in the Electromagnetoscopes inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-25T16:41:38Z | gh search repos topic:rf stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-ff54173c438b10` from `github_search_electromagnetoscopes` as `registry_expansion`
