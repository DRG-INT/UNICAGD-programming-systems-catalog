...
| Source record ids | curated_language_routes-6223c0b4d31113 |

## System Engineer Summary

Metadata hub for datasets, schemas, lineage, owners, governance, search, and data discovery.

## Operational Role

For a systems engineer, DataHub belongs in the Hubs inventory as part of ecosystem capability
...
- `curated_language_routes-6223c0b4d31113` from `curated_language_routes` as `registry_expansion`
