...
| Canonical URL | [https://crates.io/crates/attohttpc](https://crates.io/crates/attohttpc) |
| Source record ids | crates_io-29071183f4aab8 |
...
For a systems engineer, attohttpc belongs in the Rust inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.31.0 | 2026-05-25T03:09:33.175942Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-29071183f4aab8` from `crates_io` as `registry_expansion`
