...
[Catalog index](../index.md) · [Language: Cocoa](../by-language/cocoa.md) · [Category: Data Science](../by-category/data-science.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://www.bugsnag.com/platforms/ios-crash-reporting -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.bugsnag.com/platforms/ios-crash-reporting](https://www.bugsnag.com/platforms/ios-crash-reporting) |
| Source record ids | awesome_list-8ed8c674ae3bd8 |

## System Engineer Summary

Error tracking with a free tier. Error reports include data on device, release, user, and allows
arbitrary data.

## Operational Role

For a systems engineer, Bugsnag belongs in the Cocoa inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 6.37.0 | 2026-08-18 10:06:41 UTC | [https://trunk.cocoapods.org/api/v1/pods/Bugsnag](https://trunk.cocoapods.org/api/v1/pods/Bugsnag) |  |
...
- Latest stable metadata was observed from `https://trunk.cocoapods.org/api/v1/pods/Bugsnag` at `2026-09-01T07:24:05+00:00`.
...
- `awesome_list-8ed8c674ae3bd8` from `awesome_list` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Aptabase | Data Science | [open](cocoa-aptabase-475e4e02.md) |
| Mixpanel | Data Science | [open](cocoa-mixpanel-6b7d41ab.md) |
