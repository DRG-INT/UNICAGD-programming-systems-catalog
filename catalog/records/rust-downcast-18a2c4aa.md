...
<!-- canonical: https://crates.io/crates/downcast -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/downcast](https://crates.io/crates/downcast) |
| Source record ids | crates_io-182e8e7381fc4d |
...
For a systems engineer, downcast belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.11.0 | 2021-11-09T09:57:28.963027Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-182e8e7381fc4d` from `crates_io` as `registry_expansion`
