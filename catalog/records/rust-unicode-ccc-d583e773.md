...
| Canonical URL | [https://crates.io/crates/unicode-ccc](https://crates.io/crates/unicode-ccc) |
| Source record ids | crates_io-ca4450113920fe |
...
For a systems engineer, unicode-ccc belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0 | 2024-09-26T05:38:58.695054Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
...
- `crates_io-ca4450113920fe` from `crates_io` as `registry_expansion`
