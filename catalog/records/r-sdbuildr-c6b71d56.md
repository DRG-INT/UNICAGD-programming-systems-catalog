...
<!-- canonical: https://cran.r-project.org/web/packages/sdbuildR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/sdbuildR/index.html](https://cran.r-project.org/web/packages/sdbuildR/index.html) |
| Source record ids | cran_packages_by_date-5b1f8be017560f |

## System Engineer Summary

An Accessible Interface for Stock-and-Flow Modelling

## Operational Role

For a systems engineer, sdbuildR belongs in the R inventory as part of build graph control, artifact
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.2.3 | 2026-08-23 11:30:02 UTC | [https://cran.r-project.org/web/packages/sdbuildR/DESCRIPTION](https://cran.r-project.org/web/packages/sdbuildR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/sdbuildR/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-5b1f8be017560f` from `cran_packages_by_date` as `registry_expansion`
