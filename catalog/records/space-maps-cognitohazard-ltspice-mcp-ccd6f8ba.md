...
<!-- canonical: https://github.com/Cognitohazard/ltspice-mcp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Cognitohazard/ltspice-mcp](https://github.com/Cognitohazard/ltspice-mcp) |
| Source record ids | github_search_space_maps-5274c14f0f30bf |

## System Engineer Summary

MCP server giving LLMs the ability to design, simulate, and analyze SPICE circuits via LTSpice and
NGspice

## Operational Role

For a systems engineer, Cognitohazard/ltspice-mcp belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T03:27:30Z | gh search repos topic:spice stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-5274c14f0f30bf` from `github_search_space_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| agentstation/starmap | Web Framework | [open](space-maps-agentstation-starmap-8fdcd317.md) |
