...
[Catalog index](../index.md) · [Language: Font Briefcase](../by-language/font-briefcase.md) · [Category: Undefined Behavior Analyzer](../by-category/undefined-behavior-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/johnkil/Android-RobotoTextView -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/johnkil/Android-RobotoTextView](https://github.com/johnkil/Android-RobotoTextView) |
| Source record ids | github_search_font_briefcase-b9d084b02920b9 |

## System Engineer Summary

Implementation of a TextView and all its direct/indirect subclasses with native support for the
Roboto fonts, includes the brand new Roboto Slab fonts.

## Operational Role

For a systems engineer, johnkil/Android-RobotoTextView belongs in the Font Briefcase inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2017-07-26T11:32:54Z | gh search repos topic:typeface stars:>50 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-10 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:typeface stars:>50", "retrieved": "2026-09-10", "status": "forge-cli-derived"}` |
...
- `github_search_font_briefcase-b9d084b02920b9` from `github_search_font_briefcase` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ambroisemaupate/webfont-generator | Undefined Behavior Analyzer | [open](font-briefcase-ambroisemaupate-webfont-generator-cc50b8ed.md) |
| bearcove/fontcull | Undefined Behavior Analyzer | [open](font-briefcase-bearcove-fontcull-c7a78ec4.md) |
| exuanbo/file-icons-js | Undefined Behavior Analyzer | [open](font-briefcase-exuanbo-file-icons-js-efb54f36.md) |
| githubnext/monaspace | Undefined Behavior Analyzer | [open](font-briefcase-githubnext-monaspace-a8c7b718.md) |
| KonghaYao/cn-font-split | Undefined Behavior Analyzer | [open](font-briefcase-konghayao-cn-font-split-4b1774ab.md) |
| opensourcedesign/fonts | Undefined Behavior Analyzer | [open](font-briefcase-opensourcedesign-fonts-afd14247.md) |
| rubjo/victor-mono | Undefined Behavior Analyzer | [open](font-briefcase-rubjo-victor-mono-2ab28caa.md) |
| subframe7536/maple-font | Undefined Behavior Analyzer | [open](font-briefcase-subframe7536-maple-font-a9616e1f.md) |
