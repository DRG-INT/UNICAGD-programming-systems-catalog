...
<!-- canonical: https://www.npmjs.com/package/@types/oauth2-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@types/oauth2-server](https://www.npmjs.com/package/@types/oauth2-server) |
| Source record ids | npm_registry-2afa43d8528037 |
...
For a systems engineer, @types/oauth2-server belongs in the Node.js/TypeScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.18 | 2024-09-25T09:08:28.455Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-2afa43d8528037` from `npm_registry` as `registry_expansion`
