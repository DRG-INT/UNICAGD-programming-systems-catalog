...
<!-- canonical: https://github.com/Kazhuu/asm2cfg -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Kazhuu/asm2cfg](https://github.com/Kazhuu/asm2cfg) |
| Source record ids | github_search_assembly-c45199bee95890 |

## System Engineer Summary

Python command-line tool and GDB extension to view and save x86, ARM and objdump assembly files as
control-flow graph (CFG) pdf files

## Operational Role

For a systems engineer, Kazhuu/asm2cfg belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-04-01T13:23:47Z | gh search repos topic:x86 topic:assembly | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-c45199bee95890` from `github_search_assembly` as `registry_expansion`
