...
<!-- canonical: https://cran.r-project.org/web/packages/Tplyr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/Tplyr/index.html](https://cran.r-project.org/web/packages/Tplyr/index.html) |
| Source record ids | cran_packages_by_date-f13df85ab32dc3 |
...
For a systems engineer, Tplyr belongs in the R inventory as part of hot-path discovery, allocation
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.1 | 2026-08-24 18:40:41 UTC | [https://cran.r-project.org/web/packages/Tplyr/DESCRIPTION](https://cran.r-project.org/web/packages/Tplyr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/Tplyr/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-f13df85ab32dc3` from `cran_packages_by_date` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| BKT | Profiler | [open](r-bkt-97415a9e.md) |
