...
<!-- canonical: https://hackage.haskell.org/package/http-date -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/http-date](https://hackage.haskell.org/package/http-date) |
| Source record ids | hackage_top_downloads-2229cbbb14d7fb |
...
For a systems engineer, http-date belongs in the Haskell inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.11 | 2021-02-24T05:09:46Z | [https://hackage.haskell.org/package/http-date](https://hackage.haskell.org/package/http-date) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/http-date` at `2026-09-12T00:29:22+00:00`.
...
- `hackage_top_downloads-2229cbbb14d7fb` from `hackage_top_downloads` as `registry_expansion`
