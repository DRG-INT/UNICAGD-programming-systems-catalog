...
<!-- canonical: https://pypi.org/project/aclib.autowin/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/aclib.autowin/](https://pypi.org/project/aclib.autowin/) |
| Source record ids | pypi_simple-d0c744b70bb5c5 |

## System Engineer Summary

aclib.autowin is tracked as a cli record in the Python branch. The source did not provide a long
...
For a systems engineer, aclib.autowin belongs in the Python inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.5.5 | 2026-06-18T15:01:30.310741Z | [https://pypi.org/pypi/aclib.autowin/json](https://pypi.org/pypi/aclib.autowin/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/aclib.autowin/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-d0c744b70bb5c5` from `pypi_simple` as `registry_expansion`
