# bg-utp-repository/devops-y-control-de-versiones-git
...
<!-- canonical: https://gitlab.com/bg-utp-repository/devops-y-control-de-versiones-git -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/bg-utp-repository/devops-y-control-de-versiones-git](https://gitlab.com/bg-utp-repository/devops-y-control-de-versiones-git) |
| Source record ids | gitlab_projects_api-6f882f514e5955 |

## System Engineer Summary

Repositorio para curso de git que forma parte del Programa Fomento al Talento Integral TIC BG-UTP

## Operational Role

For a systems engineer, bg-utp-repository/devops-y-control-de-versiones-git belongs in the
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-10-29T18:11:13.493Z | [https://gitlab.com/api/v4/projects?search=devops&order_by=star_count&sort=desc&simple=true&per_page=100](https://gitlab.com/api/v4/projects?search=devops&order_by=star_count&sort=desc&simple=true&per_page=100) | gitlab_projects_api_reports_activity_not_release_version |
...
- `gitlab_projects_api-6f882f514e5955` from `gitlab_projects_api` as `registry_expansion`
