...
| Canonical URL | [https://luarocks.org/modules/types/inspect-tl-type](https://luarocks.org/modules/types/inspect-tl-type) |
| Source record ids | luarocks_root_manifest-bd52b25dc816cf |

## System Engineer Summary

Teal type definition files for inspect

## Operational Role

For a systems engineer, inspect-tl-type belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-bd52b25dc816cf` from `luarocks_root_manifest` as `registry_expansion`
