...
<!-- canonical: https://cran.r-project.org/web/packages/RPIV/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/RPIV/index.html](https://cran.r-project.org/web/packages/RPIV/index.html) |
| Source record ids | cran_packages_by_date-6621353a07d330 |
...
For a systems engineer, RPIV belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.1 | 2026-09-04 12:00:25 UTC | [https://cran.r-project.org/web/packages/RPIV/DESCRIPTION](https://cran.r-project.org/web/packages/RPIV/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/RPIV/DESCRIPTION` at `2026-09-04T12:25:08+00:00`.
...
- `cran_packages_by_date-6621353a07d330` from `cran_packages_by_date` as `registry_expansion`
