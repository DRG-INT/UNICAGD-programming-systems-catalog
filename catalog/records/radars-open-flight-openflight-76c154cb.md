...
<!-- canonical: https://github.com/open-flight/openflight -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/open-flight/openflight](https://github.com/open-flight/openflight) |
| Source record ids | github_search_radars-e2c03bfca5044f |

## System Engineer Summary

open-flight/openflight is tracked as a library record in the Radars branch. The source did not
...
For a systems engineer, open-flight/openflight belongs in the Radars inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T14:37:23Z | gh search repos topic:radar stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-e2c03bfca5044f` from `github_search_radars` as `registry_expansion`
