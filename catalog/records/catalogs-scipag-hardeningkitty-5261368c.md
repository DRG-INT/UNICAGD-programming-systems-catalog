...
<!-- canonical: https://github.com/scipag/HardeningKitty -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/scipag/HardeningKitty](https://github.com/scipag/HardeningKitty) |
| Source record ids | github_search_catalogs-c39d8ec3d4d76c |
...
For a systems engineer, scipag/HardeningKitty belongs in the Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-21T05:09:20Z | gh search repos topic:registry stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-c39d8ec3d4d76c` from `github_search_catalogs` as `registry_expansion`
