...
<!-- canonical: https://cran.r-project.org/web/packages/LRTesteR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/LRTesteR/index.html](https://cran.r-project.org/web/packages/LRTesteR/index.html) |
| Source record ids | cran_packages_by_date-e170be38a55d32 |
...
For a systems engineer, LRTesteR belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2026-08-24 08:10:08 UTC | [https://cran.r-project.org/web/packages/LRTesteR/DESCRIPTION](https://cran.r-project.org/web/packages/LRTesteR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/LRTesteR/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-e170be38a55d32` from `cran_packages_by_date` as `registry_expansion`
