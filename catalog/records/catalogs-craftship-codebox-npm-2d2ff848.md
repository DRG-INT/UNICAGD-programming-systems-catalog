...
<!-- canonical: https://github.com/craftship/codebox-npm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/craftship/codebox-npm](https://github.com/craftship/codebox-npm) |
| Source record ids | github_search_catalogs-17f4f583771cfb |
...
For a systems engineer, craftship/codebox-npm belongs in the Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-04-14T04:02:40Z | gh search repos topic:registry stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-17f4f583771cfb` from `github_search_catalogs` as `registry_expansion`
