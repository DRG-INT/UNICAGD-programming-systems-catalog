...
<!-- canonical: https://packagist.org/packages/hprose/hprose -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/hprose/hprose](https://packagist.org/packages/hprose/hprose) |
| Source record ids | packagist_search-6b0618412c2f2f |

## System Engineer Summary

It is a modern, lightweight, cross-language, cross-platform, object-oriented, high performance,
remote dynamic communication middleware. It is not only easy to use, but powerful. You just need a
little time to learn, then you can use it to easily construct cross language cross platform
distributed application system.

## Operational Role

For a systems engineer, hprose/hprose belongs in the PHP inventory as part of ecosystem capability
...
- `packagist_search-6b0618412c2f2f` from `packagist_search` as `registry_expansion`
...
| vcian/laravel-db-auditor | Language Specification | [open](php-vcian-laravel-db-auditor-b65c99b5.md) |
