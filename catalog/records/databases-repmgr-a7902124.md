...
<!-- canonical: https://github.com/2ndQuadrant/repmgr -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/2ndQuadrant/repmgr](https://github.com/2ndQuadrant/repmgr) |
| Source record ids | awesome_list-7682a4734da453 |
...
For a systems engineer, repmgr belongs in the Databases inventory as part of request routing,
...
- `awesome_list-7682a4734da453` from `awesome_list` as `registry_expansion`
