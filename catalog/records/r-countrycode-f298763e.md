...
<!-- canonical: https://cran.r-project.org/web/packages/countrycode/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/countrycode/index.html](https://cran.r-project.org/web/packages/countrycode/index.html) |
| Source record ids | cran_packages_by_date-c33b8bedfe64c6 |
...
For a systems engineer, countrycode belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.9.0 | 2026-08-20 05:21:29 UTC | [https://cran.r-project.org/web/packages/countrycode/DESCRIPTION](https://cran.r-project.org/web/packages/countrycode/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/countrycode/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-c33b8bedfe64c6` from `cran_packages_by_date` as `registry_expansion`
