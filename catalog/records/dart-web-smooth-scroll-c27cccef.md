...
<!-- canonical: https://pub.dev/packages/web_smooth_scroll -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/web_smooth_scroll](https://pub.dev/packages/web_smooth_scroll) |
| Source record ids | pub_dev-aa9e10f9a3fbc2 |
...
For a systems engineer, web_smooth_scroll belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2025-02-08T09:34:23.704967Z | [https://pub.dev/api/packages/web_smooth_scroll](https://pub.dev/api/packages/web_smooth_scroll) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/web_smooth_scroll` at `2026-09-05T06:22:58+00:00`.
...
- `pub_dev-aa9e10f9a3fbc2` from `pub_dev` as `registry_expansion`
