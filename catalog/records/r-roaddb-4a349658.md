...
<!-- canonical: https://cran.r-project.org/web/packages/roadDB/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/roadDB/index.html](https://cran.r-project.org/web/packages/roadDB/index.html) |
| Source record ids | cran_packages_by_date-abfb533c35571f |
...
For a systems engineer, roadDB belongs in the R inventory as part of state persistence, migrations,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-08-25 11:00:07 UTC | [https://cran.r-project.org/web/packages/roadDB/DESCRIPTION](https://cran.r-project.org/web/packages/roadDB/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/roadDB/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-abfb533c35571f` from `cran_packages_by_date` as `registry_expansion`
