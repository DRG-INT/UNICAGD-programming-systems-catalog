...
<!-- canonical: https://cran.r-project.org/web/packages/bvars/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/bvars/index.html](https://cran.r-project.org/web/packages/bvars/index.html) |
| Source record ids | cran_packages_by_date-62c465a9f42484 |
...
For a systems engineer, bvars belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1 | 2026-09-07 09:00:07 UTC | [https://cran.r-project.org/web/packages/bvars/DESCRIPTION](https://cran.r-project.org/web/packages/bvars/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/bvars/DESCRIPTION` at `2026-09-07T10:20:49+00:00`.
...
- `cran_packages_by_date-62c465a9f42484` from `cran_packages_by_date` as `registry_expansion`
