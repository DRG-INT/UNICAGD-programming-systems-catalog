...
<!-- canonical: https://github.com/Project-OSRM/osrm-backend -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Project-OSRM/osrm-backend](https://github.com/Project-OSRM/osrm-backend) |
| Source record ids | github_search_maps-79f672b5dd4712 |
...
For a systems engineer, Project-OSRM/osrm-backend belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v26.8.0 | 2026-08-01T08:47:17Z | [https://api.github.com/repos/Project-OSRM/osrm-backend/releases/latest](https://api.github.com/repos/Project-OSRM/osrm-backend/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/Project-OSRM/osrm-backend/releases/latest` at `2026-09-01T12:30:04+00:00`.
...
- `github_search_maps-79f672b5dd4712` from `github_search_maps` as `registry_expansion`
