...
| Source record ids | curated_database_systems-7e1e95c7e7b3c1 |

## System Engineer Summary

Column-oriented analytical database management system.

## Operational Role

For a systems engineer, ClickHouse belongs in the Databases inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v26.6.4.55-stable | 2026-09-01T06:18:38Z | [https://api.github.com/repos/ClickHouse/ClickHouse/releases/latest](https://api.github.com/repos/ClickHouse/ClickHouse/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/ClickHouse/ClickHouse/releases/latest` at `2026-09-01T07:24:48+00:00`.
...
- `curated_database_systems-7e1e95c7e7b3c1` from `curated_database_systems` as `registry_expansion`
