...
| Canonical URL | [https://crates.io/crates/tempdir](https://crates.io/crates/tempdir) |
| Source record ids | crates_io-c910e64047ffda |
...
For a systems engineer, tempdir belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.7 | 2018-03-21T07:46:03.078845Z | [https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads) |  |
...
- `crates_io-c910e64047ffda` from `crates_io` as `registry_expansion`
