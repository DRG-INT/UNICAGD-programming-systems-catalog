...
<!-- canonical: https://github.com/CodeTips/BaiduNetdiskPlugin-macOS -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/CodeTips/BaiduNetdiskPlugin-macOS](https://github.com/CodeTips/BaiduNetdiskPlugin-macOS) |
| Source record ids | github_search_cocoa-3f5a40c8283d28 |
...
For a systems engineer, CodeTips/BaiduNetdiskPlugin-macOS belongs in the Cocoa inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-10-17T13:18:17Z | gh search repos language:Objective-C stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-3f5a40c8283d28` from `github_search_cocoa` as `registry_expansion`
