...
[Catalog index](../index.md) · [Language: Electromagnetoscopes](../by-language/electromagnetoscopes.md) · [Category: Math Numeric Scientific](../by-category/math-numeric-scientific.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/michal34512/Magnetometer-calibration -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/michal34512/Magnetometer-calibration](https://github.com/michal34512/Magnetometer-calibration) |
| Source record ids | github_search_electromagnetoscopes-c6fe87bd8015dd |
...
For a systems engineer, michal34512/Magnetometer-calibration belongs in the Electromagnetoscopes
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-04-16T07:19:59Z | gh search repos topic:magnetometer stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-c6fe87bd8015dd` from `github_search_electromagnetoscopes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Magpylib | Math Numeric Scientific | [open](electromagnetoscopes-magpylib-a6f89736.md) |
| mathertel/Radio | Math Numeric Scientific | [open](electromagnetoscopes-mathertel-radio-997c5d22.md) |
| openEMS | Math Numeric Scientific | [open](electromagnetoscopes-openems-b7a95a4d.md) |
