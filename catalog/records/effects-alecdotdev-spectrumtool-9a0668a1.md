# alecdotdev/SpectrumTool

## Navigation

[Catalog index](../index.md) · [Language: Effects](../by-language/effects.md) · [Category: Static Analyzer](../by-category/static-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/alecdotdev/SpectrumTool -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/alecdotdev/SpectrumTool](https://github.com/alecdotdev/SpectrumTool) |
| Source record ids | github_search_effects-013211c2ed6608 |
...
For a systems engineer, alecdotdev/SpectrumTool belongs in the Effects inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-02-28T10:00:57Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; Other; MIT License; https://api.github.com/licenses/mit |
...
- `github_search_effects-013211c2ed6608` from `github_search_effects` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| cool-japan/oxiaudio | Static Analyzer | [open](effects-cool-japan-oxiaudio-c3500955.md) |
| Cyanilux/URP_RetroCRTShader | Static Analyzer | [open](effects-cyanilux-urp-retrocrtshader-39700aa8.md) |
| DatanoiseTV/dsplab | Static Analyzer | [open](effects-datanoisetv-dsplab-010bab2b.md) |
| DonaldSBosley/MATLAB_DSP | Static Analyzer | [open](effects-donaldsbosley-matlab-dsp-d6ec5804.md) |
| EndlesslyFlowering/ReShade_HDR_shaders | Static Analyzer | [open](effects-endlesslyflowering-reshade-hdr-shaders-23b572c9.md) |
| glotzerlab/freud | Static Analyzer | [open](effects-glotzerlab-freud-7097000c.md) |
| josevcm/nfc-laboratory | Static Analyzer | [open](effects-josevcm-nfc-laboratory-b7b970c6.md) |
| JuanCantu1/fpga-trumpet-dsp | Static Analyzer | [open](effects-juancantu1-fpga-trumpet-dsp-dbfb90e2.md) |
