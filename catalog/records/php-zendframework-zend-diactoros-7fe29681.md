...
<!-- canonical: https://packagist.org/packages/zendframework/zend-diactoros -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/zendframework/zend-diactoros](https://packagist.org/packages/zendframework/zend-diactoros) |
| Source record ids | packagist_search-0358c05e6ab192 |
...
For a systems engineer, zendframework/zend-diactoros belongs in the PHP inventory as part of service
...
- `packagist_search-0358c05e6ab192` from `packagist_search` as `registry_expansion`
