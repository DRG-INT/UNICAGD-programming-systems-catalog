...
<!-- canonical: https://github.com/aiven/pglookout -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/aiven/pglookout](https://github.com/aiven/pglookout) |
| Source record ids | awesome_list-de6fc1d9cf19fb |
...
For a systems engineer, pglookout belongs in the Databases inventory as part of model pipelines,
...
- `awesome_list-de6fc1d9cf19fb` from `awesome_list` as `registry_expansion`
