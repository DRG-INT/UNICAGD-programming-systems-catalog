...
| Canonical URL | [https://luarocks.org/modules/jprjr/etf](https://luarocks.org/modules/jprjr/etf) |
| Source record ids | luarocks_root_manifest-abde805c23a8bf |
...
For a systems engineer, etf belongs in the Lua family inventory as part of low-noise code review,
...
- `luarocks_root_manifest-abde805c23a8bf` from `luarocks_root_manifest` as `registry_expansion`
