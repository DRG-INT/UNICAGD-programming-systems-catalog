...
| Canonical URL | [https://packagist.org/packages/crell/serde](https://packagist.org/packages/crell/serde) |
| Source record ids | packagist_search-583e4047c4e36c |
...
For a systems engineer, crell/serde belongs in the PHP inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.6.0 | 2026-06-23T16:00:17+00:00 | [https://repo.packagist.org/p2/crell/serde.json](https://repo.packagist.org/p2/crell/serde.json) |  |
...
- Latest stable metadata was observed from `https://repo.packagist.org/p2/crell/serde.json` at `2026-09-01T07:20:24+00:00`.
...
- `packagist_search-583e4047c4e36c` from `packagist_search` as `registry_expansion`
