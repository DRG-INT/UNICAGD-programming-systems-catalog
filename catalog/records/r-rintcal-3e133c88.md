...
<!-- canonical: https://cran.r-project.org/web/packages/rintcal/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rintcal/index.html](https://cran.r-project.org/web/packages/rintcal/index.html) |
| Source record ids | cran_packages_by_date-16d334a982c446 |
...
For a systems engineer, rintcal belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.2 | 2026-09-08 05:20:07 UTC | [https://cran.r-project.org/web/packages/rintcal/DESCRIPTION](https://cran.r-project.org/web/packages/rintcal/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rintcal/DESCRIPTION` at `2026-09-08T06:25:48+00:00`.
...
- `cran_packages_by_date-16d334a982c446` from `cran_packages_by_date` as `registry_expansion`
