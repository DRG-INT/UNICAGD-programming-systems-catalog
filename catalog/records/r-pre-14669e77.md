...
<!-- canonical: https://cran.r-project.org/web/packages/pre/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/pre/index.html](https://cran.r-project.org/web/packages/pre/index.html) |
| Source record ids | cran_packages_by_date-40e182c2b5e2c1 |
...
For a systems engineer, pre belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-08-31 22:10:06 UTC | [https://cran.r-project.org/web/packages/pre/DESCRIPTION](https://cran.r-project.org/web/packages/pre/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/pre/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-40e182c2b5e2c1` from `cran_packages_by_date` as `registry_expansion`
