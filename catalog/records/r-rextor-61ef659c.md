...
<!-- canonical: https://cran.r-project.org/web/packages/rextor/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rextor/index.html](https://cran.r-project.org/web/packages/rextor/index.html) |
| Source record ids | cran_packages_by_date-6c4972884c66d2 |

## System Engineer Summary

rextor is tracked as a library record in the R branch. The source did not provide a long
...
For a systems engineer, rextor belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.0 | 2026-09-10 15:30:10 UTC | [https://cran.r-project.org/web/packages/rextor/DESCRIPTION](https://cran.r-project.org/web/packages/rextor/DESCRIPTION) |  |
...
| Evidence | GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; MIT License; https://api.github.com/licenses/mit; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rextor/DESCRIPTION` at `2026-09-10T17:19:15+00:00`.
...
- `cran_packages_by_date-6c4972884c66d2` from `cran_packages_by_date` as `registry_expansion`
