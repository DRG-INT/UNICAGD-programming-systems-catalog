...
<!-- canonical: https://cran.r-project.org/web/packages/climatekit/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/climatekit/index.html](https://cran.r-project.org/web/packages/climatekit/index.html) |
| Source record ids | cran_packages_by_date-27cc8e195cd7ce |
...
For a systems engineer, climatekit belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.2 | 2026-09-09 08:30:11 UTC | [https://cran.r-project.org/web/packages/climatekit/DESCRIPTION](https://cran.r-project.org/web/packages/climatekit/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/climatekit/DESCRIPTION` at `2026-09-09T10:21:05+00:00`.
...
- `cran_packages_by_date-27cc8e195cd7ce` from `cran_packages_by_date` as `registry_expansion`
