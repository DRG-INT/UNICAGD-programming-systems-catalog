...
<!-- canonical: https://github.com/cuebook/cuelake -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cuebook/cuelake](https://github.com/cuebook/cuelake) |
| Source record ids | github_search_databases-a439dea0b1884c |
...
For a systems engineer, cuebook/cuelake belongs in the Databases inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-05-25T20:49:32Z | gh search repos topic:data-lake stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-a439dea0b1884c` from `github_search_databases` as `registry_expansion`
...
| HariSekhon/DevOps-Bash-tools | Build System | [open](databases-harisekhon-devops-bash-tools-bd29d37f.md) |
