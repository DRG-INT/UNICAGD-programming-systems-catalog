...
| Canonical URL | [https://github.com/ngageoint/sarpy](https://github.com/ngageoint/sarpy) |
| Source record ids | curated_language_routes-546e54debc3f75 |

## System Engineer Summary

Python library for reading, writing, and processing synthetic-aperture radar data formats.

## Operational Role

For a systems engineer, sarpy belongs in the Radars inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.1.1 | 2026-08-23T15:37:45Z | [https://api.github.com/repos/ngageoint/sarpy/releases/latest](https://api.github.com/repos/ngageoint/sarpy/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/ngageoint/sarpy/releases/latest` at `2026-09-01T07:24:46+00:00`.
...
- `curated_language_routes-546e54debc3f75` from `curated_language_routes` as `registry_expansion`
