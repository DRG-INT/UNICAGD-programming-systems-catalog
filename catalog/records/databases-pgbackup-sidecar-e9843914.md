...
<!-- canonical: https://github.com/Musab520/pgbackup-sidecar -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Musab520/pgbackup-sidecar](https://github.com/Musab520/pgbackup-sidecar) |
| Source record ids | awesome_list-f652ffd77c6c63 |

## System Engineer Summary

`pgbackup-sidecar` is a lightweight Docker sidecar container designed to automate regular backups of
a PostgreSQL database using `pg_dump`, `cron`, and bash scripts while also sending output to a
webhook.

## Operational Role

For a systems engineer, pgbackup-sidecar belongs in the Databases inventory as part of ecosystem
...
- `awesome_list-f652ffd77c6c63` from `awesome_list` as `registry_expansion`
...
| DBConvert Streams | Ide Editor Integration | [open](databases-dbconvert-streams-c7b82bda.md) |
| dbForge Edge | Ide Editor Integration | [open](databases-dbforge-edge-707600a6.md) |
| dzharii/awesome-elasticsearch | Ide Editor Integration | [open](databases-dzharii-awesome-elasticsearch-81171c8b.md) |
| facebook/rocksdb | Ide Editor Integration | [open](databases-facebook-rocksdb-a5b51900.md) |
| MariaDB/server | Ide Editor Integration | [open](databases-mariadb-server-574f45f3.md) |
