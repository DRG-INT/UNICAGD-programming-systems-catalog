...
| Canonical URL | [https://crates.io/crates/type-map](https://crates.io/crates/type-map) |
| Source record ids | crates_io-5bfe47c700bbd1 |
...
For a systems engineer, type-map belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.1 | 2025-05-22T12:32:51.654590Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
...
- `crates_io-5bfe47c700bbd1` from `crates_io` as `registry_expansion`
