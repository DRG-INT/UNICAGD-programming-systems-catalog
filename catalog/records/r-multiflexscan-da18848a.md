...
<!-- canonical: https://cran.r-project.org/web/packages/multiflexscan/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/multiflexscan/index.html](https://cran.r-project.org/web/packages/multiflexscan/index.html) |
| Source record ids | cran_packages_by_date-9fd0182161b54d |
...
For a systems engineer, multiflexscan belongs in the R inventory as part of defect discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-09-14 07:40:31 UTC | [https://cran.r-project.org/web/packages/multiflexscan/DESCRIPTION](https://cran.r-project.org/web/packages/multiflexscan/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/multiflexscan/DESCRIPTION` at `2026-09-14T08:22:23+00:00`.
...
- `cran_packages_by_date-9fd0182161b54d` from `cran_packages_by_date` as `registry_expansion`
