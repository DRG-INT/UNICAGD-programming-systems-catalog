...
<!-- canonical: https://cran.r-project.org/web/packages/bscm/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/bscm/index.html](https://cran.r-project.org/web/packages/bscm/index.html) |
| Source record ids | cran_packages_by_date-4b63f4b67a2651 |
...
For a systems engineer, bscm belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-08-09 06:40:02 UTC | [https://cran.r-project.org/web/packages/bscm/DESCRIPTION](https://cran.r-project.org/web/packages/bscm/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/bscm/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-4b63f4b67a2651` from `cran_packages_by_date` as `registry_expansion`
