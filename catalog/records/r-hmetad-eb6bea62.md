...
<!-- canonical: https://cran.r-project.org/web/packages/hmetad/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/hmetad/index.html](https://cran.r-project.org/web/packages/hmetad/index.html) |
| Source record ids | cran_packages_by_date-dcca0d997c4ac9 |
...
For a systems engineer, hmetad belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-08-21 05:42:50 UTC | [https://cran.r-project.org/web/packages/hmetad/DESCRIPTION](https://cran.r-project.org/web/packages/hmetad/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/hmetad/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-dcca0d997c4ac9` from `cran_packages_by_date` as `registry_expansion`
