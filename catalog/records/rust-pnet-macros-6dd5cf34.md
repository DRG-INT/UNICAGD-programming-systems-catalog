...
| Canonical URL | [https://crates.io/crates/pnet_macros](https://crates.io/crates/pnet_macros) |
| Source record ids | crates_io-cba6ea2917aa98 |
...
For a systems engineer, pnet_macros belongs in the Rust inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.35.0 | 2024-05-30T17:52:40.449340Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
...
- `crates_io-cba6ea2917aa98` from `crates_io` as `registry_expansion`
