...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Node.js/JavaScript](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/node-js-javascript.md) · [Category: Parser Lexer Ast](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/parser-lexer-ast.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://www.npmjs.com/package/@percy/cli-command](https://www.npmjs.com/package/@percy/cli-command) |
| Source record ids | npm_registry-30358293449d0b |
...
For a systems engineer, @percy/cli-command belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.32.7 | 2026-08-20T12:28:38.816Z | [https://registry.npmjs.org/-/v1/search?text=cli&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=cli&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
| Name | Category | Page |
| --- | --- | --- |
| @achingbrain/http-parser-js | Parser Lexer Ast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-achingbrain-http-parser-js-8505e6ab.md) |
| @contrast/logger | Parser Lexer Ast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-contrast-logger-a68ffedd.md) |
| @elastic/ecs-helpers | Parser Lexer Ast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-elastic-ecs-helpers-8d648081.md) |
| @expressots/cli | Parser Lexer Ast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-expressots-cli-4d128df9.md) |
| @fastify/forwarded | Parser Lexer Ast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-fastify-forwarded-03d42012.md) |
| @fastify/http-proxy | Parser Lexer Ast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-fastify-http-proxy-a9bfdde1.md) |
| @faststore/cli | Parser Lexer Ast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-faststore-cli-98f71262.md) |
| @middy/http-json-body-parser | Parser Lexer Ast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/node-js-javascript-middy-http-json-body-parser-654d90bf.md) |
