...
<!-- canonical: https://github.com/DSPKM/DSPKM -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/DSPKM/DSPKM](https://github.com/DSPKM/DSPKM) |
| Source record ids | github_search_matlab-686104f0297982 |
...
For a systems engineer, DSPKM/DSPKM belongs in the Matlab inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2017-06-22T12:39:39Z | gh search repos language:MATLAB topic:machine-learning | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-686104f0297982` from `github_search_matlab` as `registry_expansion`
