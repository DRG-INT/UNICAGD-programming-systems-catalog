...
<!-- canonical: https://github.com/ahujasid/blender-mcp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ahujasid/blender-mcp](https://github.com/ahujasid/blender-mcp) |
| Source record ids | github_search_aims-0710f848ce9f7b |
...
For a systems engineer, ahujasid/blender-mcp belongs in the "aim's" inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-05T04:44:40Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-0710f848ce9f7b` from `github_search_aims` as `registry_expansion`
