...
[Catalog index](../index.md) · [Language: Swift](../by-language/swift.md) · [Category: Precommit Ci Quality](../by-category/precommit-ci-quality.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/ochococo/Design-Patterns-In-Swift -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ochococo/Design-Patterns-In-Swift](https://github.com/ochococo/Design-Patterns-In-Swift) |
| Source record ids | github_search_swift-b1152c0970585e |
...
For a systems engineer, ochococo/Design-Patterns-In-Swift belongs in the Swift inventory as part of
...
- `github_search_swift-b1152c0970585e` from `github_search_swift` as `registry_expansion`
