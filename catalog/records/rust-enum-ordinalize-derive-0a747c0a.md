...
<!-- canonical: https://crates.io/crates/enum-ordinalize-derive -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/enum-ordinalize-derive](https://crates.io/crates/enum-ordinalize-derive) |
| Source record ids | crates_io-e32cd54f00b00c |

## System Engineer Summary

This crate provides a procedural macro that enables enums to not only obtain the ordinal values of
their variants but also allows for the construction of enums from an ordinal value.

## Operational Role

For a systems engineer, enum-ordinalize-derive belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.4.2 | 2026-08-01T03:09:18.297565Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
- `crates_io-e32cd54f00b00c` from `crates_io` as `registry_expansion`
