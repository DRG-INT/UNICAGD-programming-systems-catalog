...
<!-- canonical: https://cran.r-project.org/web/packages/ramps/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ramps/index.html](https://cran.r-project.org/web/packages/ramps/index.html) |
| Source record ids | cran_packages_by_date-f0aa83d8698c2c |
...
For a systems engineer, ramps belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.19 | 2026-08-21 05:40:49 UTC | [https://cran.r-project.org/web/packages/ramps/DESCRIPTION](https://cran.r-project.org/web/packages/ramps/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ramps/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-f0aa83d8698c2c` from `cran_packages_by_date` as `registry_expansion`
