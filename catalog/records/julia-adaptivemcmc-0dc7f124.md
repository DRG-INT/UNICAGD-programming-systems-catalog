...
| Evidence | GNU GENERAL PUBLIC LICENSEVersion 3, 29 June 2007; License :: OSI Approved :: GNU Lesser General Public License v3 (LGPLv3); License :: Other/Proprietary License |
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "A/AdaptiveMCMC", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-9dc538c4ae8100` from `julia_general` as `registry_expansion`
