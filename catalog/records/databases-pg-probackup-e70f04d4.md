...
[Catalog index](../index.md) · [Language: Databases](../by-language/databases.md) · [Category: Concurrency Parallelism](../by-category/concurrency-parallelism.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/postgrespro/pg_probackup -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/postgrespro/pg_probackup](https://github.com/postgrespro/pg_probackup) |
| Source record ids | awesome_list-2dfcd708d6d1b3 |

## System Engineer Summary

– A fork of pg\_arman, improved by @PostgresPro, supports incremental backups, backups from replica,
multithreaded backup and restore, and anonymous backup without archive command.

## Operational Role

For a systems engineer, pg\_probackup belongs in the Databases inventory as part of ecosystem
...
- `awesome_list-2dfcd708d6d1b3` from `awesome_list` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| apache/cloudberry | Concurrency Parallelism | [open](databases-apache-cloudberry-5e9a8481.md) |
| dingodb/dingo | Concurrency Parallelism | [open](databases-dingodb-dingo-78d057f3.md) |
| Pometry/Raphtory | Concurrency Parallelism | [open](databases-pometry-raphtory-3352e434.md) |
| sogou/workflow | Concurrency Parallelism | [open](databases-sogou-workflow-93ca580b.md) |
