...
<!-- canonical: https://cran.r-project.org/web/packages/QuickJSR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/QuickJSR/index.html](https://cran.r-project.org/web/packages/QuickJSR/index.html) |
| Source record ids | cran_packages_by_date-667ac313bad182 |
...
For a systems engineer, QuickJSR belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.11.0 | 2026-08-21 22:01:33 UTC | [https://cran.r-project.org/web/packages/QuickJSR/DESCRIPTION](https://cran.r-project.org/web/packages/QuickJSR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/QuickJSR/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-667ac313bad182` from `cran_packages_by_date` as `registry_expansion`
