...
<!-- canonical: https://github.com/crmne/spotifast -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/crmne/spotifast](https://github.com/crmne/spotifast) |
| Source record ids | github_search_audio-4fdd546253208b |

## System Engineer Summary

Spotify, native and fast. One lightweight Rust app for your whole library, local playback, and
Spotify Connect on Linux, macOS, and Windows.

## Operational Role

For a systems engineer, crmne/spotifast belongs in the Audio inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-14T22:34:53Z | gh search repos topic:audio stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-4fdd546253208b` from `github_search_audio` as `registry_expansion`
