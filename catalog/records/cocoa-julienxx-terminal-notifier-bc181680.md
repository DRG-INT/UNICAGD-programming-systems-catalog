...
<!-- canonical: https://github.com/julienXX/terminal-notifier -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/julienXX/terminal-notifier](https://github.com/julienXX/terminal-notifier) |
| Source record ids | github_search_cocoa-e57748e3161587 |
...
For a systems engineer, julienXX/terminal-notifier belongs in the Cocoa inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-30T13:06:54Z | gh search repos language:Objective-C stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-e57748e3161587` from `github_search_cocoa` as `registry_expansion`
