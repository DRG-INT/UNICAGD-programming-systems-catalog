...
<!-- canonical: https://packagist.org/packages/workerman/redis-queue -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/workerman/redis-queue](https://packagist.org/packages/workerman/redis-queue) |
| Source record ids | packagist_search-4adf2a14d1b20a |
...
For a systems engineer, workerman/redis-queue belongs in the PHP inventory as part of state
...
- `packagist_search-4adf2a14d1b20a` from `packagist_search` as `registry_expansion`
