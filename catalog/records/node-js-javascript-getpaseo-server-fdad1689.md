...
<!-- canonical: https://www.npmjs.com/package/@getpaseo/server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@getpaseo/server](https://www.npmjs.com/package/@getpaseo/server) |
| Source record ids | npm_registry-7886e4b667562a |

## System Engineer Summary

@getpaseo/server is tracked as a web framework record in the Node.js/JavaScript branch. The source
...
For a systems engineer, @getpaseo/server belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.7.2 | 2026-09-02T00:10:54.602Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-7886e4b667562a` from `npm_registry` as `registry_expansion`
