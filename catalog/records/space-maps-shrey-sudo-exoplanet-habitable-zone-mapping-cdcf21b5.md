# shrey-sudo/Exoplanet-Habitable-Zone-Mapping
...
<!-- canonical: https://github.com/shrey-sudo/Exoplanet-Habitable-Zone-Mapping -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/shrey-sudo/Exoplanet-Habitable-Zone-Mapping](https://github.com/shrey-sudo/Exoplanet-Habitable-Zone-Mapping) |
| Source record ids | github_search_space_maps-2bc72ecb6bab31 |

## System Engineer Summary

A Python project to map and visualize habitable zones around stars based on user input and known
planetary data.

## Operational Role

For a systems engineer, shrey-sudo/Exoplanet-Habitable-Zone-Mapping belongs in the Space Maps
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-05-06T19:15:38Z | gh search repos planetary maps | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-2bc72ecb6bab31` from `github_search_space_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| kjnapier/spacerocks | Api Abi Checker | [open](space-maps-kjnapier-spacerocks-5b53cf7c.md) |
