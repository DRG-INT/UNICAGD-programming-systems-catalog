...
<!-- canonical: https://cran.r-project.org/web/packages/lame/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/lame/index.html](https://cran.r-project.org/web/packages/lame/index.html) |
| Source record ids | cran_packages_by_date-6de4013140a6e5 |
...
For a systems engineer, lame belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.4 | 2026-08-04 15:10:03 UTC | [https://cran.r-project.org/web/packages/lame/DESCRIPTION](https://cran.r-project.org/web/packages/lame/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/lame/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-6de4013140a6e5` from `cran_packages_by_date` as `registry_expansion`
