...
<!-- canonical: https://www.nuget.org/packages/Microsoft.IdentityModel.JsonWebTokens -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Microsoft.IdentityModel.JsonWebTokens](https://www.nuget.org/packages/Microsoft.IdentityModel.JsonWebTokens) |
| Source record ids | nuget_search-9f599ed3e834dc |

## System Engineer Summary

Includes types that provide support for creating, serializing and validating JSON Web Tokens. This
is a newer, faster version of System.IdentityModel.Tokens.Jwt that has additional functionality.

## Operational Role

For a systems engineer, Microsoft.IdentityModel.JsonWebTokens belongs in the C-Sharp inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 8.22.0 | 2026-07-29T10:21:09.73+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/microsoft.identitymodel.jsonwebtokens/index.json](https://api.nuget.org/v3/registration5-gz-semver2/microsoft.identitymodel.jsonwebtokens/index.json) |  |
| preview | known | 8.0.0-preview1 | 2024-06-19T14:54:29.223+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/microsoft.identitymodel.jsonwebtokens/index.json](https://api.nuget.org/v3/registration5-gz-semver2/microsoft.identitymodel.jsonwebtokens/index.json) |  |
...
| --- | --- |
| Detected family | MIT |
| Evidence | {"key": "", "name": "", "url": ""}; MIT; https://www.nuget.org/packages/Microsoft.IdentityModel.JsonWebTokens/8.22.0/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/microsoft.identitymodel.jsonwebtokens/index.json` at `2026-09-01T07:23:58+00:00`.
...
- `nuget_search-9f599ed3e834dc` from `nuget_search` as `registry_expansion`
