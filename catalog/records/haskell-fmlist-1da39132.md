...
<!-- canonical: https://hackage.haskell.org/package/fmlist -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/fmlist](https://hackage.haskell.org/package/fmlist) |
| Source record ids | hackage_top_downloads-8100f45356933a |
...
For a systems engineer, fmlist belongs in the Haskell inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.5 | 2026-06-25T12:53:19Z | [https://hackage.haskell.org/package/fmlist](https://hackage.haskell.org/package/fmlist) |  |
| candidate | partial | 0.9.2 |  | [https://hackage.haskell.org/package/fmlist](https://hackage.haskell.org/package/fmlist) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/fmlist` at `2026-09-01T14:24:15+00:00`.
...
- `hackage_top_downloads-8100f45356933a` from `hackage_top_downloads` as `registry_expansion`
