...
<!-- canonical: https://cran.r-project.org/web/packages/NHSRdatasets/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/NHSRdatasets/index.html](https://cran.r-project.org/web/packages/NHSRdatasets/index.html) |
| Source record ids | cran_packages_by_date-b1e7cddd4c2a07 |
...
For a systems engineer, NHSRdatasets belongs in the R inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2026-09-08 17:50:13 UTC | [https://cran.r-project.org/web/packages/NHSRdatasets/DESCRIPTION](https://cran.r-project.org/web/packages/NHSRdatasets/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/NHSRdatasets/DESCRIPTION` at `2026-09-08T18:23:46+00:00`.
...
- `cran_packages_by_date-b1e7cddd4c2a07` from `cran_packages_by_date` as `registry_expansion`
