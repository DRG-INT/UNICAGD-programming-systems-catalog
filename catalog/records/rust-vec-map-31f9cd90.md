...
<!-- canonical: https://crates.io/crates/vec_map -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/vec_map](https://crates.io/crates/vec_map) |
| Source record ids | crates_io-6de66221015db1 |
...
For a systems engineer, vec_map belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.2 | 2020-05-06T13:38:10.140555Z | [https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=6&per_page=100&sort=downloads) |  |
...
- `crates_io-6de66221015db1` from `crates_io` as `registry_expansion`
