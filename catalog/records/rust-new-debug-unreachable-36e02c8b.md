...
| Name | Category | Page |
| --- | --- | --- |
| debugid | Debugger | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-debugid-9261fd14.md) |
| more-asserts | Debugger | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-more-asserts-547082fd.md) |
| opaque-debug | Debugger | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-opaque-debug-788ae81c.md) |
| sentry-debug-images | Debugger | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-sentry-debug-images-c8d7d11e.md) |
| sval_fmt | Debugger | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/rust-sval-fmt-a722981f.md) |
