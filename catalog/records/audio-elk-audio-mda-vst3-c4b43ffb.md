...
<!-- canonical: https://github.com/elk-audio/mda-vst3 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/elk-audio/mda-vst3](https://github.com/elk-audio/mda-vst3) |
| Source record ids | github_search_audio-eddadb52294cd2 |

## System Engineer Summary

MDA plugins in VST 3 format, adapted from Steinberg's VST 3 SDK examples

## Operational Role

For a systems engineer, elk-audio/mda-vst3 belongs in the Audio inventory as part of low-noise code
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-11-14T09:26:47Z | gh search repos topic:audio-plugin stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-eddadb52294cd2` from `github_search_audio` as `registry_expansion`
