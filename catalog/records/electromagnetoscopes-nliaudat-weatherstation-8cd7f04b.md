...
<!-- canonical: https://github.com/nliaudat/weatherstation -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nliaudat/weatherstation](https://github.com/nliaudat/weatherstation) |
| Source record ids | github_search_electromagnetoscopes-e1cc9b24c9840f |
...
For a systems engineer, nliaudat/weatherstation belongs in the Electromagnetoscopes inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-11-09T06:51:20Z | gh search repos topic:magnetometer stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-e1cc9b24c9840f` from `github_search_electromagnetoscopes` as `registry_expansion`
