...
<!-- canonical: https://crates.io/crates/local-waker -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/local-waker](https://crates.io/crates/local-waker) |
| Source record ids | crates_io-3710e2b469b87d |
...
For a systems engineer, local-waker belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.4 | 2023-10-29T23:18:39.529257Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- `crates_io-3710e2b469b87d` from `crates_io` as `registry_expansion`
