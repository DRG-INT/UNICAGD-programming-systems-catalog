...
<!-- canonical: https://hackage.haskell.org/package/aivika-experiment-chart -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/aivika-experiment-chart](https://hackage.haskell.org/package/aivika-experiment-chart) |
| Source record ids | hackage_top_downloads-b29c8ff3a6d355 |
...
For a systems engineer, aivika-experiment-chart belongs in the Haskell inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.4.1 | 2023-10-14T12:03:42Z | [https://hackage.haskell.org/package/aivika-experiment-chart](https://hackage.haskell.org/package/aivika-experiment-chart) |  |
| candidate | partial | 1.0 |  | [https://hackage.haskell.org/package/aivika-experiment-chart](https://hackage.haskell.org/package/aivika-experiment-chart) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/aivika-experiment-chart` at `2026-09-01T14:24:04+00:00`.
...
- `hackage_top_downloads-b29c8ff3a6d355` from `hackage_top_downloads` as `registry_expansion`
