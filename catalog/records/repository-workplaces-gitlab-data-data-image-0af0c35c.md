...
<!-- canonical: https://gitlab.com/gitlab-data/data-image -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/gitlab-data/data-image](https://gitlab.com/gitlab-data/data-image) |
| Source record ids | gitlab_projects_api-ca385a203cbda6 |
...
For a systems engineer, gitlab-data/data-image belongs in the Repository Workplaces inventory as
...
- `gitlab_projects_api-ca385a203cbda6` from `gitlab_projects_api` as `registry_expansion`
