...
<!-- canonical: https://packagist.org/packages/playwright-php/playwright -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/playwright-php/playwright](https://packagist.org/packages/playwright-php/playwright) |
| Source record ids | packagist_search-2a0d20f1e447cd |
...
For a systems engineer, playwright-php/playwright belongs in the PHP inventory as part of
...
- `packagist_search-2a0d20f1e447cd` from `packagist_search` as `registry_expansion`
