...
<!-- canonical: https://hackage.haskell.org/package/syb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/syb](https://hackage.haskell.org/package/syb) |
| Source record ids | hackage_top_downloads-50acd7a199487d |
...
For a systems engineer, syb belongs in the Haskell inventory as part of ecosystem capability
...
- `hackage_top_downloads-50acd7a199487d` from `hackage_top_downloads` as `registry_expansion`
