...
<!-- canonical: https://hackage.haskell.org/package/servant-ede -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/servant-ede](https://hackage.haskell.org/package/servant-ede) |
| Source record ids | hackage_recent-caaad4e7e9d8e0 |

## System Engineer Summary

Hackage package recently uploaded by isovector.

## Operational Role

For a systems engineer, servant-ede belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0.0 | 2026-09-02T19:18:40Z | [https://hackage.haskell.org/package/servant-ede](https://hackage.haskell.org/package/servant-ede) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/servant-ede` at `2026-09-03T16:25:12+00:00`.
...
- `hackage_recent-caaad4e7e9d8e0` from `hackage_recent` as `registry_expansion`
