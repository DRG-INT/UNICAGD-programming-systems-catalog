...
<!-- canonical: https://github.com/dan-k-k/vocal-gate -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dan-k-k/vocal-gate](https://github.com/dan-k-k/vocal-gate) |
| Source record ids | github_search_audio-d826f29e56d3e0 |

## System Engineer Summary

Free real-time AI Noise Gate VST3/AU plugin. Removes coughs, sneezes, and other artifacts from your
live streams, podcasts, and videos.

## Operational Role

For a systems engineer, dan-k-k/vocal-gate belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-05T12:35:55Z | gh search repos topic:audio-plugin stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-d826f29e56d3e0` from `github_search_audio` as `registry_expansion`
