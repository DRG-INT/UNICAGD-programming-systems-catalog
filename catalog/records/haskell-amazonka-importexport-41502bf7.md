...
<!-- canonical: https://hackage.haskell.org/package/amazonka-importexport -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/amazonka-importexport](https://hackage.haskell.org/package/amazonka-importexport) |
| Source record ids | hackage_top_downloads-826db0f963d92f |
...
For a systems engineer, amazonka-importexport belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0 | 2023-07-27T21:36:57Z | [https://hackage.haskell.org/package/amazonka-importexport](https://hackage.haskell.org/package/amazonka-importexport) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/amazonka-importexport` at `2026-09-01T14:24:05+00:00`.
...
- `hackage_top_downloads-826db0f963d92f` from `hackage_top_downloads` as `registry_expansion`
