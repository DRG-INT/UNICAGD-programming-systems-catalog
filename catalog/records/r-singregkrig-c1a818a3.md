...
<!-- canonical: https://cran.r-project.org/web/packages/SingRegKrig/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/SingRegKrig/index.html](https://cran.r-project.org/web/packages/SingRegKrig/index.html) |
| Source record ids | cran_packages_by_date-dcc9e9f2aa21ca |
...
For a systems engineer, SingRegKrig belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-08 12:30:18 UTC | [https://cran.r-project.org/web/packages/SingRegKrig/DESCRIPTION](https://cran.r-project.org/web/packages/SingRegKrig/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/SingRegKrig/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-dcc9e9f2aa21ca` from `cran_packages_by_date` as `registry_expansion`
