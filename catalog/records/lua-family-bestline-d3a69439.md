...
<!-- canonical: https://luarocks.org/modules/leandrovital/bestline -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/leandrovital/bestline](https://luarocks.org/modules/leandrovital/bestline) |
| Source record ids | luarocks_root_manifest-6fa61eeb19e6bc |

## System Engineer Summary

Lua binding for the Bestline command line editing library

## Operational Role

For a systems engineer, bestline belongs in the Lua family inventory as part of cross-language
...
- `luarocks_root_manifest-6fa61eeb19e6bc` from `luarocks_root_manifest` as `registry_expansion`
