...
<!-- canonical: https://cran.r-project.org/web/packages/MineSDG/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/MineSDG/index.html](https://cran.r-project.org/web/packages/MineSDG/index.html) |
| Source record ids | cran_packages_by_date-e07a036bca8f10 |

## System Engineer Summary

Mining Industry SDG Impact Calculator

## Operational Role

For a systems engineer, MineSDG belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0 | 2026-08-07 17:20:21 UTC | [https://cran.r-project.org/web/packages/MineSDG/DESCRIPTION](https://cran.r-project.org/web/packages/MineSDG/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/MineSDG/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-e07a036bca8f10` from `cran_packages_by_date` as `registry_expansion`
