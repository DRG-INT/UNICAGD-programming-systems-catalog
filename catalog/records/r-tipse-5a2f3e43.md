...
<!-- canonical: https://cran.r-project.org/web/packages/tipse/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/tipse/index.html](https://cran.r-project.org/web/packages/tipse/index.html) |
| Source record ids | cran_packages_by_date-a1cf4bc2dbb912 |
...
For a systems engineer, tipse belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1 | 2026-08-21 09:20:02 UTC | [https://cran.r-project.org/web/packages/tipse/DESCRIPTION](https://cran.r-project.org/web/packages/tipse/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/tipse/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-a1cf4bc2dbb912` from `cran_packages_by_date` as `registry_expansion`
