...
<!-- canonical: https://github.com/ryukinix/audio-effects-matlab -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ryukinix/audio-effects-matlab](https://github.com/ryukinix/audio-effects-matlab) |
| Source record ids | github_search_effects-73391338bde4c7 |

## System Engineer Summary

A set of audio effects for audio processing: delay, flanger and distortion. Project of a college
course.

## Operational Role

For a systems engineer, ryukinix/audio-effects-matlab belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-02-05T02:09:51Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-73391338bde4c7` from `github_search_effects` as `registry_expansion`
