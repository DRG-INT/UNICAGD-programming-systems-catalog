...
| Canonical URL | [https://github.com/OpenBMB/VoxCPM](https://github.com/OpenBMB/VoxCPM) |
| Source record ids | github_search_audio-2db499cab622a2 |

## System Engineer Summary

VoxCPM2: Tokenizer-Free TTS for Multilingual Speech Generation, Creative Voice Design, and True-to-
Life Cloning

## Operational Role

For a systems engineer, OpenBMB/VoxCPM belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.3 | 2026-05-11T11:59:20Z | [https://api.github.com/repos/OpenBMB/VoxCPM/releases/latest](https://api.github.com/repos/OpenBMB/VoxCPM/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/OpenBMB/VoxCPM/releases/latest` at `2026-09-01T09:23:19+00:00`.
...
- `github_search_audio-2db499cab622a2` from `github_search_audio` as `registry_expansion`
