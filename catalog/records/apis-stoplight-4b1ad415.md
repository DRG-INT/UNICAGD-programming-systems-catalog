...
[Catalog index](../index.md) · [Language: APIs](../by-language/apis.md) · [Category: Api Doc Generator](../by-category/api-doc-generator.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://stoplight.io/open-source -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://stoplight.io/open-source](https://stoplight.io/open-source) |
| Source record ids | curated_language_routes-a3e9a09439e6e6 |

## System Engineer Summary

API design, governance, documentation, mocking, and style-guide ecosystem.

## Operational Role

For a systems engineer, Stoplight belongs in the APIs inventory as part of ecosystem capability
...
- `curated_language_routes-a3e9a09439e6e6` from `curated_language_routes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Swagger Editor | Api Doc Generator | [open](apis-swagger-editor-9b4bec6c.md) |
| Swagger UI | Api Doc Generator | [open](apis-swagger-ui-87903bfc.md) |
