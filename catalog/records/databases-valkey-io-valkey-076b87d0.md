...
<!-- canonical: https://github.com/valkey-io/valkey -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/valkey-io/valkey](https://github.com/valkey-io/valkey) |
| Source record ids | github_search_databases-dafdc74080fdc1 |

## System Engineer Summary

A flexible distributed key-value database that is optimized for caching and other realtime
workloads.

## Operational Role

For a systems engineer, valkey-io/valkey belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-07T02:26:59Z | gh search repos topic:database stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-dafdc74080fdc1` from `github_search_databases` as `registry_expansion`
