...
<!-- canonical: https://www.npmjs.com/package/oauth2-mock-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/oauth2-mock-server](https://www.npmjs.com/package/oauth2-mock-server) |
| Source record ids | npm_registry-ccd99ffc8e4b8b |
...
For a systems engineer, oauth2-mock-server belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 9.1.0 | 2026-06-30T09:59:08.498Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-ccd99ffc8e4b8b` from `npm_registry` as `registry_expansion`
