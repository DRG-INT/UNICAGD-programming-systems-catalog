...
<!-- canonical: https://cran.r-project.org/web/packages/diegr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/diegr/index.html](https://cran.r-project.org/web/packages/diegr/index.html) |
| Source record ids | cran_packages_by_date-d7532f092f519c |
...
For a systems engineer, diegr belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.1 | 2026-08-21 05:44:05 UTC | [https://cran.r-project.org/web/packages/diegr/DESCRIPTION](https://cran.r-project.org/web/packages/diegr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/diegr/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-d7532f092f519c` from `cran_packages_by_date` as `registry_expansion`
