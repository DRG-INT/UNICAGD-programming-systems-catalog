...
<!-- canonical: https://github.com/learning-zone/java-basics -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/learning-zone/java-basics](https://github.com/learning-zone/java-basics) |
| Source record ids | github_search_databases-973482c5c9363d |

## System Engineer Summary

learning-zone/java-basics is tracked as a library record in the Databases branch. The source did not
...
For a systems engineer, learning-zone/java-basics belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-09-29T17:11:07Z | gh search repos topic:jdbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-973482c5c9363d` from `github_search_databases` as `registry_expansion`
