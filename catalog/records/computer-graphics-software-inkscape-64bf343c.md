...
<!-- canonical: https://gitlab.com/inkscape/inkscape -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/inkscape/inkscape](https://gitlab.com/inkscape/inkscape) |
| Source record ids | curated_language_routes-94e82aac016104 |

## System Engineer Summary

Vector graphics editor for SVG authoring, illustration, paths, typography, extensions, and export
workflows.

## Operational Role

For a systems engineer, Inkscape belongs in the Computer Graphics Software inventory as part of
...
| --- | --- |
| Detected family | MIT |
| Evidence | {"key": "", "name": "", "url": ""}; zlib License; https://api.github.com/licenses/zlib; MIT License; https://api.github.com/licenses/mit; Other |
...
- `curated_language_routes-94e82aac016104` from `curated_language_routes` as `registry_expansion`
...
| GIMP | Visualization Gui | [open](computer-graphics-software-gimp-628fdedd.md) |
