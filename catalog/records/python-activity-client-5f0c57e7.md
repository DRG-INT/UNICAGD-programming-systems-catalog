...
<!-- canonical: https://pypi.org/project/activity-client/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/activity-client/](https://pypi.org/project/activity-client/) |
| Source record ids | pypi_simple-e4b7e84e61d877 |
...
For a systems engineer, activity-client belongs in the Python inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.1 | 2020-09-21T08:39:36.973092Z | [https://pypi.org/pypi/activity-client/json](https://pypi.org/pypi/activity-client/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/activity-client/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-e4b7e84e61d877` from `pypi_simple` as `registry_expansion`
