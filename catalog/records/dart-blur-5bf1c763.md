...
<!-- canonical: https://pub.dev/packages/blur -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/blur](https://pub.dev/packages/blur) |
| Source record ids | pub_dev-329c6b23472a9f |

## System Engineer Summary

Blur is a wrapper widget that blur it's child. There are ImageBlur.asset and ImageBlur.network that
blur the image. Frost is another wrapper which blurs the background.

## Operational Role

For a systems engineer, blur belongs in the Dart inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.0.2 | 2025-04-06T20:37:10.612759Z | [https://pub.dev/api/packages/blur](https://pub.dev/api/packages/blur) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/blur` at `2026-09-01T07:20:12+00:00`.
...
- `pub_dev-329c6b23472a9f` from `pub_dev` as `registry_expansion`
