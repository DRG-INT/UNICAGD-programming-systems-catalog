...
<!-- canonical: https://github.com/NodeBB/NodeBB -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/NodeBB/NodeBB](https://github.com/NodeBB/NodeBB) |
| Source record ids | github_search_databases-73b5eed150623c |
...
For a systems engineer, NodeBB/NodeBB belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-08T00:46:56Z | gh search repos topic:postgresql stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-73b5eed150623c` from `github_search_databases` as `registry_expansion`
