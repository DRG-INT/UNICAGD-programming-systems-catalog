...
<!-- canonical: https://github.com/lelong37/msdn-spa-primer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lelong37/msdn-spa-primer](https://github.com/lelong37/msdn-spa-primer) |
| Source record ids | github_search_magazines-cba4cc9d613eb6 |

## System Engineer Summary

MSDN Magazine Article: .NET Developer Primer for Single-Page Applications (SPA)

## Operational Role

For a systems engineer, lelong37/msdn-spa-primer belongs in the Magazines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-03-02T08:19:32Z | gh search repos developer magazine | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-cba4cc9d613eb6` from `github_search_magazines` as `registry_expansion`
