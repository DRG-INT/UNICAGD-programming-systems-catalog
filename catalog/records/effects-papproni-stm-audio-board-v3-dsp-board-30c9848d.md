# Papproni/stm_audio_board_v3_dsp_board
...
<!-- canonical: https://github.com/Papproni/stm_audio_board_v3_dsp_board -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Papproni/stm_audio_board_v3_dsp_board](https://github.com/Papproni/stm_audio_board_v3_dsp_board) |
| Source record ids | github_search_effects-df77a464e2bb4a |

## System Engineer Summary

This contains the DSP board pcb design in KICAD for the digital effects pedal.

## Operational Role

For a systems engineer, Papproni/stm_audio_board_v3_dsp_board belongs in the Effects inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-04-28T21:16:38Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-df77a464e2bb4a` from `github_search_effects` as `registry_expansion`
