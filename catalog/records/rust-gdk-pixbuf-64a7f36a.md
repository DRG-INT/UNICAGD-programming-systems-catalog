...
| Canonical URL | [https://crates.io/crates/gdk-pixbuf](https://crates.io/crates/gdk-pixbuf) |
| Source record ids | crates_io-7c0fa50a8c3e22 |
...
For a systems engineer, gdk-pixbuf belongs in the Rust inventory as part of cross-language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.22.0 | 2026-02-20T08:21:14.941263Z | [https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=17&per_page=100&sort=downloads) |  |
...
- `crates_io-7c0fa50a8c3e22` from `crates_io` as `registry_expansion`
