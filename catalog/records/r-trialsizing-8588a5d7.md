...
<!-- canonical: https://cran.r-project.org/web/packages/trialSizing/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/trialSizing/index.html](https://cran.r-project.org/web/packages/trialSizing/index.html) |
| Source record ids | cran_packages_by_date-4d6ddd696d5d56 |

## System Engineer Summary

Tools for Experimental Design Sizing

## Operational Role

For a systems engineer, trialSizing belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-05 09:30:02 UTC | [https://cran.r-project.org/web/packages/trialSizing/DESCRIPTION](https://cran.r-project.org/web/packages/trialSizing/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/trialSizing/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-4d6ddd696d5d56` from `cran_packages_by_date` as `registry_expansion`
