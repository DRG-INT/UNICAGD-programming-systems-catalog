...
<!-- canonical: https://github.com/danalvarez/gr-quetzal1 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/danalvarez/gr-quetzal1](https://github.com/danalvarez/gr-quetzal1) |
| Source record ids | github_search_satcom_satellites-e8ba6f6062adae |

## System Engineer Summary

This repository includes the UHF specifications for Quetzal-1, information on demodulating and
decoding beacons from the satellite, as well as a graphical application to view beacon data.

## Operational Role

For a systems engineer, danalvarez/gr-quetzal1 belongs in the SatCom Satellites inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-12-11T23:55:55Z | gh search repos topic:gnuradio stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-e8ba6f6062adae` from `github_search_satcom_satellites` as `registry_expansion`
