...
[Catalog index](../index.md) · [Language: Audio](../by-language/audio.md) · [Category: Dependency Manager](../by-category/dependency-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/RandyGaul/cute_headers -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/RandyGaul/cute_headers](https://github.com/RandyGaul/cute_headers) |
| Source record ids | github_search_audio-139e9fb89a398c |
...
For a systems engineer, RandyGaul/cute_headers belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-05T00:10:44Z | gh search repos topic:audio stars:>500 | gh_search_reports_activity_not_release_version |
...
| Evidence | GPL-2; {"key": "", "name": "", "url": ""}; Other |
...
- `github_search_audio-139e9fb89a398c` from `github_search_audio` as `registry_expansion`
