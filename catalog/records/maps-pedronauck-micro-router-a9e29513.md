...
<!-- canonical: https://github.com/pedronauck/micro-router -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pedronauck/micro-router](https://github.com/pedronauck/micro-router) |
| Source record ids | github_search_maps-fd04d487d94b27 |
...
For a systems engineer, pedronauck/micro-router belongs in the Maps inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-12-07T09:40:24Z | gh search repos topic:routing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-fd04d487d94b27` from `github_search_maps` as `registry_expansion`
