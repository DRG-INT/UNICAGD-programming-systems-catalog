...
<!-- canonical: https://hackage.haskell.org/package/doctest -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/doctest](https://hackage.haskell.org/package/doctest) |
| Source record ids | hackage_top_downloads-7aba9de059a4f9 |
...
For a systems engineer, doctest belongs in the Haskell inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.25.0 | 2026-05-03T17:07:23Z | [https://hackage.haskell.org/package/doctest](https://hackage.haskell.org/package/doctest) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/doctest` at `2026-09-01T14:24:14+00:00`.
...
- `hackage_top_downloads-7aba9de059a4f9` from `hackage_top_downloads` as `registry_expansion`
