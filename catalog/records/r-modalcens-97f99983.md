...
<!-- canonical: https://cran.r-project.org/web/packages/ModalCens/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ModalCens/index.html](https://cran.r-project.org/web/packages/ModalCens/index.html) |
| Source record ids | cran_packages_by_date-e23c4acaffc8fa |
...
For a systems engineer, ModalCens belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-08-21 17:50:02 UTC | [https://cran.r-project.org/web/packages/ModalCens/DESCRIPTION](https://cran.r-project.org/web/packages/ModalCens/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ModalCens/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-e23c4acaffc8fa` from `cran_packages_by_date` as `registry_expansion`
