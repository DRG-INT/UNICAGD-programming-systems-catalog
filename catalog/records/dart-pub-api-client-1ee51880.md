...
<!-- canonical: https://pub.dev/packages/pub_api_client -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/pub_api_client](https://pub.dev/packages/pub_api_client) |
| Source record ids | pub_dev-083637ffe54d8c |
...
For a systems engineer, pub_api_client belongs in the Dart inventory as part of low-noise code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.0.0 | 2026-08-19T01:20:11.489851Z | [https://pub.dev/api/packages/pub_api_client](https://pub.dev/api/packages/pub_api_client) |  |
| preview | known | 2.0.0-beta.1 | 2021-03-25T13:23:24.407495Z | [https://pub.dev/api/packages/pub_api_client](https://pub.dev/api/packages/pub_api_client) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/pub_api_client` at `2026-09-01T16:41:08+00:00`.
...
- `pub_dev-083637ffe54d8c` from `pub_dev` as `registry_expansion`
