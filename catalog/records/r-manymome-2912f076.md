...
<!-- canonical: https://cran.r-project.org/web/packages/manymome/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/manymome/index.html](https://cran.r-project.org/web/packages/manymome/index.html) |
| Source record ids | cran_packages_by_date-cecfa39666f12f |
...
For a systems engineer, manymome belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.7 | 2026-09-03 05:20:28 UTC | [https://cran.r-project.org/web/packages/manymome/DESCRIPTION](https://cran.r-project.org/web/packages/manymome/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/manymome/DESCRIPTION` at `2026-09-03T05:28:48+00:00`.
...
- `cran_packages_by_date-cecfa39666f12f` from `cran_packages_by_date` as `registry_expansion`
