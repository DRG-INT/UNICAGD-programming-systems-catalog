...
[Catalog index](../index.md) · [Language: Go](../by-language/go.md) · [Category: Cli](../by-category/cli.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/yorukot/superfile -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/yorukot/superfile](https://github.com/yorukot/superfile) |
| Source record ids | github_search_go-dd85a95785ab3f |
...
For a systems engineer, yorukot/superfile belongs in the Go inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-07T18:09:48Z | gh search repos topic:golang stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-dd85a95785ab3f` from `github_search_go` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| golang-migrate/migrate | Cli | [open](go-golang-migrate-migrate-c00bf5c0.md) |
| JanDeDobbeleer/oh-my-posh | Cli | [open](go-jandedobbeleer-oh-my-posh-0e751a91.md) |
