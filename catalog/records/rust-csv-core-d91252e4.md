...
<!-- canonical: https://crates.io/crates/csv-core -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/csv-core](https://crates.io/crates/csv-core) |
| Source record ids | crates_io-7d1057ff20ca1a |
...
For a systems engineer, csv-core belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.13 | 2025-10-17T13:55:35.267702Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
- `crates_io-7d1057ff20ca1a` from `crates_io` as `registry_expansion`
