...
<!-- canonical: https://hackage.haskell.org/package/zoovisitor -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/zoovisitor](https://hackage.haskell.org/package/zoovisitor) |
| Source record ids | hackage_top_downloads-a516c48caa77f9 |
...
For a systems engineer, zoovisitor belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.7.0 | 2024-05-24T09:11:31Z | [https://hackage.haskell.org/package/zoovisitor](https://hackage.haskell.org/package/zoovisitor) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/zoovisitor` at `2026-09-03T20:22:51+00:00`.
...
- `hackage_top_downloads-a516c48caa77f9` from `hackage_top_downloads` as `registry_expansion`
