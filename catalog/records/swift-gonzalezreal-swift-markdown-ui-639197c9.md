...
<!-- canonical: https://github.com/gonzalezreal/swift-markdown-ui -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/gonzalezreal/swift-markdown-ui](https://github.com/gonzalezreal/swift-markdown-ui) |
| Source record ids | github_search_swift-075f1aa4adbe89 |

## System Engineer Summary

Maintenance mode — new development in Textual:

## Operational Role

For a systems engineer, gonzalezreal/swift-markdown-ui belongs in the Swift inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-12-28T07:33:47Z | gh search repos topic:swiftui stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-075f1aa4adbe89` from `github_search_swift` as `registry_expansion`
