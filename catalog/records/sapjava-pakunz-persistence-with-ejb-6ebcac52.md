# pakunz/persistence-with-ejb

## Navigation

[Catalog index](../index.md) · [Language: SAPJava](../by-language/sapjava.md) · [Category: Testing Framework](../by-category/testing-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/pakunz/persistence-with-ejb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pakunz/persistence-with-ejb](https://github.com/pakunz/persistence-with-ejb) |
| Source record ids | github_search_sapjava-cc9da0a5772cc5 |

## System Engineer Summary

Testing Repository for Persistence with Enterprise Java Beans (EJBs) based on EclipseLink and SAP
HANA Cloud

## Operational Role

For a systems engineer, pakunz/persistence-with-ejb belongs in the SAPJava inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2013-09-03T11:25:30Z | gh search repos SAP HANA Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-cc9da0a5772cc5` from `github_search_sapjava` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| com.sap.cloud.sdk.testutil:testutil-parent | Testing Framework | [open](sapjava-com-sap-cloud-sdk-testutil-testutil-parent-8bbe3f5c.md) |
| m-tanya/sap-codegen | Testing Framework | [open](sapjava-m-tanya-sap-codegen-32f87ed7.md) |
| YoheiFukuhara/cloud-sdk-test | Testing Framework | [open](sapjava-yoheifukuhara-cloud-sdk-test-a65d29fe.md) |
