...
[Catalog index](../index.md) · [Language: Maps](../by-language/maps.md) · [Category: Build System](../by-category/build-system.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/falcoframework/Falco -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/falcoframework/Falco](https://github.com/falcoframework/Falco) |
| Source record ids | github_search_maps-1428effc3f4303 |
...
For a systems engineer, falcoframework/Falco belongs in the Maps inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-27T10:24:53Z | gh search repos topic:routing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-1428effc3f4303` from `github_search_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| appbaseio/reactivemaps | Build System | [open](maps-appbaseio-reactivemaps-b4b5d16a.md) |
| domlysz/BlenderGIS | Build System | [open](maps-domlysz-blendergis-8c375370.md) |
| emicklei/go-restful | Build System | [open](maps-emicklei-go-restful-1944b345.md) |
| evansiroky/timezone-boundary-builder | Build System | [open](maps-evansiroky-timezone-boundary-builder-78c4b912.md) |
| mark-when/markwhen | Build System | [open](maps-mark-when-markwhen-a69d618c.md) |
| NASAWorldWind/WorldWindJava | Build System | [open](maps-nasaworldwind-worldwindjava-5ccaa328.md) |
| noncomputable/AgentMaps | Build System | [open](maps-noncomputable-agentmaps-d9a25ae5.md) |
| onthegomap/planetiler | Build System | [open](maps-onthegomap-planetiler-3a2ddfcf.md) |
