...
<!-- canonical: https://packagist.org/packages/illuminate/database -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/illuminate/database](https://packagist.org/packages/illuminate/database) |
| Source record ids | packagist_search-5db504f19e0206 |
...
For a systems engineer, illuminate/database belongs in the PHP inventory as part of state
...
- `packagist_search-5db504f19e0206` from `packagist_search` as `registry_expansion`
