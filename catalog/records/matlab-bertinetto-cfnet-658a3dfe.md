...
<!-- canonical: https://github.com/bertinetto/cfnet -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/bertinetto/cfnet](https://github.com/bertinetto/cfnet) |
| Source record ids | github_search_matlab-07687ee37bc4dd |

## System Engineer Summary

CVPR'17 Training a Correlation Filter end-to-end allows lightweight networks of 2 layers (600 kB) to
high performance at fast speed..

## Operational Role

For a systems engineer, bertinetto/cfnet belongs in the Matlab inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-05-31T13:59:08Z | gh search repos language:MATLAB topic:machine-learning | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-09 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "language:MATLAB topic:machine-learning", "retrieved": "2026-09-09", "status": "forge-cli-derived"}` |
...
- `github_search_matlab-07687ee37bc4dd` from `github_search_matlab` as `registry_expansion`
