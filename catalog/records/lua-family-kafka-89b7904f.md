...
| Canonical URL | [https://luarocks.org/modules/chensoft/kafka](https://luarocks.org/modules/chensoft/kafka) |
| Source record ids | luarocks_root_manifest-0d1cb95bd3fcf6 |
...
For a systems engineer, kafka belongs in the Lua family inventory as part of cross-language
...
- `luarocks_root_manifest-0d1cb95bd3fcf6` from `luarocks_root_manifest` as `registry_expansion`
