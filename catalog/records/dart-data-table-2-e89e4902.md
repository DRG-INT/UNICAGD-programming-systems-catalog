...
<!-- canonical: https://pub.dev/packages/data_table_2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/data_table_2](https://pub.dev/packages/data_table_2) |
| Source record ids | pub_dev-04cbab71e67152 |

## System Engineer Summary

In-place substitute for Flutter's DataTable and PaginatedDataTable with fixed/sticky headers and few
extra features

## Operational Role

For a systems engineer, data_table_2 belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.0 | 2026-08-17T08:10:54.231577Z | [https://pub.dev/api/packages/data_table_2](https://pub.dev/api/packages/data_table_2) |  |
| preview | known | 2.0.0-dev.1 | 2021-04-24T12:07:21.359063Z | [https://pub.dev/api/packages/data_table_2](https://pub.dev/api/packages/data_table_2) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/data_table_2` at `2026-09-01T07:20:11+00:00`.
...
- `pub_dev-04cbab71e67152` from `pub_dev` as `registry_expansion`
