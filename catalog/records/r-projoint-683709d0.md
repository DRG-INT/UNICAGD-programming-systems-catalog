...
<!-- canonical: https://cran.r-project.org/web/packages/projoint/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/projoint/index.html](https://cran.r-project.org/web/packages/projoint/index.html) |
| Source record ids | cran_packages_by_date-5ec651bda7f2b7 |
...
For a systems engineer, projoint belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.4 | 2026-08-28 19:30:02 UTC | [https://cran.r-project.org/web/packages/projoint/DESCRIPTION](https://cran.r-project.org/web/packages/projoint/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/projoint/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-5ec651bda7f2b7` from `cran_packages_by_date` as `registry_expansion`
