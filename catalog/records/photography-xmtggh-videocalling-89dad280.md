...
<!-- canonical: https://github.com/xmtggh/VideoCalling -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/xmtggh/VideoCalling](https://github.com/xmtggh/VideoCalling) |
| Source record ids | github_search_photography-3387cf799a4cbb |

## System Engineer Summary

xmtggh/VideoCalling is tracked as an ide editor integration record in the Photography branch. The
...
For a systems engineer, xmtggh/VideoCalling belongs in the Photography inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-08-26T02:13:50Z | gh search repos topic:camera stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-3387cf799a4cbb` from `github_search_photography` as `registry_expansion`
