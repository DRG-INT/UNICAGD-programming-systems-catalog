...
<!-- canonical: https://github.com/cwrowley/organ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cwrowley/organ](https://github.com/cwrowley/organ) |
| Source record ids | github_search_repertoare_catalogs-5a738c77cce371 |

## System Engineer Summary

Track organ repertoire and performances

## Operational Role

For a systems engineer, cwrowley/organ belongs in the Repertoare Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-11T04:41:52Z | gh search repos performance repertoire | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-5a738c77cce371` from `github_search_repertoare_catalogs` as `registry_expansion`
