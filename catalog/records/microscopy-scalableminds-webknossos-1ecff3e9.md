...
| Canonical URL | [https://github.com/scalableminds/webknossos](https://github.com/scalableminds/webknossos) |
| Source record ids | github_search_microscopy-3092ac1b6f3863 |
...
For a systems engineer, scalableminds/webknossos belongs in the Microscopy inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 26.09.1 | 2026-08-31T08:14:58Z | [https://api.github.com/repos/scalableminds/webknossos/releases/latest](https://api.github.com/repos/scalableminds/webknossos/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/scalableminds/webknossos/releases/latest` at `2026-09-01T11:22:10+00:00`.
...
- `github_search_microscopy-3092ac1b6f3863` from `github_search_microscopy` as `registry_expansion`
