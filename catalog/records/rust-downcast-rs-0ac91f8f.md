...
<!-- canonical: https://crates.io/crates/downcast-rs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/downcast-rs](https://crates.io/crates/downcast-rs) |
| Source record ids | crates_io-3660235fb6175e |

## System Engineer Summary

Trait object downcasting support using only safe Rust. It supports type parameters, associated
types, and type constraints.

## Operational Role

For a systems engineer, downcast-rs belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.2 | 2025-09-01T20:32:31.465521Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-3660235fb6175e` from `crates_io` as `registry_expansion`
