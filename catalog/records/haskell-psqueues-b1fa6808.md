...
<!-- canonical: https://hackage.haskell.org/package/psqueues -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/psqueues](https://hackage.haskell.org/package/psqueues) |
| Source record ids | hackage_top_downloads-fa6478fe6b72a5 |
...
For a systems engineer, psqueues belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.8.3 | 2025-12-28T06:54:17Z | [https://hackage.haskell.org/package/psqueues](https://hackage.haskell.org/package/psqueues) |  |
| candidate | partial | 0.2.8.1 |  | [https://hackage.haskell.org/package/psqueues](https://hackage.haskell.org/package/psqueues) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/psqueues` at `2026-09-01T14:24:28+00:00`.
...
- `hackage_top_downloads-fa6478fe6b72a5` from `hackage_top_downloads` as `registry_expansion`
...
| stomp-queue | Message Broker | [open](haskell-stomp-queue-894bae3e.md) |
