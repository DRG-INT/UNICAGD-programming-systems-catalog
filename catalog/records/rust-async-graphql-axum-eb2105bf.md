...
| Canonical URL | [https://crates.io/crates/async-graphql-axum](https://crates.io/crates/async-graphql-axum) |
| Source record ids | crates_io-9a4924c7076b1b |

## System Engineer Summary

async-graphql-axum is tracked as an async runtime record in the Rust branch. The source did not
...
For a systems engineer, async-graphql-axum belongs in the Rust inventory as part of concurrency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.2.1 | 2026-04-21T22:50:17.909459Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
- `crates_io-9a4924c7076b1b` from `crates_io` as `registry_expansion`
