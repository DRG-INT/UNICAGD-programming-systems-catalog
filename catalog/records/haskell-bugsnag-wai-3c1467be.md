...
<!-- canonical: https://hackage.haskell.org/package/bugsnag-wai -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/bugsnag-wai](https://hackage.haskell.org/package/bugsnag-wai) |
| Source record ids | hackage_recent-b0a2156f477e6d |
...
For a systems engineer, bugsnag-wai belongs in the Haskell inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0.4 | 2026-09-04T16:18:11Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-b0a2156f477e6d` from `hackage_recent` as `registry_expansion`
