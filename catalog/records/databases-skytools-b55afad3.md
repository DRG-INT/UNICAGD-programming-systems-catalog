...
<!-- canonical: https://github.com/pgq/skytools-legacy -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pgq/skytools-legacy](https://github.com/pgq/skytools-legacy) |
| Source record ids | awesome_list-3f106317d1c6e0 |

## System Engineer Summary

Replication tools, including PgQ, a queuing system, and Londiste, a replication system a bit simpler
to manage than Slony.

## Operational Role

For a systems engineer, SkyTools belongs in the Databases inventory as part of model pipelines,
...
| --- | --- | --- | --- |
| community_reference_markdown | curated-list-derived | 2026-09-01 | `{"kind": "community_reference_markdown", "retrieved": "2026-09-01", "section": "High-Availability", "source_url": "https://raw.githubusercontent.com/dhamaniasad/awesome-postgres/master/README.md", "status": "curated-list-derived"}` |
...
- `awesome_list-3f106317d1c6e0` from `awesome_list` as `registry_expansion`
...
| NVIDIA/aistore | Machine Learning | [open](databases-nvidia-aistore-c8de1037.md) |
