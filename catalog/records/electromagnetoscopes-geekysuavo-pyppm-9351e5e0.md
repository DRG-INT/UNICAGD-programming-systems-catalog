...
<!-- canonical: https://github.com/geekysuavo/pyppm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/geekysuavo/pyppm](https://github.com/geekysuavo/pyppm) |
| Source record ids | github_search_electromagnetoscopes-0151d1bd07e2aa |
...
For a systems engineer, geekysuavo/pyppm belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-07-04T15:42:35Z | gh search repos topic:magnetometer stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-0151d1bd07e2aa` from `github_search_electromagnetoscopes` as `registry_expansion`
