...
| Canonical URL | [https://luarocks.org/modules/technomancy/jeejah](https://luarocks.org/modules/technomancy/jeejah) |
| Source record ids | luarocks_root_manifest-41596df3ece35b |

## System Engineer Summary

jeejah is tracked as a web framework record in the Lua family branch. The source did not provide a
...
For a systems engineer, jeejah belongs in the Lua family inventory as part of request routing,
...
- `luarocks_root_manifest-41596df3ece35b` from `luarocks_root_manifest` as `registry_expansion`
