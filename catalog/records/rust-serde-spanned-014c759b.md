...
<!-- canonical: https://crates.io/crates/serde_spanned -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/serde_spanned](https://crates.io/crates/serde_spanned) |
| Source record ids | crates_io-f299a0a0ed4c68 |
...
For a systems engineer, serde_spanned belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.1 | 2026-03-31T19:06:07.042176Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-f299a0a0ed4c68` from `crates_io` as `registry_expansion`
