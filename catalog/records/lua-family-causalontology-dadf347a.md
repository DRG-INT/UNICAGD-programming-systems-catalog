...
<!-- canonical: https://luarocks.org/modules/ai-university-aiu/causalontology -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/ai-university-aiu/causalontology](https://luarocks.org/modules/ai-university-aiu/causalontology) |
| Source record ids | luarocks_root_manifest-42afb8044dfb4d |

## System Engineer Summary

The Lua binding of the Causalontology standard.

## Operational Role

For a systems engineer, causalontology belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-42afb8044dfb4d` from `luarocks_root_manifest` as `registry_expansion`
