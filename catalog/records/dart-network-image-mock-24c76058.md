...
<!-- canonical: https://pub.dev/packages/network_image_mock -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/network_image_mock](https://pub.dev/packages/network_image_mock) |
| Source record ids | pub_dev-925781ed50d7ce |
...
For a systems engineer, network_image_mock belongs in the Dart inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.1 | 2022-06-28T07:41:35.318689Z | [https://pub.dev/api/packages/network_image_mock](https://pub.dev/api/packages/network_image_mock) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/network_image_mock` at `2026-09-01T15:35:58+00:00`.
...
- `pub_dev-925781ed50d7ce` from `pub_dev` as `registry_expansion`
