...
| Source record ids | hackage_recent-937137731886a8 |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/hledger-lib` at `2026-09-11T01:22:34+00:00`.
...
- `hackage_recent-937137731886a8` from `hackage_recent` as `registry_expansion`
