...
| Canonical URL | [https://luarocks.org/modules/vl4d/kong-oidc-consumer](https://luarocks.org/modules/vl4d/kong-oidc-consumer) |
| Source record ids | luarocks_root_manifest-1aa5be613e351c |

## System Engineer Summary

A Kong plugin for adding/linking consumers to the email response within userInfo returned by the
kong-oidc project

## Operational Role

For a systems engineer, kong-oidc-consumer belongs in the Lua family inventory as part of model
...
- `luarocks_root_manifest-1aa5be613e351c` from `luarocks_root_manifest` as `registry_expansion`
