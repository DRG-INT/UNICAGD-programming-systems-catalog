...
<!-- canonical: https://github.com/learnin/sap-cap-example -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/learnin/sap-cap-example](https://github.com/learnin/sap-cap-example) |
| Source record ids | github_search_sapjava-5323f2a62519c0 |
...
For a systems engineer, learnin/sap-cap-example belongs in the SAPJava inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-05-25T15:42:51Z | gh search repos SAP HANA Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-5323f2a62519c0` from `github_search_sapjava` as `registry_expansion`
