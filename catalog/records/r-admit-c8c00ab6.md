...
<!-- canonical: https://cran.r-project.org/web/packages/AdMit/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/AdMit/index.html](https://cran.r-project.org/web/packages/AdMit/index.html) |
| Source record ids | cran_packages_by_date-d45775d8326e20 |
...
For a systems engineer, AdMit belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.12 | 2026-08-21 15:50:12 UTC | [https://cran.r-project.org/web/packages/AdMit/DESCRIPTION](https://cran.r-project.org/web/packages/AdMit/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/AdMit/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-d45775d8326e20` from `cran_packages_by_date` as `registry_expansion`
