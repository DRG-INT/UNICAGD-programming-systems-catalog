...
<!-- canonical: https://packagist.org/packages/pestphp/pest-plugin-faker -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/pestphp/pest-plugin-faker](https://packagist.org/packages/pestphp/pest-plugin-faker) |
| Source record ids | packagist_search-18edf48142b534 |

## System Engineer Summary

pestphp/pest-plugin-faker is tracked as a testing framework record in the PHP branch. The source did
...
For a systems engineer, pestphp/pest-plugin-faker belongs in the PHP inventory as part of
...
- `packagist_search-18edf48142b534` from `packagist_search` as `registry_expansion`
