...
<!-- canonical: https://hackage.haskell.org/package/mono-traversable -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/mono-traversable](https://hackage.haskell.org/package/mono-traversable) |
| Source record ids | hackage_top_downloads-879d7bf9466c0a |
...
For a systems engineer, mono-traversable belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.21.0 | 2024-12-13T16:53:34Z | [https://hackage.haskell.org/package/mono-traversable](https://hackage.haskell.org/package/mono-traversable) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/mono-traversable` at `2026-09-01T07:24:03+00:00`.
...
- `hackage_top_downloads-879d7bf9466c0a` from `hackage_top_downloads` as `registry_expansion`
