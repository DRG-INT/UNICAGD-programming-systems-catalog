...
<!-- canonical: https://github.com/thulab/tsfile -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/thulab/tsfile](https://github.com/thulab/tsfile) |
| Source record ids | github_search_databases-18dde63bffc726 |

## System Engineer Summary

THIS REPO HAS MOVED TO TsFile is a columnar file format designed for time-series data, which
supports efficient compression and query. It is easy to integrate TsFile with your IOT big data
processing frameworks.

## Operational Role

For a systems engineer, thulab/tsfile belongs in the Databases inventory as part of low-noise code
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-12T08:52:07Z | gh search repos topic:time-series-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-18dde63bffc726` from `github_search_databases` as `registry_expansion`
...
| realdatadriven/etlx | Formatter | [open](databases-realdatadriven-etlx-e354a7b4.md) |
