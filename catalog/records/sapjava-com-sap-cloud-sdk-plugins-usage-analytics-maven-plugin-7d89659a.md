...
[Catalog index](../index.md) · [Language: SAPJava](../by-language/sapjava.md) · [Category: Data Science](../by-category/data-science.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://central.sonatype.com/artifact/com.sap.cloud.sdk.plugins/usage-analytics-maven-plugin -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://central.sonatype.com/artifact/com.sap.cloud.sdk.plugins/usage-analytics-maven-plugin](https://central.sonatype.com/artifact/com.sap.cloud.sdk.plugins/usage-analytics-maven-plugin) |
| Source record ids | maven_central_search-fb4ce34a256c03 |
...
For a systems engineer, com.sap.cloud.sdk.plugins:usage-analytics-maven-plugin belongs in the
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.78.0 | 2022-12-19T12:44:14+00:00 | [https://search.maven.org/solrsearch/select?q=sap%20cloud%20sdk&rows=100&wt=json](https://search.maven.org/solrsearch/select?q=sap%20cloud%20sdk&rows=100&wt=json) |  |
...
- `maven_central_search-fb4ce34a256c03` from `maven_central_search` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| com.sap.cloud.sdk.plugins:usage-analytics | Data Science | [open](sapjava-com-sap-cloud-sdk-plugins-usage-analytics-46b83d38.md) |
