...
| Canonical URL | [https://www.mypy-lang.org/](https://www.mypy-lang.org/) |
| Source record ids | web-verified-0005 |
...
For a systems engineer, mypy belongs in the Python inventory as part of interface contracts,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.1 | 2026-08-15T03:03:38.549479Z | [https://pypi.org/pypi/mypy/json](https://pypi.org/pypi/mypy/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/mypy/json` at `2026-09-01T02:13:00+00:00`.
...
- `web-verified-0005` from `master_json` as `type_checker`
