...
<!-- canonical: https://luarocks.org/modules/nevyn/allonet -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/nevyn/allonet](https://luarocks.org/modules/nevyn/allonet) |
| Source record ids | luarocks_root_manifest-6fd0a791518a64 |

## System Engineer Summary

Network and UI library for writing Alloverse apps

## Operational Role

For a systems engineer, allonet belongs in the Lua family inventory as part of service
...
- `luarocks_root_manifest-6fd0a791518a64` from `luarocks_root_manifest` as `registry_expansion`
