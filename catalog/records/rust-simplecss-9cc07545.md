...
| Canonical URL | [https://crates.io/crates/simplecss](https://crates.io/crates/simplecss) |
| Source record ids | crates_io-71b19c0a0287f5 |
...
For a systems engineer, simplecss belongs in the Rust inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.2 | 2025-01-06T13:06:27.458973Z | [https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads) |  |
...
- `crates_io-71b19c0a0287f5` from `crates_io` as `registry_expansion`
