...
<!-- canonical: https://cran.r-project.org/web/packages/mx.crypto/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mx.crypto/index.html](https://cran.r-project.org/web/packages/mx.crypto/index.html) |
| Source record ids | cran_packages_by_date-366f4f822305fd |

## System Engineer Summary

Matrix End-to-End Encryption Primitives

## Operational Role

For a systems engineer, mx.crypto belongs in the R inventory as part of confidentiality, integrity,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2026-08-04 22:10:02 UTC | [https://cran.r-project.org/web/packages/mx.crypto/DESCRIPTION](https://cran.r-project.org/web/packages/mx.crypto/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mx.crypto/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-366f4f822305fd` from `cran_packages_by_date` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| hashtable | Cryptography | [open](r-hashtable-b59ae827.md) |
