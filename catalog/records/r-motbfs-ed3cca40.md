...
<!-- canonical: https://cran.r-project.org/web/packages/MoTBFs/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/MoTBFs/index.html](https://cran.r-project.org/web/packages/MoTBFs/index.html) |
| Source record ids | cran_packages_by_date-c67506238c5165 |
...
For a systems engineer, MoTBFs belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0 | 2026-08-21 21:50:31 UTC | [https://cran.r-project.org/web/packages/MoTBFs/DESCRIPTION](https://cran.r-project.org/web/packages/MoTBFs/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/MoTBFs/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-c67506238c5165` from `cran_packages_by_date` as `registry_expansion`
