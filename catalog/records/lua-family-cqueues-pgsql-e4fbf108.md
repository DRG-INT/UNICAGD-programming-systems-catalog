...
<!-- canonical: https://luarocks.org/modules/daurnimator/cqueues-pgsql -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/daurnimator/cqueues-pgsql](https://luarocks.org/modules/daurnimator/cqueues-pgsql) |
| Source record ids | luarocks_root_manifest-809ce5cd7c376b |
...
For a systems engineer, cqueues-pgsql belongs in the Lua family inventory as part of state
...
- `luarocks_root_manifest-809ce5cd7c376b` from `luarocks_root_manifest` as `registry_expansion`
