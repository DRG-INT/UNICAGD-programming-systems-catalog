...
<!-- canonical: https://github.com/WebKit/WebKit/tree/main/Source/JavaScriptCore -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/WebKit/WebKit/tree/main/Source/JavaScriptCore](https://github.com/WebKit/WebKit/tree/main/Source/JavaScriptCore) |
| Source record ids | curated_language_routes-af9b5fe5d501cc |

## System Engineer Summary

WebKit JavaScript engine with bytecode, JIT, garbage collection, WebAssembly, and embedding
surfaces.

## Operational Role

For a systems engineer, JavaScriptCore belongs in the Engines inventory as part of ecosystem
...
- `curated_language_routes-af9b5fe5d501cc` from `curated_language_routes` as `registry_expansion`
