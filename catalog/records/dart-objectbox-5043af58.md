...
<!-- canonical: https://pub.dev/packages/objectbox -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/objectbox](https://pub.dev/packages/objectbox) |
| Source record ids | pub_dev-9e64a1c0edafdb |
...
For a systems engineer, objectbox belongs in the Dart inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.3.2 | 2026-05-20T05:36:00.661934Z | [https://pub.dev/api/packages/objectbox](https://pub.dev/api/packages/objectbox) |  |
| preview | known | 6.0.0-preview.2 | 2026-07-15T14:24:54.505615Z | [https://pub.dev/api/packages/objectbox](https://pub.dev/api/packages/objectbox) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/objectbox` at `2026-09-01T15:35:55+00:00`.
...
- `pub_dev-9e64a1c0edafdb` from `pub_dev` as `registry_expansion`
