...
<!-- canonical: https://cran.r-project.org/web/packages/gmeans/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/gmeans/index.html](https://cran.r-project.org/web/packages/gmeans/index.html) |
| Source record ids | cran_packages_by_date-97ecf6ef9106e0 |

## System Engineer Summary

gmeans is tracked as a library record in the R branch. The source did not provide a long
...
For a systems engineer, gmeans belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-05 06:40:08 UTC | [https://cran.r-project.org/web/packages/gmeans/DESCRIPTION](https://cran.r-project.org/web/packages/gmeans/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/gmeans/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-97ecf6ef9106e0` from `cran_packages_by_date` as `registry_expansion`
