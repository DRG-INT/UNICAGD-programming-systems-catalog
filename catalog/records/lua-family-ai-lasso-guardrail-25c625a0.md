...
<!-- canonical: https://luarocks.org/modules/lassosecurity/ai-lasso-guardrail -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/lassosecurity/ai-lasso-guardrail](https://luarocks.org/modules/lassosecurity/ai-lasso-guardrail) |
| Source record ids | luarocks_root_manifest-bc38275551bbf9 |

## System Engineer Summary

Kong plugin: classify chat traffic with Lasso Security and block or mask inline.

## Operational Role

For a systems engineer, ai-lasso-guardrail belongs in the Lua family inventory as part of supply-
...
- `luarocks_root_manifest-bc38275551bbf9` from `luarocks_root_manifest` as `registry_expansion`
