...
<!-- canonical: https://cran.r-project.org/web/packages/svines/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/svines/index.html](https://cran.r-project.org/web/packages/svines/index.html) |
| Source record ids | cran_packages_by_date-529926e668dc3a |
...
For a systems engineer, svines belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-08-31 21:50:08 UTC | [https://cran.r-project.org/web/packages/svines/DESCRIPTION](https://cran.r-project.org/web/packages/svines/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/svines/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-529926e668dc3a` from `cran_packages_by_date` as `registry_expansion`
