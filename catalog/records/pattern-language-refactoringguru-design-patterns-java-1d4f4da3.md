...
[Catalog index](../index.md) · [Language: Pattern language](../by-language/pattern-language.md) · [Category: Codegen Codemod Refactoring](../by-category/codegen-codemod-refactoring.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/RefactoringGuru/design-patterns-java -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/RefactoringGuru/design-patterns-java](https://github.com/RefactoringGuru/design-patterns-java) |
| Source record ids | github_search_pattern_language-b7257a137df2ea |
...
For a systems engineer, RefactoringGuru/design-patterns-java belongs in the Pattern language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-14T17:37:09Z | gh search repos design patterns stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_pattern_language-b7257a137df2ea` from `github_search_pattern_language` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| RefactoringGuru/design-patterns-php | Codegen Codemod Refactoring | [open](pattern-language-refactoringguru-design-patterns-php-ff83cf85.md) |
| RefactoringGuru/design-patterns-python | Codegen Codemod Refactoring | [open](pattern-language-refactoringguru-design-patterns-python-1b5ed9b2.md) |
