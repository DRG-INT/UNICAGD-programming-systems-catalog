...
<!-- canonical: https://cran.r-project.org/web/packages/winning/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/winning/index.html](https://cran.r-project.org/web/packages/winning/index.html) |
| Source record ids | cran_packages_by_date-91dcbbc83647ae |

## System Engineer Summary

Contest Win Probabilities and Ability Calibration

## Operational Role

For a systems engineer, winning belongs in the R inventory as part of unit/integration validation,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0 | 2026-09-09 16:30:02 UTC | [https://cran.r-project.org/web/packages/winning/DESCRIPTION](https://cran.r-project.org/web/packages/winning/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/winning/DESCRIPTION` at `2026-09-09T18:24:02+00:00`.
...
- `cran_packages_by_date-91dcbbc83647ae` from `cran_packages_by_date` as `registry_expansion`
