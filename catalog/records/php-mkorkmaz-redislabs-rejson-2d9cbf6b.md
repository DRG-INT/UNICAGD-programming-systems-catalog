...
<!-- canonical: https://packagist.org/packages/mkorkmaz/redislabs-rejson -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/mkorkmaz/redislabs-rejson](https://packagist.org/packages/mkorkmaz/redislabs-rejson) |
| Source record ids | packagist_search-a4fdbba1d495ec |
...
For a systems engineer, mkorkmaz/redislabs-rejson belongs in the PHP inventory as part of wire
...
- `packagist_search-a4fdbba1d495ec` from `packagist_search` as `registry_expansion`
