...
<!-- canonical: https://pub.dev/packages/animated_size_and_fade -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/animated_size_and_fade](https://pub.dev/packages/animated_size_and_fade) |
| Source record ids | pub_dev-cf932aa29a65ed |

## System Engineer Summary

Does a fade and size transition between widgets of different heights. Also used to show/hide a
widget.

## Operational Role

For a systems engineer, animated_size_and_fade belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.1.1 | 2025-02-13T21:38:02.102321Z | [https://pub.dev/api/packages/animated_size_and_fade](https://pub.dev/api/packages/animated_size_and_fade) |  |
| preview | known | 2.0.0-nullsafety.1 | 2021-02-13T17:59:23.614640Z | [https://pub.dev/api/packages/animated_size_and_fade](https://pub.dev/api/packages/animated_size_and_fade) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/animated_size_and_fade` at `2026-09-01T07:20:14+00:00`.
...
- `pub_dev-cf932aa29a65ed` from `pub_dev` as `registry_expansion`
