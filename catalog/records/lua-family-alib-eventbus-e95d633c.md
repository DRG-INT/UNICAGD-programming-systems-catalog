...
<!-- canonical: https://luarocks.org/modules/swarg/alib.eventbus -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/swarg/alib.eventbus](https://luarocks.org/modules/swarg/alib.eventbus) |
| Source record ids | luarocks_root_manifest-618c0312ac271d |
...
For a systems engineer, alib.eventbus belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-618c0312ac271d` from `luarocks_root_manifest` as `registry_expansion`
