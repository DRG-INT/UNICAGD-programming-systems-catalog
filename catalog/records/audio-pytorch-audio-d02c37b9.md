...
<!-- canonical: https://github.com/pytorch/audio -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pytorch/audio](https://github.com/pytorch/audio) |
| Source record ids | github_search_audio-75220362558f6a |
...
For a systems engineer, pytorch/audio belongs in the Audio inventory as part of low-noise code
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-14T11:37:55Z | gh search repos topic:audio stars:>500 | gh_search_reports_activity_not_release_version |
...
| Evidence | GNU Lesser General Public License v3.0; https://api.github.com/licenses/lgpl-3.0; BSD 2-Clause "Simplified" License; https://api.github.com/licenses/bsd-2-clause |
...
- `github_search_audio-75220362558f6a` from `github_search_audio` as `registry_expansion`
