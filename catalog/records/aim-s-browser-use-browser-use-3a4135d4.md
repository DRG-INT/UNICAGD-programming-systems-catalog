...
| Source record ids | github_search_aims-3b5e85f1356107 |
...
For a systems engineer, browser-use/browser-use belongs in the "aim's" inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T00:37:55Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-3b5e85f1356107` from `github_search_aims` as `registry_expansion`
