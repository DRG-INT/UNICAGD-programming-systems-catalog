...
<!-- canonical: https://hackage.haskell.org/package/derive -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/derive](https://hackage.haskell.org/package/derive) |
| Source record ids | hackage_top_downloads-576a07f83d4b60 |
...
For a systems engineer, derive belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.6.5 | 2019-01-22T13:51:14Z | [https://hackage.haskell.org/package/derive](https://hackage.haskell.org/package/derive) |  |
| candidate | partial | 2.6.4 |  | [https://hackage.haskell.org/package/derive](https://hackage.haskell.org/package/derive) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/derive` at `2026-09-01T14:24:13+00:00`.
...
- `hackage_top_downloads-576a07f83d4b60` from `hackage_top_downloads` as `registry_expansion`
