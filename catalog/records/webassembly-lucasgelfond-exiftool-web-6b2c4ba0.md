...
<!-- canonical: https://github.com/lucasgelfond/exiftool-web -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lucasgelfond/exiftool-web](https://github.com/lucasgelfond/exiftool-web) |
| Source record ids | github_search_webassembly-0c90d530fbe42c |
...
For a systems engineer, lucasgelfond/exiftool-web belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-10T18:07:32Z | gh search repos topic:wasi stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-0c90d530fbe42c` from `github_search_webassembly` as `registry_expansion`
