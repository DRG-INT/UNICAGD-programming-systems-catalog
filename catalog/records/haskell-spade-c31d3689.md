...
<!-- canonical: https://hackage.haskell.org/package/spade -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/spade](https://hackage.haskell.org/package/spade) |
| Source record ids | hackage_top_downloads-cdc76792fd7e19 |
...
For a systems engineer, spade belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0.0 | 2026-07-28T09:01:41Z | [https://hackage.haskell.org/package/spade](https://hackage.haskell.org/package/spade) |  |
| candidate | partial | 0.1.0.7 |  | [https://hackage.haskell.org/package/spade](https://hackage.haskell.org/package/spade) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/spade` at `2026-09-11T00:31:36+00:00`.
...
- `hackage_top_downloads-cdc76792fd7e19` from `hackage_top_downloads` as `registry_expansion`
