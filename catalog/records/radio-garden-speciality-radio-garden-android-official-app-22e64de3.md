# Radio Garden Android Official App

## Navigation

[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Radio Garden Speciality](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/radio-garden-speciality.md) · [Category: Registry Repository](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/registry-repository.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://play.google.com/store/apps/details?id=com.jonathanpuckey.radiogarden](https://play.google.com/store/apps/details?id=com.jonathanpuckey.radiogarden) |
| Source record ids | curated_language_routes-f7efdfaf29fa71 |

## System Engineer Summary

Official Android application route; useful as the canonical mobile target for emulator and wrapper
testing, but not an open-source client.

## Operational Role

For a systems engineer, Radio Garden Android Official App belongs in the Radio Garden Speciality
...
- `curated_language_routes-f7efdfaf29fa71` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Radio Garden iOS App Store | Registry Repository | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/radio-garden-speciality-radio-garden-ios-app-store-ac5eab89.md) |
