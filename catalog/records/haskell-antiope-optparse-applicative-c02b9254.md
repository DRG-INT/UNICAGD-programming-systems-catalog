...
<!-- canonical: https://hackage.haskell.org/package/antiope-optparse-applicative -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/antiope-optparse-applicative](https://hackage.haskell.org/package/antiope-optparse-applicative) |
| Source record ids | hackage_top_downloads-d58e3a8acc21ae |
...
For a systems engineer, antiope-optparse-applicative belongs in the Haskell inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.5.3 | 2020-10-22T11:56:16Z | [https://hackage.haskell.org/package/antiope-optparse-applicative](https://hackage.haskell.org/package/antiope-optparse-applicative) |  |
| candidate | partial | 7.0.1 |  | [https://hackage.haskell.org/package/antiope-optparse-applicative](https://hackage.haskell.org/package/antiope-optparse-applicative) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/antiope-optparse-applicative` at `2026-09-01T14:24:06+00:00`.
...
- `hackage_top_downloads-d58e3a8acc21ae` from `hackage_top_downloads` as `registry_expansion`
