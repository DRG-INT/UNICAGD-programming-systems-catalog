...
<!-- canonical: https://github.com/katanemo/plano -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/katanemo/plano](https://github.com/katanemo/plano) |
| Source record ids | github_search_maps-286b304b6d7be6 |

## System Engineer Summary

Plano is an AI-native proxy server and data plane for agentic apps. Smart LLM routing,
observability, agent orchestration, and guardrails so you stay focused on your agents core logic.

## Operational Role

For a systems engineer, katanemo/plano belongs in the Maps inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.36 | 2026-08-19T19:29:09Z | [https://api.github.com/repos/katanemo/plano/releases/latest](https://api.github.com/repos/katanemo/plano/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/katanemo/plano/releases/latest` at `2026-09-01T12:30:01+00:00`.
...
- `github_search_maps-286b304b6d7be6` from `github_search_maps` as `registry_expansion`
...
| neo4j-contrib/spatial | Web Framework | [open](maps-neo4j-contrib-spatial-1f247f57.md) |
