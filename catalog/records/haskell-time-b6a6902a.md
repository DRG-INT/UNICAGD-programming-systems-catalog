...
<!-- canonical: https://hackage.haskell.org/package/time -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/time](https://hackage.haskell.org/package/time) |
| Source record ids | hackage_top_downloads-5a88adf19a14e6 |
...
For a systems engineer, time belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.16.0.1 | 2026-07-20T21:55:18Z | [https://hackage.haskell.org/package/time](https://hackage.haskell.org/package/time) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/time` at `2026-09-01T14:24:35+00:00`.
...
- `hackage_top_downloads-5a88adf19a14e6` from `hackage_top_downloads` as `registry_expansion`
