...
<!-- canonical: https://cran.r-project.org/web/packages/multivator/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/multivator/index.html](https://cran.r-project.org/web/packages/multivator/index.html) |
| Source record ids | cran_packages_by_date-a0da9bdc2d520a |

## System Engineer Summary

multivator is tracked as a library record in the R branch. The source did not provide a long
...
For a systems engineer, multivator belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2-1 | 2026-09-15 21:40:02 UTC | [https://cran.r-project.org/web/packages/multivator/DESCRIPTION](https://cran.r-project.org/web/packages/multivator/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/multivator/DESCRIPTION` at `2026-09-15T22:19:01+00:00`.
...
- `cran_packages_by_date-a0da9bdc2d520a` from `cran_packages_by_date` as `registry_expansion`
