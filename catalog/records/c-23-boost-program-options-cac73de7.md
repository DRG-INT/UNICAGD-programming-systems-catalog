...
| Source record ids | corpus-610553a3079852 |

## System Engineer Summary

Boost.Program_options is tracked as a cli record in the C++23 branch. The source did not provide a
...
For a systems engineer, Boost.Program_options belongs in the C++23 inventory as part of ecosystem
...
- `corpus-610553a3079852` from `master_json` as `cli`
...
| cxxopts | Cli | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c-23-cxxopts-d786378d.md) |
