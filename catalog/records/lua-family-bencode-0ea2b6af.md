...
<!-- canonical: https://luarocks.org/modules/mw/bencode -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/mw/bencode](https://luarocks.org/modules/mw/bencode) |
| Source record ids | luarocks_root_manifest-fbd0ca7db2eb04 |
...
For a systems engineer, bencode belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-fbd0ca7db2eb04` from `luarocks_root_manifest` as `registry_expansion`
