...
<!-- canonical: https://pub.dev/packages/gaimon -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/gaimon](https://pub.dev/packages/gaimon) |
| Source record ids | pub_dev-2756afb990da20 |
...
For a systems engineer, gaimon belongs in the Dart inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.5.0 | 2026-08-30T10:06:42.907127Z | [https://pub.dev/api/packages/gaimon](https://pub.dev/api/packages/gaimon) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/gaimon` at `2026-09-01T14:20:32+00:00`.
...
- `pub_dev-2756afb990da20` from `pub_dev` as `registry_expansion`
