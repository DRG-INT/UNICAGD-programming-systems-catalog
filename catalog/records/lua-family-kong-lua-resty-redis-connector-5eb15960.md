# kong-lua-resty-redis-connector
...
| Canonical URL | [https://luarocks.org/modules/kong/kong-lua-resty-redis-connector](https://luarocks.org/modules/kong/kong-lua-resty-redis-connector) |
| Source record ids | luarocks_root_manifest-c5e8b8b692f161 |
...
For a systems engineer, kong-lua-resty-redis-connector belongs in the Lua family inventory as part
...
- `luarocks_root_manifest-c5e8b8b692f161` from `luarocks_root_manifest` as `registry_expansion`
