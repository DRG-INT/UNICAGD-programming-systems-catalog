...
[Catalog index](../index.md) · [Language: Telescopes](../by-language/telescopes.md) · [Category: Machine Learning](../by-category/machine-learning.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/RTS2/rts2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/RTS2/rts2](https://github.com/RTS2/rts2) |
| Source record ids | github_search_telescopes-df74b29e2f85bd |
...
For a systems engineer, RTS2/rts2 belongs in the Telescopes inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-02T16:07:43Z | gh search repos topic:observatory stars:>10 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-05 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:observatory stars:>10", "retrieved": "2026-09-05", "status": "forge-cli-derived"}` |
...
- `github_search_telescopes-df74b29e2f85bd` from `github_search_telescopes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| danieljprice/splash | Machine Learning | [open](telescopes-danieljprice-splash-ecd53203.md) |
| iff-gsc/FTC_Quadrotor_EuroGNC_2022 | Machine Learning | [open](telescopes-iff-gsc-ftc-quadrotor-eurognc-2022-2e374214.md) |
| nforrester/NexPlane | Machine Learning | [open](telescopes-nforrester-nexplane-4845bbeb.md) |
