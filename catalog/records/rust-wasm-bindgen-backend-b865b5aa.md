...
<!-- canonical: https://crates.io/crates/wasm-bindgen-backend -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/wasm-bindgen-backend](https://crates.io/crates/wasm-bindgen-backend) |
| Source record ids | crates_io-f246bb91c6b9ab |
...
For a systems engineer, wasm-bindgen-backend belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.104 | 2025-09-24T15:09:20.715312Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- `crates_io-f246bb91c6b9ab` from `crates_io` as `registry_expansion`
