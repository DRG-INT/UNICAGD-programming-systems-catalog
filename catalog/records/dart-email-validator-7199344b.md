...
<!-- canonical: https://pub.dev/packages/email_validator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/email_validator](https://pub.dev/packages/email_validator) |
| Source record ids | pub_dev-95fa22aea479cb |
...
For a systems engineer, email_validator belongs in the Dart inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.0 | 2024-06-21T13:46:38.945200Z | [https://pub.dev/api/packages/email_validator](https://pub.dev/api/packages/email_validator) |  |
| preview | known | 2.0.0-nullsafety | 2021-02-10T09:43:50.415592Z | [https://pub.dev/api/packages/email_validator](https://pub.dev/api/packages/email_validator) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/email_validator` at `2026-09-01T14:20:29+00:00`.
...
- `pub_dev-95fa22aea479cb` from `pub_dev` as `registry_expansion`
