...
| Canonical URL | [https://luarocks.org/modules/chensoft/kcp](https://luarocks.org/modules/chensoft/kcp) |
| Source record ids | luarocks_root_manifest-aed5429aaab835 |

## System Engineer Summary

kcp is tracked as a ffi bindings record in the Lua family branch. The source did not provide a long
...
For a systems engineer, kcp belongs in the Lua family inventory as part of cross-language
...
- `luarocks_root_manifest-aed5429aaab835` from `luarocks_root_manifest` as `registry_expansion`
