...
<!-- canonical: https://www.npmjs.com/package/@cubejs-backend/testing-shared -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@cubejs-backend/testing-shared](https://www.npmjs.com/package/@cubejs-backend/testing-shared) |
| Source record ids | npm_registry-317ab944fd7461 |

## System Engineer Summary

@cubejs-backend/testing-shared is tracked as an undefined behavior analyzer record in the
Node.js/JavaScript branch. The source did not provide a long description, so this page keeps the
identity, release state, provenance, and operational classification explicit for later enrichment.

## Operational Role

For a systems engineer, @cubejs-backend/testing-shared belongs in the Node.js/JavaScript inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.7.35 | 2026-09-07T15:14:59.623Z | [https://registry.npmjs.org/-/v1/search?text=testing&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=testing&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- Latest stable metadata was observed from `https://registry.npmjs.org/-/v1/search?text=testing&size=250&quality=0.35&popularity=0.45&maintenance=0.20` at `2026-09-07T16:20:11+00:00`.
...
- `npm_registry-317ab944fd7461` from `npm_registry` as `registry_expansion`
