...
<!-- canonical: https://pypi.org/project/ado_backlog_cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/ado_backlog_cli/](https://pypi.org/project/ado_backlog_cli/) |
| Source record ids | pypi_simple-8971ef72acda92 |
...
For a systems engineer, ado_backlog_cli belongs in the Python inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.8 | 2024-03-16T15:33:49.753694Z | [https://pypi.org/pypi/ado_backlog_cli/json](https://pypi.org/pypi/ado_backlog_cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/ado_backlog_cli/json` at `2026-09-01T07:19:47+00:00`.
...
- `pypi_simple-8971ef72acda92` from `pypi_simple` as `registry_expansion`
