...
<!-- canonical: https://github.com/Kong/ngx_wasm_module -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Kong/ngx_wasm_module](https://github.com/Kong/ngx_wasm_module) |
| Source record ids | github_search_webassembly-4c57958460c866 |

## System Engineer Summary

Kong/ngx_wasm_module is tracked as a library record in the WebAssembly branch. The source did not
...
For a systems engineer, Kong/ngx_wasm_module belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-03T21:18:17Z | gh search repos topic:wasi stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-4c57958460c866` from `github_search_webassembly` as `registry_expansion`
