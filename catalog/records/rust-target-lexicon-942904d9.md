...
<!-- canonical: https://crates.io/crates/target-lexicon -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/target-lexicon](https://crates.io/crates/target-lexicon) |
| Source record ids | crates_io-521965389146c1 |
...
For a systems engineer, target-lexicon belongs in the Rust inventory as part of compiler selection,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.13.5 | 2026-02-15T23:26:15.120555Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- `crates_io-521965389146c1` from `crates_io` as `registry_expansion`
