...
<!-- canonical: https://hackage.haskell.org/package/zwirn -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/zwirn](https://hackage.haskell.org/package/zwirn) |
| Source record ids | hackage_recent-099ef0f0903b8a |

## System Engineer Summary

Hackage package recently uploaded by MartinGius.

## Operational Role

For a systems engineer, zwirn belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.3.1 | 2026-09-15T17:56:20Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/packages/recent` at `2026-09-15T18:21:23+00:00`.
...
- `hackage_recent-099ef0f0903b8a` from `hackage_recent` as `registry_expansion`
