...
<!-- canonical: https://luarocks.org/modules/durrendal/atentu -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/durrendal/atentu](https://luarocks.org/modules/durrendal/atentu) |
| Source record ids | luarocks_root_manifest-2e3ec6827e6c5c |

## System Engineer Summary

atentu is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, atentu belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-2e3ec6827e6c5c` from `luarocks_root_manifest` as `registry_expansion`
