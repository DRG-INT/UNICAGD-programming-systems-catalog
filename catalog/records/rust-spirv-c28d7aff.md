...
| Canonical URL | [https://crates.io/crates/spirv](https://crates.io/crates/spirv) |
| Source record ids | crates_io-f5fdc7d4cc9d62 |
...
For a systems engineer, spirv belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0+sdk-1.4.341.0 | 2026-03-13T15:38:20.118579Z | [https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads) |  |
...
- `crates_io-f5fdc7d4cc9d62` from `crates_io` as `registry_expansion`
