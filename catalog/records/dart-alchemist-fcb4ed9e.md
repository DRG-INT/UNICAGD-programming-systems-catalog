...
<!-- canonical: https://pub.dev/packages/alchemist -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/alchemist](https://pub.dev/packages/alchemist) |
| Source record ids | pub_dev-16f7abc74ee8e1 |
...
For a systems engineer, alchemist belongs in the Dart inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.14.0 | 2026-03-13T13:33:30.915976Z | [https://pub.dev/api/packages/alchemist](https://pub.dev/api/packages/alchemist) |  |
| preview | known | 0.6.0-dev.1 | 2022-11-16T16:01:20.382909Z | [https://pub.dev/api/packages/alchemist](https://pub.dev/api/packages/alchemist) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/alchemist` at `2026-09-01T07:20:11+00:00`.
...
- `pub_dev-16f7abc74ee8e1` from `pub_dev` as `registry_expansion`
