...
| Canonical URL | [https://luarocks.org/modules/functorflow/functorflow](https://luarocks.org/modules/functorflow/functorflow) |
| Source record ids | luarocks_root_manifest-ed0d4958660793 |

## System Engineer Summary

FunctorFlow is tracked as a library record in the Lua family branch. The source did not provide a
...
For a systems engineer, FunctorFlow belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-ed0d4958660793` from `luarocks_root_manifest` as `registry_expansion`
