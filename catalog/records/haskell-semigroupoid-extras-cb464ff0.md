...
<!-- canonical: https://hackage.haskell.org/package/semigroupoid-extras -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/semigroupoid-extras](https://hackage.haskell.org/package/semigroupoid-extras) |
| Source record ids | hackage_top_downloads-e9a4802530a582 |
...
For a systems engineer, semigroupoid-extras belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5 | 2015-05-15T07:00:20Z | [https://hackage.haskell.org/package/semigroupoid-extras](https://hackage.haskell.org/package/semigroupoid-extras) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/semigroupoid-extras` at `2026-09-12T00:29:30+00:00`.
...
- `hackage_top_downloads-e9a4802530a582` from `hackage_top_downloads` as `registry_expansion`
