...
[Catalog index](../index.md) · [Language: Assembly](../by-language/assembly.md) · [Category: Build System](../by-category/build-system.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/unicity-aos/capsule-identity -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/unicity-aos/capsule-identity](https://github.com/unicity-aos/capsule-identity) |
| Source record ids | github_search_assembly-e6f5f54cdb71e6 |

## System Engineer Summary

System prompt builder. Assembles agent identity from workspace config and spark.toml. Part of
Unicity AOS.

## Operational Role

For a systems engineer, unicity-aos/capsule-identity belongs in the Assembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-02T04:13:02Z | gh search repos assembler stars:>300 | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-e6f5f54cdb71e6` from `github_search_assembly` as `registry_expansion`
