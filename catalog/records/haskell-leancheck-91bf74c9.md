...
<!-- canonical: https://hackage.haskell.org/package/leancheck -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/leancheck](https://hackage.haskell.org/package/leancheck) |
| Source record ids | hackage_top_downloads-53f66a394c3aa0 |
...
For a systems engineer, leancheck belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.4 | 2025-08-07T12:43:14Z | [https://hackage.haskell.org/package/leancheck](https://hackage.haskell.org/package/leancheck) |  |
| candidate | partial | 1.0.4 |  | [https://hackage.haskell.org/package/leancheck](https://hackage.haskell.org/package/leancheck) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/leancheck` at `2026-09-01T14:24:23+00:00`.
...
- `hackage_top_downloads-53f66a394c3aa0` from `hackage_top_downloads` as `registry_expansion`
