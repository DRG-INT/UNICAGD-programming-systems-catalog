...
<!-- canonical: https://github.com/hike-lab/public-data-lens -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/hike-lab/public-data-lens](https://github.com/hike-lab/public-data-lens) |
| Source record ids | github_search_catalogs-5e1c75f0600185 |

## System Engineer Summary

MCP-based discovery and judgment layer for Korea’s open data portal—helping AI agents find, compare,
and assess datasets with explicit evidence, JSON-LD/DCAT metadata, and versioned deterministic
rules.

## Operational Role

For a systems engineer, hike-lab/public-data-lens belongs in the Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-25T10:29:57Z | gh search repos topic:data-catalog stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-5e1c75f0600185` from `github_search_catalogs` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| infosecB/Rulehound | Lint Rule Pack | [open](catalogs-infosecb-rulehound-e095dcf6.md) |
