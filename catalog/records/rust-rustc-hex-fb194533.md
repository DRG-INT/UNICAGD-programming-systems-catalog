...
| Canonical URL | [https://crates.io/crates/rustc-hex](https://crates.io/crates/rustc-hex) |
| Source record ids | crates_io-58f0c30c652108 |
...
For a systems engineer, rustc-hex belongs in the Rust inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.0 | 2020-01-10T14:09:36.503165Z | [https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=13&per_page=100&sort=downloads) |  |
...
- `crates_io-58f0c30c652108` from `crates_io` as `registry_expansion`
