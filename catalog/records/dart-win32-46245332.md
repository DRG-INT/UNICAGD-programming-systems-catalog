...
<!-- canonical: https://pub.dev/packages/win32 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/win32](https://pub.dev/packages/win32) |
| Source record ids | pub_dev-baf4bc1643a1de |
...
For a systems engineer, win32 belongs in the Dart inventory as part of cross-language integration,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 6.4.0 | 2026-08-05T08:45:19.974634Z | [https://pub.dev/api/packages/win32](https://pub.dev/api/packages/win32) |  |
| preview | known | 2.1.0-pre.0 | 2021-04-25T03:25:12.376437Z | [https://pub.dev/api/packages/win32](https://pub.dev/api/packages/win32) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/win32` at `2026-09-01T16:41:06+00:00`.
...
- `pub_dev-baf4bc1643a1de` from `pub_dev` as `registry_expansion`
