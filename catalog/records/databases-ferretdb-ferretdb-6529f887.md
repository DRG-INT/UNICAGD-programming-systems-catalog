...
<!-- canonical: https://github.com/FerretDB/FerretDB -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/FerretDB/FerretDB](https://github.com/FerretDB/FerretDB) |
| Source record ids | github_search_databases-3a4cbee2ec1570 |
...
For a systems engineer, FerretDB/FerretDB belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-05T07:31:28Z | gh search repos topic:postgresql stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-3a4cbee2ec1570` from `github_search_databases` as `registry_expansion`
