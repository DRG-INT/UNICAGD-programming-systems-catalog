...
<!-- canonical: https://github.com/googleapis/mcp-toolbox -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/googleapis/mcp-toolbox](https://github.com/googleapis/mcp-toolbox) |
| Source record ids | github_search_databases-edd18f39dcd1d3 |
...
For a systems engineer, googleapis/mcp-toolbox belongs in the Databases inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T20:16:55Z | gh search repos topic:postgresql stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-edd18f39dcd1d3` from `github_search_databases` as `registry_expansion`
