...
<!-- canonical: https://cran.r-project.org/web/packages/mcauchyd/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mcauchyd/index.html](https://cran.r-project.org/web/packages/mcauchyd/index.html) |
| Source record ids | cran_packages_by_date-60d55a001a3d97 |
...
For a systems engineer, mcauchyd belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.3.6 | 2026-08-25 10:30:02 UTC | [https://cran.r-project.org/web/packages/mcauchyd/DESCRIPTION](https://cran.r-project.org/web/packages/mcauchyd/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mcauchyd/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-60d55a001a3d97` from `cran_packages_by_date` as `registry_expansion`
