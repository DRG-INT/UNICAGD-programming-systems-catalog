...
| Canonical URL | [https://gitlab.com/nb-tech-support/devops](https://gitlab.com/nb-tech-support/devops) |
| Source record ids | gitlab_projects_api-4f410f0e13f03d |
...
For a systems engineer, nb-tech-support/devops belongs in the Repository Workplaces inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-12-25T11:27:25.191Z | [https://gitlab.com/api/v4/projects?search=devops&order_by=star_count&sort=desc&simple=true&per_page=100](https://gitlab.com/api/v4/projects?search=devops&order_by=star_count&sort=desc&simple=true&per_page=100) | gitlab_projects_api_reports_activity_not_release_version |
...
- `gitlab_projects_api-4f410f0e13f03d` from `gitlab_projects_api` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| sandro.lechner/aula-devops-fundamentals | Library | [open](repository-workplaces-sandro-lechner-aula-devops-fundamentals-4052fbb6.md) |
