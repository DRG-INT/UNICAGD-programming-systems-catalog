...
<!-- canonical: https://www.npmjs.com/package/@mcp-ui/server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@mcp-ui/server](https://www.npmjs.com/package/@mcp-ui/server) |
| Source record ids | npm_registry-c85eb4fc134826 |

## System Engineer Summary

@mcp-ui/server is tracked as a web framework record in the Node.js/JavaScript branch. The source did
...
For a systems engineer, @mcp-ui/server belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 6.1.0 | 2026-02-13T00:56:47.232Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-c85eb4fc134826` from `npm_registry` as `registry_expansion`
