...
<!-- canonical: https://github.com/tenderlove/fisk -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tenderlove/fisk](https://github.com/tenderlove/fisk) |
| Source record ids | github_search_assembly-fe089d52b19de7 |

## System Engineer Summary

tenderlove/fisk is tracked as an undefined behavior analyzer record in the Assembly branch. The
...
For a systems engineer, tenderlove/fisk belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-04-07T23:47:40Z | gh search repos topic:x86 topic:assembly | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-fe089d52b19de7` from `github_search_assembly` as `registry_expansion`
