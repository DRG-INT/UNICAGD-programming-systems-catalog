...
<!-- canonical: https://cran.r-project.org/web/packages/libopenexr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/libopenexr/index.html](https://cran.r-project.org/web/packages/libopenexr/index.html) |
| Source record ids | cran_packages_by_date-419c4fd0f5e467 |

## System Engineer Summary

Static Library and Headers for 'OpenEXR' Image I/O

## Operational Role

For a systems engineer, libopenexr belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.4.12-6 | 2026-09-13 06:10:03 UTC | [https://cran.r-project.org/web/packages/libopenexr/DESCRIPTION](https://cran.r-project.org/web/packages/libopenexr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/libopenexr/DESCRIPTION` at `2026-09-13T06:28:29+00:00`.
...
- `cran_packages_by_date-419c4fd0f5e467` from `cran_packages_by_date` as `registry_expansion`
