...
<!-- canonical: https://cran.r-project.org/web/packages/robustrcp/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/robustrcp/index.html](https://cran.r-project.org/web/packages/robustrcp/index.html) |
| Source record ids | cran_packages_by_date-791b7a9149f81a |

## System Engineer Summary

Outlier-Robust Ratio-cum-Product Estimators of Finite Population Mean

## Operational Role

For a systems engineer, robustrcp belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-20 15:30:02 UTC | [https://cran.r-project.org/web/packages/robustrcp/DESCRIPTION](https://cran.r-project.org/web/packages/robustrcp/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/robustrcp/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-791b7a9149f81a` from `cran_packages_by_date` as `registry_expansion`
