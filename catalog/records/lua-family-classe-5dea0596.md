...
<!-- canonical: https://luarocks.org/modules/y-akulau/classe -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/y-akulau/classe](https://luarocks.org/modules/y-akulau/classe) |
| Source record ids | luarocks_root_manifest-db25466f6514ba |

## System Engineer Summary

classe is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, classe belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-db25466f6514ba` from `luarocks_root_manifest` as `registry_expansion`
