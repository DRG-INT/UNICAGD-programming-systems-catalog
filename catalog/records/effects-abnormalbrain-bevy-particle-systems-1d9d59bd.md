# abnormalbrain/bevy_particle_systems

## Navigation

[Catalog index](../index.md) · [Language: Effects](../by-language/effects.md) · [Category: Machine Learning](../by-category/machine-learning.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/abnormalbrain/bevy_particle_systems -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/abnormalbrain/bevy_particle_systems](https://github.com/abnormalbrain/bevy_particle_systems) |
| Source record ids | github_search_effects-b33227cb8c2ae3 |
...
For a systems engineer, abnormalbrain/bevy_particle_systems belongs in the Effects inventory as part
of model pipelines, numerical runtime constraints, and data/deployment interfaces.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-12-02T02:42:13Z | gh search repos particle system | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-09 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "particle system", "retrieved": "2026-09-09", "status": "forge-cli-derived"}` |
...
- `github_search_effects-b33227cb8c2ae3` from `github_search_effects` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| afterimage-lab/Rainform | Machine Learning | [open](effects-afterimage-lab-rainform-39857d48.md) |
| ampactor-labs/sonido | Machine Learning | [open](effects-ampactor-labs-sonido-bed68043.md) |
| bazz1tv/snestracker | Machine Learning | [open](effects-bazz1tv-snestracker-e6975267.md) |
| city41/particle.js | Machine Learning | [open](effects-city41-particle-js-e976a724.md) |
| cullenwebber/three-ml-sharp | Machine Learning | [open](effects-cullenwebber-three-ml-sharp-524c449b.md) |
| djeedai/bevy_hanabi | Machine Learning | [open](effects-djeedai-bevy-hanabi-e16b8425.md) |
| doomlaser/DepthMask-Unity-Shader | Machine Learning | [open](effects-doomlaser-depthmask-unity-shader-910913b1.md) |
| electro-smith/DaisySP | Machine Learning | [open](effects-electro-smith-daisysp-7dd7ed54.md) |
