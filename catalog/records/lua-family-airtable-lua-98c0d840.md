...
<!-- canonical: https://luarocks.org/modules/charmunk/airtable-lua -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/charmunk/airtable-lua](https://luarocks.org/modules/charmunk/airtable-lua) |
| Source record ids | luarocks_root_manifest-4a3ff20beb50ee |
...
For a systems engineer, airtable-lua belongs in the Lua family inventory as part of service
...
- `luarocks_root_manifest-4a3ff20beb50ee` from `luarocks_root_manifest` as `registry_expansion`
