...
<!-- canonical: https://github.com/OCSInventory-NG/OCSInventory-ocsreports -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/OCSInventory-NG/OCSInventory-ocsreports](https://github.com/OCSInventory-NG/OCSInventory-ocsreports) |
| Source record ids | github_search_assets-f10d491428c164 |
...
For a systems engineer, OCSInventory-NG/OCSInventory-ocsreports belongs in the Assets inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-25T07:57:08Z | gh search repos topic:assets stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-f10d491428c164` from `github_search_assets` as `registry_expansion`
