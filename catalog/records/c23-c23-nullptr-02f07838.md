...
| Source record ids | corpus-2acb544b1473db |

## System Engineer Summary

C23 nullptr is tracked as a language specification record in the C23 branch. The source did not
...
For a systems engineer, C23 nullptr belongs in the C23 inventory as part of ecosystem capability
...
- `corpus-2acb544b1473db` from `master_json` as `language_specification`
