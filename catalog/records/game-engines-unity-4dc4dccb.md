...
| Canonical URL | [https://unity.com/](https://unity.com/) |
| Source record ids | curated_language_routes-4d81de9f7cf911 |

## System Engineer Summary

Real-time development platform and game engine for 2D/3D projects, editor workflows, assets,
physics, and deployment.

## Operational Role

For a systems engineer, Unity belongs in the Game Engines inventory as part of ecosystem capability
...
- `curated_language_routes-4d81de9f7cf911` from `curated_language_routes` as `registry_expansion`
