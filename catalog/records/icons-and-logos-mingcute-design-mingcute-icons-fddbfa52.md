...
<!-- canonical: https://github.com/mingcute-design/mingcute-icons -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mingcute-design/mingcute-icons](https://github.com/mingcute-design/mingcute-icons) |
| Source record ids | github_search_icons_and_logos-82338478396276 |

## System Engineer Summary

Carefully designed icons for modern interfaces. MingCute is a simple, elegant open-source icon
library built for web and mobile products.

## Operational Role

For a systems engineer, mingcute-design/mingcute-icons belongs in the Icons and Logos inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-31T09:08:45Z | gh search repos topic:icons stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-82338478396276` from `github_search_icons_and_logos` as `registry_expansion`
