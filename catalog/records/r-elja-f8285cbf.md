...
<!-- canonical: https://cran.r-project.org/web/packages/Elja/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/Elja/index.html](https://cran.r-project.org/web/packages/Elja/index.html) |
| Source record ids | cran_packages_by_date-f2c5ee3e0f422f |
...
For a systems engineer, Elja belongs in the R inventory as part of diagnostics, metrics,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.1 | 2026-08-24 19:20:02 UTC | [https://cran.r-project.org/web/packages/Elja/DESCRIPTION](https://cran.r-project.org/web/packages/Elja/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/Elja/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-f2c5ee3e0f422f` from `cran_packages_by_date` as `registry_expansion`
