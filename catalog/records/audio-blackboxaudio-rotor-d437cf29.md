...
[Catalog index](../index.md) · [Language: Audio](../by-language/audio.md) · [Category: Formatter](../by-category/formatter.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/blackboxaudio/rotor -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/blackboxaudio/rotor](https://github.com/blackboxaudio/rotor) |
| Source record ids | github_search_audio-ad5ddaa868f3ad |
...
For a systems engineer, blackboxaudio/rotor belongs in the Audio inventory as part of low-noise code
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-11-21T23:50:42Z | gh search repos topic:audio-plugin stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-ad5ddaa868f3ad` from `github_search_audio` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| atsushieno/aap-core | Formatter | [open](audio-atsushieno-aap-core-1b7d89bc.md) |
| blackcandy-org/blackcandy | Formatter | [open](audio-blackcandy-org-blackcandy-e95601ca.md) |
| elk-audio/mda-vst3 | Formatter | [open](audio-elk-audio-mda-vst3-c4b43ffb.md) |
| ExistentialAudio/BlackHole | Formatter | [open](audio-existentialaudio-blackhole-14b406da.md) |
| MikeMorenoDSP/LIRA-8 | Formatter | [open](audio-mikemorenodsp-lira-8-251c75e9.md) |
| MycroftAI/ZZZ-RETIRED__openstt | Formatter | [open](audio-mycroftai-zzz-retired-openstt-d192df70.md) |
| pdeljanov/Symphonia | Formatter | [open](audio-pdeljanov-symphonia-b302ab81.md) |
| pytorch/audio | Formatter | [open](audio-pytorch-audio-d02c37b9.md) |
