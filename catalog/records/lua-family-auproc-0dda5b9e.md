...
<!-- canonical: https://luarocks.org/modules/osch/auproc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/osch/auproc](https://luarocks.org/modules/osch/auproc) |
| Source record ids | luarocks_root_manifest-48b29229ee99fb |
...
For a systems engineer, auproc belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-48b29229ee99fb` from `luarocks_root_manifest` as `registry_expansion`
...
| Digital Signal Processing | Image Audio Dsp | [open](lua-family-digital-signal-processing-cff5d9fc.md) |
