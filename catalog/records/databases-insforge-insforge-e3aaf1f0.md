...
<!-- canonical: https://github.com/InsForge/InsForge -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/InsForge/InsForge](https://github.com/InsForge/InsForge) |
| Source record ids | github_search_databases-6eb69d4fb95d8b |

## System Engineer Summary

The all-in-one, open-source backend platform for agentic coding. InsForge gives your coding agent
database, auth, storage, compute, hosting, and AI gateway to ship full-stack apps end-to-end.

## Operational Role

For a systems engineer, InsForge/InsForge belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T22:39:08Z | gh search repos topic:postgresql stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-6eb69d4fb95d8b` from `github_search_databases` as `registry_expansion`
