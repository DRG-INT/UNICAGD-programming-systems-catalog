...
[Catalog index](../index.md) · [Language: WebAssembly](../by-language/webassembly.md) · [Category: Testing Framework](../by-category/testing-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/WebAssembly/testsuite -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/WebAssembly/testsuite](https://github.com/WebAssembly/testsuite) |
| Source record ids | github_search_webassembly-716a4aa7a94a3a |
...
For a systems engineer, WebAssembly/testsuite belongs in the WebAssembly inventory as part of
...
- `github_search_webassembly-716a4aa7a94a3a` from `github_search_webassembly` as `registry_expansion`
