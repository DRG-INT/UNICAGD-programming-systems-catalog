...
<!-- canonical: https://github.com/je-suis-tm/web-scraping -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/je-suis-tm/web-scraping](https://github.com/je-suis-tm/web-scraping) |
| Source record ids | github_search_magazines-d534bc363240a3 |

## System Engineer Summary

Detailed web scraping tutorials for dummies with financial data crawlers on Reddit WallStreetBets,
CME (both options and futures), US Treasury, CFTC, LME, MacroTrends, SHFE and alternative data
crawlers on Tomtom, BBC, Wall Street Journal, Al Jazeera, Reuters, Financial Times, Bloomberg, CNN,
Fortune, The Economist

## Operational Role

For a systems engineer, je-suis-tm/web-scraping belongs in the Magazines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-02-01T14:40:40Z | gh search repos topic:newsletter stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-d534bc363240a3` from `github_search_magazines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Destaq/life-calendar | Datetime | [open](magazines-destaq-life-calendar-9a3fafa0.md) |
