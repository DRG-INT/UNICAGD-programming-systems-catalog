...
<!-- canonical: https://github.com/Snailclimb/JavaGuide -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Snailclimb/JavaGuide](https://github.com/Snailclimb/JavaGuide) |
| Source record ids | github_search_databases-cd56219238813b |
...
For a systems engineer, Snailclimb/JavaGuide belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T01:38:01Z | gh search repos topic:mysql stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-cd56219238813b` from `github_search_databases` as `registry_expansion`
