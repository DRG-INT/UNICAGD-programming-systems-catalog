...
<!-- canonical: https://github.com/tmroyal/woff-viewer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tmroyal/woff-viewer](https://github.com/tmroyal/woff-viewer) |
| Source record ids | github_search_font_briefcase-1e87f325b3539f |

## System Engineer Summary

Simple web application allowing for the basic viewing of woff and woff2 file. Additional
functionality for searching and viewing Unicode descriptions and ranges.

## Operational Role

For a systems engineer, tmroyal/woff-viewer belongs in the Font Briefcase inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-09-06T19:24:05Z | gh search repos topic:woff2 stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_font_briefcase-1e87f325b3539f` from `github_search_font_briefcase` as `registry_expansion`
