...
| Source record ids | corpus-6b6b2d250b1160 |

## System Engineer Summary

libmicrohttpd is tracked as a networking http record in the C99 branch. The source did not provide a
...
For a systems engineer, libmicrohttpd belongs in the C99 inventory as part of service communication,
...
- `corpus-6b6b2d250b1160` from `master_json` as `networking_http`
...
| libevent | Networking Http | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-libevent-60eb4ee1.md) |
