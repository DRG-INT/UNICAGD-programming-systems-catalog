...
<!-- canonical: https://luarocks.org/modules/mah0x211/clock -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/mah0x211/clock](https://luarocks.org/modules/mah0x211/clock) |
| Source record ids | luarocks_root_manifest-b0c8903dab3130 |
...
For a systems engineer, clock belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-b0c8903dab3130` from `luarocks_root_manifest` as `registry_expansion`
