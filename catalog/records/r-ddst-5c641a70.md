...
<!-- canonical: https://cran.r-project.org/web/packages/ddst/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ddst/index.html](https://cran.r-project.org/web/packages/ddst/index.html) |
| Source record ids | cran_packages_by_date-507b6b8b6694c2 |
...
For a systems engineer, ddst belongs in the R inventory as part of unit/integration validation,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.6.11 | 2026-09-12 05:10:02 UTC | [https://cran.r-project.org/web/packages/ddst/DESCRIPTION](https://cran.r-project.org/web/packages/ddst/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ddst/DESCRIPTION` at `2026-09-12T06:23:40+00:00`.
...
- `cran_packages_by_date-507b6b8b6694c2` from `cran_packages_by_date` as `registry_expansion`
