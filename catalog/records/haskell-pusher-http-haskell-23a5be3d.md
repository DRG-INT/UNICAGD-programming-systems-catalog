...
<!-- canonical: https://hackage.haskell.org/package/pusher-http-haskell -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/pusher-http-haskell](https://hackage.haskell.org/package/pusher-http-haskell) |
| Source record ids | hackage_top_downloads-7471d1a556c501 |
...
For a systems engineer, pusher-http-haskell belongs in the Haskell inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.0.25 | 2026-06-01T00:49:07Z | [https://hackage.haskell.org/package/pusher-http-haskell](https://hackage.haskell.org/package/pusher-http-haskell) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/pusher-http-haskell` at `2026-09-01T14:24:28+00:00`.
...
- `hackage_top_downloads-7471d1a556c501` from `hackage_top_downloads` as `registry_expansion`
