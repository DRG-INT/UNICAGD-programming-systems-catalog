...
<!-- canonical: https://github.com/ys-ll/uniterm -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ys-ll/uniterm](https://github.com/ys-ll/uniterm) |
| Source record ids | github_search_space_maps-0ad71b0a88b5e0 |

## System Engineer Summary

A lightweight all-in-one terminal with 30+ protocols — SSH, RDP, SFTP, databases, Kubernetes and
more. With a built-in autonomous AI Agent that plans and runs multi-turn shell commands.

## Operational Role

For a systems engineer, ys-ll/uniterm belongs in the Space Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T14:01:09Z | gh search repos topic:spice stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-0ad71b0a88b5e0` from `github_search_space_maps` as `registry_expansion`
