...
<!-- canonical: https://hackage.haskell.org/package/shikumi-eval -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/shikumi-eval](https://hackage.haskell.org/package/shikumi-eval) |
| Source record ids | hackage_recent-d3fb17ca1c884a |
...
For a systems engineer, shikumi-eval belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.0.0 | 2026-09-08T19:34:12Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-d3fb17ca1c884a` from `hackage_recent` as `registry_expansion`
