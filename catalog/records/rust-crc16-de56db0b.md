...
| Canonical URL | [https://crates.io/crates/crc16](https://crates.io/crates/crc16) |
| Source record ids | crates_io-998d7cc9bb4ed2 |

## System Engineer Summary

crc16 is tracked as a library record in the Rust branch. The source did not provide a long
...
For a systems engineer, crc16 belongs in the Rust inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0 | 2018-05-28T09:15:47.613118Z | [https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=16&per_page=100&sort=downloads) |  |
...
- `crates_io-998d7cc9bb4ed2` from `crates_io` as `registry_expansion`
