...
| Source record ids | github_search_electromagnetoscopes-bfe5fceed10840 |

## System Engineer Summary

miek/inspectrum is tracked as an image audio dsp record in the Electromagnetoscopes branch. The
...
For a systems engineer, miek/inspectrum belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.4.0 | 2025-12-06T15:44:29Z | [https://api.github.com/repos/miek/inspectrum/releases/latest](https://api.github.com/repos/miek/inspectrum/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/miek/inspectrum/releases/latest` at `2026-09-01T08:26:41+00:00`.
...
- `github_search_electromagnetoscopes-bfe5fceed10840` from `github_search_electromagnetoscopes` as `registry_expansion`
