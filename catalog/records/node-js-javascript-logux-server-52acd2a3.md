...
<!-- canonical: https://www.npmjs.com/package/@logux/server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@logux/server](https://www.npmjs.com/package/@logux/server) |
| Source record ids | npm_registry-26fe282d706ea6 |

## System Engineer Summary

@logux/server is tracked as a build system record in the Node.js/JavaScript branch. The source did
...
For a systems engineer, @logux/server belongs in the Node.js/JavaScript inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.16.3 | 2026-09-12T15:26:35.941Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- Latest stable metadata was observed from `https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20` at `2026-09-12T16:19:23+00:00`.
...
- `npm_registry-26fe282d706ea6` from `npm_registry` as `registry_expansion`
