...
<!-- canonical: https://hackage.haskell.org/package/jsaddle -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/jsaddle](https://hackage.haskell.org/package/jsaddle) |
| Source record ids | hackage_top_downloads-278e738726442c |
...
For a systems engineer, jsaddle belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.9.4 | 2026-03-26T04:40:37Z | [https://hackage.haskell.org/package/jsaddle](https://hackage.haskell.org/package/jsaddle) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/jsaddle` at `2026-09-01T14:24:22+00:00`.
...
- `hackage_top_downloads-278e738726442c` from `hackage_top_downloads` as `registry_expansion`
