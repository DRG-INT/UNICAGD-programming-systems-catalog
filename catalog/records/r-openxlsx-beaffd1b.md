...
<!-- canonical: https://cran.r-project.org/web/packages/openxlsx/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/openxlsx/index.html](https://cran.r-project.org/web/packages/openxlsx/index.html) |
| Source record ids | cran_packages_by_date-a79128bc2b90f7 |
...
For a systems engineer, openxlsx belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.2.9 | 2026-09-02 09:30:02 UTC | [https://cran.r-project.org/web/packages/openxlsx/DESCRIPTION](https://cran.r-project.org/web/packages/openxlsx/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/openxlsx/DESCRIPTION` at `2026-09-02T10:21:04+00:00`.
...
- `cran_packages_by_date-a79128bc2b90f7` from `cran_packages_by_date` as `registry_expansion`
