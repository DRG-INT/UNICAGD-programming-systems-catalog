...
<!-- canonical: https://github.com/nkarasiak/dzetsaka -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nkarasiak/dzetsaka](https://github.com/nkarasiak/dzetsaka) |
| Source record ids | github_search_electromagnetoscopes-df86889ee194da |
...
For a systems engineer, nkarasiak/dzetsaka belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-29T21:21:24Z | gh search repos topic:rf stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-df86889ee194da` from `github_search_electromagnetoscopes` as `registry_expansion`
