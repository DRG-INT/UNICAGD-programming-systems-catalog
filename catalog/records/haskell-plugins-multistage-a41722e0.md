...
<!-- canonical: https://hackage.haskell.org/package/plugins-multistage -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/plugins-multistage](https://hackage.haskell.org/package/plugins-multistage) |
| Source record ids | hackage_top_downloads-798d424cf55159 |
...
For a systems engineer, plugins-multistage belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.3 | 2020-03-11T15:05:04Z | [https://hackage.haskell.org/package/plugins-multistage](https://hackage.haskell.org/package/plugins-multistage) |  |
| candidate | partial | 0.6.3 |  | [https://hackage.haskell.org/package/plugins-multistage](https://hackage.haskell.org/package/plugins-multistage) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/plugins-multistage` at `2026-09-01T14:24:27+00:00`.
...
- `hackage_top_downloads-798d424cf55159` from `hackage_top_downloads` as `registry_expansion`
