...
[Catalog index](../index.md) · [Language: Cocoa](../by-language/cocoa.md) · [Category: Parser Lexer Ast](../by-category/parser-lexer-ast.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/pinterest/PINCache -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pinterest/PINCache](https://github.com/pinterest/PINCache) |
| Source record ids | github_search_cocoa-a8c3e4a5456454 |
...
For a systems engineer, pinterest/PINCache belongs in the Cocoa inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T22:01:39Z | gh search repos topic:cocoapods stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-a8c3e4a5456454` from `github_search_cocoa` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| CaliCastle/PopMenu | Parser Lexer Ast | [open](cocoa-calicastle-popmenu-4a75e526.md) |
| CocoaLumberjack/CocoaLumberjack | Parser Lexer Ast | [open](cocoa-cocoalumberjack-cocoalumberjack-5c5f99b5.md) |
| Mijick/Popups | Parser Lexer Ast | [open](cocoa-mijick-popups-14686208.md) |
| twitter/scrooge | Parser Lexer Ast | [open](cocoa-twitter-scrooge-3eef7c88.md) |
