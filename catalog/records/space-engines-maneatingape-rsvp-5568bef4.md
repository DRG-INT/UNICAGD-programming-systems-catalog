...
| Canonical URL | [https://github.com/maneatingape/rsvp](https://github.com/maneatingape/rsvp) |
| Source record ids | github_search_space_engines-c29fd692a8d42b |

## System Engineer Summary

kOS library that enables scripted orbital transfer window planning and vessel rendezvous for the the
game Kerbal Space Program

## Operational Role

For a systems engineer, maneatingape/rsvp belongs in the Space Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v9 | 2023-02-18T18:57:47Z | [https://api.github.com/repos/maneatingape/rsvp/releases/latest](https://api.github.com/repos/maneatingape/rsvp/releases/latest) |  |
...
| Evidence | Apache-2.0; License :: OSI Approved :: Apache Software License; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
- Latest stable metadata was observed from `https://api.github.com/repos/maneatingape/rsvp/releases/latest` at `2026-09-01T07:24:19+00:00`.
...
- `github_search_space_engines-c29fd692a8d42b` from `github_search_space_engines` as `registry_expansion`
