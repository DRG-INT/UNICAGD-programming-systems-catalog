...
[Catalog index](../index.md) · [Language: Cocoa](../by-language/cocoa.md) · [Category: Api Abi Checker](../by-category/api-abi-checker.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/progrium/darwinkit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/progrium/darwinkit](https://github.com/progrium/darwinkit) |
| Source record ids | github_search_cocoa-876769e3e625aa |
...
For a systems engineer, progrium/darwinkit belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-03-08T16:47:06Z | gh search repos topic:cocoa stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-876769e3e625aa` from `github_search_cocoa` as `registry_expansion`
