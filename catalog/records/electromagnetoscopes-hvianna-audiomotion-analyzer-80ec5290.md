...
[Catalog index](../index.md) · [Language: Electromagnetoscopes](../by-language/electromagnetoscopes.md) · [Category: Dependency Manager](../by-category/dependency-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/hvianna/audioMotion-analyzer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/hvianna/audioMotion-analyzer](https://github.com/hvianna/audioMotion-analyzer) |
| Source record ids | github_search_electromagnetoscopes-fd56a589fcf57d |
...
For a systems engineer, hvianna/audioMotion-analyzer belongs in the Electromagnetoscopes inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-19T19:08:01Z | gh search repos topic:spectrum-analyzer stars:>10 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-02 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:spectrum-analyzer stars:>10", "retrieved": "2026-09-02", "status": "forge-cli-derived"}` |
...
- `github_search_electromagnetoscopes-fd56a589fcf57d` from `github_search_electromagnetoscopes` as `registry_expansion`
