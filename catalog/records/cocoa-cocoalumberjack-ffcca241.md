...
<!-- canonical: https://cocoapods.org/pods/CocoaLumberjack -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cocoapods.org/pods/CocoaLumberjack](https://cocoapods.org/pods/CocoaLumberjack) |
| Source record ids | cocoapods_cdn-c4a6f9cda48dc2 |
...
For a systems engineer, CocoaLumberjack belongs in the Cocoa inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.9.1 | 2026-04-16 06:33:41 UTC | [https://trunk.cocoapods.org/api/v1/pods/CocoaLumberjack](https://trunk.cocoapods.org/api/v1/pods/CocoaLumberjack) |  |
| preview | known | 2.1.0-rc | 2015-10-22 13:13:15 UTC | [https://trunk.cocoapods.org/api/v1/pods/CocoaLumberjack](https://trunk.cocoapods.org/api/v1/pods/CocoaLumberjack) |  |
...
- Latest stable metadata was observed from `https://trunk.cocoapods.org/api/v1/pods/CocoaLumberjack` at `2026-09-01T07:21:27+00:00`.
...
- `cocoapods_cdn-c4a6f9cda48dc2` from `cocoapods_cdn` as `registry_expansion`
