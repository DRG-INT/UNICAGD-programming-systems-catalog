...
| Canonical URL | [https://luarocks.org/modules/lomori/external-oid](https://luarocks.org/modules/lomori/external-oid) |
| Source record ids | luarocks_root_manifest-1ae29f3eb1787a |

## System Engineer Summary

External OID plugin for Kong.

## Operational Role

For a systems engineer, external-oid belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-1ae29f3eb1787a` from `luarocks_root_manifest` as `registry_expansion`
