...
| Source record ids | master-cc5d985dddfa |

## System Engineer Summary

Nginx-based web platform embedding Lua

## Operational Role

For a systems engineer, OpenResty belongs in the Lua family inventory as part of request routing,
...
- `master-cc5d985dddfa` from `master_json` as `web_framework`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Lapis | Web Framework | [open](lua-family-lapis-d301e93f.md) |
| Pegasus.lua | Web Framework | [open](lua-family-pegasus-lua-0e3051d2.md) |
| Sailor | Web Framework | [open](lua-family-sailor-fad8364d.md) |
