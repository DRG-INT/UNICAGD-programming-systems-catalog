...
<!-- canonical: https://luarocks.org/modules/e3oroush/askcode -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/e3oroush/askcode](https://luarocks.org/modules/e3oroush/askcode) |
| Source record ids | luarocks_root_manifest-f151ca141c2131 |

## System Engineer Summary

An AI-powered assistant for Neovim that connects to services like Gemini and Amazon Q to help you
understand and write code directly in your editor.

## Operational Role

For a systems engineer, askcode belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-f151ca141c2131` from `luarocks_root_manifest` as `registry_expansion`
