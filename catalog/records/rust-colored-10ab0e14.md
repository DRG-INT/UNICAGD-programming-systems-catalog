...
<!-- canonical: https://crates.io/crates/colored -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/colored](https://crates.io/crates/colored) |
| Source record ids | crates_io-3548963dd7ec1b |
...
For a systems engineer, colored belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.1.1 | 2026-01-16T16:13:51.893178Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
- `crates_io-3548963dd7ec1b` from `crates_io` as `registry_expansion`
