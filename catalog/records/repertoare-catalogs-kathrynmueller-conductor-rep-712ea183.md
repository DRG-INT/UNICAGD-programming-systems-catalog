...
<!-- canonical: https://github.com/kathrynmueller/conductor-rep -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/kathrynmueller/conductor-rep](https://github.com/kathrynmueller/conductor-rep) |
| Source record ids | github_search_repertoare_catalogs-c3c4ff5cf3e874 |

## System Engineer Summary

Web application that allows a conductor to catalog and sort repertoire and present public-facing
info

## Operational Role

For a systems engineer, kathrynmueller/conductor-rep belongs in the Repertoare Catalogs inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-01-17T14:11:20Z | gh search repos repertoire catalog | gh_search_reports_activity_not_release_version |
...
| Evidence | Other; Mozilla Public License 2.0; https://api.github.com/licenses/mpl-2.0; {"key": "", "name": "", "url": ""} |
...
- `github_search_repertoare_catalogs-c3c4ff5cf3e874` from `github_search_repertoare_catalogs` as `registry_expansion`
