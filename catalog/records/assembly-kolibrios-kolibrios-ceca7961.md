...
<!-- canonical: https://github.com/KolibriOS/kolibrios -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/KolibriOS/kolibrios](https://github.com/KolibriOS/kolibrios) |
| Source record ids | github_search_assembly-a4de8eb40ec14b |
...
For a systems engineer, KolibriOS/kolibrios belongs in the Assembly inventory as part of cross-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T12:02:50Z | gh search repos topic:assembly stars:>300 | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-a4de8eb40ec14b` from `github_search_assembly` as `registry_expansion`
...
| cheng-alvin/jas | Ffi Bindings | [open](assembly-cheng-alvin-jas-3c7aa7a0.md) |
