...
<!-- canonical: https://crates.io/crates/rpassword -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/rpassword](https://crates.io/crates/rpassword) |
| Source record ids | crates_io-70c86481b02bdd |
...
For a systems engineer, rpassword belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 7.5.4 | 2026-05-31T07:30:19.957545Z | [https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=12&per_page=100&sort=downloads) |  |
...
- `crates_io-70c86481b02bdd` from `crates_io` as `registry_expansion`
