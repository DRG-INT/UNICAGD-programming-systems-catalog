...
<!-- canonical: https://github.com/hustcc/canvas-nest.js -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/hustcc/canvas-nest.js](https://github.com/hustcc/canvas-nest.js) |
| Source record ids | github_search_effects-1790499b8e9e85 |
...
For a systems engineer, hustcc/canvas-nest.js belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v2.0.1 | 2018-06-23T04:31:11Z | [https://api.github.com/repos/hustcc/canvas-nest.js/releases/latest](https://api.github.com/repos/hustcc/canvas-nest.js/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/hustcc/canvas-nest.js/releases/latest` at `2026-09-01T09:23:10+00:00`.
...
- `github_search_effects-1790499b8e9e85` from `github_search_effects` as `registry_expansion`
