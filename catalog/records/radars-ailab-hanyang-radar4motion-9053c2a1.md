...
<!-- canonical: https://github.com/ailab-hanyang/Radar4Motion -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ailab-hanyang/Radar4Motion](https://github.com/ailab-hanyang/Radar4Motion) |
| Source record ids | github_search_radars-fceaed52a8104e |

## System Engineer Summary

(T-IV) Radar4Motion: 4D Imaging Radar based IMU-free Odometry with Radar Cross Section (RCS)
weighted Correspondences

## Operational Role

For a systems engineer, ailab-hanyang/Radar4Motion belongs in the Radars inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-06-15T09:01:50Z | gh search repos topic:radar stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-fceaed52a8104e` from `github_search_radars` as `registry_expansion`
