...
<!-- canonical: https://cran.r-project.org/web/packages/ghcclm/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ghcclm/index.html](https://cran.r-project.org/web/packages/ghcclm/index.html) |
| Source record ids | cran_packages_by_date-f11944cf80c6c3 |

## System Engineer Summary

Generalized Hybrid Contrast Coding in Linear Models

## Operational Role

For a systems engineer, ghcclm belongs in the R inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-08 13:00:06 UTC | [https://cran.r-project.org/web/packages/ghcclm/DESCRIPTION](https://cran.r-project.org/web/packages/ghcclm/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ghcclm/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-f11944cf80c6c3` from `cran_packages_by_date` as `registry_expansion`
