...
<!-- canonical: https://github.com/x-ream/sqli -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/x-ream/sqli](https://github.com/x-ream/sqli) |
| Source record ids | github_search_databases-8e4f67ae81c6cf |
...
For a systems engineer, x-ream/sqli belongs in the Databases inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-24T03:14:00Z | gh search repos topic:jdbc stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; MIT License; https://api.github.com/licenses/mit; Other; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; The Unlicense; https://api.github.com/licenses/unlicense |
...
- `github_search_databases-8e4f67ae81c6cf` from `github_search_databases` as `registry_expansion`
