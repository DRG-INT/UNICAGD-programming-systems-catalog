...
<!-- canonical: https://www.nuget.org/packages/Flurl.Http -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Flurl.Http](https://www.nuget.org/packages/Flurl.Http) |
| Source record ids | nuget_search-660e566a533400 |
...
For a systems engineer, Flurl.Http belongs in the C-Sharp inventory as part of unit/integration
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.0.2 | 2024-01-17T21:26:28.65+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/flurl.http/index.json](https://api.nuget.org/v3/registration5-gz-semver2/flurl.http/index.json) |  |
| preview | known | 4.0.0-pre7 | 2023-12-08T05:51:09.867+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/flurl.http/index.json](https://api.nuget.org/v3/registration5-gz-semver2/flurl.http/index.json) |  |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/flurl.http/index.json` at `2026-09-01T07:23:57+00:00`.
...
- `nuget_search-660e566a533400` from `nuget_search` as `registry_expansion`
...
| RichardSzalay.MockHttp | Testing Framework | [open](c-sharp-richardszalay-mockhttp-4f55fe95.md) |
