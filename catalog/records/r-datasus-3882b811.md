...
<!-- canonical: https://cran.r-project.org/web/packages/datasus/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/datasus/index.html](https://cran.r-project.org/web/packages/datasus/index.html) |
| Source record ids | cran_packages_by_date-62a8a813fdea83 |

## System Engineer Summary

An Interface to Brazilian Public Health Data

## Operational Role

For a systems engineer, datasus belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.16.1 | 2026-09-05 13:10:02 UTC | [https://cran.r-project.org/web/packages/datasus/DESCRIPTION](https://cran.r-project.org/web/packages/datasus/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/datasus/DESCRIPTION` at `2026-09-05T14:17:39+00:00`.
...
- `cran_packages_by_date-62a8a813fdea83` from `cran_packages_by_date` as `registry_expansion`
