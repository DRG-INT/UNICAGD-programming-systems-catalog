...
<!-- canonical: https://github.com/xushier/HD-Icons-docker -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/xushier/HD-Icons-docker](https://github.com/xushier/HD-Icons-docker) |
| Source record ids | github_search_icons_and_logos-3111d1ec5d3c4c |

## System Engineer Summary

HD-Icons 图标展示项目的 Docker 工具，可在网页查看、复制、更新、上传图标，与 HD-Icons 保持同步。

## Operational Role

For a systems engineer, xushier/HD-Icons-docker belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-07-01T07:12:03Z | gh search repos topic:logo stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_icons_and_logos-3111d1ec5d3c4c` from `github_search_icons_and_logos` as `registry_expansion`
