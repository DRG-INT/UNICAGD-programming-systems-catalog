...
<!-- canonical: https://github.com/SwiftGen/SwiftGen -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/SwiftGen/SwiftGen](https://github.com/SwiftGen/SwiftGen) |
| Source record ids | github_search_swift-a4feafb01791a8 |

## System Engineer Summary

The Swift code generator for your assets, storyboards, Localizable.strings, … — Get rid of all
String-based APIs!

## Operational Role

For a systems engineer, SwiftGen/SwiftGen belongs in the Swift inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-16T08:20:58Z | gh search repos language:Swift stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-a4feafb01791a8` from `github_search_swift` as `registry_expansion`
