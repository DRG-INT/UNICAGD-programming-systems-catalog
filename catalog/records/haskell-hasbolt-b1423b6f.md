...
<!-- canonical: https://hackage.haskell.org/package/hasbolt -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/hasbolt](https://hackage.haskell.org/package/hasbolt) |
| Source record ids | hackage_top_downloads-6be5a95d9ac615 |
...
For a systems engineer, hasbolt belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.7.2 | 2025-11-11T10:13:07Z | [https://hackage.haskell.org/package/hasbolt](https://hackage.haskell.org/package/hasbolt) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/hasbolt` at `2026-09-01T14:24:18+00:00`.
...
- `hackage_top_downloads-6be5a95d9ac615` from `hackage_top_downloads` as `registry_expansion`
