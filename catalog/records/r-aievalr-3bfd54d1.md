...
<!-- canonical: https://cran.r-project.org/web/packages/aiEvalR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/aiEvalR/index.html](https://cran.r-project.org/web/packages/aiEvalR/index.html) |
| Source record ids | cran_packages_by_date-ce76ae8384c69f |
...
For a systems engineer, aiEvalR belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-30 09:10:27 UTC | [https://cran.r-project.org/web/packages/aiEvalR/DESCRIPTION](https://cran.r-project.org/web/packages/aiEvalR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/aiEvalR/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-ce76ae8384c69f` from `cran_packages_by_date` as `registry_expansion`
