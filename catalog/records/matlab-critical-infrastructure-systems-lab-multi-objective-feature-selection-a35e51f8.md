# Critical-Infrastructure-Systems-Lab/Multi-objective-feature-selection
...
<!-- canonical: https://github.com/Critical-Infrastructure-Systems-Lab/Multi-objective-feature-selection -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Critical-Infrastructure-Systems-Lab/Multi-objective-feature-selection](https://github.com/Critical-Infrastructure-Systems-Lab/Multi-objective-feature-selection) |
| Source record ids | github_search_matlab-82eb9d764d7b73 |

## System Engineer Summary

MatLab implementation of W-QEISS, F-QEISS and W-MOSS: three algorithms for the selection of (quasi)
equally informative subsets

## Operational Role

For a systems engineer, Critical-Infrastructure-Systems-Lab/Multi-objective-feature-selection
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-05-19T12:51:27Z | gh search repos language:MATLAB topic:machine-learning | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-82eb9d764d7b73` from `github_search_matlab` as `registry_expansion`
