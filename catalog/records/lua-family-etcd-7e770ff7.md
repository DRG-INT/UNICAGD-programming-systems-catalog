...
| Canonical URL | [https://luarocks.org/modules/anibali/etcd](https://luarocks.org/modules/anibali/etcd) |
| Source record ids | luarocks_root_manifest-888780c08f76c1 |

## System Engineer Summary

etcd is tracked as a networking http record in the Lua family branch. The source did not provide a
...
For a systems engineer, etcd belongs in the Lua family inventory as part of service communication,
...
- `luarocks_root_manifest-888780c08f76c1` from `luarocks_root_manifest` as `registry_expansion`
