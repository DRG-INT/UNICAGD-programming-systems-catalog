...
[Catalog index](../index.md) · [Language: Telescopes](../by-language/telescopes.md) · [Category: Networking Http](../by-category/networking-http.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/telescopejs/telescope -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/telescopejs/telescope](https://github.com/telescopejs/telescope) |
| Source record ids | github_search_telescopes-a9edd1f978011f |

## System Engineer Summary

🔭 The service ( from Client or Server ) works for render view ( markdown / code / image... ) from
fetching URL.

## Operational Role

For a systems engineer, telescopejs/telescope belongs in the Telescopes inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-12-07T13:25:21Z | gh search repos topic:telescope stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_telescopes-a9edd1f978011f` from `github_search_telescopes` as `registry_expansion`
