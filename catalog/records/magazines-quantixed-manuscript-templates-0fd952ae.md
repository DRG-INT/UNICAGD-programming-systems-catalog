...
[Catalog index](../index.md) · [Language: Magazines](../by-language/magazines.md) · [Category: Project Scaffolding](../by-category/project-scaffolding.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/quantixed/manuscript-templates -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/quantixed/manuscript-templates](https://github.com/quantixed/manuscript-templates) |
| Source record ids | github_search_magazines-b0928f7c33acdb |

## System Engineer Summary

LaTeX templates for manuscripts. bioRxiv preprint and journal submission templates. For use on
Overleaf.

## Operational Role

For a systems engineer, quantixed/manuscript-templates belongs in the Magazines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-01-21T08:54:04Z | gh search repos topic:journal stars:>20 | gh_search_reports_activity_not_release_version |
...
| Evidence | Do What The F*ck You Want To Public License; https://api.github.com/licenses/wtfpl; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0 |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-12 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:journal stars:>20", "retrieved": "2026-09-12", "status": "forge-cli-derived"}` |
...
- `github_search_magazines-b0928f7c33acdb` from `github_search_magazines` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| blogger-templates/Plus-UI-V3.7.0 | Project Scaffolding | [open](magazines-blogger-templates-plus-ui-v3-7-0-c6d6a0c1.md) |
| chrisnmorrison/revista-gatsby-blog-magazine | Project Scaffolding | [open](magazines-chrisnmorrison-revista-gatsby-blog-magazine-99fc1244.md) |
| edgarlr/magazine | Project Scaffolding | [open](magazines-edgarlr-magazine-ca1ef2f0.md) |
| emailmonday/Cerberus | Project Scaffolding | [open](magazines-emailmonday-cerberus-362169d4.md) |
| james-d-h/quarto-phd-thesis | Project Scaffolding | [open](magazines-james-d-h-quarto-phd-thesis-bd759f31.md) |
| jazzband/django-newsletter | Project Scaffolding | [open](magazines-jazzband-django-newsletter-e0a873c3.md) |
| loke-dev/sveltekit-mdsvex-blog-template | Project Scaffolding | [open](magazines-loke-dev-sveltekit-mdsvex-blog-template-632f36d8.md) |
| razacreative/blog-dark | Project Scaffolding | [open](magazines-razacreative-blog-dark-50487664.md) |
