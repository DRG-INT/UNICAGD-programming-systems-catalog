...
<!-- canonical: https://github.com/inexorgame/vulkan-renderer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/inexorgame/vulkan-renderer](https://github.com/inexorgame/vulkan-renderer) |
| Source record ids | github_search_engines-a18c59016a2f84 |

## System Engineer Summary

A new, render-graph based 3D game engine for Linux and Windows using C++20 and Vulkan API 1.3 (in
early development)

## Operational Role

For a systems engineer, inexorgame/vulkan-renderer belongs in the Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-10T23:43:59Z | gh search repos topic:engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-a18c59016a2f84` from `github_search_engines` as `registry_expansion`
