...
<!-- canonical: https://github.com/aminueza/terraform-provider-minio -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/aminueza/terraform-provider-minio](https://github.com/aminueza/terraform-provider-minio) |
| Source record ids | github_search_databases-7ba1b4850d938f |

## System Engineer Summary

Terraform provider for MinIO and S3-compatible storage (R2, B2, Hetzner, Spaces) — buckets, IAM,
replication, lifecycle, encryption & more.

## Operational Role

For a systems engineer, aminueza/terraform-provider-minio belongs in the Databases inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T13:22:33Z | gh search repos topic:object-storage stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-7ba1b4850d938f` from `github_search_databases` as `registry_expansion`
