...
<!-- canonical: https://hackage.haskell.org/package/markdown -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/markdown](https://hackage.haskell.org/package/markdown) |
| Source record ids | hackage_top_downloads-104daf3eef270f |
...
For a systems engineer, markdown belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.17.5 | 2021-09-29T05:41:04Z | [https://hackage.haskell.org/package/markdown](https://hackage.haskell.org/package/markdown) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/markdown` at `2026-09-01T14:24:24+00:00`.
...
- `hackage_top_downloads-104daf3eef270f` from `hackage_top_downloads` as `registry_expansion`
