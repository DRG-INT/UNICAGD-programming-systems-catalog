...
<!-- canonical: https://github.com/AsjadIqbal/InventoryManagementSystem -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/AsjadIqbal/InventoryManagementSystem](https://github.com/AsjadIqbal/InventoryManagementSystem) |
| Source record ids | github_search_databases-3440a253b13cab |

## System Engineer Summary

This is an inventory management software built in Java using MySQL database that can be used at any
Point of Sale of a small to mid-sized store.

## Operational Role

For a systems engineer, AsjadIqbal/InventoryManagementSystem belongs in the Databases inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-02-11T07:13:38Z | gh search repos topic:jdbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-3440a253b13cab` from `github_search_databases` as `registry_expansion`
