...
<!-- canonical: https://github.com/ffaxl/spice_kernels -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ffaxl/spice_kernels](https://github.com/ffaxl/spice_kernels) |
| Source record ids | github_search_space_maps-924512922a0892 |

## System Engineer Summary

ffaxl/spice_kernels is tracked as a library record in the Space Maps branch. The source did not
...
For a systems engineer, ffaxl/spice_kernels belongs in the Space Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-12-30T17:06:37Z | gh search repos SPICE kernels | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-924512922a0892` from `github_search_space_maps` as `registry_expansion`
