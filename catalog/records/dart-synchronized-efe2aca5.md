...
[Catalog index](../index.md) · [Language: Dart](../by-language/dart.md) · [Category: Async Runtime](../by-category/async-runtime.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://pub.dev/packages/synchronized -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/synchronized](https://pub.dev/packages/synchronized) |
| Source record ids | pub_dev-43908f2199c3f7 |
...
For a systems engineer, synchronized belongs in the Dart inventory as part of concurrency
...
- `pub_dev-43908f2199c3f7` from `pub_dev` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| async | Async Runtime | [open](dart-async-c11b24b8.md) |
| dropdown_search | Async Runtime | [open](dart-dropdown-search-4ffe6c19.md) |
| loader_overlay | Async Runtime | [open](dart-loader-overlay-73331022.md) |
| localstorage | Async Runtime | [open](dart-localstorage-e3529975.md) |
| retry | Async Runtime | [open](dart-retry-e99e010e.md) |
