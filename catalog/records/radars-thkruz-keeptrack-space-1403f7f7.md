...
[Catalog index](../index.md) · [Language: Radars](../by-language/radars.md) · [Category: Type Checker](../by-category/type-checker.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/thkruz/keeptrack.space -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/thkruz/keeptrack.space](https://github.com/thkruz/keeptrack.space) |
| Source record ids | github_search_radars-d37a079421179f |

## System Engineer Summary

🌎📡 TypeScript Astrodynamics Software for Non-Engineers. 3D Visualization of satellite data and the
sensors that track them.

## Operational Role

For a systems engineer, thkruz/keeptrack.space belongs in the Radars inventory as part of interface
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-10T12:18:20Z | gh search repos topic:radar stars:>20 | gh_search_reports_activity_not_release_version |
...
| Evidence | Apache License 2.0; https://api.github.com/licenses/apache-2.0; Creative Commons Attribution Share Alike 4.0 International; https://api.github.com/licenses/cc-by-sa-4.0; GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0 |
...
- `github_search_radars-d37a079421179f` from `github_search_radars` as `registry_expansion`
