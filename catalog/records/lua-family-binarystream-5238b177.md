...
<!-- canonical: https://luarocks.org/modules/tarik02/binarystream -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/tarik02/binarystream](https://luarocks.org/modules/tarik02/binarystream) |
| Source record ids | luarocks_root_manifest-eed7bece43cd50 |
...
For a systems engineer, binarystream belongs in the Lua family inventory as part of cross-language
...
- `luarocks_root_manifest-eed7bece43cd50` from `luarocks_root_manifest` as `registry_expansion`
