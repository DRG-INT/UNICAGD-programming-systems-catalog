...
<!-- canonical: https://cran.r-project.org/web/packages/ggpop/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/ggpop/index.html](https://cran.r-project.org/web/packages/ggpop/index.html) |
| Source record ids | cran_packages_by_date-908d6d2b615fb9 |

## System Engineer Summary

Icon-Based Population Charts and Plots for 'ggplot2'

## Operational Role

For a systems engineer, ggpop belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.8.0 | 2026-08-23 20:10:11 UTC | [https://cran.r-project.org/web/packages/ggpop/DESCRIPTION](https://cran.r-project.org/web/packages/ggpop/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/ggpop/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-908d6d2b615fb9` from `cran_packages_by_date` as `registry_expansion`
