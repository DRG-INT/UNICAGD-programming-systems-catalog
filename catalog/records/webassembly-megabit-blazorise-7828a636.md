...
<!-- canonical: https://github.com/Megabit/Blazorise -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Megabit/Blazorise](https://github.com/Megabit/Blazorise) |
| Source record ids | github_search_webassembly-3cb5a27196184d |

## System Engineer Summary

Blazorise is a component library built on top of Blazor with support for CSS frameworks like
Bootstrap, Tailwind, Bulma, AntDesign, and Material.

## Operational Role

For a systems engineer, Megabit/Blazorise belongs in the WebAssembly inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T08:44:25Z | gh search repos topic:wasm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-3cb5a27196184d` from `github_search_webassembly` as `registry_expansion`
