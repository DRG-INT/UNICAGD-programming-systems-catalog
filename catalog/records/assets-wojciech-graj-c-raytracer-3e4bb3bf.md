...
<!-- canonical: https://github.com/wojciech-graj/C-Raytracer -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/wojciech-graj/C-Raytracer](https://github.com/wojciech-graj/C-Raytracer) |
| Source record ids | github_search_assets-1495709a9e6a29 |
...
For a systems engineer, wojciech-graj/C-Raytracer belongs in the Assets inventory as part of hot-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-04-29T11:14:57Z | gh search repos topic:textures stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-1495709a9e6a29` from `github_search_assets` as `registry_expansion`
