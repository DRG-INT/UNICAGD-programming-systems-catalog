...
<!-- canonical: https://github.com/tokern/piicatcher -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tokern/piicatcher](https://github.com/tokern/piicatcher) |
| Source record ids | github_search_catalogs-de5eea1304fe4c |

## System Engineer Summary

Scan databases and data warehouses for PII data. Tag tables and columns in data catalogs like
Amundsen and Datahub

## Operational Role

For a systems engineer, tokern/piicatcher belongs in the Catalogs inventory as part of defect
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-01-05T17:37:23Z | gh search repos topic:catalog stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | GPL (>= 2.0); {"key": "", "name": "", "url": ""}; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
- `github_search_catalogs-de5eea1304fe4c` from `github_search_catalogs` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| ICIJ/extract | Static Analyzer | [open](catalogs-icij-extract-23bf4f26.md) |
