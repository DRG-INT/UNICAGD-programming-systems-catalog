...
[Catalog index](../index.md) · [Language: WebAssembly](../by-language/webassembly.md) · [Category: Memory Analyzer](../by-category/memory-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/ruvnet/RuVector -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ruvnet/RuVector](https://github.com/ruvnet/RuVector) |
| Source record ids | github_search_webassembly-a2ef0fa44bb2fd |
...
For a systems engineer, ruvnet/RuVector belongs in the WebAssembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T15:31:43Z | gh search repos topic:wasm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-a2ef0fa44bb2fd` from `github_search_webassembly` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| plbrault/youre-the-os | Memory Analyzer | [open](webassembly-plbrault-youre-the-os-d4e46ea2.md) |
| studio-lagier/heapviz | Memory Analyzer | [open](webassembly-studio-lagier-heapviz-52eb5d17.md) |
