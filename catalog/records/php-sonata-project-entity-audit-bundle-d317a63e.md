...
<!-- canonical: https://packagist.org/packages/sonata-project/entity-audit-bundle -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/sonata-project/entity-audit-bundle](https://packagist.org/packages/sonata-project/entity-audit-bundle) |
| Source record ids | packagist_search-b5bf6447318ec7 |
...
For a systems engineer, sonata-project/entity-audit-bundle belongs in the PHP inventory as part of
...
- `packagist_search-b5bf6447318ec7` from `packagist_search` as `registry_expansion`
