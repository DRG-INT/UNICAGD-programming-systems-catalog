...
<!-- canonical: https://github.com/yonie/WetReverb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/yonie/WetReverb](https://github.com/yonie/WetReverb) |
| Source record ids | github_search_audio-64a8ee526068e8 |

## System Engineer Summary

An open-source reverb with 80s rack-style character: five modes, 24 kHz internal rate, 12-bit
quantisation. Free, MIT, VST3 for Windows, macOS and Linux.

## Operational Role

For a systems engineer, yonie/WetReverb belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-30T10:32:46Z | gh search repos topic:audio-plugin stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_audio-64a8ee526068e8` from `github_search_audio` as `registry_expansion`
