...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Julia](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/julia.md) · [Category: Web Framework](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/web-framework.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/jll/C/code_server_jll](https://github.com/JuliaRegistries/General/tree/master/jll/C/code_server_jll) |
| Source record ids | julia_general-f199b32d702bd8 |

## System Engineer Summary

Julia package registered in General at jll/C/code_server_jll.

## Operational Role

For a systems engineer, code_server_jll belongs in the Julia inventory as part of request routing,
...
| Name | Category | Page |
| --- | --- | --- |
| BokehServer | Web Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-bokehserver-eff4705a.md) |
| CacheServers | Web Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-cacheservers-9b8be051.md) |
| CallableExpressions | Web Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-callableexpressions-1ee969a5.md) |
| CFMMRouter | Web Framework | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/julia-cfmmrouter-ae5831db.md) |
