...
<!-- canonical: https://luarocks.org/modules/mistrza/cfg -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/mistrza/cfg](https://luarocks.org/modules/mistrza/cfg) |
| Source record ids | luarocks_root_manifest-caefd084c0b9ac |

## System Engineer Summary

Context free grammar expander

## Operational Role

For a systems engineer, cfg belongs in the Lua family inventory as part of language tooling, code
...
- `luarocks_root_manifest-caefd084c0b9ac` from `luarocks_root_manifest` as `registry_expansion`
