...
| Canonical URL | [https://www.npmjs.com/package/@exodus/account-security](https://www.npmjs.com/package/@exodus/account-security) |
| Source record ids | npm_registry-9abe8d5afdac61 |

## System Engineer Summary

This Exodus SDK feature reports active account security warnings (GLOBAL_SCAM / LOST_PERMISSIONS)
into the Safe Report.

## Operational Role

For a systems engineer, @exodus/account-security belongs in the Node.js/JavaScript inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.0 | 2026-06-25T06:51:35.295Z | [https://registry.npmjs.org/-/v1/search?text=security&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=security&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-9abe8d5afdac61` from `npm_registry` as `registry_expansion`
