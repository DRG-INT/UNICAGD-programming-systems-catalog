...
<!-- canonical: https://github.com/fscorrupt/posterizarr -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/fscorrupt/posterizarr](https://github.com/fscorrupt/posterizarr) |
| Source record ids | github_search_assets-f72b861b61783b |
...
For a systems engineer, fscorrupt/posterizarr belongs in the Assets inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T11:44:12Z | gh search repos topic:assets stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-f72b861b61783b` from `github_search_assets` as `registry_expansion`
