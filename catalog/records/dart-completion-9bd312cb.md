...
<!-- canonical: https://pub.dev/packages/completion -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/completion](https://pub.dev/packages/completion) |
| Source record ids | pub_dev-ac799a2cdc2a43 |
...
For a systems engineer, completion belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.2 | 2025-07-17T23:04:20.696556Z | [https://pub.dev/api/packages/completion](https://pub.dev/api/packages/completion) |  |
| preview | known | 0.1.0-dev+1 | 2014-02-15T23:00:26.395650Z | [https://pub.dev/api/packages/completion](https://pub.dev/api/packages/completion) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/completion` at `2026-09-01T07:20:13+00:00`.
...
- `pub_dev-ac799a2cdc2a43` from `pub_dev` as `registry_expansion`
