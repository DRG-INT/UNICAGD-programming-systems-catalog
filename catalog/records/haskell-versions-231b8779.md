...
<!-- canonical: https://hackage.haskell.org/package/versions -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/versions](https://hackage.haskell.org/package/versions) |
| Source record ids | hackage_top_downloads-f43f235be8c54b |
...
For a systems engineer, versions belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 6.0.9 | 2026-08-27T21:23:00Z | [https://hackage.haskell.org/package/versions](https://hackage.haskell.org/package/versions) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/versions` at `2026-09-01T14:24:36+00:00`.
...
- `hackage_top_downloads-f43f235be8c54b` from `hackage_top_downloads` as `registry_expansion`
