...
| Canonical URL | [https://github.com/LaoFeng-mouse/flyingmouse-format](https://github.com/LaoFeng-mouse/flyingmouse-format) |
| Source record ids | github_search_video-b8f8c8da86958b |

## System Engineer Summary

飞鼠格式 FlyingMouse Format - Windows 免费文件格式转换工具（离线可用，内置
FFmpeg/LibreOffice/Poppler/Tesseract）。图片/文档/表格/PPT/PDF/音视频/WPS 格式互转 + OCR +
批量转换；音频仅支持普通格式。作者：牢蜂（LaoFeng）｜仅供个人免费使用，禁止商业售卖/转卖/套壳

## Operational Role

For a systems engineer, LaoFeng-mouse/flyingmouse-format belongs in the Video inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T14:32:12Z | gh search repos topic:ffmpeg stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-b8f8c8da86958b` from `github_search_video` as `registry_expansion`
