...
<!-- canonical: https://github.com/Chocolate4U/Iran-v2ray-rules -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Chocolate4U/Iran-v2ray-rules](https://github.com/Chocolate4U/Iran-v2ray-rules) |
| Source record ids | github_search_maps-10fea8add81628 |

## System Engineer Summary

Enhanced v2ray/xray and v2ray/xray-clients routing rules with built-in Iranian domains and a focus
on security and adblocking.

## Operational Role

For a systems engineer, Chocolate4U/Iran-v2ray-rules belongs in the Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T01:11:12Z | gh search repos topic:routing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-10fea8add81628` from `github_search_maps` as `registry_expansion`
