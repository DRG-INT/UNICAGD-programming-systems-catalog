...
<!-- canonical: https://github.com/napari/napari -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/napari/napari](https://github.com/napari/napari) |
| Source record ids | curated_language_routes-8bfd91f7990072 |

## System Engineer Summary

n-dimensional image viewer and plugin platform for microscopy, annotation, segmentation, and
analysis.

## Operational Role

For a systems engineer, napari belongs in the Microscopy inventory as part of ecosystem capability
...
- `curated_language_routes-8bfd91f7990072` from `curated_language_routes` as `registry_expansion`
