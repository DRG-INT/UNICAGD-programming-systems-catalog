...
<!-- canonical: https://luarocks.org/modules/luarocks/diff -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/luarocks/diff](https://luarocks.org/modules/luarocks/diff) |
| Source record ids | luarocks_root_manifest-b9d5880ad9e368 |

## System Engineer Summary

Diff is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, Diff belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-b9d5880ad9e368` from `luarocks_root_manifest` as `registry_expansion`
