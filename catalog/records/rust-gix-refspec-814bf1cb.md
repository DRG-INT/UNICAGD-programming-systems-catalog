...
<!-- canonical: https://crates.io/crates/gix-refspec -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/gix-refspec](https://crates.io/crates/gix-refspec) |
| Source record ids | crates_io-d5888f57ed2450 |
...
For a systems engineer, gix-refspec belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.45.1 | 2026-08-24T13:57:44.457865Z | [https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=14&per_page=100&sort=downloads) |  |
