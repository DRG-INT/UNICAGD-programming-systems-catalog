...
<!-- canonical: https://github.com/acyucel/VoxHenry -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/acyucel/VoxHenry](https://github.com/acyucel/VoxHenry) |
| Source record ids | github_search_electromagnetoscopes-cd3a18ae150c38 |
...
For a systems engineer, acyucel/VoxHenry belongs in the Electromagnetoscopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-01-02T22:04:08Z | gh search repos topic:electromagnetics stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-cd3a18ae150c38` from `github_search_electromagnetoscopes` as `registry_expansion`
