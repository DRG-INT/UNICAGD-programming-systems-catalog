...
<!-- canonical: https://pypi.org/project/a2a-cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/a2a-cli/](https://pypi.org/project/a2a-cli/) |
| Source record ids | pypi_simple-4059840d65f036 |
...
For a systems engineer, a2a-cli belongs in the Python inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2 | 2025-08-26T18:02:27.240744Z | [https://pypi.org/pypi/a2a-cli/json](https://pypi.org/pypi/a2a-cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/a2a-cli/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-4059840d65f036` from `pypi_simple` as `registry_expansion`
