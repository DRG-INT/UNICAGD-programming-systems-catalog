...
<!-- canonical: https://gitlab.com/just.insane/kubernetes -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/just.insane/kubernetes](https://gitlab.com/just.insane/kubernetes) |
| Source record ids | gitlab_projects_api-0d4e3eafd4810a |

## System Engineer Summary

Kubernetes Cluster configuration and services documentation/files.

## Operational Role

For a systems engineer, just.insane/kubernetes belongs in the Repository Workplaces inventory as
...
- `gitlab_projects_api-0d4e3eafd4810a` from `gitlab_projects_api` as `registry_expansion`
