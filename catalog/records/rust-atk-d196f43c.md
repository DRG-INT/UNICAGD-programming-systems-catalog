...
| Canonical URL | [https://crates.io/crates/atk](https://crates.io/crates/atk) |
| Source record ids | crates_io-e579b76b0e79d9 |
...
For a systems engineer, atk belongs in the Rust inventory as part of cross-language integration, ABI
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.18.2 | 2024-12-09T11:45:55.239461Z | [https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads) |  |
...
- `crates_io-e579b76b0e79d9` from `crates_io` as `registry_expansion`
