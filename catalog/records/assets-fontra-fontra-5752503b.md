...
<!-- canonical: https://github.com/fontra/fontra -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/fontra/fontra](https://github.com/fontra/fontra) |
| Source record ids | github_search_assets-7029232b69a915 |
...
For a systems engineer, fontra/fontra belongs in the Assets inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T14:19:37Z | gh search repos topic:fonts stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-7029232b69a915` from `github_search_assets` as `registry_expansion`
...
| JeffersonQin/YuzuMarker.FontDetection | Ide Editor Integration | [open](assets-jeffersonqin-yuzumarker-fontdetection-c21fcdcb.md) |
