...
<!-- canonical: https://crates.io/crates/aws-sdk-ssooidc -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/aws-sdk-ssooidc](https://crates.io/crates/aws-sdk-ssooidc) |
| Source record ids | crates_io-89ec63336cdf3d |
...
For a systems engineer, aws-sdk-ssooidc belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.111.0 | 2026-09-04T19:07:01.502485Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads` at `2026-09-04T20:18:55+00:00`.
...
- `crates_io-89ec63336cdf3d` from `crates_io` as `registry_expansion`
