...
<!-- canonical: https://github.com/Jack-Hayes/planetquery -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Jack-Hayes/planetquery](https://github.com/Jack-Hayes/planetquery) |
| Source record ids | github_search_space_maps-cf854c2a22fafa |

## System Engineer Summary

Voila and Binder interactvie web map for fetching (Xarray-standard) and visualzing COGs
(localtileserver) from the Planetary Computer STAC

## Operational Role

For a systems engineer, Jack-Hayes/planetquery belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-10-15T05:47:38Z | gh search repos planetary maps | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-cf854c2a22fafa` from `github_search_space_maps` as `registry_expansion`
