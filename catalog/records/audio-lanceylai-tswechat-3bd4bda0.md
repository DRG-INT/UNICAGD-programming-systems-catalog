...
| Canonical URL | [https://github.com/lanceylai/TSWeChat](https://github.com/lanceylai/TSWeChat) |
| Source record ids | github_search_audio-8edf70d6b63fe5 |
...
For a systems engineer, lanceylai/TSWeChat belongs in the Audio inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.0 | 2016-11-26T14:05:45Z | [https://api.github.com/repos/lanceylai/TSWeChat/releases/latest](https://api.github.com/repos/lanceylai/TSWeChat/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/lanceylai/TSWeChat/releases/latest` at `2026-09-01T09:23:17+00:00`.
...
- `github_search_audio-8edf70d6b63fe5` from `github_search_audio` as `registry_expansion`
