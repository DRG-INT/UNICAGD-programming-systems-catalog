...
<!-- canonical: https://hackage.haskell.org/package/inj -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/inj](https://hackage.haskell.org/package/inj) |
| Source record ids | hackage_recent-9407f3530f90ff |

## System Engineer Summary

Hackage package recently uploaded by int_index.

## Operational Role

For a systems engineer, inj belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0 | 2026-09-03T18:02:48Z | [https://hackage.haskell.org/package/inj](https://hackage.haskell.org/package/inj) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/inj` at `2026-09-04T13:25:57+00:00`.
...
- `hackage_recent-9407f3530f90ff` from `hackage_recent` as `registry_expansion`
