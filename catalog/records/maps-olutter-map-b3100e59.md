...
<!-- canonical: https://github.com/olutter/map -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/olutter/map](https://github.com/olutter/map) |
| Source record ids | github_search_maps-1fd2638bc4544c |

## System Engineer Summary

Lightweight Map widget for flutter supporting different projections including
EPSG4326/Mercator/WGS1984.

## Operational Role

For a systems engineer, olutter/map belongs in the Maps inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-16T14:48:12Z | gh search repos topic:vector-tiles stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-1fd2638bc4544c` from `github_search_maps` as `registry_expansion`
