...
[Catalog index](../index.md) · [Language: Catalogs](../by-language/catalogs.md) · [Category: Language Specification](../by-category/language-specification.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/vercel/components.build -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/vercel/components.build](https://github.com/vercel/components.build) |
| Source record ids | github_search_catalogs-65c73917b9de3b |
...
For a systems engineer, vercel/components.build belongs in the Catalogs inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-20T09:04:44Z | gh search repos topic:registry stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-65c73917b9de3b` from `github_search_catalogs` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| acode/cli | Language Specification | [open](catalogs-acode-cli-1ebd111e.md) |
| datenoio/dataportals-registry | Language Specification | [open](catalogs-datenoio-dataportals-registry-cb7b7ccb.md) |
| Schema.org | Language Specification | [open](catalogs-schema-org-e6f3f640.md) |
