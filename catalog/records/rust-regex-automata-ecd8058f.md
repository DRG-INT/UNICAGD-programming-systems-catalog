...
<!-- canonical: https://crates.io/crates/regex-automata -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/regex-automata](https://crates.io/crates/regex-automata) |
| Source record ids | crates_io-7c47bfe64bf92c |
...
For a systems engineer, regex-automata belongs in the Rust inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.18 | 2026-08-04T13:10:37.385020Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-7c47bfe64bf92c` from `crates_io` as `registry_expansion`
