...
<!-- canonical: https://github.com/juicedata/juicefs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/juicedata/juicefs](https://github.com/juicedata/juicefs) |
| Source record ids | github_search_databases-4ac971c345a017 |
...
For a systems engineer, juicedata/juicefs belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T11:57:36Z | gh search repos topic:object-storage stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-4ac971c345a017` from `github_search_databases` as `registry_expansion`
