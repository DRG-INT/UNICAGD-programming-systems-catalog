...
<!-- canonical: https://github.com/ming1016/SwiftPamphletApp -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ming1016/SwiftPamphletApp](https://github.com/ming1016/SwiftPamphletApp) |
| Source record ids | github_search_swift-198ce632ef44ae |

## System Engineer Summary

戴铭的小册子，一本活的知识手册。使用 SwiftUI + SwiftData + Swift Concurrency Aysnc/Await Actor + GitHub API 开发的 macOS
应用

## Operational Role

For a systems engineer, ming1016/SwiftPamphletApp belongs in the Swift inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-08-16T09:03:34Z | gh search repos topic:swiftui stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-198ce632ef44ae` from `github_search_swift` as `registry_expansion`
