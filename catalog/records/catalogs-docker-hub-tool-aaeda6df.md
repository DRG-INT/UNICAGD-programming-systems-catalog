...
<!-- canonical: https://github.com/docker/hub-tool -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/docker/hub-tool](https://github.com/docker/hub-tool) |
| Source record ids | github_search_catalogs-80a0fabc02215e |
...
For a systems engineer, docker/hub-tool belongs in the Catalogs inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-03-16T18:08:27Z | gh search repos topic:registry stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-80a0fabc02215e` from `github_search_catalogs` as `registry_expansion`
