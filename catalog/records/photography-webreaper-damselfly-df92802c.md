...
| Canonical URL | [https://github.com/Webreaper/Damselfly](https://github.com/Webreaper/Damselfly) |
| Source record ids | github_search_photography-8c4f222246b162 |

## System Engineer Summary

Damselfly is a server-based Photograph Management app. The goal of Damselfly is to index an
extremely large collection of images, and allow easy search and retrieval of those images, using
metadata such as the IPTC keyword tags, as well as the folder and file names. Damselfly includes
support for object/face detection.

## Operational Role

For a systems engineer, Webreaper/Damselfly belongs in the Photography inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.5.3 | 2026-01-14T13:50:05Z | [https://api.github.com/repos/Webreaper/Damselfly/releases/latest](https://api.github.com/repos/Webreaper/Damselfly/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/Webreaper/Damselfly/releases/latest` at `2026-09-01T09:23:35+00:00`.
...
- `github_search_photography-8c4f222246b162` from `github_search_photography` as `registry_expansion`
