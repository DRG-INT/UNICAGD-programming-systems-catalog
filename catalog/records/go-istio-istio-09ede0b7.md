...
<!-- canonical: https://github.com/istio/istio -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/istio/istio](https://github.com/istio/istio) |
| Source record ids | github_search_go-15edcc5c3c6b88 |
...
For a systems engineer, istio/istio belongs in the Go inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T01:13:17Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-15edcc5c3c6b88` from `github_search_go` as `registry_expansion`
