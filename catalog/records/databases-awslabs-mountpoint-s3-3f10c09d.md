...
<!-- canonical: https://github.com/awslabs/mountpoint-s3 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/awslabs/mountpoint-s3](https://github.com/awslabs/mountpoint-s3) |
| Source record ids | github_search_databases-ea43e520eedd47 |
...
For a systems engineer, awslabs/mountpoint-s3 belongs in the Databases inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T11:16:31Z | gh search repos topic:object-storage stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-ea43e520eedd47` from `github_search_databases` as `registry_expansion`
