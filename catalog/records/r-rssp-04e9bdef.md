...
<!-- canonical: https://cran.r-project.org/web/packages/rSSP/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rSSP/index.html](https://cran.r-project.org/web/packages/rSSP/index.html) |
| Source record ids | cran_packages_by_date-1ec975510c1869 |

## System Engineer Summary

Single Acceptance Sampling Plans for Time-Truncated Life Test

## Operational Role

For a systems engineer, rSSP belongs in the R inventory as part of unit/integration validation,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-09-14 20:00:02 UTC | [https://cran.r-project.org/web/packages/rSSP/DESCRIPTION](https://cran.r-project.org/web/packages/rSSP/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rSSP/DESCRIPTION` at `2026-09-14T20:20:20+00:00`.
...
- `cran_packages_by_date-1ec975510c1869` from `cran_packages_by_date` as `registry_expansion`
