...
<!-- canonical: https://cran.r-project.org/web/packages/reporter/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/reporter/index.html](https://cran.r-project.org/web/packages/reporter/index.html) |
| Source record ids | cran_packages_by_date-1115737008092b |
...
For a systems engineer, reporter belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.9 | 2026-09-12 14:40:14 UTC | [https://cran.r-project.org/web/packages/reporter/DESCRIPTION](https://cran.r-project.org/web/packages/reporter/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/reporter/DESCRIPTION` at `2026-09-12T16:19:31+00:00`.
...
- `cran_packages_by_date-1115737008092b` from `cran_packages_by_date` as `registry_expansion`
