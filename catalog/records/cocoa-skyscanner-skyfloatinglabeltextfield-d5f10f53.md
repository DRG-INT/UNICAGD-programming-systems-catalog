...
[Catalog index](../index.md) · [Language: Cocoa](../by-language/cocoa.md) · [Category: Static Analyzer](../by-category/static-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Skyscanner/SkyFloatingLabelTextField -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Skyscanner/SkyFloatingLabelTextField](https://github.com/Skyscanner/SkyFloatingLabelTextField) |
| Source record ids | github_search_cocoa-586e2bb009bc9c |

## System Engineer Summary

A beautiful and flexible text field control implementation of "Float Label Pattern". Written in
Swift.

## Operational Role

For a systems engineer, Skyscanner/SkyFloatingLabelTextField belongs in the Cocoa inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-07-14T20:03:31Z | gh search repos topic:cocoapods stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_cocoa-586e2bb009bc9c` from `github_search_cocoa` as `registry_expansion`
