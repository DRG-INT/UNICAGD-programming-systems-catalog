...
<!-- canonical: https://github.com/flipped-aurora/gin-vue-admin -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/flipped-aurora/gin-vue-admin](https://github.com/flipped-aurora/gin-vue-admin) |
| Source record ids | github_search_go-866604ca57e9e5 |

## System Engineer Summary

🚀Vite+Vue3+Gin拥有AI辅助的基础开发平台，企业级业务AI+开发解决方案，内置mcp辅助服务，内置skills管理，支持TS和JS混用。它集成了JWT鉴权、权限管理、动态路由、显隐可控组件
、分页封装、多点登录拦截、资源权限、上传下载、代码生成器、表单生成器和可配置的导入导出等开发必备功能。

## Operational Role

For a systems engineer, flipped-aurora/gin-vue-admin belongs in the Go inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T08:38:30Z | gh search repos topic:golang stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-866604ca57e9e5` from `github_search_go` as `registry_expansion`
