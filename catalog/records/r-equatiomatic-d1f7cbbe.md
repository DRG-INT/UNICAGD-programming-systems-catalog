...
<!-- canonical: https://cran.r-project.org/web/packages/equatiomatic/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/equatiomatic/index.html](https://cran.r-project.org/web/packages/equatiomatic/index.html) |
| Source record ids | cran_packages_by_date-dc551400cfbb11 |
...
For a systems engineer, equatiomatic belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.9 | 2026-08-19 12:50:09 UTC | [https://cran.r-project.org/web/packages/equatiomatic/DESCRIPTION](https://cran.r-project.org/web/packages/equatiomatic/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/equatiomatic/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-dc551400cfbb11` from `cran_packages_by_date` as `registry_expansion`
