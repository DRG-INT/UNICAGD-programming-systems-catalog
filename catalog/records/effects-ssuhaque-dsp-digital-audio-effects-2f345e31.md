# ssuhaque/DSP_Digital_Audio_Effects
...
<!-- canonical: https://github.com/ssuhaque/DSP_Digital_Audio_Effects -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ssuhaque/DSP_Digital_Audio_Effects](https://github.com/ssuhaque/DSP_Digital_Audio_Effects) |
| Source record ids | github_search_effects-55a887951dba7d |

## System Engineer Summary

ssuhaque/DSP_Digital_Audio_Effects is tracked as an image audio dsp record in the Effects branch.
...
For a systems engineer, ssuhaque/DSP_Digital_Audio_Effects belongs in the Effects inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-10-24T19:59:30Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-55a887951dba7d` from `github_search_effects` as `registry_expansion`
