...
<!-- canonical: https://crates.io/crates/objc2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/objc2](https://crates.io/crates/objc2) |
| Source record ids | crates_io-3812246cb70464 |
...
For a systems engineer, objc2 belongs in the Rust inventory as part of runtime behavior, deployment
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.4 | 2026-02-26T15:35:34.959793Z | [https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=8&per_page=100&sort=downloads` at `2026-09-03T12:26:04+00:00`.
...
- `crates_io-3812246cb70464` from `crates_io` as `registry_expansion`
