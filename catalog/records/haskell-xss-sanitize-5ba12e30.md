...
<!-- canonical: https://hackage.haskell.org/package/xss-sanitize -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/xss-sanitize](https://hackage.haskell.org/package/xss-sanitize) |
| Source record ids | hackage_top_downloads-20ef67ceec7928 |
...
For a systems engineer, xss-sanitize belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.7.2 | 2023-04-01T17:04:24Z | [https://hackage.haskell.org/package/xss-sanitize](https://hackage.haskell.org/package/xss-sanitize) |  |
...
| Evidence | GNU General Public License v3.0; https://api.github.com/licenses/gpl-3.0; Apache License 2.0; https://api.github.com/licenses/apache-2.0; GNU Lesser General Public License v3.0; https://api.github.com/licenses/lgpl-3.0 |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/xss-sanitize` at `2026-09-01T14:24:43+00:00`.
...
- `hackage_top_downloads-20ef67ceec7928` from `hackage_top_downloads` as `registry_expansion`
