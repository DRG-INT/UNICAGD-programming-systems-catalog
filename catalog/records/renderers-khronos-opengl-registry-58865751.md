...
<!-- canonical: https://registry.khronos.org/OpenGL/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://registry.khronos.org/OpenGL/](https://registry.khronos.org/OpenGL/) |
| Source record ids | curated_language_routes-d9575dfcb31337 |

## System Engineer Summary

Official OpenGL specification, extension, shading-language, and API registry route for renderer
compatibility work.

## Operational Role

For a systems engineer, Khronos OpenGL Registry belongs in the Renderers inventory as part of
...
- `curated_language_routes-d9575dfcb31337` from `curated_language_routes` as `registry_expansion`
