...
<!-- canonical: https://cran.r-project.org/web/packages/dapper/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/dapper/index.html](https://cran.r-project.org/web/packages/dapper/index.html) |
| Source record ids | cran_packages_by_date-ccf38ca3af35d4 |
...
For a systems engineer, dapper belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.1 | 2026-09-06 13:00:10 UTC | [https://cran.r-project.org/web/packages/dapper/DESCRIPTION](https://cran.r-project.org/web/packages/dapper/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/dapper/DESCRIPTION` at `2026-09-06T14:18:36+00:00`.
...
- `cran_packages_by_date-ccf38ca3af35d4` from `cran_packages_by_date` as `registry_expansion`
