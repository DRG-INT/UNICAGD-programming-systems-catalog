...
<!-- canonical: https://pub.dev/packages/stac -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/stac](https://pub.dev/packages/stac) |
| Source record ids | pub_dev-f32b39a203170d |

## System Engineer Summary

Stac is a Server-Driven UI (SDUI) framework for Flutter. Stac allows you to build beautiful cross-
platform applications with JSON in real time.

## Operational Role

For a systems engineer, stac belongs in the Dart inventory as part of build graph control, artifact
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.6.0 | 2026-09-13T06:03:35.771576Z | [https://pub.dev/api/packages/stac](https://pub.dev/api/packages/stac) |  |
| preview | known | 1.0.0-dev.7 | 2025-09-22T16:25:58.749628Z | [https://pub.dev/api/packages/stac](https://pub.dev/api/packages/stac) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/stac` at `2026-09-14T03:21:23+00:00`.
...
- `pub_dev-f32b39a203170d` from `pub_dev` as `registry_expansion`
