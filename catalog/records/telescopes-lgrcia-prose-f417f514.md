...
[Catalog index](../index.md) · [Language: Telescopes](../by-language/telescopes.md) · [Category: Package Manager](../by-category/package-manager.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/lgrcia/prose -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/lgrcia/prose](https://github.com/lgrcia/prose) |
| Source record ids | github_search_telescopes-cf48aa07c4884d |
...
For a systems engineer, lgrcia/prose belongs in the Telescopes inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.3.4 | 2024-07-26T17:46:24Z | [https://api.github.com/repos/lgrcia/prose/releases/latest](https://api.github.com/repos/lgrcia/prose/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/lgrcia/prose/releases/latest` at `2026-09-01T11:22:15+00:00`.
...
- `github_search_telescopes-cf48aa07c4884d` from `github_search_telescopes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| spacetelescope/jwst | Package Manager | [open](telescopes-spacetelescope-jwst-e1b99f64.md) |
