...
<!-- canonical: https://github.com/k3b/APhotoManager -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/k3b/APhotoManager](https://github.com/k3b/APhotoManager) |
| Source record ids | github_search_photography-1386c2e2321bd8 |

## System Engineer Summary

Manage local photos on Android: gallery, geotag with photomap, privacy, tags, find, sort, view,
copy, send, ... .

## Operational Role

For a systems engineer, k3b/APhotoManager belongs in the Photography inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-08-14T08:52:22Z | gh search repos topic:exif stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-1386c2e2321bd8` from `github_search_photography` as `registry_expansion`
