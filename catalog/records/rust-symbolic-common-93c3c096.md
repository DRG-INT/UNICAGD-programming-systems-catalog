...
<!-- canonical: https://crates.io/crates/symbolic-common -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/symbolic-common](https://crates.io/crates/symbolic-common) |
| Source record ids | crates_io-1237ebd252b118 |

## System Engineer Summary

Common types and utilities for symbolic, a library to symbolicate and process stack traces from
native applications, minidumps or minified JavaScript.

## Operational Role

For a systems engineer, symbolic-common belongs in the Rust inventory as part of hot-path discovery,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 13.9.0 | 2026-07-23T08:51:15.872908Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- `crates_io-1237ebd252b118` from `crates_io` as `registry_expansion`
