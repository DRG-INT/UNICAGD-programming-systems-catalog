...
<!-- canonical: https://crates.io/crates/actix-macros -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/actix-macros](https://crates.io/crates/actix-macros) |
| Source record ids | crates_io-8af7b76d382b3a |
...
For a systems engineer, actix-macros belongs in the Rust inventory as part of runtime behavior,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.4 | 2023-07-19T22:54:08.231118Z | [https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=11&per_page=100&sort=downloads) |  |
...
- `crates_io-8af7b76d382b3a` from `crates_io` as `registry_expansion`
