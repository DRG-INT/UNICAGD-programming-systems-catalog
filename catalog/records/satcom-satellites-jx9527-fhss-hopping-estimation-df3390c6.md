# jx9527/FHSS-Hopping-Estimation
...
<!-- canonical: https://github.com/jx9527/FHSS-Hopping-Estimation -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jx9527/FHSS-Hopping-Estimation](https://github.com/jx9527/FHSS-Hopping-Estimation) |
| Source record ids | github_search_satcom_satellites-7b84c2e3f9d4ab |

## System Engineer Summary

1. HackRF and GUNRadio are used to generate and transmit frequency hopping signals 2. Use LSTM to
realize FH point identification of FH signal

## Operational Role

For a systems engineer, jx9527/FHSS-Hopping-Estimation belongs in the SatCom Satellites inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-06-27T02:51:40Z | gh search repos topic:gnuradio stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-7b84c2e3f9d4ab` from `github_search_satcom_satellites` as `registry_expansion`
