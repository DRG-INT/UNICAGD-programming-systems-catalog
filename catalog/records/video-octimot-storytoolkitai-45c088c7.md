...
| Canonical URL | [https://github.com/octimot/StoryToolkitAI](https://github.com/octimot/StoryToolkitAI) |
| Source record ids | github_search_video-0262866fea501c |

## System Engineer Summary

An editing tool that uses AI to transcribe, understand content and search for anything in your
footage, integrated with ChatGPT and other AI models

## Operational Role

For a systems engineer, octimot/StoryToolkitAI belongs in the Video inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.25.1 | 2025-02-20T11:20:24Z | [https://api.github.com/repos/octimot/StoryToolkitAI/releases/latest](https://api.github.com/repos/octimot/StoryToolkitAI/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/octimot/StoryToolkitAI/releases/latest` at `2026-09-01T09:23:25+00:00`.
...
- `github_search_video-0262866fea501c` from `github_search_video` as `registry_expansion`
