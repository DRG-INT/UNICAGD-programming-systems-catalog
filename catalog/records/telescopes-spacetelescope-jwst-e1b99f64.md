...
| Source record ids | github_search_telescopes-d7adc1bf09c9ed |
...
For a systems engineer, spacetelescope/jwst belongs in the Telescopes inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.0 | 2026-07-14T20:58:09Z | [https://api.github.com/repos/spacetelescope/jwst/releases/latest](https://api.github.com/repos/spacetelescope/jwst/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/spacetelescope/jwst/releases/latest` at `2026-09-01T08:26:26+00:00`.
...
- `github_search_telescopes-d7adc1bf09c9ed` from `github_search_telescopes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| lgrcia/prose | Package Manager | [open](telescopes-lgrcia-prose-f417f514.md) |
