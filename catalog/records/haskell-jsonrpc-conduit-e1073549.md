...
<!-- canonical: https://hackage.haskell.org/package/jsonrpc-conduit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/jsonrpc-conduit](https://hackage.haskell.org/package/jsonrpc-conduit) |
| Source record ids | hackage_top_downloads-ecd25ad2a19923 |
...
For a systems engineer, jsonrpc-conduit belongs in the Haskell inventory as part of wire formats,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.1 | 2024-02-19T21:37:42Z | [https://hackage.haskell.org/package/jsonrpc-conduit](https://hackage.haskell.org/package/jsonrpc-conduit) |  |
| candidate | partial | 0.3.2 |  | [https://hackage.haskell.org/package/jsonrpc-conduit](https://hackage.haskell.org/package/jsonrpc-conduit) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/jsonrpc-conduit` at `2026-09-01T14:24:22+00:00`.
...
- `hackage_top_downloads-ecd25ad2a19923` from `hackage_top_downloads` as `registry_expansion`
