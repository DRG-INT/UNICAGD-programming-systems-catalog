...
| Source record ids | github_search_assets-34a983340b712b |
...
For a systems engineer, assimp/assimp belongs in the Assets inventory as part of low-noise code
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T08:32:33Z | gh search repos topic:assets stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_assets-34a983340b712b` from `github_search_assets` as `registry_expansion`
