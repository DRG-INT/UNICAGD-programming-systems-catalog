# Gitea: AndreyWorker312/chat-server
...
<!-- canonical: https://gitea.com/AndreyWorker312/chat-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/AndreyWorker312/chat-server](https://gitea.com/AndreyWorker312/chat-server) |
| Source record ids | gitea_repositories_api-3b4e314a65814e |

## System Engineer Summary

Gitea: AndreyWorker312/chat-server is tracked as a web framework record in the Repository Workplaces
...
For a systems engineer, Gitea: AndreyWorker312/chat-server belongs in the Repository Workplaces
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-04-21T16:11:23Z | [https://gitea.com/api/v1/repos/search?q=server&limit=50](https://gitea.com/api/v1/repos/search?q=server&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-3b4e314a65814e` from `gitea_repositories_api` as `registry_expansion`
