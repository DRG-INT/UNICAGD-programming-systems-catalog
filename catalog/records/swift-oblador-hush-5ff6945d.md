...
<!-- canonical: https://github.com/oblador/hush -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/oblador/hush](https://github.com/oblador/hush) |
| Source record ids | github_search_swift-96615003288555 |
...
For a systems engineer, oblador/hush belongs in the Swift inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-26T21:10:57Z | gh search repos topic:swiftui stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_swift-96615003288555` from `github_search_swift` as `registry_expansion`
