...
<!-- canonical: https://github.com/iflytek/astron-agent -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/iflytek/astron-agent](https://github.com/iflytek/astron-agent) |
| Source record ids | github_search_engines-b9e5ca2c5f77e5 |

## System Engineer Summary

Enterprise-grade, commercial-friendly agentic workflow platform for building next-generation
SuperAgents.

## Operational Role

For a systems engineer, iflytek/astron-agent belongs in the Engines inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T02:11:31Z | gh search repos topic:workflow-engine stars:>100 | gh_search_reports_activity_not_release_version |
...
| Evidence | GPL-2; BSD 2-Clause "Simplified" License; https://api.github.com/licenses/bsd-2-clause; MIT License; https://api.github.com/licenses/mit; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
- `github_search_engines-b9e5ca2c5f77e5` from `github_search_engines` as `registry_expansion`
