...
<!-- canonical: https://github.com/v2fly/geoip -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/v2fly/geoip](https://github.com/v2fly/geoip) |
| Source record ids | github_search_maps-08431a0c8df186 |

## System Engineer Summary

GeoIP for V2Ray. Generate and release GeoIP files such as geoip.dat and geoip-only-cn-private.dat
for V2Ray automatically monthly.

## Operational Role

For a systems engineer, v2fly/geoip belongs in the Maps inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T05:55:23Z | gh search repos topic:routing stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0; The Unlicense; https://api.github.com/licenses/unlicense; Creative Commons Attribution Share Alike 4.0 International; https://api.github.com/licenses/cc-by-sa-4.0 |
...
- `github_search_maps-08431a0c8df186` from `github_search_maps` as `registry_expansion`
