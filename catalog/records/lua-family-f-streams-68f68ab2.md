...
| Canonical URL | [https://luarocks.org/modules/fsantanna/f-streams](https://luarocks.org/modules/fsantanna/f-streams) |
| Source record ids | luarocks_root_manifest-d84c1fd0b7cd65 |
...
For a systems engineer, f-streams belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-d84c1fd0b7cd65` from `luarocks_root_manifest` as `registry_expansion`
