# Gitea: philosopher033427615/awesome-chatgpt-prompts
...
<!-- canonical: https://gitea.com/philosopher033427615/awesome-chatgpt-prompts -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitea.com/philosopher033427615/awesome-chatgpt-prompts](https://gitea.com/philosopher033427615/awesome-chatgpt-prompts) |
| Source record ids | gitea_repositories_api-40ba737225f6eb |

## System Engineer Summary

This repo includes ChatGPT prompt curation to use ChatGPT better. - @: Fatih Kadir Akın - source:
github.com/f/awesome-chatgpt-prompts

## Operational Role

For a systems engineer, Gitea: philosopher033427615/awesome-chatgpt-prompts belongs in the
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-11-13T13:12:13Z | [https://gitea.com/api/v1/repos/search?q=language&limit=50](https://gitea.com/api/v1/repos/search?q=language&limit=50) | gitea_search_api_reports_activity_not_release_version |
...
- `gitea_repositories_api-40ba737225f6eb` from `gitea_repositories_api` as `registry_expansion`
