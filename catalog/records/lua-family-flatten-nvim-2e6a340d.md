...
| Canonical URL | [https://luarocks.org/modules/willothy/flatten.nvim](https://luarocks.org/modules/willothy/flatten.nvim) |
| Source record ids | luarocks_root_manifest-51cc7836bab41c |

## System Engineer Summary

Remotely open files and command output from :term, Wezterm and Kitty in your current Neovim
instance.

## Operational Role

For a systems engineer, flatten.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-51cc7836bab41c` from `luarocks_root_manifest` as `registry_expansion`
