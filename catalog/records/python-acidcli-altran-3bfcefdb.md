...
<!-- canonical: https://pypi.org/project/acidcli-altran/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acidcli-altran/](https://pypi.org/project/acidcli-altran/) |
| Source record ids | pypi_simple-3f0492eb47f776 |
...
For a systems engineer, acidcli-altran belongs in the Python inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.13.0 | 2024-03-05T16:24:28.082078Z | [https://pypi.org/pypi/acidcli-altran/json](https://pypi.org/pypi/acidcli-altran/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acidcli-altran/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-3f0492eb47f776` from `pypi_simple` as `registry_expansion`
