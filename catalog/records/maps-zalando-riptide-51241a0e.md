...
<!-- canonical: https://github.com/zalando/riptide -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/zalando/riptide](https://github.com/zalando/riptide) |
| Source record ids | github_search_maps-9806f0f21bd346 |
...
For a systems engineer, zalando/riptide belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T09:40:28Z | gh search repos topic:routing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-9806f0f21bd346` from `github_search_maps` as `registry_expansion`
