...
[Catalog index](../index.md) · [Language: SAPJava](../by-language/sapjava.md) · [Category: Ide Editor Integration](../by-category/ide-editor-integration.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/jcombs-pointblue/SAP_Hana_Collector -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jcombs-pointblue/SAP_Hana_Collector](https://github.com/jcombs-pointblue/SAP_Hana_Collector) |
| Source record ids | github_search_sapjava-be16a73a650e31 |

## System Engineer Summary

Identity Governance Collector for S4/HANA

## Operational Role

For a systems engineer, jcombs-pointblue/SAP_Hana_Collector belongs in the SAPJava inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.0.0 | 2026-04-23T15:19:53Z | [https://api.github.com/repos/jcombs-pointblue/SAP_Hana_Collector/releases/latest](https://api.github.com/repos/jcombs-pointblue/SAP_Hana_Collector/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/jcombs-pointblue/SAP_Hana_Collector/releases/latest` at `2026-09-01T10:25:34+00:00`.
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-01 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "SAP HANA Java", "retrieved": "2026-09-01", "status": "forge-cli-derived"}` |
...
- `github_search_sapjava-be16a73a650e31` from `github_search_sapjava` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| advaitsfit/incident-management-cap-java | Ide Editor Integration | [open](sapjava-advaitsfit-incident-management-cap-java-09a797bb.md) |
| Arthur-Liu-boop/CAP_JAVA | Ide Editor Integration | [open](sapjava-arthur-liu-boop-cap-java-aa3196a2.md) |
| cabralbrcwb/incident-management | Ide Editor Integration | [open](sapjava-cabralbrcwb-incident-management-70ceff1c.md) |
| cap-java/cds-ai | Ide Editor Integration | [open](sapjava-cap-java-cds-ai-9b69a547.md) |
| ckyycc/hana-topology-editor | Ide Editor Integration | [open](sapjava-ckyycc-hana-topology-editor-d8045f61.md) |
| com.sap.cds:cds-feature-identity | Ide Editor Integration | [open](sapjava-com-sap-cds-cds-feature-identity-d9b992ff.md) |
| SAP/java-integration-for-sap-mobile-services | Ide Editor Integration | [open](sapjava-sap-java-integration-for-sap-mobile-services-1a48c7a1.md) |
| shiAraki/incident-management_CF-to-Java | Ide Editor Integration | [open](sapjava-shiaraki-incident-management-cf-to-java-ef08d60a.md) |
