...
<!-- canonical: https://crates.io/crates/pest_meta -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/pest_meta](https://crates.io/crates/pest_meta) |
| Source record ids | crates_io-7ab086c1be4710 |
...
For a systems engineer, pest_meta belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.9.0 | 2026-08-13T12:30:29.061012Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- `crates_io-7ab086c1be4710` from `crates_io` as `registry_expansion`
