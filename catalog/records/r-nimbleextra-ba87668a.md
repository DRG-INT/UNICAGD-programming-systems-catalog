...
<!-- canonical: https://cran.r-project.org/web/packages/nimbleExtra/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/nimbleExtra/index.html](https://cran.r-project.org/web/packages/nimbleExtra/index.html) |
| Source record ids | cran_packages_by_date-4cf87fc9a21ec1 |
...
For a systems engineer, nimbleExtra belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.15 | 2026-08-08 11:30:13 UTC | [https://cran.r-project.org/web/packages/nimbleExtra/DESCRIPTION](https://cran.r-project.org/web/packages/nimbleExtra/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/nimbleExtra/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-4cf87fc9a21ec1` from `cran_packages_by_date` as `registry_expansion`
