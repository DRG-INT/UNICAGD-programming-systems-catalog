...
<!-- canonical: https://crates.io/crates/bincode -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/bincode](https://crates.io/crates/bincode) |
| Source record ids | crates_io-25fc7c5da5b7d1 |

## System Engineer Summary

A binary serialization / deserialization strategy for transforming structs into bytes and vice
versa!

## Operational Role

For a systems engineer, bincode belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.0 | 2025-12-16T21:34:14.694603Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- `crates_io-25fc7c5da5b7d1` from `crates_io` as `registry_expansion`
