...
<!-- canonical: https://crates.io/crates/simd-adler32 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/simd-adler32](https://crates.io/crates/simd-adler32) |
| Source record ids | crates_io-cb579054c22208 |
...
For a systems engineer, simd-adler32 belongs in the Rust inventory as part of confidentiality,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.10 | 2026-07-14T17:42:45.047242Z | [https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=4&per_page=100&sort=downloads) |  |
...
- `crates_io-cb579054c22208` from `crates_io` as `registry_expansion`
