...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CatColabInterop](https://github.com/JuliaRegistries/General/tree/master/C/CatColabInterop) |
| Source record ids | julia_general-562019897c56d3 |

## System Engineer Summary

Julia package registered in General at C/CatColabInterop.

## Operational Role

For a systems engineer, CatColabInterop belongs in the Julia inventory as part of ecosystem
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "C/CatColabInterop", "retrieved": "2026-09-01", "status": "registry-derived"}` |

## Evidence

Evidence records merged into this identity: `1`.

- `julia_general-562019897c56d3` from `julia_general` as `registry_expansion`
