...
| Canonical URL | [https://mixpanel.com/](https://mixpanel.com/) |
| Source record ids | awesome_list-97cdb5e4a0c54a |
...
For a systems engineer, Mixpanel belongs in the Cocoa inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.0.8 | 2025-02-26 22:48:59 UTC | [https://trunk.cocoapods.org/api/v1/pods/Mixpanel](https://trunk.cocoapods.org/api/v1/pods/Mixpanel) |  |
...
- Latest stable metadata was observed from `https://trunk.cocoapods.org/api/v1/pods/Mixpanel` at `2026-09-01T07:24:06+00:00`.
...
- `awesome_list-97cdb5e4a0c54a` from `awesome_list` as `registry_expansion`
...
| Bugsnag | Data Science | [open](cocoa-bugsnag-3d54b3f5.md) |
