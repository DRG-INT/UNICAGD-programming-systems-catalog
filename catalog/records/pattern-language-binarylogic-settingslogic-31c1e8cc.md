...
[Catalog index](../index.md) · [Language: Pattern language](../by-language/pattern-language.md) · [Category: Serialization](../by-category/serialization.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/binarylogic/settingslogic -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/binarylogic/settingslogic](https://github.com/binarylogic/settingslogic) |
| Source record ids | github_search_pattern_language-a9d694259112ec |
...
For a systems engineer, binarylogic/settingslogic belongs in the Pattern language inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-04-23T08:43:29Z | gh search repos design patterns stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_pattern_language-a9d694259112ec` from `github_search_pattern_language` as `registry_expansion`
