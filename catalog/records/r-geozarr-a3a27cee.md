...
<!-- canonical: https://cran.r-project.org/web/packages/geozarr/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/geozarr/index.html](https://cran.r-project.org/web/packages/geozarr/index.html) |
| Source record ids | cran_packages_by_date-e3b214427b414b |

## System Engineer Summary

GeoZarr Conventions for Geospatial Data in Zarr Stores

## Operational Role

For a systems engineer, geozarr belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-09-16 00:10:02 UTC | [https://cran.r-project.org/web/packages/geozarr/DESCRIPTION](https://cran.r-project.org/web/packages/geozarr/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/geozarr/DESCRIPTION` at `2026-09-16T00:25:59+00:00`.
...
- `cran_packages_by_date-e3b214427b414b` from `cran_packages_by_date` as `registry_expansion`
