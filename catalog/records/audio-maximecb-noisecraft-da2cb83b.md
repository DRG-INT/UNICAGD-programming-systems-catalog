...
<!-- canonical: https://github.com/maximecb/noisecraft -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/maximecb/noisecraft](https://github.com/maximecb/noisecraft) |
| Source record ids | github_search_audio-7b5c4a2a474182 |
...
For a systems engineer, maximecb/noisecraft belongs in the Audio inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-06T14:42:55Z | gh search repos topic:synthesizer stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | Mozilla Public License 2.0; https://api.github.com/licenses/mpl-2.0; Apache License 2.0; https://api.github.com/licenses/apache-2.0; GNU General Public License v2.0; https://api.github.com/licenses/gpl-2.0 |
...
- `github_search_audio-7b5c4a2a474182` from `github_search_audio` as `registry_expansion`
