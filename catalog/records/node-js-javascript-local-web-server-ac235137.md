...
<!-- canonical: https://www.npmjs.com/package/local-web-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/local-web-server](https://www.npmjs.com/package/local-web-server) |
| Source record ids | npm_registry-48041ecef7b598 |
...
For a systems engineer, local-web-server belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.4.0 | 2024-08-01T08:46:19.834Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-48041ecef7b598` from `npm_registry` as `registry_expansion`
