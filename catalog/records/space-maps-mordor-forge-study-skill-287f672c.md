...
<!-- canonical: https://github.com/mordor-forge/study-skill -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/mordor-forge/study-skill](https://github.com/mordor-forge/study-skill) |
| Source record ids | github_search_space_maps-9abd106b7b4477 |

## System Engineer Summary

Claude Code skill for interactive learning with FSRS-6 spaced repetition, research agents, book
catalog, ADHD-aware sessions, and domain-specific visualization

## Operational Role

For a systems engineer, mordor-forge/study-skill belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-17T19:44:53Z | gh search repos space visualization | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-9abd106b7b4477` from `github_search_space_maps` as `registry_expansion`
