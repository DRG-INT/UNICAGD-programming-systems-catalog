...
<!-- canonical: https://cran.r-project.org/web/packages/NHANES/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/NHANES/index.html](https://cran.r-project.org/web/packages/NHANES/index.html) |
| Source record ids | cran_packages_by_date-94a4e1ebb0f42c |
...
For a systems engineer, NHANES belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.1.4 | 2026-09-01 08:00:08 UTC | [https://cran.r-project.org/web/packages/NHANES/DESCRIPTION](https://cran.r-project.org/web/packages/NHANES/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/NHANES/DESCRIPTION` at `2026-09-01T08:22:07+00:00`.
...
- `cran_packages_by_date-94a4e1ebb0f42c` from `cran_packages_by_date` as `registry_expansion`
