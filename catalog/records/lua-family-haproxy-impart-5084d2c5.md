...
| Canonical URL | [https://luarocks.org/modules/impart-security/haproxy-impart](https://luarocks.org/modules/impart-security/haproxy-impart) |
| Source record ids | luarocks_root_manifest-6f91165704e7e3 |

## System Engineer Summary

Impart Security's HAProxy module.

## Operational Role

For a systems engineer, haproxy-impart belongs in the Lua family inventory as part of supply-chain
...
- `luarocks_root_manifest-6f91165704e7e3` from `luarocks_root_manifest` as `registry_expansion`
