# magendooro/magento2-catalog-quality
...
<!-- canonical: https://github.com/magendooro/magento2-catalog-quality -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/magendooro/magento2-catalog-quality](https://github.com/magendooro/magento2-catalog-quality) |
| Source record ids | github_search_repertoare_catalogs-93326904d6c09a |

## System Engineer Summary

Catalog data quality observability for Magento 2 — completeness scoring, filter-blind detection, and
gap reporting

## Operational Role

For a systems engineer, magendooro/magento2-catalog-quality belongs in the Repertoare Catalogs
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-21T18:27:37Z | gh search repos score catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-93326904d6c09a` from `github_search_repertoare_catalogs` as `registry_expansion`
