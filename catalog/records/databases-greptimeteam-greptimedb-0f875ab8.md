...
<!-- canonical: https://github.com/GreptimeTeam/greptimedb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/GreptimeTeam/greptimedb](https://github.com/GreptimeTeam/greptimedb) |
| Source record ids | github_search_databases-d288cdd7a88ded |

## System Engineer Summary

The open-source observability database. One columnar engine for metrics, logs, and traces, on object
storage.

## Operational Role

For a systems engineer, GreptimeTeam/greptimedb belongs in the Databases inventory as part of hot-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T15:37:38Z | gh search repos topic:object-storage stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-d288cdd7a88ded` from `github_search_databases` as `registry_expansion`
