...
<!-- canonical: https://pub.dev/packages/flutter_polyline_points -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/flutter_polyline_points](https://pub.dev/packages/flutter_polyline_points) |
| Source record ids | pub_dev-6cbce484c26ac2 |

## System Engineer Summary

A flutter package to get polyline points by either passing the coordinates or google encoded
polyline string

## Operational Role

For a systems engineer, flutter_polyline_points belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.1.0 | 2025-09-20T11:49:45.078396Z | [https://pub.dev/api/packages/flutter_polyline_points](https://pub.dev/api/packages/flutter_polyline_points) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/flutter_polyline_points` at `2026-09-01T14:20:35+00:00`.
...
- `pub_dev-6cbce484c26ac2` from `pub_dev` as `registry_expansion`
