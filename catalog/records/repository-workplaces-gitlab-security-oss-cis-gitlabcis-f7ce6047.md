# gitlab-security-oss/cis/gitlabcis
...
<!-- canonical: https://gitlab.com/gitlab-security-oss/cis/gitlabcis -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/gitlab-security-oss/cis/gitlabcis](https://gitlab.com/gitlab-security-oss/cis/gitlabcis) |
| Source record ids | gitlab_projects_api-92cecddc4cf531 |

## System Engineer Summary

A Python-based CLI tool designed to scan GitLab projects for compliance against the . Check out the
in this repo. for more info.

## Operational Role

For a systems engineer, gitlab-security-oss/cis/gitlabcis belongs in the Repository Workplaces
...
- `gitlab_projects_api-92cecddc4cf531` from `gitlab_projects_api` as `registry_expansion`
