...
| Source record ids | corpus-68e6f85fcee53f |

## System Engineer Summary

lua-MessagePack is tracked as a serialization record in the Lua family branch. The source did not
...
For a systems engineer, lua-MessagePack belongs in the Lua family inventory as part of wire formats,
...
- `corpus-68e6f85fcee53f` from `master_json` as `serialization`
