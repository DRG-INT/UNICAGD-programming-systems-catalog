...
<!-- canonical: https://cran.r-project.org/web/packages/fitODBOD/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/fitODBOD/index.html](https://cran.r-project.org/web/packages/fitODBOD/index.html) |
| Source record ids | cran_packages_by_date-f29042584db398 |
...
For a systems engineer, fitODBOD belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.5.6 | 2026-08-23 15:10:02 UTC | [https://cran.r-project.org/web/packages/fitODBOD/DESCRIPTION](https://cran.r-project.org/web/packages/fitODBOD/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/fitODBOD/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-f29042584db398` from `cran_packages_by_date` as `registry_expansion`
