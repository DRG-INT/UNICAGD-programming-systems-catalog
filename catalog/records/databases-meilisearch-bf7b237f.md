...
| Source record ids | curated_database_systems-8d6c3f637ff357 |

## System Engineer Summary

Search engine for full-text and hybrid search use cases.

## Operational Role

For a systems engineer, Meilisearch belongs in the Databases inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.53.1 | 2026-08-13T13:03:58Z | [https://api.github.com/repos/meilisearch/meilisearch/releases/latest](https://api.github.com/repos/meilisearch/meilisearch/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/meilisearch/meilisearch/releases/latest` at `2026-09-01T07:24:49+00:00`.
...
- `curated_database_systems-8d6c3f637ff357` from `curated_database_systems` as `registry_expansion`
