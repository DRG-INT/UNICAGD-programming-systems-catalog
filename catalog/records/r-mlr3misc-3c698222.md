...
<!-- canonical: https://cran.r-project.org/web/packages/mlr3misc/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/mlr3misc/index.html](https://cran.r-project.org/web/packages/mlr3misc/index.html) |
| Source record ids | cran_packages_by_date-7cc74fc198bfdc |
...
For a systems engineer, mlr3misc belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.23.0 | 2026-08-21 06:20:10 UTC | [https://cran.r-project.org/web/packages/mlr3misc/DESCRIPTION](https://cran.r-project.org/web/packages/mlr3misc/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/mlr3misc/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-7cc74fc198bfdc` from `cran_packages_by_date` as `registry_expansion`
