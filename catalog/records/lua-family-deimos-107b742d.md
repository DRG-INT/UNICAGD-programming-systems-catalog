...
<!-- canonical: https://luarocks.org/modules/luarocks/deimos -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/luarocks/deimos](https://luarocks.org/modules/luarocks/deimos) |
| Source record ids | luarocks_root_manifest-289dc2e53762cd |
...
For a systems engineer, deimos belongs in the Lua family inventory as part of interface contracts,
...
- `luarocks_root_manifest-289dc2e53762cd` from `luarocks_root_manifest` as `registry_expansion`
