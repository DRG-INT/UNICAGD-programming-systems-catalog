...
<!-- canonical: https://github.com/Notifuse/notifuse -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Notifuse/notifuse](https://github.com/Notifuse/notifuse) |
| Source record ids | github_search_magazines-18f845498c9b45 |

## System Engineer Summary

Open-source, self-hosted newsletter, email marketing and transactional email platform. Visual MJML
editor, Liquid templating, 7 sending providers.

## Operational Role

For a systems engineer, Notifuse/notifuse belongs in the Magazines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T07:41:45Z | gh search repos topic:newsletter stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-18f845498c9b45` from `github_search_magazines` as `registry_expansion`
