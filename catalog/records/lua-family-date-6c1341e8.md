...
<!-- canonical: https://luarocks.org/modules/tieske/date -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/tieske/date](https://luarocks.org/modules/tieske/date) |
| Source record ids | luarocks_root_manifest-6de5f368915ece |
...
For a systems engineer, date belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-6de5f368915ece` from `luarocks_root_manifest` as `registry_expansion`
