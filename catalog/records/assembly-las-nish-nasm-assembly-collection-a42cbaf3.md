...
<!-- canonical: https://github.com/las-nish/NASM-Assembly-Collection -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/las-nish/NASM-Assembly-Collection](https://github.com/las-nish/NASM-Assembly-Collection) |
| Source record ids | github_search_assembly-02858eaac5f439 |
...
For a systems engineer, las-nish/NASM-Assembly-Collection belongs in the Assembly inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-03-29T03:18:01Z | gh search repos topic:x86 topic:assembly | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-02858eaac5f439` from `github_search_assembly` as `registry_expansion`
