...
<!-- canonical: https://github.com/visionspacetec/sle-provider -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/visionspacetec/sle-provider](https://github.com/visionspacetec/sle-provider) |
| Source record ids | github_search_satcom_satellites-c5594cad741ca0 |
...
For a systems engineer, visionspacetec/sle-provider belongs in the SatCom Satellites inventory as
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-06-30T08:34:14Z | gh search repos topic:ccsds stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_satcom_satellites-c5594cad741ca0` from `github_search_satcom_satellites` as `registry_expansion`
