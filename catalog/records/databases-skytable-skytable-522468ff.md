...
<!-- canonical: https://github.com/skytable/skytable -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/skytable/skytable](https://github.com/skytable/skytable) |
| Source record ids | github_search_databases-c27a01093683ab |

## System Engineer Summary

Skytable is a modern scalable NoSQL database with BlueQL, designed for performance, scalability and
flexibility. Skytable gives you spaces, models, data types, complex collections and more to build
powerful experiences

## Operational Role

For a systems engineer, skytable/skytable belongs in the Databases inventory as part of build graph
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-23T00:14:03Z | gh search repos topic:nosql stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-c27a01093683ab` from `github_search_databases` as `registry_expansion`
...
| redis/redis | Build System | [open](databases-redis-redis-110f7316.md) |
| sinaptik-ai/pandas-ai | Build System | [open](databases-sinaptik-ai-pandas-ai-51421c6b.md) |
| supabase/supabase | Build System | [open](databases-supabase-supabase-100a1793.md) |
| terminusdb/terminusdb | Build System | [open](databases-terminusdb-terminusdb-a8652993.md) |
