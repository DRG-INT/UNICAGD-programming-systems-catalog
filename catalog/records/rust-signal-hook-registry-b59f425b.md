...
<!-- canonical: https://crates.io/crates/signal-hook-registry -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/signal-hook-registry](https://crates.io/crates/signal-hook-registry) |
| Source record ids | crates_io-b9d892ee732dbb |
...
For a systems engineer, signal-hook-registry belongs in the Rust inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4.8 | 2025-12-25T17:35:43.742246Z | [https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=2&per_page=100&sort=downloads) |  |
...
- `crates_io-b9d892ee732dbb` from `crates_io` as `registry_expansion`
