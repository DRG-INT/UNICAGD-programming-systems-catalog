...
<!-- canonical: https://pypi.org/project/abrade-cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/abrade-cli/](https://pypi.org/project/abrade-cli/) |
| Source record ids | pypi_simple-6ca8e4313adda8 |

## System Engineer Summary

Abrade's self-hosted CLI — run the injection suite on your own machine, results stay local, no SaaS
account required.

## Operational Role

For a systems engineer, abrade-cli belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-08-08T04:25:52.921873Z | [https://pypi.org/pypi/abrade-cli/json](https://pypi.org/pypi/abrade-cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/abrade-cli/json` at `2026-09-01T07:19:45+00:00`.
...
- `pypi_simple-6ca8e4313adda8` from `pypi_simple` as `registry_expansion`
