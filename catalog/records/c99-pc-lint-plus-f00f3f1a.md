...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: C99](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/c99.md) · [Category: Static Analyzer](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/static-analyzer.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Source record ids | corpus-c426d65b9e948e |

## System Engineer Summary

PC-lint Plus is tracked as a static analyzer record in the C99 branch. The source did not provide a
...
For a systems engineer, PC-lint Plus belongs in the C99 inventory as part of defect discovery,
...
- `corpus-c426d65b9e948e` from `master_json` as `static_analyzer`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Clang Static Analyzer | Static Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-clang-static-analyzer-cc386d4c.md) |
| clang-tidy | Static Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-clang-tidy-226c97d5.md) |
| CodeQL C/C++ | Static Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-codeql-c-c-f36f1676.md) |
| CodeSonar | Static Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-codesonar-7c500307.md) |
| Coverity C/C++ | Static Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-coverity-c-c-6a1535f5.md) |
| Cppcheck | Static Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-cppcheck-c70adb22.md) |
| Frama-C | Static Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-frama-c-a6d8f7e7.md) |
| GCC -fanalyzer | Static Analyzer | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/c99-gcc-fanalyzer-c3c2ece8.md) |
