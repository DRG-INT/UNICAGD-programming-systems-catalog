# Crowdrocker/WehttamSnaps-Niri

## Navigation

[Catalog index](../index.md) · [Language: Effects](../by-language/effects.md) · [Category: Documentation](../by-category/documentation.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/Crowdrocker/WehttamSnaps-Niri -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/Crowdrocker/WehttamSnaps-Niri](https://github.com/Crowdrocker/WehttamSnaps-Niri) |
| Source record ids | github_search_effects-f4981792b686f8 |

## System Engineer Summary

Arch Linux Niri configuration for photography, gaming, and content creation. Features gradient
borders, J.A.R.V.I.S. integration, audio routing, and comprehensive documentation.

## Operational Role

For a systems engineer, Crowdrocker/WehttamSnaps-Niri belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-15T05:11:40Z | gh search repos topic:compositor stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-f4981792b686f8` from `github_search_effects` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| krispuckett/SwiftUIShaders | Documentation | [open](effects-krispuckett-swiftuishaders-037488ee.md) |
