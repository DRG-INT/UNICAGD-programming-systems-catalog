...
<!-- canonical: https://pub.dev/packages/share_plus -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/share_plus](https://pub.dev/packages/share_plus) |
| Source record ids | pub_dev-242725afa83bcc |

## System Engineer Summary

Flutter plugin for sharing content via the platform share UI, using the ACTION_SEND intent on
Android and UIActivityViewController on iOS.

## Operational Role

For a systems engineer, share_plus belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 13.3.0 | 2026-07-23T21:32:59.660054Z | [https://pub.dev/api/packages/share_plus](https://pub.dev/api/packages/share_plus) |  |
| preview | known | 2.1.0-nullsafety.0 | 2021-02-06T16:15:10.783091Z | [https://pub.dev/api/packages/share_plus](https://pub.dev/api/packages/share_plus) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/share_plus` at `2026-09-01T16:41:08+00:00`.
...
- `pub_dev-242725afa83bcc` from `pub_dev` as `registry_expansion`
