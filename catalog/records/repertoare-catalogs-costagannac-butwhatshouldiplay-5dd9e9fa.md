# costagannac/butwhatshouldiplay
...
<!-- canonical: https://github.com/costagannac/butwhatshouldiplay -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/costagannac/butwhatshouldiplay](https://github.com/costagannac/butwhatshouldiplay) |
| Source record ids | github_search_repertoare_catalogs-db294d8070c03d |

## System Engineer Summary

A website to help students find and choose performance repertoire

## Operational Role

For a systems engineer, costagannac/butwhatshouldiplay belongs in the Repertoare Catalogs inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-11-19T09:11:21Z | gh search repos performance repertoire | gh_search_reports_activity_not_release_version |
...
- `github_search_repertoare_catalogs-db294d8070c03d` from `github_search_repertoare_catalogs` as `registry_expansion`
