...
| Source record ids | curated_language_routes-df6075171eb424 |

## System Engineer Summary

Real-time collision detection and rigid-body physics engine used in games, robotics, simulation, and
graphics tools.

## Operational Role

For a systems engineer, Bullet Physics belongs in the Physics Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.25 | 2022-04-24T23:54:27Z | [https://api.github.com/repos/bulletphysics/bullet3/releases/latest](https://api.github.com/repos/bulletphysics/bullet3/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/bulletphysics/bullet3/releases/latest` at `2026-09-01T07:24:40+00:00`.
...
- `curated_language_routes-df6075171eb424` from `curated_language_routes` as `registry_expansion`
