...
<!-- canonical: https://github.com/HeidiSQL/HeidiSQL -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/HeidiSQL/HeidiSQL](https://github.com/HeidiSQL/HeidiSQL) |
| Source record ids | github_search_databases-9864a7922d1fe6 |

## System Engineer Summary

A lightweight client for managing MariaDB, MySQL, SQL Server, PostgreSQL, SQLite, Interbase and
Firebird, written in Delphi and Lazarus/FreePascal

## Operational Role

For a systems engineer, HeidiSQL/HeidiSQL belongs in the Databases inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-27T17:26:07Z | gh search repos topic:postgresql stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-9864a7922d1fe6` from `github_search_databases` as `registry_expansion`
