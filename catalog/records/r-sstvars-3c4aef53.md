...
<!-- canonical: https://cran.r-project.org/web/packages/sstvars/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/sstvars/index.html](https://cran.r-project.org/web/packages/sstvars/index.html) |
| Source record ids | cran_packages_by_date-7a1cc137ad36e8 |
...
For a systems engineer, sstvars belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.2.5 | 2026-08-04 13:10:02 UTC | [https://cran.r-project.org/web/packages/sstvars/DESCRIPTION](https://cran.r-project.org/web/packages/sstvars/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/sstvars/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-7a1cc137ad36e8` from `cran_packages_by_date` as `registry_expansion`
