...
[Catalog index](../index.md) · [Language: Radars](../by-language/radars.md) · [Category: Security Sast](../by-category/security-sast.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/ChenHongruixuan/BRIGHT -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ChenHongruixuan/BRIGHT](https://github.com/ChenHongruixuan/BRIGHT) |
| Source record ids | github_search_radars-9beac54a5a320a |

## System Engineer Summary

ESSD 2025 & IEEE DFC 2025 & CVPRW 2026 Bright: A globally distributed multimodal VHR dataset for
all-weather disaster response

## Operational Role

For a systems engineer, ChenHongruixuan/BRIGHT belongs in the Radars inventory as part of supply-
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-21T11:43:55Z | gh search repos topic:synthetic-aperture-radar stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-9beac54a5a320a` from `github_search_radars` as `registry_expansion`
