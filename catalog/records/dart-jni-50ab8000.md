...
<!-- canonical: https://pub.dev/packages/jni -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/jni](https://pub.dev/packages/jni) |
| Source record ids | pub_dev-d7967a5cb914e1 |
...
For a systems engineer, jni belongs in the Dart inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.3 | 2026-07-30T07:49:04.428207Z | [https://pub.dev/api/packages/jni](https://pub.dev/api/packages/jni) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/jni` at `2026-09-01T15:35:58+00:00`.
...
- `pub_dev-d7967a5cb914e1` from `pub_dev` as `registry_expansion`
