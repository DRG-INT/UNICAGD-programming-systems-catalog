...
<!-- canonical: https://cran.r-project.org/web/packages/spsurvey/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/spsurvey/index.html](https://cran.r-project.org/web/packages/spsurvey/index.html) |
| Source record ids | cran_packages_by_date-ff75d7eb0dd7b0 |
...
For a systems engineer, spsurvey belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 5.7.0 | 2026-08-29 12:30:02 UTC | [https://cran.r-project.org/web/packages/spsurvey/DESCRIPTION](https://cran.r-project.org/web/packages/spsurvey/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/spsurvey/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-ff75d7eb0dd7b0` from `cran_packages_by_date` as `registry_expansion`
