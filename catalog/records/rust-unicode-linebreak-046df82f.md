...
<!-- canonical: https://crates.io/crates/unicode-linebreak -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/unicode-linebreak](https://crates.io/crates/unicode-linebreak) |
| Source record ids | crates_io-12c90e9b2d5f3f |
...
For a systems engineer, unicode-linebreak belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.5 | 2023-07-25T11:49:38.560848Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- `crates_io-12c90e9b2d5f3f` from `crates_io` as `registry_expansion`
