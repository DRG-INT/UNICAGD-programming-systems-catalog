...
<!-- canonical: https://github.com/elastic/logstash -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/elastic/logstash](https://github.com/elastic/logstash) |
| Source record ids | github_search_video-fc1db2f4d8e710 |
...
For a systems engineer, elastic/logstash belongs in the Video inventory as part of language tooling,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T11:00:37Z | gh search repos topic:streaming stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_video-fc1db2f4d8e710` from `github_search_video` as `registry_expansion`
