...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Lua family](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/lua-family.md) · [Category: Compiler Diagnostics](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/compiler-diagnostics.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://luarocks.org/modules/imagicthecat-0a6b669a3a/ewd](https://luarocks.org/modules/imagicthecat-0a6b669a3a/ewd) |
| Source record ids | luarocks_root_manifest-18e2d6329e6367 |
...
For a systems engineer, ewd belongs in the Lua family inventory as part of ecosystem capability
...
| Name | Category | Page |
| --- | --- | --- |
| copy-diagnostics | Compiler Diagnostics | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-copy-diagnostics-d2022385.md) |
| copy-diagnostics.nvim | Compiler Diagnostics | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/lua-family-copy-diagnostics-nvim-284daa64.md) |
