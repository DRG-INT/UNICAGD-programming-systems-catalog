...
<!-- canonical: https://www.nuget.org/packages/Volo.Abp.Http -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Volo.Abp.Http](https://www.nuget.org/packages/Volo.Abp.Http) |
| Source record ids | nuget_search-a65c336080af5f |

## System Engineer Summary

Volo.Abp.Http is tracked as a project scaffolding record in the C-Sharp branch. The source did not
...
For a systems engineer, Volo.Abp.Http belongs in the C-Sharp inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 10.6.0 | 2026-07-27T07:06:12.2+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/volo.abp.http/index.json](https://api.nuget.org/v3/registration5-gz-semver2/volo.abp.http/index.json) |  |
| preview | known | 10.7.0-rc.3 | 2026-08-18T08:30:33.3+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/volo.abp.http/index.json](https://api.nuget.org/v3/registration5-gz-semver2/volo.abp.http/index.json) |  |
...
| Evidence | MIT License; https://api.github.com/licenses/mit; LGPL-3.0-only; https://www.nuget.org/packages/Volo.Abp.Http/10.6.0/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/volo.abp.http/index.json` at `2026-09-01T07:23:59+00:00`.
...
- `nuget_search-a65c336080af5f` from `nuget_search` as `registry_expansion`
