...
<!-- canonical: https://github.com/leungwensen/svg-icon -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/leungwensen/svg-icon](https://github.com/leungwensen/svg-icon) |
| Source record ids | github_search_icons_and_logos-0f42f363ff927d |
...
For a systems engineer, leungwensen/svg-icon belongs in the Icons and Logos inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-07-09T03:35:42Z | gh search repos topic:icon-font stars:>100 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-04 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:icon-font stars:>100", "retrieved": "2026-09-04", "status": "forge-cli-derived"}` |
...
- `github_search_icons_and_logos-0f42f363ff927d` from `github_search_icons_and_logos` as `registry_expansion`
