...
<!-- canonical: https://github.com/v2space-labs/shader-for-interfaces -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/v2space-labs/shader-for-interfaces](https://github.com/v2space-labs/shader-for-interfaces) |
| Source record ids | github_search_effects-dc53573f2bde60 |

## System Engineer Summary

Agent Skill for designing, building, debugging, and validating focused GPU effects in product
interfaces.

## Operational Role

For a systems engineer, v2space-labs/shader-for-interfaces belongs in the Effects inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-01T13:54:48Z | gh search repos shader effects | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-dc53573f2bde60` from `github_search_effects` as `registry_expansion`
