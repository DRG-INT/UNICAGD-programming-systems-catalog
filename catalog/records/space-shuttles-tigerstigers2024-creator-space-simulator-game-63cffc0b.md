# tigerstigers2024-creator/space-simulator-game
...
<!-- canonical: https://github.com/tigerstigers2024-creator/space-simulator-game -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tigerstigers2024-creator/space-simulator-game](https://github.com/tigerstigers2024-creator/space-simulator-game) |
| Source record ids | github_search_space_shuttles-1fe6294e21ef8c |

## System Engineer Summary

A KSP-like space flight simulator game with rocket building and orbital mechanics

## Operational Role

For a systems engineer, tigerstigers2024-creator/space-simulator-game belongs in the Space Shuttles
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-29T04:06:20Z | gh search repos orbiter space flight simulator | gh_search_reports_activity_not_release_version |
...
- `github_search_space_shuttles-1fe6294e21ef8c` from `github_search_space_shuttles` as `registry_expansion`
