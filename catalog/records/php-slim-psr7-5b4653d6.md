...
<!-- canonical: https://packagist.org/packages/slim/psr7 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/slim/psr7](https://packagist.org/packages/slim/psr7) |
| Source record ids | packagist_search-be70a9ba6752a6 |
...
For a systems engineer, slim/psr7 belongs in the PHP inventory as part of service communication,
...
- `packagist_search-be70a9ba6752a6` from `packagist_search` as `registry_expansion`
