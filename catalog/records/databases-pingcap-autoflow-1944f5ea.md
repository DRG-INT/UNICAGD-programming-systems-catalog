...
<!-- canonical: https://github.com/pingcap/autoflow -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pingcap/autoflow](https://github.com/pingcap/autoflow) |
| Source record ids | github_search_databases-ff6c0810fcd0bc |

## System Engineer Summary

pingcap/autoflow is a Graph RAG based and conversational knowledge base tool built with TiDB
Serverless Vector Storage. Demo:

## Operational Role

For a systems engineer, pingcap/autoflow belongs in the Databases inventory as part of service
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-27T13:55:14Z | gh search repos topic:vector-database stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-ff6c0810fcd0bc` from `github_search_databases` as `registry_expansion`
