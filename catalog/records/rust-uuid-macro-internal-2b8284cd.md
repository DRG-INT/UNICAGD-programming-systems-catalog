...
| Canonical URL | [https://crates.io/crates/uuid-macro-internal](https://crates.io/crates/uuid-macro-internal) |
| Source record ids | crates_io-8772906a047910 |
...
For a systems engineer, uuid-macro-internal belongs in the Rust inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.19.0 | 2025-12-02T02:39:33.068222Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
...
- `crates_io-8772906a047910` from `crates_io` as `registry_expansion`
