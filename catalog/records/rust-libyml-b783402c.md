...
| Canonical URL | [https://crates.io/crates/libyml](https://crates.io/crates/libyml) |
| Source record ids | crates_io-4f5c0de09cff42 |

## System Engineer Summary

DEPRECATED — `libyml` is unmaintained. This release is a thin compatibility shim that forwards every
call to `unsafe-libyaml` (the upstream C-libyaml translation `libyml` was originally forked from).
Please migrate to `unsafe-libyaml`, `yaml-rust2`, or `noyalib`.

## Operational Role

For a systems engineer, libyml belongs in the Rust inventory as part of wire formats, persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.6 | 2026-05-29T19:54:08.134460Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
- `crates_io-4f5c0de09cff42` from `crates_io` as `registry_expansion`
