...
<!-- canonical: https://luarocks.org/modules/castlelecs/cluautils -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/castlelecs/cluautils](https://luarocks.org/modules/castlelecs/cluautils) |
| Source record ids | luarocks_root_manifest-f3cd44591c8230 |

## System Engineer Summary

cluautils is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, cluautils belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-f3cd44591c8230` from `luarocks_root_manifest` as `registry_expansion`
