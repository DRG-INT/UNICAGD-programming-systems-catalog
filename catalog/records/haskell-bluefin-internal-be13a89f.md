...
| Source record ids | hackage_recent-ae10114e37a4f7 |

## System Engineer Summary

Hackage package recently uploaded by tomjaguarpaw.
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.1.0 | 2026-09-11T12:11:41Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/packages/recent` at `2026-09-11T12:25:28+00:00`.
...
- `hackage_recent-ae10114e37a4f7` from `hackage_recent` as `registry_expansion`
