...
<!-- canonical: https://github.com/amusi/AI-Job-Notes -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/amusi/AI-Job-Notes](https://github.com/amusi/AI-Job-Notes) |
| Source record ids | github_search_photography-4efa60c117de41 |
...
For a systems engineer, amusi/AI-Job-Notes belongs in the Photography inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-06-05T05:50:01Z | gh search repos topic:image-processing stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-4efa60c117de41` from `github_search_photography` as `registry_expansion`
