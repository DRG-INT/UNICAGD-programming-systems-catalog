...
[Catalog index](../index.md) · [Language: Catalogs](../by-language/catalogs.md) · [Category: Web Framework](../by-category/web-framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/expressjs/serve-index -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/expressjs/serve-index](https://github.com/expressjs/serve-index) |
| Source record ids | github_search_catalogs-64fa399648ba2f |
...
For a systems engineer, expressjs/serve-index belongs in the Catalogs inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-05T14:00:57Z | gh search repos topic:index stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_catalogs-64fa399648ba2f` from `github_search_catalogs` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| emertozd/Compose-Material-3-Expressive-Catalog | Web Framework | [open](catalogs-emertozd-compose-material-3-expressive-catalog-37be1c96.md) |
| fabiodalez-dev/Pinakes | Web Framework | [open](catalogs-fabiodalez-dev-pinakes-55aa7480.md) |
| sergiisyrovatchenko/SQLIndexManager | Web Framework | [open](catalogs-sergiisyrovatchenko-sqlindexmanager-c47bdf29.md) |
| zyegfryed/django-statici18n | Web Framework | [open](catalogs-zyegfryed-django-statici18n-7d8a9ed5.md) |
