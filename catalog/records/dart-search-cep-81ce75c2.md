...
<!-- canonical: https://pub.dev/packages/search_cep -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/search_cep](https://pub.dev/packages/search_cep) |
| Source record ids | pub_dev-ec2664c0a969dc |

## System Engineer Summary

Pacote para facilitar e agilizar a comunicação com a API via_cep e obter informações sobre CEPs e
localidades de todo o Brasil

## Operational Role

For a systems engineer, search_cep belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.0.2 | 2023-06-28T20:28:12.626555Z | [https://pub.dev/api/packages/search_cep](https://pub.dev/api/packages/search_cep) |  |
| preview | known | 4.0.0-nullsafety.1 | 2021-05-25T12:02:25.732347Z | [https://pub.dev/api/packages/search_cep](https://pub.dev/api/packages/search_cep) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/search_cep` at `2026-09-05T06:22:58+00:00`.
...
- `pub_dev-ec2664c0a969dc` from `pub_dev` as `registry_expansion`
