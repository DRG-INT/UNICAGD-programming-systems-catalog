...
<!-- canonical: https://crates.io/crates/backon -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/backon](https://crates.io/crates/backon) |
| Source record ids | crates_io-156a56b1c90a4a |
...
For a systems engineer, backon belongs in the Rust inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.6.0 | 2025-10-18T14:26:03.985662Z | [https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=10&per_page=100&sort=downloads) |  |
...
| Evidence | Apache-2.0; https://www.nuget.org/packages/Confluent.SchemaRegistry.Serdes.Json/2.15.0/license |
...
- `crates_io-156a56b1c90a4a` from `crates_io` as `registry_expansion`
...
| cmake | Build System | [open](rust-cmake-cc6b32da.md) |
