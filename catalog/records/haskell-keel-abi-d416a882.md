...
<!-- canonical: https://hackage.haskell.org/package/keel-abi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/keel-abi](https://hackage.haskell.org/package/keel-abi) |
| Source record ids | hackage_recent-dffafcd891d797 |
...
For a systems engineer, keel-abi belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1.0 | 2026-09-03T12:55:26Z | [https://hackage.haskell.org/package/keel-abi](https://hackage.haskell.org/package/keel-abi) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/keel-abi` at `2026-09-03T16:25:12+00:00`.
...
- `hackage_recent-dffafcd891d797` from `hackage_recent` as `registry_expansion`
...
| telegram-api | Api Abi Checker | [open](haskell-telegram-api-b35e4b3f.md) |
