...
[Catalog index](../index.md) · [Language: nix](../by-language/nix.md) · [Category: Language Specification](../by-category/language-specification.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://nix.dev/manual/nix/stable/language/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://nix.dev/manual/nix/stable/language/](https://nix.dev/manual/nix/stable/language/) |
| Source record ids | curated_language_routes-16594b7a3787c3 |

## System Engineer Summary

Official Nix language manual for expressions, values, functions, derivations, imports, and
evaluation semantics.

## Operational Role

For a systems engineer, Nix Language belongs in the nix inventory as part of ecosystem capability
...
- `curated_language_routes-16594b7a3787c3` from `curated_language_routes` as `registry_expansion`
