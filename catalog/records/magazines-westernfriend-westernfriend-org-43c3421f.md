...
<!-- canonical: https://github.com/WesternFriend/westernfriend.org -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/WesternFriend/westernfriend.org](https://github.com/WesternFriend/westernfriend.org) |
| Source record ids | github_search_magazines-6179013ff065c3 |

## System Engineer Summary

A website for Western Friend (westernfriend.org), a Quaker publication that provides resources and
support for Quaker communities and individuals seeking to live out their faith in the world. Western
Friend is part of the Religious Society of Friends.

## Operational Role

For a systems engineer, WesternFriend/westernfriend.org belongs in the Magazines inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-10T19:34:25Z | gh search repos topic:magazine stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_magazines-6179013ff065c3` from `github_search_magazines` as `registry_expansion`
