...
| Canonical URL | [https://crates.io/crates/tauri](https://crates.io/crates/tauri) |
| Source record ids | crates_io-39c7b15049ffc7 |
...
For a systems engineer, tauri belongs in the Rust inventory as part of build graph control, artifact
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.11.5 | 2026-07-01T13:56:38.810372Z | [https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=18&per_page=100&sort=downloads) |  |
...
- `crates_io-39c7b15049ffc7` from `crates_io` as `registry_expansion`
