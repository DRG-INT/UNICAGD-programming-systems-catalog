...
<!-- canonical: https://github.com/open-meteo/geocoding-api -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/open-meteo/geocoding-api](https://github.com/open-meteo/geocoding-api) |
| Source record ids | github_search_maps-c7b7511b3136e3 |
...
For a systems engineer, open-meteo/geocoding-api belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.0 | 2026-07-27T15:53:37Z | [https://api.github.com/repos/open-meteo/geocoding-api/releases/latest](https://api.github.com/repos/open-meteo/geocoding-api/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/open-meteo/geocoding-api/releases/latest` at `2026-09-01T12:30:03+00:00`.
...
- `github_search_maps-c7b7511b3136e3` from `github_search_maps` as `registry_expansion`
...
| leontoeides/google_maps | Language Specification | [open](maps-leontoeides-google-maps-f8801bd0.md) |
