...
<!-- canonical: https://hackage.haskell.org/package/fast-arithmetic -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/fast-arithmetic](https://hackage.haskell.org/package/fast-arithmetic) |
| Source record ids | hackage_top_downloads-b3b910acec500f |
...
For a systems engineer, fast-arithmetic belongs in the Haskell inventory as part of language
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.6.7.0 | 2022-01-17T21:07:50Z | [https://hackage.haskell.org/package/fast-arithmetic](https://hackage.haskell.org/package/fast-arithmetic) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/fast-arithmetic` at `2026-09-01T14:24:15+00:00`.
...
- `hackage_top_downloads-b3b910acec500f` from `hackage_top_downloads` as `registry_expansion`
