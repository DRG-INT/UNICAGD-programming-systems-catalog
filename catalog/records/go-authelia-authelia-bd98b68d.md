...
<!-- canonical: https://github.com/authelia/authelia -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/authelia/authelia](https://github.com/authelia/authelia) |
| Source record ids | github_search_go-96540a5e9fe2d1 |

## System Engineer Summary

The Single Sign-On Multi-Factor portal for web apps. OpenID Certified™ and Post-Quantum Cryptography
Ready.

## Operational Role

For a systems engineer, authelia/authelia belongs in the Go inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-07T19:57:43Z | gh search repos language:Go stars:>3000 | gh_search_reports_activity_not_release_version |
...
- `github_search_go-96540a5e9fe2d1` from `github_search_go` as `registry_expansion`
