...
<!-- canonical: https://github.com/acgeospatial/awesome-earthobservation-code -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/acgeospatial/awesome-earthobservation-code](https://github.com/acgeospatial/awesome-earthobservation-code) |
| Source record ids | github_search_radars-1a45599879857c |

## System Engineer Summary

A curated list of awesome tools, tutorials, code, projects, links, stuff about Earth Observation,
Geospatial Satellite Imagery

## Operational Role

For a systems engineer, acgeospatial/awesome-earthobservation-code belongs in the Radars inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-05-13T19:36:13Z | gh search repos topic:remote-sensing stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_radars-1a45599879857c` from `github_search_radars` as `registry_expansion`
