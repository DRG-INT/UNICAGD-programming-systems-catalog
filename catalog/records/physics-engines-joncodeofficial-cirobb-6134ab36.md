...
<!-- canonical: https://github.com/joncodeofficial/Cirobb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/joncodeofficial/Cirobb](https://github.com/joncodeofficial/Cirobb) |
| Source record ids | github_search_physics_engines-9a162ea5387a3e |
...
For a systems engineer, joncodeofficial/Cirobb belongs in the Physics Engines inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-15T02:13:24Z | gh search repos topic:physics-engine stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_physics_engines-9a162ea5387a3e` from `github_search_physics_engines` as `registry_expansion`
