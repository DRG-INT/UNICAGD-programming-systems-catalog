...
<!-- canonical: https://github.com/dpaulat/supercell-wx -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dpaulat/supercell-wx](https://github.com/dpaulat/supercell-wx) |
| Source record ids | github_search_radars-1564d62f6e35cb |
...
For a systems engineer, dpaulat/supercell-wx belongs in the Radars inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v0.6.1-release | 2026-07-19T19:54:27Z | [https://api.github.com/repos/dpaulat/supercell-wx/releases/latest](https://api.github.com/repos/dpaulat/supercell-wx/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/dpaulat/supercell-wx/releases/latest` at `2026-09-01T08:26:28+00:00`.
...
- `github_search_radars-1564d62f6e35cb` from `github_search_radars` as `registry_expansion`
