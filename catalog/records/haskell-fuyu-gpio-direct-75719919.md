...
<!-- canonical: https://hackage.haskell.org/package/fuyu-gpio-direct -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/fuyu-gpio-direct](https://hackage.haskell.org/package/fuyu-gpio-direct) |
| Source record ids | hackage_recent-02ddd1d9509596 |
...
For a systems engineer, fuyu-gpio-direct belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0.0 | 2026-09-06T06:01:30Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-02ddd1d9509596` from `hackage_recent` as `registry_expansion`
