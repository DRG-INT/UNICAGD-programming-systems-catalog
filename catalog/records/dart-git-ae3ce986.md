...
<!-- canonical: https://pub.dev/packages/git -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/git](https://pub.dev/packages/git) |
| Source record ids | pub_dev-f01e52bc35248a |

## System Engineer Summary

Git command line wrapper. Exposes a Git directory abstraction that makes it easy to inspect and
manipulate a local Git repository.

## Operational Role

For a systems engineer, git belongs in the Dart inventory as part of build graph control, artifact
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.3.2 | 2025-09-04T23:24:34.918548Z | [https://pub.dev/api/packages/git](https://pub.dev/api/packages/git) |  |
| preview | known | 0.5.0-dev | 2018-03-09T17:49:00.936199Z | [https://pub.dev/api/packages/git](https://pub.dev/api/packages/git) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/git` at `2026-09-02T00:28:56+00:00`.
...
- `pub_dev-f01e52bc35248a` from `pub_dev` as `registry_expansion`
