...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Braces](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/braces.md) · [Category: Parser Lexer Ast](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/parser-lexer-ast.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://tree-sitter.github.io/tree-sitter/](https://tree-sitter.github.io/tree-sitter/) |
| Source record ids | curated_language_routes-9d02c545e5be6c |

## System Engineer Summary

Incremental parsing system used for brace-aware syntax trees, editor highlighting, navigation, and
structural tooling.

## Operational Role

For a systems engineer, tree-sitter belongs in the Braces inventory as part of language tooling,
...
- `curated_language_routes-9d02c545e5be6c` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| ANTLR grammars-v4 | Parser Lexer Ast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/braces-antlr-grammars-v4-d6d6e244.md) |
| TextMate Grammars | Parser Lexer Ast | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/braces-textmate-grammars-8cc36d2e.md) |
