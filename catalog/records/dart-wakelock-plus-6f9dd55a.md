...
<!-- canonical: https://pub.dev/packages/wakelock_plus -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/wakelock_plus](https://pub.dev/packages/wakelock_plus) |
| Source record ids | pub_dev-174d6f06c0f2b0 |
...
For a systems engineer, wakelock_plus belongs in the Dart inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.8.0 | 2026-09-01T00:55:50.915326Z | [https://pub.dev/api/packages/wakelock_plus](https://pub.dev/api/packages/wakelock_plus) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/wakelock_plus` at `2026-09-01T16:41:06+00:00`.
...
- `pub_dev-174d6f06c0f2b0` from `pub_dev` as `registry_expansion`
