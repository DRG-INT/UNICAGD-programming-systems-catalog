...
<!-- canonical: https://luarocks.org/modules/moyu/dromozoa-vecmath -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/moyu/dromozoa-vecmath](https://luarocks.org/modules/moyu/dromozoa-vecmath) |
| Source record ids | luarocks_root_manifest-5e20f590cfcbee |
...
For a systems engineer, dromozoa-vecmath belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-5e20f590cfcbee` from `luarocks_root_manifest` as `registry_expansion`
