...
<!-- canonical: https://github.com/tgfrerer/island -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tgfrerer/island](https://github.com/tgfrerer/island) |
| Source record ids | github_search_engines-4c3c65645cee57 |

## System Engineer Summary

🌋🐎 Project Island is an experimental, hot-reloading Vulkan Renderer for Linux and Windows, written
in C/C++.

## Operational Role

For a systems engineer, tgfrerer/island belongs in the Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T16:49:21Z | gh search repos topic:engine stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_engines-4c3c65645cee57` from `github_search_engines` as `registry_expansion`
