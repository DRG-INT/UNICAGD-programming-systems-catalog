...
<!-- canonical: https://github.com/c8r/iso -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/c8r/iso](https://github.com/c8r/iso) |
| Source record ids | github_search_effects-55ffcfbd205330 |
...
For a systems engineer, c8r/iso belongs in the Effects inventory as part of build graph control,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2018-06-03T18:44:56Z | gh search repos topic:compositor stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-55ffcfbd205330` from `github_search_effects` as `registry_expansion`
