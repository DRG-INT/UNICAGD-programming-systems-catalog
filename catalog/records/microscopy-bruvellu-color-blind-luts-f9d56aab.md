...
| Canonical URL | [https://github.com/bruvellu/color-blind-luts](https://github.com/bruvellu/color-blind-luts) |
| Source record ids | github_search_microscopy-f7dc68eb6fb3db |

## System Engineer Summary

Color blind friendly lookup tables for Fiji/ImageJ

## Operational Role

For a systems engineer, bruvellu/color-blind-luts belongs in the Microscopy inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v1.2.1 | 2023-02-01T23:56:55Z | [https://api.github.com/repos/bruvellu/color-blind-luts/releases/latest](https://api.github.com/repos/bruvellu/color-blind-luts/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/bruvellu/color-blind-luts/releases/latest` at `2026-09-01T08:26:17+00:00`.
...
- `github_search_microscopy-f7dc68eb6fb3db` from `github_search_microscopy` as `registry_expansion`
