...
<!-- canonical: https://luarocks.org/modules/tokyob0t/bundle.lua -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/tokyob0t/bundle.lua](https://luarocks.org/modules/tokyob0t/bundle.lua) |
| Source record ids | luarocks_root_manifest-763db214df5cc1 |

## System Engineer Summary

bundle.lua is tracked as a library record in the Lua family branch. The source did not provide a
...
For a systems engineer, bundle.lua belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-763db214df5cc1` from `luarocks_root_manifest` as `registry_expansion`
