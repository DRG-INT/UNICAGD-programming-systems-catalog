...
<!-- canonical: https://github.com/alphansahin/mmWaveSDR -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/alphansahin/mmWaveSDR](https://github.com/alphansahin/mmWaveSDR) |
| Source record ids | github_search_electromagnetoscopes-7d2b20dfe91f43 |

## System Engineer Summary

This repository includes the source codes for the mmWave SDR developed at the University of South
Carolina for the AERPAW at NCSU for wireless experimentation in millimeter-wave bands, e.g., 28 GHz
and 60 GHz.

## Operational Role

For a systems engineer, alphansahin/mmWaveSDR belongs in the Electromagnetoscopes inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-09-19T13:47:06Z | gh search repos topic:rf stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-7d2b20dfe91f43` from `github_search_electromagnetoscopes` as `registry_expansion`
