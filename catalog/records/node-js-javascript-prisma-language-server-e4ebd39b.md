...
<!-- canonical: https://www.npmjs.com/package/@prisma/language-server -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@prisma/language-server](https://www.npmjs.com/package/@prisma/language-server) |
| Source record ids | npm_registry-11c4a5fa323853 |

## System Engineer Summary

@prisma/language-server is tracked as a language specification record in the Node.js/JavaScript
...
For a systems engineer, @prisma/language-server belongs in the Node.js/JavaScript inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 31.12.8 | 2026-09-04T13:42:26.997Z | [https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- Latest stable metadata was observed from `https://registry.npmjs.org/-/v1/search?text=server&size=250&quality=0.35&popularity=0.45&maintenance=0.20` at `2026-09-04T14:18:59+00:00`.
...
- `npm_registry-11c4a5fa323853` from `npm_registry` as `registry_expansion`
