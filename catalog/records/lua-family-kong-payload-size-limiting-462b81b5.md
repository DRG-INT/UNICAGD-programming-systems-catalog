...
| Canonical URL | [https://luarocks.org/modules/rockymadden/kong-payload-size-limiting](https://luarocks.org/modules/rockymadden/kong-payload-size-limiting) |
| Source record ids | luarocks_root_manifest-b011972e8d6b8d |

## System Engineer Summary

A better request size limiting plugin for Kong

## Operational Role

For a systems engineer, kong-payload-size-limiting belongs in the Lua family inventory as part of
...
- `luarocks_root_manifest-b011972e8d6b8d` from `luarocks_root_manifest` as `registry_expansion`
