...
[Catalog index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../index.md) · [Language: Maps](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-language/maps.md) · [Category: Registry Repository](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../by-category/registry-repository.md) · [Release watch](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../release-watch.md) · [Apache/MIT license index](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/../license-index.md)
...
| Canonical URL | [https://www.openstreetmap.org/](https://www.openstreetmap.org/) |
| Source record ids | curated_language_routes-5cf8b854f05069 |

## System Engineer Summary

Collaborative map database and editing ecosystem for roads, places, routing, tiles, geocoding, and
geospatial applications.

## Operational Role

For a systems engineer, OpenStreetMap belongs in the Maps inventory as part of ecosystem capability
...
- `curated_language_routes-5cf8b854f05069` from `curated_language_routes` as `registry_expansion`
