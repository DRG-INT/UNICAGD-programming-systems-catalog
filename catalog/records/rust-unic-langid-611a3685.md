...
| Canonical URL | [https://crates.io/crates/unic-langid](https://crates.io/crates/unic-langid) |
| Source record ids | crates_io-b4f931112930e5 |
...
For a systems engineer, unic-langid belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.6 | 2025-05-09T16:47:21.641723Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
- `crates_io-b4f931112930e5` from `crates_io` as `registry_expansion`
