...
<!-- canonical: https://github.com/pixijs-userland/particle-emitter -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pixijs-userland/particle-emitter](https://github.com/pixijs-userland/particle-emitter) |
| Source record ids | github_search_effects-6404bc12601a3b |
...
For a systems engineer, pixijs-userland/particle-emitter belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | v5.0.8 | 2022-11-28T04:04:45Z | [https://api.github.com/repos/pixijs-userland/particle-emitter/releases/latest](https://api.github.com/repos/pixijs-userland/particle-emitter/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/pixijs-userland/particle-emitter/releases/latest` at `2026-09-01T09:23:13+00:00`.
...
- `github_search_effects-6404bc12601a3b` from `github_search_effects` as `registry_expansion`
