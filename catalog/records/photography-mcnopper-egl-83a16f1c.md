...
<!-- canonical: https://github.com/McNopper/EGL -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/McNopper/EGL](https://github.com/McNopper/EGL) |
| Source record ids | github_search_photography-45659e80af819e |

## System Engineer Summary

EGL 1.5 supporting OpenGL and HDR

## Operational Role

For a systems engineer, McNopper/EGL belongs in the Photography inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-01T18:15:48Z | gh search repos topic:hdr stars:>20 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-45659e80af819e` from `github_search_photography` as `registry_expansion`
