...
<!-- canonical: https://pypi.org/project/AdminToolsDjango/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/AdminToolsDjango/](https://pypi.org/project/AdminToolsDjango/) |
| Source record ids | pypi_simple-712a6599bcb673 |

## System Engineer Summary

AdminToolsDjango is tracked as a web framework record in the Python branch. The source did not
...
For a systems engineer, AdminToolsDjango belongs in the Python inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0.6 | 2023-06-03T12:38:01.591473Z | [https://pypi.org/pypi/AdminToolsDjango/json](https://pypi.org/pypi/AdminToolsDjango/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/AdminToolsDjango/json` at `2026-09-01T07:19:47+00:00`.
...
- `pypi_simple-712a6599bcb673` from `pypi_simple` as `registry_expansion`
