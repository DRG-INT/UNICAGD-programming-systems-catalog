...
<!-- canonical: http://kripken.github.io/emscripten-site/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [http://kripken.github.io/emscripten-site/](http://kripken.github.io/emscripten-site/) |
| Source record ids | awesome_list-246ea16aeee8fc |

## System Engineer Summary

Emscripten - LLVM-based project that compiles C and C++ is tracked as a compiler record in the
...
For a systems engineer, Emscripten - LLVM-based project that compiles C and C++ belongs in the
WebAssembly inventory as part of compiler selection, diagnostics behavior, target support, ABI
expectations, and build reproducibility.
...
- `awesome_list-246ea16aeee8fc` from `awesome_list` as `registry_expansion`
