...
<!-- canonical: https://github.com/tursodatabase/agentfs -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tursodatabase/agentfs](https://github.com/tursodatabase/agentfs) |
| Source record ids | github_search_databases-9b70af7ecf802d |
...
For a systems engineer, tursodatabase/agentfs belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-06-03T10:48:12Z | gh search repos topic:sqlite stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-9b70af7ecf802d` from `github_search_databases` as `registry_expansion`
