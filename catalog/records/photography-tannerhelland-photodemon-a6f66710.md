...
<!-- canonical: https://github.com/tannerhelland/PhotoDemon -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tannerhelland/PhotoDemon](https://github.com/tannerhelland/PhotoDemon) |
| Source record ids | github_search_photography-c2db5bf9e672d2 |
...
For a systems engineer, tannerhelland/PhotoDemon belongs in the Photography inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-18T17:17:58Z | gh search repos topic:image-processing stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-c2db5bf9e672d2` from `github_search_photography` as `registry_expansion`
