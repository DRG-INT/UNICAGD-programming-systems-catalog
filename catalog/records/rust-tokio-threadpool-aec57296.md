...
[Catalog index](../index.md) · [Language: Rust](../by-language/rust.md) · [Category: Concurrency Parallelism](../by-category/concurrency-parallelism.md) · [Release watch](../release-watch.md)
...
| Canonical URL | [https://crates.io/crates/tokio-threadpool](https://crates.io/crates/tokio-threadpool) |
| Source record ids | crates_io-de78ff886145b1 |
...
For a systems engineer, tokio-threadpool belongs in the Rust inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.18 | 2020-02-04T23:50:31.496978Z | [https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads) |  |
...
- `crates_io-de78ff886145b1` from `crates_io` as `registry_expansion`
