...
<!-- canonical: https://cran.r-project.org/web/packages/osmapiR/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/osmapiR/index.html](https://cran.r-project.org/web/packages/osmapiR/index.html) |
| Source record ids | cran_packages_by_date-8ee5cfccf22eff |

## System Engineer Summary

osmapiR is tracked as a filesystem os record in the R branch. The source did not provide a long
...
For a systems engineer, osmapiR belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.6 | 2026-09-04 19:00:03 UTC | [https://cran.r-project.org/web/packages/osmapiR/DESCRIPTION](https://cran.r-project.org/web/packages/osmapiR/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/osmapiR/DESCRIPTION` at `2026-09-04T20:19:05+00:00`.
...
- `cran_packages_by_date-8ee5cfccf22eff` from `cran_packages_by_date` as `registry_expansion`
