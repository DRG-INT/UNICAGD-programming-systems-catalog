...
<!-- canonical: https://github.com/WebAssembly/exception-handling -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/WebAssembly/exception-handling](https://github.com/WebAssembly/exception-handling) |
| Source record ids | github_search_webassembly-210d7c8e882db8 |
...
For a systems engineer, WebAssembly/exception-handling belongs in the WebAssembly inventory as part
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2025-03-20T12:59:27Z | gh search repos language:WebAssembly stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-210d7c8e882db8` from `github_search_webassembly` as `registry_expansion`
