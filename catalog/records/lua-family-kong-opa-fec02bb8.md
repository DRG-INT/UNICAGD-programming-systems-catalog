...
| Canonical URL | [https://luarocks.org/modules/dimi-f/kong-opa](https://luarocks.org/modules/dimi-f/kong-opa) |
| Source record ids | luarocks_root_manifest-f796d7b02fd049 |

## System Engineer Summary

kong-opa is tracked as a library record in the Lua family branch. The source did not provide a long
...
For a systems engineer, kong-opa belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-f796d7b02fd049` from `luarocks_root_manifest` as `registry_expansion`
