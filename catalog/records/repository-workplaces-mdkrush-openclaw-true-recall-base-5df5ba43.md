# mdkrush/openclaw-true-recall-base

## Navigation

[Catalog index](../index.md) · [Language: Repository Workplaces](../by-language/repository-workplaces.md) · [Category: Memory Analyzer](../by-category/memory-analyzer.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://gitlab.com/mdkrush/openclaw-true-recall-base -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://gitlab.com/mdkrush/openclaw-true-recall-base](https://gitlab.com/mdkrush/openclaw-true-recall-base) |
| Source record ids | gitlab_projects_api-119963e630e5e0 |

## System Engineer Summary

OpenClaw memory addon - True-Recall Base. Captures every conversation to local Qdrant database.

## Operational Role

For a systems engineer, mdkrush/openclaw-true-recall-base belongs in the Repository Workplaces
...
- `gitlab_projects_api-119963e630e5e0` from `gitlab_projects_api` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Gitea: deepim/flatbuffers | Memory Analyzer | [open](repository-workplaces-gitea-deepim-flatbuffers-d97eab34.md) |
| Gitea: lunny/size | Memory Analyzer | [open](repository-workplaces-gitea-lunny-size-39ab5da8.md) |
