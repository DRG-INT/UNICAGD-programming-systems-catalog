...
<!-- canonical: https://luarocks.org/modules/misanthropicbit/decipher.nvim -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/misanthropicbit/decipher.nvim](https://luarocks.org/modules/misanthropicbit/decipher.nvim) |
| Source record ids | luarocks_root_manifest-77e7d25eeab66c |
...
For a systems engineer, decipher.nvim belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-77e7d25eeab66c` from `luarocks_root_manifest` as `registry_expansion`
