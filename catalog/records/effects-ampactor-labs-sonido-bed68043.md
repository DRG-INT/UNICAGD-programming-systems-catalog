...
<!-- canonical: https://github.com/ampactor-labs/sonido -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/ampactor-labs/sonido](https://github.com/ampactor-labs/sonido) |
| Source record ids | github_search_effects-9af3f22ce48f76 |
...
For a systems engineer, ampactor-labs/sonido belongs in the Effects inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-31T01:13:57Z | gh search repos audio effects dsp | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-9af3f22ce48f76` from `github_search_effects` as `registry_expansion`
