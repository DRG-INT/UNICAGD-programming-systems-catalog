...
<!-- canonical: https://hackage.haskell.org/package/persistent-mongoDB -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/persistent-mongoDB](https://hackage.haskell.org/package/persistent-mongoDB) |
| Source record ids | hackage_top_downloads-fd84eda81aaa8e |
...
For a systems engineer, persistent-mongoDB belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.13.1.0 | 2024-09-13T15:11:56Z | [https://hackage.haskell.org/package/persistent-mongoDB](https://hackage.haskell.org/package/persistent-mongoDB) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/persistent-mongoDB` at `2026-09-01T07:24:03+00:00`.
...
- `hackage_top_downloads-fd84eda81aaa8e` from `hackage_top_downloads` as `registry_expansion`
