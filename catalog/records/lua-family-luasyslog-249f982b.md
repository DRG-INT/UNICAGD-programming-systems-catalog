...
<!-- canonical: https://luarocks.org/modules/luarocks/luasyslog -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/luarocks/luasyslog](https://luarocks.org/modules/luarocks/luasyslog) |
| Source record ids | lua-source-150 |
...
For a systems engineer, luasyslog belongs in the Lua family inventory as part of dependency
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 150}}` |
...
- `lua-source-150` from `master_json` as `source_list_item`
