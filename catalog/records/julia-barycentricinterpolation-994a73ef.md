...
<!-- canonical: https://github.com/JuliaRegistries/General/tree/master/B/BarycentricInterpolation -->
<!-- crawl-delay: 10 -->
...
| --- | --- | --- | --- |
| julia_general_registry | registry-derived | 2026-09-01 | `{"kind": "julia_general_registry", "registry_path": "B/BarycentricInterpolation", "retrieved": "2026-09-01", "status": "registry-derived"}` |
...
- `julia_general-d8d494f5137e6b` from `julia_general` as `registry_expansion`
