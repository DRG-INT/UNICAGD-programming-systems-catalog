...
[Catalog index](../index.md) · [Language: WebAssembly](../by-language/webassembly.md) · [Category: Profiler](../by-category/profiler.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/tracel-ai/burn -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/tracel-ai/burn](https://github.com/tracel-ai/burn) |
| Source record ids | github_search_webassembly-98439cfc7751ad |
...
For a systems engineer, tracel-ai/burn belongs in the WebAssembly inventory as part of hot-path
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T20:05:34Z | gh search repos topic:wasm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-98439cfc7751ad` from `github_search_webassembly` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| deepflowio/deepflow | Profiler | [open](webassembly-deepflowio-deepflow-68e659d6.md) |
| mtharrison/wasm-raytracer | Profiler | [open](webassembly-mtharrison-wasm-raytracer-f02716a0.md) |
