...
| Canonical URL | [https://crates.io/crates/tls_codec](https://crates.io/crates/tls_codec) |
| Source record ids | crates_io-a88f27b01d9bf4 |
...
For a systems engineer, tls_codec belongs in the Rust inventory as part of confidentiality,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2026-07-13T13:47:34.660960Z | [https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=19&per_page=100&sort=downloads) |  |
...
- `crates_io-a88f27b01d9bf4` from `crates_io` as `registry_expansion`
