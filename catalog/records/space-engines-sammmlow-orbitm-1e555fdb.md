...
[Catalog index](../index.md) · [Language: Space Engines](../by-language/space-engines.md) · [Category: Datetime](../by-category/datetime.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Canonical URL | [https://github.com/sammmlow/ORBITM](https://github.com/sammmlow/ORBITM) |
| Source record ids | github_search_space_engines-bfb5b91a5e4735 |

## System Engineer Summary

:earth_asia: :satellite: :earth_asia: :satellite: ORBITM - Orbit maintenance, propulsion sizing, and
life-time estimation of space objects!

## Operational Role

For a systems engineer, sammmlow/ORBITM belongs in the Space Engines inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.0 | 2021-04-15T07:24:31Z | [https://api.github.com/repos/sammmlow/ORBITM/releases/latest](https://api.github.com/repos/sammmlow/ORBITM/releases/latest) |  |
...
- Latest stable metadata was observed from `https://api.github.com/repos/sammmlow/ORBITM/releases/latest` at `2026-09-01T07:24:20+00:00`.
...
- `github_search_space_engines-bfb5b91a5e4735` from `github_search_space_engines` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| DJBen/Graviton | Datetime | [open](space-engines-djben-graviton-f877f6fa.md) |
| nasa/fprime | Datetime | [open](space-engines-nasa-fprime-2ac5a2cc.md) |
