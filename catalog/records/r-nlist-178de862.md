...
<!-- canonical: https://cran.r-project.org/web/packages/nlist/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/nlist/index.html](https://cran.r-project.org/web/packages/nlist/index.html) |
| Source record ids | cran_packages_by_date-de6baa4995254f |
...
For a systems engineer, nlist belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.5.0 | 2026-08-27 13:50:02 UTC | [https://cran.r-project.org/web/packages/nlist/DESCRIPTION](https://cran.r-project.org/web/packages/nlist/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/nlist/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-de6baa4995254f` from `cran_packages_by_date` as `registry_expansion`
