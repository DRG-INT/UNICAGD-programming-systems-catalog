...
| Source record ids | github_search_aims-14d78713b2653d |
...
For a systems engineer, Mintplex-Labs/anything-llm belongs in the "aim's" inventory as part of model
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-02T03:33:26Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-14d78713b2653d` from `github_search_aims` as `registry_expansion`
