...
<!-- canonical: https://cran.r-project.org/web/packages/rmgarch/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/rmgarch/index.html](https://cran.r-project.org/web/packages/rmgarch/index.html) |
| Source record ids | cran_packages_by_date-e47462af657489 |
...
For a systems engineer, rmgarch belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4-3 | 2026-09-13 23:50:02 UTC | [https://cran.r-project.org/web/packages/rmgarch/DESCRIPTION](https://cran.r-project.org/web/packages/rmgarch/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/rmgarch/DESCRIPTION` at `2026-09-14T00:28:12+00:00`.
...
- `cran_packages_by_date-e47462af657489` from `cran_packages_by_date` as `registry_expansion`
