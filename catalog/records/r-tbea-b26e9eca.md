...
<!-- canonical: https://cran.r-project.org/web/packages/tbea/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/tbea/index.html](https://cran.r-project.org/web/packages/tbea/index.html) |
| Source record ids | cran_packages_by_date-d422dd73b5111f |
...
For a systems engineer, tbea belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.8.0 | 2026-09-06 23:10:02 UTC | [https://cran.r-project.org/web/packages/tbea/DESCRIPTION](https://cran.r-project.org/web/packages/tbea/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/tbea/DESCRIPTION` at `2026-09-07T00:31:41+00:00`.
...
- `cran_packages_by_date-d422dd73b5111f` from `cran_packages_by_date` as `registry_expansion`
