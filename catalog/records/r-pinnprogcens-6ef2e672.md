...
<!-- canonical: https://cran.r-project.org/web/packages/PINNProgCens/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/PINNProgCens/index.html](https://cran.r-project.org/web/packages/PINNProgCens/index.html) |
| Source record ids | cran_packages_by_date-87749ac4ab5bed |

## System Engineer Summary

Physics-Informed Neural Networks for Progressive Censoring

## Operational Role

For a systems engineer, PINNProgCens belongs in the R inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.0 | 2026-08-09 08:10:15 UTC | [https://cran.r-project.org/web/packages/PINNProgCens/DESCRIPTION](https://cran.r-project.org/web/packages/PINNProgCens/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/PINNProgCens/DESCRIPTION` at `2026-09-01T14:20:25+00:00`.
...
- `cran_packages_by_date-87749ac4ab5bed` from `cran_packages_by_date` as `registry_expansion`
