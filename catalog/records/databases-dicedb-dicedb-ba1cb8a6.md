...
<!-- canonical: https://github.com/dicedb/dicedb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/dicedb/dicedb](https://github.com/dicedb/dicedb) |
| Source record ids | github_search_databases-c7a9fb343d5538 |

## System Engineer Summary

Open-source, low-latency key/value engine built on Valkey with query subscriptions and hierarchical
storage tiers.

## Operational Role

For a systems engineer, dicedb/dicedb belongs in the Databases inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-04-23T01:00:36Z | gh search repos topic:nosql stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-c7a9fb343d5538` from `github_search_databases` as `registry_expansion`
