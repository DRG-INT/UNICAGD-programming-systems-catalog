...
<!-- canonical: https://github.com/alash3al/redix -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/alash3al/redix](https://github.com/alash3al/redix) |
| Source record ids | github_search_databases-f0f09d20840c9f |

## System Engineer Summary

a very simple pure key => value storage system that speaks Redis protocol with Postgres as storage
engine and more

## Operational Role

For a systems engineer, alash3al/redix belongs in the Databases inventory as part of state
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-03-07T03:13:26Z | gh search repos topic:nosql stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-f0f09d20840c9f` from `github_search_databases` as `registry_expansion`
