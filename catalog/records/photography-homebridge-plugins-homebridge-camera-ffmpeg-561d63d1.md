...
<!-- canonical: https://github.com/homebridge-plugins/homebridge-camera-ffmpeg -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/homebridge-plugins/homebridge-camera-ffmpeg](https://github.com/homebridge-plugins/homebridge-camera-ffmpeg) |
| Source record ids | github_search_photography-32d3adef364c96 |
...
For a systems engineer, homebridge-plugins/homebridge-camera-ffmpeg belongs in the Photography
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-02-09T21:42:33Z | gh search repos topic:camera stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_photography-32d3adef364c96` from `github_search_photography` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| cristibaluta/Imagin-Raw | Interop Bindings | [open](photography-cristibaluta-imagin-raw-54672bc8.md) |
