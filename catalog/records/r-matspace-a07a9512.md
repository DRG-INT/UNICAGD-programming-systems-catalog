...
<!-- canonical: https://cran.r-project.org/web/packages/matSPACE/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/matSPACE/index.html](https://cran.r-project.org/web/packages/matSPACE/index.html) |
| Source record ids | cran_packages_by_date-55ab3b0bd001a0 |
...
For a systems engineer, matSPACE belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2026-09-14 07:00:08 UTC | [https://cran.r-project.org/web/packages/matSPACE/DESCRIPTION](https://cran.r-project.org/web/packages/matSPACE/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/matSPACE/DESCRIPTION` at `2026-09-14T08:22:23+00:00`.
...
- `cran_packages_by_date-55ab3b0bd001a0` from `cran_packages_by_date` as `registry_expansion`
