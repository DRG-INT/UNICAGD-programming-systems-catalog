...
| Canonical URL | [https://crates.io/crates/git-version](https://crates.io/crates/git-version) |
| Source record ids | crates_io-27215325febe21 |
...
For a systems engineer, git-version belongs in the Rust inventory as part of confidentiality,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.9 | 2023-12-13T18:22:15.286666Z | [https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=20&per_page=100&sort=downloads) |  |
...
- `crates_io-27215325febe21` from `crates_io` as `registry_expansion`
