...
<!-- canonical: https://cran.r-project.org/web/packages/haplo.stats/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/haplo.stats/index.html](https://cran.r-project.org/web/packages/haplo.stats/index.html) |
| Source record ids | cran_packages_by_date-f3ed240c88003b |
...
For a systems engineer, haplo.stats belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.9.9.1 | 2026-09-10 20:00:02 UTC | [https://cran.r-project.org/web/packages/haplo.stats/DESCRIPTION](https://cran.r-project.org/web/packages/haplo.stats/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/haplo.stats/DESCRIPTION` at `2026-09-10T20:18:42+00:00`.
...
- `cran_packages_by_date-f3ed240c88003b` from `cran_packages_by_date` as `registry_expansion`
