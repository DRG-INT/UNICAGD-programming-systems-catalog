...
<!-- canonical: https://pub.dev/packages/graphic -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/graphic](https://pub.dev/packages/graphic) |
| Source record ids | pub_dev-c1a27f1cc4dc02 |
...
For a systems engineer, graphic belongs in the Dart inventory as part of language tooling, code
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.7.0 | 2026-02-25T02:44:22.600809Z | [https://pub.dev/api/packages/graphic](https://pub.dev/api/packages/graphic) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/graphic` at `2026-09-01T15:35:56+00:00`.
...
- `pub_dev-c1a27f1cc4dc02` from `pub_dev` as `registry_expansion`
