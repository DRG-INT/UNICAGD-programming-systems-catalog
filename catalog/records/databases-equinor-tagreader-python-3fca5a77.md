...
<!-- canonical: https://github.com/equinor/tagreader-python -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/equinor/tagreader-python](https://github.com/equinor/tagreader-python) |
| Source record ids | github_search_databases-5c30d3b23641a2 |
...
For a systems engineer, equinor/tagreader-python belongs in the Databases inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T21:52:52Z | gh search repos topic:odbc stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-5c30d3b23641a2` from `github_search_databases` as `registry_expansion`
