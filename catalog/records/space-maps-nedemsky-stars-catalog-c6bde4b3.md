...
<!-- canonical: https://github.com/nedemsky/stars-catalog -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/nedemsky/stars-catalog](https://github.com/nedemsky/stars-catalog) |
| Source record ids | github_search_space_maps-343f50c9445332 |

## System Engineer Summary

Simple CRUD application using Spring, MyBatis, jQuery and BootStrap.

## Operational Role

For a systems engineer, nedemsky/stars-catalog belongs in the Space Maps inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2016-06-14T05:53:51Z | gh search repos star catalog | gh_search_reports_activity_not_release_version |
...
- `github_search_space_maps-343f50c9445332` from `github_search_space_maps` as `registry_expansion`
