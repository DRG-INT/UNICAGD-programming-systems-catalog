...
<!-- canonical: https://www.php.net/git.php -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.php.net/git.php](https://www.php.net/git.php) |
| Source record ids | curated_repository_workplace_routes-c12a4fee022420 |

## System Engineer Summary

Official PHP Git source access and workflow entry point.

## Operational Role

For a systems engineer, PHP Git Access belongs in the Repository Workplaces inventory as part of
...
- `curated_repository_workplace_routes-c12a4fee022420` from `curated_repository_workplace_routes` as `registry_expansion`
