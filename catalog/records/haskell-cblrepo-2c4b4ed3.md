...
<!-- canonical: https://hackage.haskell.org/package/cblrepo -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/cblrepo](https://hackage.haskell.org/package/cblrepo) |
| Source record ids | hackage_top_downloads-202ac989869225 |
...
For a systems engineer, cblrepo belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.24.0 | 2016-12-31T17:35:53Z | [https://hackage.haskell.org/package/cblrepo](https://hackage.haskell.org/package/cblrepo) |  |
| candidate | partial | 0.9.3 |  | [https://hackage.haskell.org/package/cblrepo](https://hackage.haskell.org/package/cblrepo) | hackage_candidate_date_missing |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/cblrepo` at `2026-09-09T00:34:54+00:00`.
...
- `hackage_top_downloads-202ac989869225` from `hackage_top_downloads` as `registry_expansion`
