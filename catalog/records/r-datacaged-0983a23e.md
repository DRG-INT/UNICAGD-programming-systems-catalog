...
<!-- canonical: https://cran.r-project.org/web/packages/datacaged/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/datacaged/index.html](https://cran.r-project.org/web/packages/datacaged/index.html) |
| Source record ids | cran_packages_by_date-1357b5d306eae9 |

## System Engineer Summary

CAGED Microdata Download and Storage in 'DuckDB'

## Operational Role

For a systems engineer, datacaged belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2026-09-09 16:40:07 UTC | [https://cran.r-project.org/web/packages/datacaged/DESCRIPTION](https://cran.r-project.org/web/packages/datacaged/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/datacaged/DESCRIPTION` at `2026-09-09T18:24:02+00:00`.
...
- `cran_packages_by_date-1357b5d306eae9` from `cran_packages_by_date` as `registry_expansion`
