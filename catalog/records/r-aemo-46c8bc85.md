...
<!-- canonical: https://cran.r-project.org/web/packages/aemo/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/aemo/index.html](https://cran.r-project.org/web/packages/aemo/index.html) |
| Source record ids | cran_packages_by_date-df7d1a97410c30 |
...
For a systems engineer, aemo belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.4.2 | 2026-09-09 10:40:33 UTC | [https://cran.r-project.org/web/packages/aemo/DESCRIPTION](https://cran.r-project.org/web/packages/aemo/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/aemo/DESCRIPTION` at `2026-09-09T12:25:57+00:00`.
...
- `cran_packages_by_date-df7d1a97410c30` from `cran_packages_by_date` as `registry_expansion`
