...
<!-- canonical: https://github.com/DrugowitschLab/VBLinLogit -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/DrugowitschLab/VBLinLogit](https://github.com/DrugowitschLab/VBLinLogit) |
| Source record ids | github_search_matlab-607b27b1cc9e27 |
...
For a systems engineer, DrugowitschLab/VBLinLogit belongs in the Matlab inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2019-06-27T02:25:44Z | gh search repos language:MATLAB topic:machine-learning | gh_search_reports_activity_not_release_version |
...
- `github_search_matlab-607b27b1cc9e27` from `github_search_matlab` as `registry_expansion`
