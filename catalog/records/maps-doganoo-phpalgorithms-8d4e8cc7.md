...
<!-- canonical: https://github.com/doganoo/PHPAlgorithms -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/doganoo/PHPAlgorithms](https://github.com/doganoo/PHPAlgorithms) |
| Source record ids | github_search_maps-ef13b230230ecd |

## System Engineer Summary

A collection of common algorithms implemented in PHP. The collection is based on "Cracking the
Coding Interview" by Gayle Laakmann McDowell

## Operational Role

For a systems engineer, doganoo/PHPAlgorithms belongs in the Maps inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-10-24T09:07:15Z | gh search repos topic:maps stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-ef13b230230ecd` from `github_search_maps` as `registry_expansion`
