...
[Catalog index](../index.md) · [Language: Julia](../by-language/julia.md) · [Category: Datetime](../by-category/datetime.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/JuliaRegistries/General/tree/master/C/CategoricalTimeSeries -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/JuliaRegistries/General/tree/master/C/CategoricalTimeSeries](https://github.com/JuliaRegistries/General/tree/master/C/CategoricalTimeSeries) |
| Source record ids | julia_general-6f688860de894d |

## System Engineer Summary

Julia package registered in General at C/CategoricalTimeSeries.

## Operational Role

For a systems engineer, CategoricalTimeSeries belongs in the Julia inventory as part of ecosystem
...
| Name | Category | Page |
| --- | --- | --- |
| BeliefUpdaters | Datetime | [open](julia-beliefupdaters-3ab772ea.md) |
| Calendars | Datetime | [open](julia-calendars-bebac7ca.md) |
| CFTime | Datetime | [open](julia-cftime-98b6c591.md) |
| CompTime | Datetime | [open](julia-comptime-6ac56cbf.md) |
