...
<!-- canonical: https://github.com/rundiwu/DeepCAD -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rundiwu/DeepCAD](https://github.com/rundiwu/DeepCAD) |
| Source record ids | github_search_computer_graphics_software-48a574b5be3a2f |
...
For a systems engineer, rundiwu/DeepCAD belongs in the Computer Graphics Software inventory as part
...
- `github_search_computer_graphics_software-48a574b5be3a2f` from `github_search_computer_graphics_software` as `registry_expansion`
