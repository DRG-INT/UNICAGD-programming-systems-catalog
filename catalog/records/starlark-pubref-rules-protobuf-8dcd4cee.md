...
<!-- canonical: https://github.com/pubref/rules_protobuf -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/pubref/rules_protobuf](https://github.com/pubref/rules_protobuf) |
| Source record ids | github_search_starlark-1af0ffb81c7a67 |
...
For a systems engineer, pubref/rules_protobuf belongs in the Starlark inventory as part of build
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2023-07-28T17:49:54Z | gh search repos topic:bazel rules stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_starlark-1af0ffb81c7a67` from `github_search_starlark` as `registry_expansion`
