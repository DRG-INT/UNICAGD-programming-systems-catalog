...
<!-- canonical: https://github.com/neondatabase/neon -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/neondatabase/neon](https://github.com/neondatabase/neon) |
| Source record ids | github_search_databases-a9193d52ec88ba |

## System Engineer Summary

Neon: Serverless Postgres. We separated storage and compute to offer autoscaling, code-like database
branching, and scale to zero.

## Operational Role

For a systems engineer, neondatabase/neon belongs in the Databases inventory as part of request
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-31T11:03:14Z | gh search repos topic:postgresql stars:>1000 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-a9193d52ec88ba` from `github_search_databases` as `registry_expansion`
