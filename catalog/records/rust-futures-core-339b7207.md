...
<!-- canonical: https://crates.io/crates/futures-core -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/futures-core](https://crates.io/crates/futures-core) |
| Source record ids | crates_io-6bcf0ec4b7135f |
...
For a systems engineer, futures-core belongs in the Rust inventory as part of model pipelines,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.34 | 2026-08-11T12:13:01.547638Z | [https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=1&per_page=100&sort=downloads) |  |
...
- `crates_io-6bcf0ec4b7135f` from `crates_io` as `registry_expansion`
