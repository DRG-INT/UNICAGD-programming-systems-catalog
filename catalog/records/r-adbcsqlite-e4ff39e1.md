...
<!-- canonical: https://cran.r-project.org/web/packages/adbcsqlite/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/adbcsqlite/index.html](https://cran.r-project.org/web/packages/adbcsqlite/index.html) |
| Source record ids | cran_packages_by_date-61f0b2b2d48afb |
...
For a systems engineer, adbcsqlite belongs in the R inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.24.0-2 | 2026-09-15 11:00:54 UTC | [https://cran.r-project.org/web/packages/adbcsqlite/DESCRIPTION](https://cran.r-project.org/web/packages/adbcsqlite/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/adbcsqlite/DESCRIPTION` at `2026-09-15T12:24:49+00:00`.
...
- `cran_packages_by_date-61f0b2b2d48afb` from `cran_packages_by_date` as `registry_expansion`
