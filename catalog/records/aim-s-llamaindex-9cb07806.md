...
[Catalog index](../index.md) · [Language: "aim's"](../by-language/aim-s.md) · [Category: Framework](../by-category/framework.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)
...
| Source record ids | curated_language_routes-0b90f0fe554b04 |

## System Engineer Summary

Data and retrieval framework for connecting LLM applications to documents, databases, indexes, and
tools.

## Operational Role

For a systems engineer, LlamaIndex belongs in the "aim's" inventory as part of ecosystem capability
...
- `curated_language_routes-0b90f0fe554b04` from `curated_language_routes` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| DSPy | Framework | [open](aim-s-dspy-39e05307.md) |
| LangChain | Framework | [open](aim-s-langchain-eed8b0c9.md) |
