...
<!-- canonical: https://packagist.org/packages/jenner/redis_sentinel -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/jenner/redis_sentinel](https://packagist.org/packages/jenner/redis_sentinel) |
| Source record ids | packagist_search-a4008aa6354efb |
...
For a systems engineer, jenner/redis_sentinel belongs in the PHP inventory as part of service
...
- `packagist_search-a4008aa6354efb` from `packagist_search` as `registry_expansion`
