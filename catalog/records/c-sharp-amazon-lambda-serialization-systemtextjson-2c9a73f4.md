...
<!-- canonical: https://www.nuget.org/packages/Amazon.Lambda.Serialization.SystemTextJson -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.nuget.org/packages/Amazon.Lambda.Serialization.SystemTextJson](https://www.nuget.org/packages/Amazon.Lambda.Serialization.SystemTextJson) |
| Source record ids | nuget_search-d1d32c23dd07fd |
...
For a systems engineer, Amazon.Lambda.Serialization.SystemTextJson belongs in the C-Sharp inventory
as part of wire formats, persistence, interoperability, and compatibility boundaries.

## Release Intelligence

| Channel | Status | Version | Date | Source | Reason |
| --- | --- | --- | --- | --- | --- |
| stable | known | 3.0.1 | 2026-08-17T22:27:21.623+00:00 | [https://api.nuget.org/v3/registration5-gz-semver2/amazon.lambda.serialization.systemtextjson/index.json](https://api.nuget.org/v3/registration5-gz-semver2/amazon.lambda.serialization.systemtextjson/index.json) |  |
...
| Evidence | The Unlicense; https://api.github.com/licenses/unlicense; Apache-2.0; https://www.nuget.org/packages/Amazon.Lambda.Serialization.SystemTextJson/3.0.1/license |
...
- Latest stable metadata was observed from `https://api.nuget.org/v3/registration5-gz-semver2/amazon.lambda.serialization.systemtextjson/index.json` at `2026-09-01T07:23:57+00:00`.
...
- `nuget_search-d1d32c23dd07fd` from `nuget_search` as `registry_expansion`
