...
| Canonical URL | [https://crates.io/crates/deadpool-postgres](https://crates.io/crates/deadpool-postgres) |
| Source record ids | crates_io-78890c64e85b7f |
...
For a systems engineer, deadpool-postgres belongs in the Rust inventory as part of concurrency
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.14.2 | 2026-08-26T15:14:50.266241Z | [https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=21&per_page=100&sort=downloads) |  |
...
- `crates_io-78890c64e85b7f` from `crates_io` as `registry_expansion`
