...
<!-- canonical: https://cran.r-project.org/web/packages/adbcdrivermanager/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/adbcdrivermanager/index.html](https://cran.r-project.org/web/packages/adbcdrivermanager/index.html) |
| Source record ids | cran_packages_by_date-a7fe2506639d2b |
...
For a systems engineer, adbcdrivermanager belongs in the R inventory as part of state persistence,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.24.0-2 | 2026-08-23 07:40:02 UTC | [https://cran.r-project.org/web/packages/adbcdrivermanager/DESCRIPTION](https://cran.r-project.org/web/packages/adbcdrivermanager/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/adbcdrivermanager/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-a7fe2506639d2b` from `cran_packages_by_date` as `registry_expansion`
