...
| Source record ids | github_search_electromagnetoscopes-5a249bced6f981 |

## System Engineer Summary

Python/C++ electromagnetic simulator for photonic devices using the finite-difference time-domain
(FDTD) method.
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-04T13:51:33Z | gh search repos topic:electromagnetics stars:>5 | gh_search_reports_activity_not_release_version |
...
- `github_search_electromagnetoscopes-5a249bced6f981` from `github_search_electromagnetoscopes` as `registry_expansion`
