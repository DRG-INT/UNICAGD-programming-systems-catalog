...
<!-- canonical: https://packagist.org/packages/kg-bot/laravel-localization-to-vue -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://packagist.org/packages/kg-bot/laravel-localization-to-vue](https://packagist.org/packages/kg-bot/laravel-localization-to-vue) |
| Source record ids | packagist_search-904ddb7e447516 |

## System Engineer Summary

Laravel package used to collect all localization files from resources/lang (and custom) directories
and sub-directories and make them available as JSON file

## Operational Role

For a systems engineer, kg-bot/laravel-localization-to-vue belongs in the PHP inventory as part of
...
- `packagist_search-904ddb7e447516` from `packagist_search` as `registry_expansion`
