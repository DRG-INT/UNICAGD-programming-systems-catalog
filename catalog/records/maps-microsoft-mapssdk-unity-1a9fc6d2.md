...
[Catalog index](../index.md) · [Language: Maps](../by-language/maps.md) · [Category: Documentation](../by-category/documentation.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/microsoft/MapsSDK-Unity -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/microsoft/MapsSDK-Unity](https://github.com/microsoft/MapsSDK-Unity) |
| Source record ids | github_search_maps-65f3db130f77aa |

## System Engineer Summary

This repository contains samples, documentation, and supporting scripts for Maps SDK, a Microsoft
Garage project.

## Operational Role

For a systems engineer, microsoft/MapsSDK-Unity belongs in the Maps inventory as part of operator
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2024-02-23T00:17:46Z | gh search repos topic:maps stars:>100 | gh_search_reports_activity_not_release_version |
...
- `github_search_maps-65f3db130f77aa` from `github_search_maps` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| Esri/arcgis-python-api | Documentation | [open](maps-esri-arcgis-python-api-81b2ba91.md) |
| OSM Wiki Map Features | Documentation | [open](maps-osm-wiki-map-features-2e7d7417.md) |
| shortbread-tiles/shortbread-docs | Documentation | [open](maps-shortbread-tiles-shortbread-docs-0c976170.md) |
