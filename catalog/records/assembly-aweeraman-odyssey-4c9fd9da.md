...
<!-- canonical: https://github.com/aweeraman/odyssey -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/aweeraman/odyssey](https://github.com/aweeraman/odyssey) |
| Source record ids | github_search_assembly-54767d3a64ff27 |
...
For a systems engineer, aweeraman/odyssey belongs in the Assembly inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-10-16T14:09:50Z | gh search repos topic:x86 topic:assembly | gh_search_reports_activity_not_release_version |
...
- `github_search_assembly-54767d3a64ff27` from `github_search_assembly` as `registry_expansion`
