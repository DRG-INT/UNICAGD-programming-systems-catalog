...
<!-- canonical: https://github.com/jankohlbach/real-world-shader -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jankohlbach/real-world-shader](https://github.com/jankohlbach/real-world-shader) |
| Source record ids | github_search_effects-78576e183fa7e1 |
...
For a systems engineer, jankohlbach/real-world-shader belongs in the Effects inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-07-27T09:40:22Z | gh search repos shader effects | gh_search_reports_activity_not_release_version |
...
- `github_search_effects-78576e183fa7e1` from `github_search_effects` as `registry_expansion`
