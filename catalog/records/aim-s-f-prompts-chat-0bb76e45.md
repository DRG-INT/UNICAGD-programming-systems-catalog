...
<!-- canonical: https://github.com/f/prompts.chat -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/f/prompts.chat](https://github.com/f/prompts.chat) |
| Source record ids | github_search_aims-ee1b52c7043ba0 |

## System Engineer Summary

f.k.a. Awesome ChatGPT Prompts. Share, discover, and collect prompts from the community. Free and
open source — self-host for your organization with complete privacy.

## Operational Role

For a systems engineer, f/prompts.chat belongs in the "aim's" inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T04:30:27Z | gh search repos topic:llm stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_aims-ee1b52c7043ba0` from `github_search_aims` as `registry_expansion`
