...
<!-- canonical: https://github.com/marvin-w/ccv2-kotlin-sdk -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/marvin-w/ccv2-kotlin-sdk](https://github.com/marvin-w/ccv2-kotlin-sdk) |
| Source record ids | github_search_sapjava-2ddf38ac214898 |

## System Engineer Summary

Java SDK for the SAP Commerce Cloud Version 2 API

## Operational Role

For a systems engineer, marvin-w/ccv2-kotlin-sdk belongs in the SAPJava inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2020-07-12T19:08:08Z | gh search repos SAP Cloud SDK Java | gh_search_reports_activity_not_release_version |
...
- `github_search_sapjava-2ddf38ac214898` from `github_search_sapjava` as `registry_expansion`
