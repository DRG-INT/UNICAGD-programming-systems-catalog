...
<!-- canonical: https://pypi.org/project/acmclient/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/acmclient/](https://pypi.org/project/acmclient/) |
| Source record ids | pypi_simple-c4b6b493be47d1 |
...
For a systems engineer, acmclient belongs in the Python inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2 | 2018-01-17T16:05:24.593269Z | [https://pypi.org/pypi/acmclient/json](https://pypi.org/pypi/acmclient/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/acmclient/json` at `2026-09-01T07:19:46+00:00`.
...
- `pypi_simple-c4b6b493be47d1` from `pypi_simple` as `registry_expansion`
