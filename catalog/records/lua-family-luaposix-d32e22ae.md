...
<!-- canonical: https://github.com/luaposix/luaposix -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/luaposix/luaposix](https://github.com/luaposix/luaposix) |
| Source record ids | lua-source-215 |
...
For a systems engineer, luaposix belongs in the Lua family inventory as part of ecosystem capability
...
| --- | --- | --- | --- |
| uploaded_file |  |  | `{"kind": "uploaded_file", "source": {"file": "readme.md", "kind": "uploaded_file", "line": 215}}` |
...
- `lua-source-215` from `master_json` as `source_list_item`
