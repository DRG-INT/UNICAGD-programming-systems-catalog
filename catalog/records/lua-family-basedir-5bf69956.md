...
<!-- canonical: https://luarocks.org/modules/mah0x211/basedir -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://luarocks.org/modules/mah0x211/basedir](https://luarocks.org/modules/mah0x211/basedir) |
| Source record ids | luarocks_root_manifest-e567123d093136 |

## System Engineer Summary

lua-basedir is a module that limits file and directory operations to be performed under a specified
directory.

## Operational Role

For a systems engineer, basedir belongs in the Lua family inventory as part of ecosystem capability
...
- `luarocks_root_manifest-e567123d093136` from `luarocks_root_manifest` as `registry_expansion`
