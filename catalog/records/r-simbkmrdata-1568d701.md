...
<!-- canonical: https://cran.r-project.org/web/packages/simBKMRdata/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/simBKMRdata/index.html](https://cran.r-project.org/web/packages/simBKMRdata/index.html) |
| Source record ids | cran_packages_by_date-ff09cf13dae99c |
...
For a systems engineer, simBKMRdata belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.2 | 2026-09-13 21:30:02 UTC | [https://cran.r-project.org/web/packages/simBKMRdata/DESCRIPTION](https://cran.r-project.org/web/packages/simBKMRdata/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/simBKMRdata/DESCRIPTION` at `2026-09-13T22:19:02+00:00`.
...
- `cran_packages_by_date-ff09cf13dae99c` from `cran_packages_by_date` as `registry_expansion`
