...
<!-- canonical: https://cran.r-project.org/web/packages/AsyPeer/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/AsyPeer/index.html](https://cran.r-project.org/web/packages/AsyPeer/index.html) |
| Source record ids | cran_packages_by_date-2627d09c07313f |
...
For a systems engineer, AsyPeer belongs in the R inventory as part of ecosystem capability mapping,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.0.1 | 2026-08-31 13:50:02 UTC | [https://cran.r-project.org/web/packages/AsyPeer/DESCRIPTION](https://cran.r-project.org/web/packages/AsyPeer/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/AsyPeer/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-2627d09c07313f` from `cran_packages_by_date` as `registry_expansion`
