...
<!-- canonical: https://cran.r-project.org/web/packages/dyadMLM/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/dyadMLM/index.html](https://cran.r-project.org/web/packages/dyadMLM/index.html) |
| Source record ids | cran_packages_by_date-483dba051527a2 |

## System Engineer Summary

Tools for Dyadic Multilevel Models

## Operational Role

For a systems engineer, dyadMLM belongs in the R inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.0 | 2026-08-21 05:43:58 UTC | [https://cran.r-project.org/web/packages/dyadMLM/DESCRIPTION](https://cran.r-project.org/web/packages/dyadMLM/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/dyadMLM/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-483dba051527a2` from `cran_packages_by_date` as `registry_expansion`
