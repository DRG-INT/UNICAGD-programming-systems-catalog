...
<!-- canonical: https://hackage.haskell.org/package/amazonka-dynamodb -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/amazonka-dynamodb](https://hackage.haskell.org/package/amazonka-dynamodb) |
| Source record ids | hackage_top_downloads-8d4a6305254d2b |
...
For a systems engineer, amazonka-dynamodb belongs in the Haskell inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0 | 2023-07-27T21:10:46Z | [https://hackage.haskell.org/package/amazonka-dynamodb](https://hackage.haskell.org/package/amazonka-dynamodb) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/amazonka-dynamodb` at `2026-09-01T14:24:05+00:00`.
...
- `hackage_top_downloads-8d4a6305254d2b` from `hackage_top_downloads` as `registry_expansion`
