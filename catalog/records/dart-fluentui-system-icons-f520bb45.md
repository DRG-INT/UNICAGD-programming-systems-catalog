...
<!-- canonical: https://pub.dev/packages/fluentui_system_icons -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/fluentui_system_icons](https://pub.dev/packages/fluentui_system_icons) |
| Source record ids | pub_dev-56c437305e824f |
...
For a systems engineer, fluentui_system_icons belongs in the Dart inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.1.273 | 2025-01-31T19:35:58.322881Z | [https://pub.dev/api/packages/fluentui_system_icons](https://pub.dev/api/packages/fluentui_system_icons) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/fluentui_system_icons` at `2026-09-01T14:20:31+00:00`.
...
- `pub_dev-56c437305e824f` from `pub_dev` as `registry_expansion`
