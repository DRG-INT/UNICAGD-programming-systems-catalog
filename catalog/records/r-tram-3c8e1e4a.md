...
<!-- canonical: https://cran.r-project.org/web/packages/tram/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/tram/index.html](https://cran.r-project.org/web/packages/tram/index.html) |
| Source record ids | cran_packages_by_date-6d8d7d6d1d650a |

## System Engineer Summary

tram is tracked as a formatter record in the R branch. The source did not provide a long
...
For a systems engineer, tram belongs in the R inventory as part of low-noise code review, style
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 1.4-5 | 2026-08-23 10:40:02 UTC | [https://cran.r-project.org/web/packages/tram/DESCRIPTION](https://cran.r-project.org/web/packages/tram/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/tram/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-6d8d7d6d1d650a` from `cran_packages_by_date` as `registry_expansion`
