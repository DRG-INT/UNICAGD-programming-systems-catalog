...
[Catalog index](../index.md) · [Language: Effects](../by-language/effects.md) · [Category: Image Audio Dsp](../by-category/image-audio-dsp.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/cutterbl/SoundTouchJS -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/cutterbl/SoundTouchJS](https://github.com/cutterbl/SoundTouchJS) |
| Source record ids | github_search_effects-0487b61ff57969 |

## System Engineer Summary

A JavaScript library for manipulating WebAudio Contexts, specifically for handling key changes

## Operational Role

For a systems engineer, cutterbl/SoundTouchJS belongs in the Effects inventory as part of ecosystem
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-03T17:39:09Z | gh search repos topic:audio-effects stars:>20 | gh_search_reports_activity_not_release_version |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-03 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:audio-effects stars:>20", "retrieved": "2026-09-03", "status": "forge-cli-derived"}` |
...
- `github_search_effects-0487b61ff57969` from `github_search_effects` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| afx1337/afxAudioEffects | Image Audio Dsp | [open](effects-afx1337-afxaudioeffects-d02ac96d.md) |
| aldebaro/dsp-audio | Image Audio Dsp | [open](effects-aldebaro-dsp-audio-1b6cfc46.md) |
| alexanderattar/dsp | Image Audio Dsp | [open](effects-alexanderattar-dsp-c82d4f48.md) |
| amsynth/amsynth | Image Audio Dsp | [open](effects-amsynth-amsynth-8b3d3dde.md) |
| andremichelle/openDAW | Image Audio Dsp | [open](effects-andremichelle-opendaw-162571f1.md) |
| ar1st0crat/NWaves | Image Audio Dsp | [open](effects-ar1st0crat-nwaves-4f5d754c.md) |
| BA17-loma-1/Audio_Signal_Processing_Toolbox | Image Audio Dsp | [open](effects-ba17-loma-1-audio-signal-processing-toolbox-15d836ba.md) |
| bajelidze/FPGA-Audio-Effects-System | Image Audio Dsp | [open](effects-bajelidze-fpga-audio-effects-system-f26bc7f5.md) |
