...
[Catalog index](../index.md) · [Language: Databases](../by-language/databases.md) · [Category: Interpreter Runtime](../by-category/interpreter-runtime.md) · [Release watch](../release-watch.md) · [Apache/MIT license index](../license-index.md)

<!-- robots.txt: compliant -->
<!-- canonical: https://github.com/jdbi/jdbi -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/jdbi/jdbi](https://github.com/jdbi/jdbi) |
| Source record ids | github_search_databases-52cdcec7559a20 |

## System Engineer Summary

The Jdbi library provides convenient, idiomatic access to relational databases in Java and other JVM
technologies such as Kotlin, Clojure or Scala.

## Operational Role

For a systems engineer, jdbi/jdbi belongs in the Databases inventory as part of runtime behavior,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-11T18:04:11Z | gh search repos topic:jdbc stars:>50 | gh_search_reports_activity_not_release_version |
...
| Evidence | Creative Commons Zero v1.0 Universal; https://api.github.com/licenses/cc0-1.0; GNU Affero General Public License v3.0; https://api.github.com/licenses/agpl-3.0; Apache License 2.0; https://api.github.com/licenses/apache-2.0 |
...
| --- | --- | --- | --- |
| github_cli_search | forge-cli-derived | 2026-09-11 | `{"command": "gh search repos", "kind": "github_cli_search", "query": "topic:jdbc stars:>50", "retrieved": "2026-09-11", "status": "forge-cli-derived"}` |
...
- `github_search_databases-52cdcec7559a20` from `github_search_databases` as `registry_expansion`
...
| Name | Category | Page |
| --- | --- | --- |
| activeloopai/deeplake | Interpreter Runtime | [open](databases-activeloopai-deeplake-8b22558d.md) |
| babyfish-ct/jimmer | Interpreter Runtime | [open](databases-babyfish-ct-jimmer-9ee1c78e.md) |
| builderz-labs/mission-control | Interpreter Runtime | [open](databases-builderz-labs-mission-control-fff15440.md) |
| guang19/framework-learning | Interpreter Runtime | [open](databases-guang19-framework-learning-16651c7a.md) |
| langchain4j/langchain4j | Interpreter Runtime | [open](databases-langchain4j-langchain4j-478395e2.md) |
| objectbox/objectbox-java | Interpreter Runtime | [open](databases-objectbox-objectbox-java-aa127825.md) |
| pubkey/rxdb | Interpreter Runtime | [open](databases-pubkey-rxdb-d6f509c0.md) |
