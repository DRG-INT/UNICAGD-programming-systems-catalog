...
| Canonical URL | [https://luarocks.org/modules/gonapps/gonapps-url-decoder](https://luarocks.org/modules/gonapps/gonapps-url-decoder) |
| Source record ids | luarocks_root_manifest-c8f625e78ecf53 |

## System Engineer Summary

gonapps-url-decoder is tracked as a library record in the Lua family branch. The source did not
...
For a systems engineer, gonapps-url-decoder belongs in the Lua family inventory as part of ecosystem
...
- `luarocks_root_manifest-c8f625e78ecf53` from `luarocks_root_manifest` as `registry_expansion`
