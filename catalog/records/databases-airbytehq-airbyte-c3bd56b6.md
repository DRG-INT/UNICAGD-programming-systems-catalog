...
<!-- canonical: https://github.com/airbytehq/airbyte -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/airbytehq/airbyte](https://github.com/airbytehq/airbyte) |
| Source record ids | github_search_databases-e5be0a54c9706c |

## System Engineer Summary

Open-source data movement for ELT pipelines and AI agents — from APIs, databases & files to
warehouses, lakes, and AI applications. Both self-hosted and Cloud.

## Operational Role

For a systems engineer, airbytehq/airbyte belongs in the Databases inventory as part of dependency
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-09-03T03:24:02Z | gh search repos topic:mysql stars:>500 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-e5be0a54c9706c` from `github_search_databases` as `registry_expansion`
