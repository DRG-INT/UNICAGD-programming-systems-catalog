...
<!-- canonical: https://crates.io/crates/snafu-derive -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/snafu-derive](https://crates.io/crates/snafu-derive) |
| Source record ids | crates_io-9e18b6b16e59cd |
...
For a systems engineer, snafu-derive belongs in the Rust inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.9.2 | 2026-07-21T17:52:49.322595Z | [https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads) |  |
...
- Latest stable metadata was observed from `https://crates.io/api/v1/crates?page=9&per_page=100&sort=downloads` at `2026-09-10T12:26:05+00:00`.
...
- `crates_io-9e18b6b16e59cd` from `crates_io` as `registry_expansion`
