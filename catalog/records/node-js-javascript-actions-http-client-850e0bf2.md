...
<!-- canonical: https://www.npmjs.com/package/@actions/http-client -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://www.npmjs.com/package/@actions/http-client](https://www.npmjs.com/package/@actions/http-client) |
| Source record ids | npm_registry-6c2a27bb25c94f |

## System Engineer Summary

@actions/http-client is tracked as a networking http record in the Node.js/JavaScript branch. The
...
For a systems engineer, @actions/http-client belongs in the Node.js/JavaScript inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.0.1 | 2026-04-21T21:42:26.809Z | [https://registry.npmjs.org/-/v1/search?text=http&size=250&quality=0.35&popularity=0.45&maintenance=0.20](https://registry.npmjs.org/-/v1/search?text=http&size=250&quality=0.35&popularity=0.45&maintenance=0.20) |  |
...
- `npm_registry-6c2a27bb25c94f` from `npm_registry` as `registry_expansion`
