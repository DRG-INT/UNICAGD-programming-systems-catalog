...
| Canonical URL | [https://unifiedfontobject.org/](https://unifiedfontobject.org/) |
| Source record ids | curated_language_routes-c5f44efcb8fd5a |

## System Engineer Summary

UFO font source format specification used for font design, interchange, and build workflows.

## Operational Role

For a systems engineer, Unified Font Object belongs in the Font Briefcase inventory as part of wire
...
- `curated_language_routes-c5f44efcb8fd5a` from `curated_language_routes` as `registry_expansion`
