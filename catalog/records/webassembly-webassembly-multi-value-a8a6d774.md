...
<!-- canonical: https://github.com/WebAssembly/multi-value -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/WebAssembly/multi-value](https://github.com/WebAssembly/multi-value) |
| Source record ids | github_search_webassembly-256395032e3ff8 |
...
For a systems engineer, WebAssembly/multi-value belongs in the WebAssembly inventory as part of
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2021-10-04T10:52:04Z | gh search repos language:WebAssembly stars:>50 | gh_search_reports_activity_not_release_version |
...
- `github_search_webassembly-256395032e3ff8` from `github_search_webassembly` as `registry_expansion`
