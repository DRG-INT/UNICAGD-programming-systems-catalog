...
<!-- canonical: https://crates.io/crates/x509-parser -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/x509-parser](https://crates.io/crates/x509-parser) |
| Source record ids | crates_io-5bb08a3fcfacbe |
...
For a systems engineer, x509-parser belongs in the Rust inventory as part of low-noise code review,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.18.1 | 2026-02-05T09:30:31.546618Z | [https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=7&per_page=100&sort=downloads) |  |
...
- `crates_io-5bb08a3fcfacbe` from `crates_io` as `registry_expansion`
