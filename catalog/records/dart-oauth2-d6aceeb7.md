...
<!-- canonical: https://pub.dev/packages/oauth2 -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pub.dev/packages/oauth2](https://pub.dev/packages/oauth2) |
| Source record ids | pub_dev-18cfa11c78feb8 |

## System Engineer Summary

A client library for authenticating with a remote service via OAuth2 on behalf of a user, and making
authorized HTTP requests with the user's OAuth2 credentials.

## Operational Role

For a systems engineer, oauth2 belongs in the Dart inventory as part of service communication,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.5 | 2025-10-20T14:33:39.626919Z | [https://pub.dev/api/packages/oauth2](https://pub.dev/api/packages/oauth2) |  |
| preview | known | 0.2.8-4 | 2012-12-13T01:37:14.834720Z | [https://pub.dev/api/packages/oauth2](https://pub.dev/api/packages/oauth2) |  |
...
- Latest stable metadata was observed from `https://pub.dev/api/packages/oauth2` at `2026-09-01T15:35:55+00:00`.
...
- `pub_dev-18cfa11c78feb8` from `pub_dev` as `registry_expansion`
