...
<!-- canonical: https://github.com/rpbouman/huey -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/rpbouman/huey](https://github.com/rpbouman/huey) |
| Source record ids | github_search_databases-0e43a02dbf8a71 |

## System Engineer Summary

Browser-based data analytics & BI with DuckDB-WASM. Privacy-first: your data stays local; no server
required.

## Operational Role

For a systems engineer, rpbouman/huey belongs in the Databases inventory as part of request routing,
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2026-08-23T20:03:47Z | gh search repos topic:olap stars:>200 | gh_search_reports_activity_not_release_version |
...
- `github_search_databases-0e43a02dbf8a71` from `github_search_databases` as `registry_expansion`
