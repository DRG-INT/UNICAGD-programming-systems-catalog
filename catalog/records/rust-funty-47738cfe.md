...
<!-- canonical: https://crates.io/crates/funty -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://crates.io/crates/funty](https://crates.io/crates/funty) |
| Source record ids | crates_io-9823344c459cf7 |
...
For a systems engineer, funty belongs in the Rust inventory as part of model pipelines, numerical
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 2.0.0 | 2023-01-29T04:40:16.975264Z | [https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads](https://crates.io/api/v1/crates?page=5&per_page=100&sort=downloads) |  |
...
- `crates_io-9823344c459cf7` from `crates_io` as `registry_expansion`
