...
| Canonical URL | [https://gitlab.freedesktop.org/pipewire/pipewire](https://gitlab.freedesktop.org/pipewire/pipewire) |
| Source record ids | curated_language_routes-00c96241e8da7a |

## System Engineer Summary

Linux multimedia server for audio/video routing, low-latency graph processing, devices, and session
integration.

## Operational Role

For a systems engineer, PipeWire belongs in the Audio inventory as part of ecosystem capability
...
- `curated_language_routes-00c96241e8da7a` from `curated_language_routes` as `registry_expansion`

## Related Records

| Name | Category | Page |
| --- | --- | --- |
| Faust | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/audio-faust-5ea678fe.md) |
| FFmpeg Audio | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/audio-ffmpeg-audio-ea69064f.md) |
| GStreamer | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/audio-gstreamer-de3f1993.md) |
| JUCE | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/audio-juce-3f2891c9.md) |
| libsndfile | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/audio-libsndfile-6065db3d.md) |
| PortAudio | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/audio-portaudio-40a7f336.md) |
| SoX | Image Audio Dsp | [open](https://github.com/DRG-INT/UNICAGD-programming-systems-catalog/blob/main/audio-sox-26fadc03.md) |
