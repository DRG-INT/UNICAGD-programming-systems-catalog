...
<!-- canonical: https://cran.r-project.org/web/packages/safestats/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/safestats/index.html](https://cran.r-project.org/web/packages/safestats/index.html) |
| Source record ids | cran_packages_by_date-91235c1a79dc7a |
...
For a systems engineer, safestats belongs in the R inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.8.8 | 2026-09-05 23:00:02 UTC | [https://cran.r-project.org/web/packages/safestats/DESCRIPTION](https://cran.r-project.org/web/packages/safestats/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/safestats/DESCRIPTION` at `2026-09-06T00:32:09+00:00`.
...
- `cran_packages_by_date-91235c1a79dc7a` from `cran_packages_by_date` as `registry_expansion`
