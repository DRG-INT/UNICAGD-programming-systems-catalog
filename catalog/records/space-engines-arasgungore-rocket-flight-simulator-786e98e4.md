...
<!-- canonical: https://github.com/arasgungore/rocket-flight-simulator -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://github.com/arasgungore/rocket-flight-simulator](https://github.com/arasgungore/rocket-flight-simulator) |
| Source record ids | github_search_space_engines-8cdafce8f83e62 |

## System Engineer Summary

A Simulink project which can accurately simulate the motion of a flying rocket in one-dimensional
space.

## Operational Role

For a systems engineer, arasgungore/rocket-flight-simulator belongs in the Space Engines inventory
...
| --- | --- | --- | --- | --- | --- |
| stable | partial |  | 2022-08-08T12:18:21Z | gh search repos topic:rocket-simulation stars:>10 | gh_search_reports_activity_not_release_version |
...
- `github_search_space_engines-8cdafce8f83e62` from `github_search_space_engines` as `registry_expansion`
