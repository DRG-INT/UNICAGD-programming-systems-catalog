...
<!-- canonical: https://cran.r-project.org/web/packages/spant/index.html -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://cran.r-project.org/web/packages/spant/index.html](https://cran.r-project.org/web/packages/spant/index.html) |
| Source record ids | cran_packages_by_date-dd90750529708c |
...
For a systems engineer, spant belongs in the R inventory as part of defect discovery, security
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 4.4.0 | 2026-08-24 16:20:02 UTC | [https://cran.r-project.org/web/packages/spant/DESCRIPTION](https://cran.r-project.org/web/packages/spant/DESCRIPTION) |  |
...
- Latest stable metadata was observed from `https://cran.r-project.org/web/packages/spant/DESCRIPTION` at `2026-09-01T07:19:53+00:00`.
...
- `cran_packages_by_date-dd90750529708c` from `cran_packages_by_date` as `registry_expansion`
