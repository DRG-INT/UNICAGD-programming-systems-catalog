...
<!-- canonical: https://hackage.haskell.org/package/warp-s2n-tls -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/warp-s2n-tls](https://hackage.haskell.org/package/warp-s2n-tls) |
| Source record ids | hackage_recent-ac4a69efbf5c4c |
...
For a systems engineer, warp-s2n-tls belongs in the Haskell inventory as part of confidentiality,
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.1.1.0 | 2026-09-08T18:39:54Z | [https://hackage.haskell.org/packages/recent](https://hackage.haskell.org/packages/recent) |  |
...
- `hackage_recent-ac4a69efbf5c4c` from `hackage_recent` as `registry_expansion`
