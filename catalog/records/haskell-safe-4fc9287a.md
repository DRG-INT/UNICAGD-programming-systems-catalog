...
<!-- canonical: https://hackage.haskell.org/package/safe -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://hackage.haskell.org/package/safe](https://hackage.haskell.org/package/safe) |
| Source record ids | hackage_top_downloads-c560758a70a6c4 |
...
For a systems engineer, safe belongs in the Haskell inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.3.21 | 2024-01-18T16:51:51Z | [https://hackage.haskell.org/package/safe](https://hackage.haskell.org/package/safe) |  |
...
- Latest stable metadata was observed from `https://hackage.haskell.org/package/safe` at `2026-09-01T14:24:29+00:00`.
...
- `hackage_top_downloads-c560758a70a6c4` from `hackage_top_downloads` as `registry_expansion`
