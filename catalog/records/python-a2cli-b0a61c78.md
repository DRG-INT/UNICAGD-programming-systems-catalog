...
<!-- canonical: https://pypi.org/project/a2cli/ -->
<!-- crawl-delay: 10 -->
...
| Canonical URL | [https://pypi.org/project/a2cli/](https://pypi.org/project/a2cli/) |
| Source record ids | pypi_simple-a96b6ada85a979 |
...
For a systems engineer, a2cli belongs in the Python inventory as part of ecosystem capability
...
| --- | --- | --- | --- | --- | --- |
| stable | known | 0.2.1 | 2025-09-16T15:43:04.421855Z | [https://pypi.org/pypi/a2cli/json](https://pypi.org/pypi/a2cli/json) |  |
...
- Latest stable metadata was observed from `https://pypi.org/pypi/a2cli/json` at `2026-09-01T07:19:44+00:00`.
...
- `pypi_simple-a96b6ada85a979` from `pypi_simple` as `registry_expansion`
