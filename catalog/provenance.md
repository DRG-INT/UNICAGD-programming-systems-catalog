...
| Kind | Status | Records |
| --- | --- | ---: |
| github_cli_search | forge-cli-derived | 1913 |
| npm_registry_search | registry-derived | 1437 |
| julia_general_registry | registry-derived | 1229 |
| crates_io | registry-derived | 1228 |
| luarocks_root_manifest | registry-derived | 858 |
| cran_available_packages_by_date | registry-derived | 801 |
...
| go_module_index | registry-derived | 387 |
...
| maven_central_search | registry-derived | 150 |
| gnu_octave_packages_index | registry-derived | 141 |
| hackage_top_downloads | registry-derived | 133 |
| gitlab_projects_api | forge-api-derived | 97 |
| github_repository_search | registry-derived | 89 |
...
- `HTTPError: https://api.github.com/repos/NebulaLumino/ai-visual-effects-shot-breakdown-compositor-brief/releases/latest: HTTP Error 404: Not Found`
...
- `HTTPError: https://api.github.com/repos/Prateek61/WayShade/releases/latest: HTTP Error 404: Not Found`
...
- `HTTPError: https://api.github.com/repos/YourGitbuddy/What-is-VFX-compositing/releases/latest: HTTP Error 404: Not Found`
...
- `HTTPError: https://api.github.com/repos/faithcure/NukeChat/releases/latest: HTTP Error 404: Not Found`
